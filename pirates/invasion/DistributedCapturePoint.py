from panda3d.core import BitMask32, CollideMask, CollisionNode, CollisionSphere, NodePath, Plane
...
class DistributedCapturePoint(DistributedHolidayObject.DistributedHolidayObject, DistributedMovingObject.DistributedMovingObject):
    ...
    def __init__(self, cr):
        ...
        self._DistributedCapturePoint__geomLoaded = 0
        self.anims = None
        self.uniqueId = ''
        ...
        if self.WantHpCheck:
            ...
            self._DistributedCapturePoint__maxHp = 0
        else:
            self.hp = 0
            self.maxHp = 0
        self.hpMeter = None
    ...
    if WantHpCheck:
        ...
        def get_hp(self):
            return self._DistributedCapturePoint__hp
        ...
        def get_maxHp(self):
            return self._DistributedCapturePoint__maxHp
