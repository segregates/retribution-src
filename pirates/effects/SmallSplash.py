...
class SmallSplash(PooledEffect, EffectController):
    ...
    def __init__(self):
        ...
        self.p0.renderer.setInitialXScale(0.0299 * self.cardScale)
    ...
    def createTrack(self):
        ...
        self.track = Sequence(Func(playSplashSfx), Func(self.p0.setBirthRate, 0.149), Func(self.p0.clearToInitial), Func(self.f.start, self, self.particleDummy), Func(self.f.reparentTo, self), Wait(0.299), Func(self.p0.setBirthRate, 100), Wait(4.0), Func(self.cleanUpEffect))
