...
class Squadrons:
    ...
    Quad_Eitc = (4, [
        ShipGlobals.EITC_TYRANT])
    Quad_Navy = (4, [
        ShipGlobals.NAVY_ELITE])
    Duo_Eitc_Hard = (2, [
...
FleetHolidayConfigs = {
    ...
    Configs.TF_EITC_RAND_KH_P_E: {
        ...
        'formation': ShipGlobals.FORMATION_ARROW,
        'countdown': [
            (Msgs.TF_EitcWarn10min, 5),
            (Msgs.TF_EitcWarn5min, 5)],
    ...
    Configs.TF_NAVY_RAND_KH_P_E: {
        ...
        'formation': ShipGlobals.FORMATION_ARROW,
        'countdown': [
            (Msgs.TF_NavyWarn10min, 5),
            (Msgs.TF_NavyWarn5min, 5)],
    ...
    Configs.TEST: {
        ...
        'formation': ShipGlobals.FORMATION_ARROW,
        'countdown': [
            (Msgs.TF_EitcWarn10min, 0.25),
            (Msgs.TF_EitcWarn5min, 0.25)],
        'launchMsg': Msgs.TF_EitcWarn0min,
        'escapedMsg': Msgs.TF_EitcEscaped,
        'defeatedMsg': Msgs.TF_EitcDefeated,
        'dates': HolidayDates(HolidayDates.TYPE_CUSTOM, [
            (2010, Month.JANUARY, 29, 19, 2, 0),
            (2010, Month.JANUARY, 29, 20, 0, 0)]) } }
