        ...
        '1141410776.53sdnaik': {
            ...
            'Objects': {
                '1135280776.06dzlu': {
                    'Type': 'Island',
                    'Name': 'Bilgewater',
                    'File': 'BilgewaterSwampIsland',
                    'Hpr': VBase3(-25.350, 0.0, 0.0),
                    'Objects': {
                        '1141788542.31sdnaik': {
                            'Type': 'LOD Sphere',
                ...
                '1142018473.22dxschafe': {
                    ...
                    'Objects': {
                        '1142029069.97sdnaik': {
                            'Type': 'LOD Sphere',
                            'Hpr': Point3(0.0, 0.0, 0.0),
                            'Pos': Point3(-381.021, 650.921, 455.237),
                            'Radi': [
                                3114,
                                3414,
                                3714],
                            'Scale': VBase3(1.0, 1.0, 1.0) } },
                    'Pos': Point3(2557.762, -9338.2520000000004, 0.0),
                    'Scale': VBase3(1.0, 1.0, 1.0),
                    'Visual': {
