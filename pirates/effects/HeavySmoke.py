...
class HeavySmoke(PooledEffect, EffectController):
    ...
    def __init__(self, parent = None):
        ...
        self.p0.renderer.getColorInterpolationManager().addLinear(0.0, 0.25, Vec4(1.0, 0.299, 0.0, 0.5), Vec4(1.0, 1.0, 1.0, 1.0), 1)
        ...
        self.p0.renderer.setFinalXScale(0.598 * self.cardScale)
        self.p0.renderer.setFinalYScale(0.598 * self.cardScale)
    ...
    def setScale(self, scale = VBase3(1, 1, 1)):
        ...
        self.p0.renderer.setInitialXScale(0.149 * self.cardScale * self.effectScale)
        self.p0.renderer.setInitialYScale(0.149 * self.cardScale * self.effectScale)
        self.p0.renderer.setFinalXScale(0.598 * self.cardScale * self.effectScale)
        self.p0.renderer.setFinalYScale(0.598 * self.cardScale * self.effectScale)
