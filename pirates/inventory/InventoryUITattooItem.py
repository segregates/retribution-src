from panda3d.core import Buffer, Camera, CardMaker, DisplayRegion, Lens, Mat4, NodePath, PerspectiveLens, TextNode, Texture, TransformState, Vec2, Vec3, Vec4
...
class InventoryUITattooItem(InventoryUIItem.InventoryUIItem):
    ...
    def __init__(self, manager, itemTuple, imageScaleFactor = 0.95):
