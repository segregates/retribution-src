...
class ShipTargetPanel(GuiTray.GuiTray):
    ...
    def destroyGui(self):
        if self.shipDisplay:
            self.shipDisplay.remove_node()
            self.shipDisplay = None

        if self.hpMeter:
            self.hpMeter.remove_node()
            self.hpMeter = None

        if self.speedMeter:
            self.speedMeter.remove_node()
            self.speedMeter = None

        if self.nameBox:
            self.nameBox.remove_node()
            self.nameBox = None

        if self.classBox:
            self.classBox.remove_node()
            self.classBox = None
        ...
        if self.boardingButton:
            self.boardingButton.remove_node()
            self.boardingButton = None
