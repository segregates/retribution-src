...
class ShipSinkSplashes(PooledEffect, EffectController):
    ...
    def createTrack(self):
        ...
        self.startEffect = Sequence(Func(self.p0.setBirthRate, 0.100), Func(self.p0.clearToInitial), Func(self.p1.setBirthRate, 0.01), Func(self.p1.clearToInitial), Func(self.f.start, self, self.particleDummy), Func(self.f.reparentTo, self))
    ...
    def setEffectScale(self, scale):
        ...
        self.p1.renderer.setInitialXScale(0.050000 * self.card2Scale * scale)
        self.p1.renderer.setFinalXScale(0.200 * self.card2Scale * scale)
        self.p1.renderer.setInitialYScale(0.100 * self.card2Scale * scale)
        self.p1.renderer.setFinalYScale(0.149 * self.card2Scale * scale)
