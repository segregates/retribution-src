from panda3d.core import Camera, Mat3, NodePath, Point3, Vec3, Vec4, lookAt
...
class CombatAnimations:
    ...
    def getEvilEye(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        def startVFX():
            ...
            if attuneEffect:
                ...
                attuneEffect.play()
                if target:
                    if hasattr(target, 'creature') and target.creature:
                        if not target.creature.headNode.isEmpty():
                            targetPos = target.creature.headNode.getPos(render)
                        else:
    ...
    def getBroadsideLeft(self, av, skillId, ammoSkillId, charge = 0, target = None, skillResult = None):
        ival = Parallel(Sequence(Func(self.lockInput, av), Func(av.setChatAbsolute, PLocalizer.getLeftBroadsidePhrase(), CFSpeech | CFTimeout), Func(base.talkAssistant.receiveOpenTalk, av.doId, av.getName(), PLocalizer.getLeftBroadsidePhrase(), av.hasGMChat())), Sequence(Wait(1.0), Func(self.unlockInput, av)))
        return ival


    def getBroadsideRight(self, av, skillId, ammoSkillId, charge = 0, target = None, skillResult = None):
        ival = Parallel(Sequence(Func(self.lockInput, av), Func(av.setChatAbsolute, PLocalizer.getRightBroadsidePhrase(), CFSpeech | CFTimeout), Func(base.talkAssistant.receiveOpenTalk, av.doId, av.getName(), PLocalizer.getRightBroadsidePhrase(), av.hasGMChat())), Sequence(Wait(1.0), Func(self.unlockInput, av)))
        return ival
    ...
    def getFullSail(self, av, skillId, ammoSkillId, charge = 0, target = None, skillResult = None):
        ...
        ival = Parallel(Sequence(Func(self.lockInput, av), Func(av.setChatAbsolute, PLocalizer.getFullSailPhrase(), CFSpeech | CFTimeout), Func(base.talkAssistant.receiveOpenTalk, av.doId, av.getName(), PLocalizer.getFullSailPhrase(), av.hasGMChat())), Func(playSfx), Sequence(Wait(1.0), Func(self.unlockInput, av)))
        del playSfx
        return ival


    def getComeAbout(self, av, skillId, ammoSkillId, charge = 0, target = None, skillResult = None):
        ival = Parallel(Sequence(Func(self.lockInput, av), Func(av.setChatAbsolute, PLocalizer.getComeAboutPhrase(), CFSpeech | CFTimeout), Func(base.talkAssistant.receiveOpenTalk, av.doId, av.getName(), PLocalizer.getComeAboutPhrase(), av.hasGMChat())), Sequence(Wait(1.0), Func(self.unlockInput, av)))
        return ival
    ...
    def getRammingSpeed(self, av, skillId, ammoSkillId, charge = 0, target = None, skillResult = None):
        ...
        ival = Parallel(Sequence(Func(self.lockInput, av), Func(av.setChatAbsolute, PLocalizer.RammingSpeed, CFSpeech | CFTimeout), Func(base.talkAssistant.receiveOpenTalk, av.doId, av.getName(), PLocalizer.RammingSpeed, av.hasGMChat())), Func(playSfx), Sequence(Wait(1.0), Func(self.unlockInput, av)))
        del playSfx
        return ival


    def getOpenFire(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ival = Parallel(Sequence(Func(self.lockInput, av), Func(av.setChatAbsolute, PLocalizer.getOpenFirePhrase(), CFSpeech | CFTimeout), Func(base.talkAssistant.receiveOpenTalk, av.doId, av.getName(), PLocalizer.getOpenFirePhrase(), av.hasGMChat())), Sequence(Wait(1.0), Func(self.unlockInput, av)))
        return ival


    def getTakeCover(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ival = Parallel(Sequence(Func(self.lockInput, av), Func(av.setChatAbsolute, PLocalizer.getTakeCoverPhrase(), CFSpeech | CFTimeout), Func(base.talkAssistant.receiveOpenTalk, av.doId, av.getName(), PLocalizer.getTakeCoverPhrase(), av.hasGMChat())), Sequence(Wait(1.0), Func(self.unlockInput, av)))
        return ival


    def getPowerRecharge(self, av, skillId, ammoSkillId, charge = 0, target = None, skillResult = None):
        ival = Parallel(Sequence(Func(self.lockInput, av), Func(av.setChatAbsolute, PLocalizer.getPowerRechargePhrase(), CFSpeech | CFTimeout), Func(base.talkAssistant.receiveOpenTalk, av.doId, av.getName(), PLocalizer.getPowerRechargePhrase(), av.hasGMChat())), Sequence(Wait(1.0), Func(self.unlockInput, av)))
        return ival


    def getWreckHull(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ival = Parallel(Sequence(Func(self.lockInput, av), Func(av.setChatAbsolute, PLocalizer.getWreckHullPhrase(), CFSpeech | CFTimeout), Func(base.talkAssistant.receiveOpenTalk, av.doId, av.getName(), PLocalizer.getWreckHullPhrase(), av.hasGMChat())), Sequence(Wait(1.0), Func(self.unlockInput, av)))
        return ival


    def getWreckMasts(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ival = Parallel(Sequence(Func(self.lockInput, av), Func(av.setChatAbsolute, PLocalizer.getWreckMastsPhrase(), CFSpeech | CFTimeout), Func(base.talkAssistant.receiveOpenTalk, av.doId, av.getName(), PLocalizer.getWreckMastsPhrase(), av.hasGMChat())), Sequence(Wait(1.0), Func(self.unlockInput, av)))
        return ival


    def getSinkHer(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ival = Parallel(Sequence(Func(self.lockInput, av), Func(av.setChatAbsolute, PLocalizer.getSinkHerPhrase(), CFSpeech | CFTimeout), Func(base.talkAssistant.receiveOpenTalk, av.doId, av.getName(), PLocalizer.getSinkHerPhrase(), av.hasGMChat())), Sequence(Wait(1.0), Func(self.unlockInput, av)))
        return ival


    def getIncoming(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ival = Parallel(Sequence(Func(self.lockInput, av), Func(av.setChatAbsolute, PLocalizer.getIncomingPhrase(), CFSpeech | CFTimeout), Func(base.talkAssistant.receiveOpenTalk, av.doId, av.getName(), PLocalizer.getIncomingPhrase(), av.hasGMChat())), Sequence(Wait(1.0), Func(self.unlockInput, av)))
        return ival


    def getFixItNow(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ival = Parallel(Sequence(Func(self.lockInput, av), Func(av.setChatAbsolute, PLocalizer.getFixItNowPhrase(), CFSpeech | CFTimeout), Func(base.talkAssistant.receiveOpenTalk, av.doId, av.getName(), PLocalizer.getFixItNowPhrase(), av.hasGMChat())), Sequence(Wait(1.0), Func(self.unlockInput, av)))
        return ival
