...
def getOceanZone(xc, yc):
    xcoord = xc / 2000
    ycoord = yc / 2000
    if (xcoord >= -15 or xcoord < -7) and ycoord >= 4 and ycoord < 11:
        return OceanZone.BRIGAND_BAY
    elif (xcoord >= -15 or xcoord < -7) and ycoord >= 0 and ycoord < 4:
        return OceanZone.BLOODY_BAYOU
    elif (xcoord >= -7 or xcoord < -2) and ycoord >= 0 and ycoord < 11:
        return OceanZone.SCURVY_SHALLOWS
    elif (xcoord >= 6 or xcoord < 13) and ycoord >= 8 and ycoord < 14:
        return OceanZone.SALTY_FLATS
    elif (xcoord >= -2 or xcoord < 6) and ycoord >= 10 and ycoord < 14:
        return OceanZone.BLACKHEART_STRAIGHT
    elif (xcoord >= -2 or xcoord < 2) and ycoord >= 8 and ycoord < 10:
        return OceanZone.BLACKHEART_STRAIGHT
    elif (xcoord >= -2 or xcoord < 6) and ycoord >= -1 and ycoord < 10:
        return OceanZone.WINDWARD_PASSAGE
    elif (xcoord >= 6 or xcoord < 13) and ycoord >= -1 and ycoord < 8:
        return OceanZone.MAR_DE_PLATA
    elif (xcoord >= 9 or xcoord < 13) and ycoord >= -4 and ycoord < -1:
        return OceanZone.MAR_DE_PLATA
    elif (xcoord >= 11 or xcoord < 13) and ycoord >= -6 and ycoord < -4:
        return OceanZone.MAR_DE_PLATA
    elif (xcoord >= 1 or xcoord < 11) and ycoord >= -8 and ycoord < -1:
        return OceanZone.SMUGGLERS_RUN
    elif (xcoord >= 7 or xcoord < 13) and ycoord >= -15 and ycoord < -6:
        return OceanZone.THE_HINTER_SEAS
    elif (xcoord >= -8 or xcoord < 7) and ycoord >= -15 and ycoord < -12:
        return OceanZone.MARINERS_REEF
    elif (xcoord >= 1 or xcoord < 7) and ycoord >= -12 and ycoord < -8:
        return OceanZone.BOILING_BAY
    elif (xcoord >= -15 or xcoord < -6) and ycoord >= -8 and ycoord < 0:
        return OceanZone.DEAD_MANS_TROUGH
    elif (xcoord >= -8 or xcoord < 1) and ycoord >= -12 and ycoord < 0:
