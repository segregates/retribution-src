...
class WaterRippleSplash(PooledEffect, EffectController):
    ...
    def __init__(self, parent = None):
        ...
        self.p1.renderer.setUserAlpha(0.200)
        ...
        self.p1.renderer.setInitialXScale(0.0149 * self.cardScale)
        self.p1.renderer.setFinalXScale(0.00500 * self.cardScale)
        self.p1.renderer.setInitialYScale(0.00500 * self.cardScale)
        ...
        self.p1.renderer.getColorInterpolationManager().addLinear(0.598, 1.0, Vec4(1.0, 1.0, 1.0, 1.0), Vec4(1.0, 1.0, 1.0, 0.0), 1)
