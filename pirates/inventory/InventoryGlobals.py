...
class Locations:
    ...
    RANGE_EQUIP_WEAPONS = (FIRST_LOCATION, 4)
    ...
    RANGE_CLOTHES = (60, 94)
    CLOTHING_TYPE_TO_RANGE = {
        ClothingGlobals.HAT: RANGE_EQUIP_HAT_CLOTHES,
        ClothingGlobals.SHIRT: RANGE_EQUIP_SHIRT_CLOTHES,
        ClothingGlobals.VEST: RANGE_EQUIP_VEST_CLOTHES,
        ClothingGlobals.COAT: RANGE_EQUIP_COAT_CLOTHES,
        ClothingGlobals.BELT: RANGE_EQUIP_BELT_CLOTHES,
        ClothingGlobals.PANT: RANGE_EQUIP_PANTS_CLOTHES,
    ...
    JEWELRY_RANGE_TO_LOCATION = {
        RANGE_EQUIP_R_EYEBROW_JEWELRY: JewelryGlobals.RBROW,
        RANGE_EQUIP_L_EYEBROW_JEWELRY: JewelryGlobals.LBROW,
        RANGE_EQUIP_R_EAR_JEWELRY: JewelryGlobals.REAR,
        RANGE_EQUIP_L_EAR_JEWELRY: JewelryGlobals.LEAR,
        RANGE_EQUIP_NOSE_JEWELRY: JewelryGlobals.NOSE,
        RANGE_EQUIP_LIP_JEWELRY: JewelryGlobals.MOUTH,
        RANGE_EQUIP_R_FINGER_JEWELRY: JewelryGlobals.RHAND,
        RANGE_EQUIP_L_FINGER_JEWELRY: JewelryGlobals.LHAND }
    ...
    TATTOO_RANGE_TO_LOCATION = {
        RANGE_EQUIP_L_ARM_TATTOO: TattooGlobals.ZONE2,
        RANGE_EQUIP_R_ARM_TATTOO: TattooGlobals.ZONE3,
        RANGE_EQUIP_CHEST_TATTOO: TattooGlobals.ZONE1,
        RANGE_EQUIP_FACE_TATTOO: TattooGlobals.ZONE4 }
    RANGE_JEWELERY_AND_TATTOO = (116, 143)
    JEWLERY_TYPE_TO_RANGE = {
        ItemGlobals.BROW: RANGE_EQUIP_BROW_JEWELRY,
        ItemGlobals.EAR: RANGE_EQUIP_EAR_JEWELRY,
        ItemGlobals.NOSE: RANGE_EQUIP_NOSE_JEWELRY,
        ItemGlobals.MOUTH: RANGE_EQUIP_LIP_JEWELRY,
        ItemGlobals.HAND: RANGE_EQUIP_HAND_JEWELRY }
    TATTOO_TYPE_TO_RANGE = {
        ItemGlobals.FACE: RANGE_EQUIP_FACE_TATTOO,
        ItemGlobals.ARM: RANGE_EQUIP_ARM_TATTOO,
        ItemGlobals.CHEST: RANGE_EQUIP_CHEST_TATTOO }
    ...
    LOCATION_RANGES = {
        InventoryType.ItemTypeWeapon: ((RANGE_WEAPONS[0], RANGE_WEAPONS[1]),),
        InventoryType.ItemTypeCharm: ((RANGE_WEAPONS[0], RANGE_WEAPONS[1]),),
        InventoryType.ItemTypeClothing: ((RANGE_CLOTHES[0], RANGE_CLOTHES[1]),),
        InventoryType.ItemTypeTattoo: (RANGE_JEWELERY_AND_TATTOO,),
        InventoryType.ItemTypeJewelry: (RANGE_JEWELERY_AND_TATTOO,),
        InventoryType.ItemTypeMusic: (RANGE_MISC,),
        InventoryType.ItemTypeConsumable: (RANGE_CONSUMABLE,),
        InventoryType.ItemTypeMoney: (RANGE_GOLD,),
        InventoryType.ItemTypeMoneyWagered: (RANGE_GOLD_WAGERED,) }
    LOCATION_EQUIP_RANGES_CLOTHING = {
        ClothingGlobals.HAT: (RANGE_EQUIP_HAT_CLOTHES,),
        ClothingGlobals.SHIRT: (RANGE_EQUIP_SHIRT_CLOTHES,),
        ClothingGlobals.VEST: (RANGE_EQUIP_VEST_CLOTHES,),
        ClothingGlobals.COAT: (RANGE_EQUIP_COAT_CLOTHES,),
    ...
    LOCATION_EQUIP_RANGES_JEWELRY = {
        ItemConstants.BROW: (RANGE_EQUIP_R_EYEBROW_JEWELRY, RANGE_EQUIP_L_EYEBROW_JEWELRY),
        ItemConstants.EAR: (RANGE_EQUIP_L_EAR_JEWELRY, RANGE_EQUIP_R_EAR_JEWELRY),
        ItemConstants.NOSE: (RANGE_EQUIP_NOSE_JEWELRY,),
        ItemConstants.MOUTH: (RANGE_EQUIP_LIP_JEWELRY,),
        ItemConstants.HAND: (RANGE_EQUIP_L_FINGER_JEWELRY, RANGE_EQUIP_R_FINGER_JEWELRY) }
    LOCATION_EQUIP_RANGES_TATTOO = {
        ItemConstants.CHEST: (RANGE_EQUIP_CHEST_TATTOO,),
        ItemConstants.ARM: (RANGE_EQUIP_L_ARM_TATTOO, RANGE_EQUIP_R_ARM_TATTOO),
        ItemConstants.FACE: (RANGE_EQUIP_FACE_TATTOO,) }
...
def getClothingTypeBySlot(slot):
    for type in Locations.LOCATION_EQUIP_RANGES_CLOTHING:
        ...
        for typeRange in typeRanges:
            ...
            if slot in xrange(rangeStart, rangeEnd + 1):
                return type
                continue
...
def isStackableType(category):
    return category in [
        ...
        InventoryType.ItemTypeMoneyWagered]


def itemStoresLocation(category):
    if category > InventoryType.begin_Category and category < InventoryType.end_Category:
        pass
...
def inOverflow(location):
    if location >= Locations.RANGE_OVERFLOW[0]:
        pass
    return location <= Locations.RANGE_OVERFLOW[1]
...
AmmoInGUI = [
    InventoryType.AmmoVenomShot,
    InventoryType.AmmoBaneShot,
    InventoryType.AmmoHexEaterShot,
    InventoryType.AmmoSilverShot,
    InventoryType.AmmoSteelShot,
    InventoryType.AmmoChainShot,
    InventoryType.AmmoGrapeShot,
    InventoryType.AmmoFirebrand,
    InventoryType.AmmoThunderbolt,
    InventoryType.AmmoExplosive,
    InventoryType.AmmoFury,
    InventoryType.AmmoGrenadeShockBomb,
    InventoryType.AmmoGrenadeFlame,
    InventoryType.AmmoGrenadeSmoke,
    InventoryType.AmmoGrenadeSiege,
    InventoryType.AmmoAsp,
    InventoryType.AmmoAdder,
    InventoryType.AmmoSidewinder,
    InventoryType.AmmoViperNest,
    InventoryType.RegularLure,
    InventoryType.LegendaryLure]
