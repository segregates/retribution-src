...
CANNON_AMMO = {
    ...
    InventoryType.CannonFirebrand: [
        ...
        0,
        'round'],
    InventoryType.CannonFlameCloud: [
        'flame_cloud',
        7,
        'M',
        3,
    ...
    InventoryType.CannonBarShot: [
        ...
        2,
        'shotgun'],
    InventoryType.CannonKnives: [
        'knives',
        10,
        'P',
        0,
        'round'],
    InventoryType.CannonMine: [
        'mine',
        11,
        'R',
        0,
        'mine'],
    InventoryType.CannonBarnacles: [
        'barnacles',
        12,
        'M',
        0,
        'round'],
    InventoryType.CannonComet: [
        'comet',
        15,
        'M',
        2,
