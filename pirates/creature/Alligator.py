...
class Alligator(Creature):
    ...
    SfxNames.update({
        'death': SoundGlobals.SFX_MONSTER_ALLIGATOR_DEATH,
        'pain': SoundGlobals.SFX_MONSTER_ALLIGATOR_PAIN })
    sfx = { }
    AnimList = (('idle', 'idle'), ('walk', 'walk'), ('run', 'run'), ('swim', 'swim'), ('swim_alt', 'swim_alt'), ('pull_back', 'pull_back'), ('pain', 'pull_back'), ('attack_left', 'attack_left'), ('attack_right', 'attack_right'), ('attack_straight', 'attack_straight'), ('flinch_left', 'flinch_left'), ('flinch_right', 'flinch_right'), ('death', 'death'))
    ...
    class AnimationMixer(Creature.AnimationMixer):
        ...
        AnimRankings = {
            ...
            'attack_straight': (ACTION['ACTION'],),
            'pickup_human': (ACTION['ACTION'],),
            'flinch_left': (ACTION['ACTION'],),
            'flinch_right': (ACTION['ACTION'],),
            'pull_back': (ACTION['ACTION'],),
            'pain': (ACTION['ACTION'],),
            'death': (ACTION['MOVIE'],) }
