from panda3d.core import ColorBlendAttrib, Texture, VBase4, Vec3, Vec4
# File: S (Python 2.4)
...
class SoulFlay(PooledEffect, EffectController):
    ...
    def createTrack(self):
        ...
        uvScroll = LerpFunctionInterval(self.setNewUVs, duration, toData = -1.25, fromData = 1.5, extraArgs = [
            self.effectModel,
            textureStage])
