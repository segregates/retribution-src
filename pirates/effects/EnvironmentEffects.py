from panda3d.core import Light, Point3, PolylightEffect, PolylightNode, Texture, TextureStage, Vec4
import random
...
class EnvironmentEffects(DirectObject):
    effectDict = {
        'effect_gypsyball': [
            (GypsyBallGlow, Options.SpecialEffectsLow)],
        'candle_effect': [
            (CandleFlame, Options.SpecialEffectsLow)],
        'torch_effect': [
            (TorchFire, Options.SpecialEffectsLow)],
        'no_glow_effect': [
            (TorchFire, Options.SpecialEffectsLow)],
        'lantern_effect': [
            (LanternGlow, Options.SpecialEffectsMedium)],
        'bonfire_effect': [
            (Bonfire, Options.SpecialEffectsMedium)],
        'fireplace_effect': [
            (Fire, Options.SpecialEffectsLow)],
        'watersplash_effect': [
            (WaterSplash, Options.SpecialEffectsHigh)],
        'steam_effect': [
            (SteamEffect, Options.SpecialEffectsHigh)],
        'darksteam_effect': [
            (DarkSteamEffect, Options.SpecialEffectsMedium)],
        'steamcloud_effect': [
            (SteamCloud, Options.SpecialEffectsMedium)],
        'cratersmoke_effect': [
            (CraterSmoke, Options.SpecialEffectsHigh)],
        'lavaburst_effect': [
            (LavaBurst, Options.SpecialEffectsHigh)],
        'blacksmoke_effect': [
            (BlackSmoke, Options.SpecialEffectsMedium)],
        'lightsmoke_effect': [
            (LightSmoke, Options.SpecialEffectsMedium)],
        'mysticsmoke_effect': [
            (MysticSmoke, Options.SpecialEffectsHigh)],
        'mysticfire_effect': [
            (MysticFire, Options.SpecialEffectsHigh)],
        'steam_vent_effect': [
            (SteamVent, Options.SpecialEffectsMedium)],
        'lava_vent_effect': [
            (LavaVent, Options.SpecialEffectsMedium)],
        'brazier_fire_effect': [
            (BrazierFire, Options.SpecialEffectsLow)],
        'lava_smoke_effect': [
            (LavaSmoke, Options.SpecialEffectsMedium)],
        'lava_steam_effect': [
            (LavaSteam, Options.SpecialEffectsMedium)],
        'light_fire_effect': [
            (LightFire, Options.SpecialEffectsLow)],
        'gentle_smoke_effect': [
            (GentleSmoke, Options.SpecialEffectsMedium)],
        'ravenflock_effect': [
            (RavenFlock, Options.SpecialEffectsMedium)] }
    soundDict = {
    ...
    def loadEffects(self):
        ...
        if base.cr.newsManager:
            for holidayId in base.cr.newsManager.getHolidayList():
                ...
                if locator.getNetTag('Holiday') == holidayName:
                    ...
                    for (effectName, effectLevel) in effects:
                        if effectLevel <= effectSetting:
                            ...
                            effect.startLoop(effectSetting)
                            if not holidayName in self.holidayEffects:
    ...
    def loadPolylights(self):
        if self.parent:
            ...
            for i in xrange(len(polyLights)):
                light = polyLights[i]
                plNode = light.node()
