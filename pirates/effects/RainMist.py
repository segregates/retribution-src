...
class RainMist(EffectController, NodePath):
    ...
    def __init__(self, reference = None):
        ...
        self.p0.renderer.setInitialYScale(0.598 * self.cardScale)
        ...
        self.p0.emitter.setExplicitLaunchVector(Vec3(0.200, 0.0, 6.0))
    ...
    def createTrack(self):
        self.p0.renderer.setColor(Vec4(0.800000, 0.800000, 1.0, 0.25))
