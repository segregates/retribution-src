from panda3d.core import BitMask32, BoundingSphere, CollideMask, CollisionHandler, CollisionHandlerFloor, CollisionNode, CollisionRay, CollisionTraverser, NodePath, Vec3
...
class InteractionManager(DirectObject.DirectObject):
    ...
    def __init__(self):
        ...
        self._InteractionManager__updateDelay = 0.2
