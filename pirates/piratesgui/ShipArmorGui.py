from panda3d.core import NodePath, Plane, PlaneNode, Vec4
# File: S (Python 2.4)
...
class ShipArmorGui(GuiTray):
    ...
    def __init__(self, parent, **kw):
        ...
        self.damageGUI = DirectFrame(parent = self, pos = (0.0, 0.0, 0.0), relief = None, image = tex, image_scale = 0.0598, sortOrder = 2)
        ...
        self.hpLeft = DirectFrame(parent = self.damageGUI, relief = None, image = tex, image_scale = 0.0598, image_color = (0.100, 0.800000, 0.100, 0.800000))
        ...
        self.hpRight = DirectFrame(parent = self.damageGUI, relief = None, image = tex, image_scale = 0.0598, image_color = (0.100, 0.800000, 0.100, 0.800000))
        ...
        self.hpRear = DirectFrame(parent = self.damageGUI, relief = None, image = tex, image_scale = 0.0598, image_color = (0.100, 0.800000, 0.100, 0.800000))
