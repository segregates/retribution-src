...
class Scoreboard(DirectFrame):
    ...
    def __init__(self, name, width, height, results, titleHeight = 1.0):
        DirectFrame.__init__(self, relief = None, state = DGG.NORMAL, frameColor = PiratesGuiGlobals.FrameColor, borderWidth = PiratesGuiGlobals.BorderWidth, pos = (0, 0, -0.0299))
        ...
        height = self.height - self.titleHeight - 0.170
