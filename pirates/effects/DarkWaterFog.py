...
class DarkWaterFog(EffectController, NodePath):
    ...
    def __init__(self, radius = 700, radiusSpread = 300, lifespan = 4.0):
        ...
        self.p0.renderer.setFinalXScale(1.91 * self.cardScale)
        self.p0.renderer.setInitialYScale(1.28 * self.cardScale)
        self.p0.renderer.setFinalYScale(0.640 * self.cardScale)
        self.p0.renderer.setNonanimatedTheta(0.0)
        self.p0.renderer.setAlphaBlendMethod(BaseParticleRenderer.PPBLENDLINEAR)
        self.p0.renderer.setAlphaDisable(0)
        self.p0.renderer.getColorInterpolationManager().addConstant(0.0, 1.0, Vec4(0.200, 0.299, 0.5, 0.299), 1)
