from panda3d.core import BitMask32, VBase3, Vec3, Vec4
import random
import copy
...
CALL_FOR_HELP_DISTANCE = 200
MINIMUM_THREAT = 0.5

def listThreats():
    for level in xrange(1, 51):
        threatThreshold = float(level - ENEMY_GANGUP_LEVEL_OFFSET)
        threatCapcity = max(1, level * ENEMY_THREAT_AMOUNT + THREAT_BASE_CAPCITY)
        print 'Level: %s Threat Threshold %s Capacity %s' % (level, threatThreshold, threatCapcity)
        lowerBound = 1
        upperBound = 55
        for monsterLevel in xrange(lowerBound, upperBound):
            maxMobs = threatCapcity
            enemyThreat = max(MINIMUM_THREAT, monsterLevel - threatThreshold)
            attackers = 0
            for i in xrange(0, MAX_ATTACKERS):
...
THREAT_ICON_DICT = {
    ...
    SHIP_THREAT_CALL_FOR_HELP: 'threat_L_Two',
    SHIP_THREAT_BOUNTY_HUNTERS: 'threat_L_Three',
...
OPEN_PORT_DICT = {
    OPEN_PORT_ALL: '',
    OPEN_PORT_NONE: '',
    OPEN_PORT_CUBA: '1160614528.73sdnaik',
...
__enemyWeaponTable = {
    MELEE: [
        ...
        InventoryType.MeleeWeaponL3],
    CUTLASS: [
        ItemGlobals.RUSTY_CUTLASS,
        ItemGlobals.IRON_CUTLASS,
        ItemGlobals.STEEL_CUTLASS],
    DAGGER: [
        ItemGlobals.BASIC_DAGGER,
        ItemGlobals.BATTLE_DIRK,
        ItemGlobals.MAIN_GAUCHE],
    PISTOL: [
        ItemGlobals.FLINTLOCK_PISTOL,
        ItemGlobals.DOUBLE_BARREL,
        ItemGlobals.TRI_BARREL],
    MUSKET: [
        ItemGlobals.OLD_MUSKET,
        ItemGlobals.FLINTLOCK_MUSKET,
        ItemGlobals.WHEELLOCK_MUSKET],
    GRENADE: [
        ItemGlobals.GRENADE_POUCH],
    WAND: [
        ItemGlobals.CURSED_STAFF,
        ItemGlobals.WARPED_STAFF,
        ItemGlobals.REND_STAFF],
    DOLL: [
        ItemGlobals.VOODOO_DOLL,
        ItemGlobals.CLOTH_DOLL,
        ItemGlobals.WITCH_DOLL],
    KETTLE: [
        InventoryType.KettleWeaponL1,
        InventoryType.KettleWeaponL2,
        InventoryType.KettleWeaponL3],
    BAYONET: [
        ...
        ItemGlobals.FLINTLOCK_BAYONET,
        ItemGlobals.WHEELLOCK_BAYONET],
    HEAVY: [],
    MONSTER: [
        ItemGlobals.MONSTER_WEAPON],
    DUALCUTLASS: [
...
__baseAvatarStats = {
    ...
    AvatarTypes.LeaderGhost: [
        ...
        MONSTER,
        0],
    AvatarTypes.PressGangVoodooZombie: [
        9,
        14,
        1.0,
        5.0,
    ...
    AvatarTypes.CookVoodooZombie: [
        ...
        MONSTER,
        0],
    AvatarTypes.SwabbieVoodooZombie: [
        18,
        25,
        1.0,
        5.0,
        ...
        MONSTER,
        0],
    AvatarTypes.LookoutVoodooZombie: [
        23,
        30,
        1.0,
        5.0,
    ...
    AvatarTypes.AngryVoodooZombie: [
        ...
        MONSTER,
        0],
    AvatarTypes.OfficerVoodooZombie: [
        33,
        40,
        1.1,
        5.0,
        ...
        MONSTER,
        0],
    AvatarTypes.SlaveDriverVoodooZombie: [
        38,
        46,
        1.0,
        5.0,
...
__baseAvatarSkills = {
    ...
    AvatarTypes.Revenant: ([
        MONSTER], [
        EnemySkills.GHOST_PHANTOM_TOUCH]),
    AvatarTypes.RageGhost: ([
        MONSTER], [
        EnemySkills.GHOST_KILL_TOUCH]),
    AvatarTypes.MutineerGhost: ([
        CUTLASS], [
        InventoryType.CutlassBrawl,
        InventoryType.CutlassCleave,
    ...
    AvatarTypes.JollyRoger: ([
        MONSTER], [
        EnemySkills.JR_GRAVEBIND,
        EnemySkills.JR_SOUL_HARVEST,
        EnemySkills.JR_CORRUPTION,
        EnemySkills.JR_THUNDER]),
    AvatarTypes.BomberZombie: ([
        MONSTER], [
        EnemySkills.BZ_EXPLODE,
        EnemySkills.BZ_EXPLODE_DEATH]),
    AvatarTypes.PressGangVoodooZombie: ([
        CUTLASS], [
        EnemySkills.CUTLASS_DOUBLESLASH,
        EnemySkills.CUTLASS_WILDSLASH]),
...
def getEnemyWeapons(avatarType, level, weaponlist = [], weaponlevel = 0):
    ...
    if not weaponlist:
        weaponlist = baseStats[WEAPON_INDEX]
    if not weaponlevel:
        weaponlevel = levelModifier[WEAPON_MOD]
