from panda3d.core import Buffer, Camera, DepthTestAttrib, DisplayRegion, GraphicsStateGuardian, RenderAttrib, Texture, VBase4
            ...
            if base.post_processing:
                ...
                if base.main_rtt:
                    ...
                    if base.hdr.success:
                        ...
                        self.success = 1
                        c = 0.58
                        #NametagGlobals.setBalloonModulationColor(VBase4(c, c, c, 1.0)) # Not written yet. Possible TODO.
                    elif base.glow:
                        base.glow.delete()
                        base.glow = None
