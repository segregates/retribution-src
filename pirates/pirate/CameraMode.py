from panda3d.core import BitMask32, Camera, CollideMask, CollisionHandler, CollisionHandlerFloor, CollisionNode, CollisionRay, CollisionTraverser, MouseButton, NodePath, WindowProperties
...
class CameraMode(DirectObject.DirectObject, FSM):
    ...
    def enableInput(self):
        self._CameraMode__inputEnabled = True
    ...
    def isInputEnabled(self):
        return self._CameraMode__inputEnabled
