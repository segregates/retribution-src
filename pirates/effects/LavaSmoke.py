...
class LavaSmoke(PooledEffect, EffectController):
    cardScale = 64.0
    ...
    def __init__(self, parent = None):
        ...
        if not LavaSmoke.particleDummy:
            LavaSmoke.particleDummy = base.effectsRoot.attachNewNode(ModelNode('LavaSmokeParticleDummy'))
    ...
    def setEffectScale(self, scale):
        ...
        self.p0.emitter.setRadius(5.0 * scale)
