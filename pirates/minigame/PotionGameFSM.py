...
class PotionGameFSM(MinigameFSM):
    ...
    def enterEval(self):
        if self.gameObject.askToExit:
            ...
            if len(self.gameObject.animationList) > 0:
                ...
                knownRecipe = True
                for i in xrange(self.gameObject.ingredientsCompleted):
                ...
                if len(self.gameObject.animationList) > 0:
                    ...
                    if len(self.gameObject.animationList) > 0:
                        ...
                        if self.gameObject.soulMade or self.gameObject.hintScreen.show('SoulMade') or self.gameObject.hintScreen.show('MatchMade'):
                            self.demand('Tutorial')
                        else:
                            self.demand('Anim')
                        self.gameObject.soulMade = False
    ...
    def enterResults(self):
        ...
        if not self.resultsShown:
            ...
            elif len(self.gameObject.currentRecipe.ingredients) == 0:
