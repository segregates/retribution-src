from panda3d.physics import BaseParticleEmitter, BaseParticleRenderer, ColorInterpolationManager, LinearNoiseForce, LinearVectorForce
...
class JRDeathEffect(PooledEffect, EffectController):
    ...
    def __init__(self, parent = None):
        ...
        self.p1.renderer.getColorInterpolationManager().addLinear(0.0, 1.0, Vec4(0.5, 0.598, 0.149, 1.0), Vec4(0.598, 0.75, 0.0, 0.0), 1)
    ...
    def setupSize(self):
        self.p0.renderer.setInitialXScale(0.050000 * self.effectScale * self.card2Scale)
        self.p0.renderer.setFinalXScale(0.0299 * self.effectScale * self.card2Scale)
        self.p0.renderer.setInitialYScale(0.0299 * self.effectScale * self.card2Scale)
        self.p0.renderer.setFinalYScale(0.08 * self.effectScale * self.card2Scale)
        self.p1.renderer.setInitialXScale(0.0250 * self.effectScale * self.card2Scale)
        self.p1.renderer.setFinalXScale(0.050000 * self.effectScale * self.card2Scale)
        self.p1.renderer.setInitialYScale(0.0250 * self.effectScale * self.card2Scale)
        self.p1.renderer.setFinalYScale(0.050000 * self.effectScale * self.card2Scale)
