from panda3d.core import NodePath, TextNode, VBase4
...
class InventoryStackSplitter(BorderFrame):
    ...
    def setup(self):
        ...
        self.confirmButton = DirectButton(parent = self, relief = None, image = buttonImage, image_scale = (0.22, 1.0, 0.22), image0_color = VBase4(0.65, 0.65, 0.65, 1), image1_color = VBase4(0.4, 0.4, 0.4, 1), image2_color = VBase4(0.9, 0.9, 0.9, 1), image3_color = VBase4(0.41, 0.4, 0.4, 1), text = PLocalizer.InventorySplitterConfirm, text_font = PiratesGlobals.getPirateBoldOutlineFont(), text_align = TextNode.ACenter, text_pos = (0, -0.01), text_scale = PiratesGuiGlobals.TextScaleLarge, text_fg = PiratesGuiGlobals.TextFG2, text_shadow = PiratesGuiGlobals.TextShadow, pos = (self.sizeX * 0.5, 0, 0.05), command = self.manager.closeSplitter)
        self.allButton = DirectButton(parent = self, relief = None, image = buttonImage, image_scale = (0.13, 1.0, 0.18), image0_color = VBase4(0.65, 0.65, 0.65, 1), image1_color = VBase4(0.4, 0.4, 0.4, 1), image2_color = VBase4(0.9, 0.9, 0.9, 1), image3_color = VBase4(0.41, 0.4, 0.4, 1), text = PLocalizer.InventorySplitterAll, text_font = PiratesGlobals.getPirateBoldOutlineFont(), text_align = TextNode.ACenter, text_pos = (0, -0.01), text_scale = PiratesGuiGlobals.TextScaleLarge, text_fg = PiratesGuiGlobals.TextFG2, text_shadow = PiratesGuiGlobals.TextShadow, pos = (self.sizeX * 0.75, 0, self.sizeZ * 0.25), command = self.setAll)
        self.noneButton = DirectButton(parent = self, relief = None, image = buttonImage, image_scale = (0.13, 1.0, 0.18), image0_color = VBase4(0.65, 0.65, 0.65, 1), image1_color = VBase4(0.4, 0.4, 0.4, 1), image2_color = VBase4(0.9, 0.9, 0.9, 1), image3_color = VBase4(0.41, 0.4, 0.4, 1), text = PLocalizer.InventorySplitterNone, text_font = PiratesGlobals.getPirateBoldOutlineFont(), text_align = TextNode.ACenter, text_pos = (0, -0.01), text_scale = PiratesGuiGlobals.TextScaleLarge, text_fg = PiratesGuiGlobals.TextFG2, text_shadow = PiratesGuiGlobals.TextShadow, pos = (self.sizeX * 0.25, 0, self.sizeZ * 0.25), command = self.setNone)
        ...
        self.slider = DirectSlider(parent = self, relief = None, command = self.updateSlider, image = charGui.find('**/chargui_slider_small'), image_scale = (2.15, 2.15, 1.5), thumb_relief = None, thumb_image = (charGui.find('**/chargui_slider_node'), charGui.find('**/chargui_slider_node_down'), charGui.find('**/chargui_slider_node_over')), pos = (self.sizeX * 0.5, 0.0, self.sizeZ * 0.38), text_align = TextNode.ACenter, text_scale = (0.1, 0.1), text_pos = (0.0, 0.1), text_fg = PiratesGuiGlobals.TextFG1, scale = 0.38, pageSize = 1.0, scrollSize = 1.0, text = 'default', value = 0, range = (0, amount))
