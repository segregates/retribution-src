...
class Wand(Weapon.Weapon):
    modelTypes = [
        'models/handheld/pir_m_hnd_stf_dark_a',
        'models/handheld/pir_m_hnd_stf_dark_b',
        'models/handheld/pir_m_hnd_stf_dark_c',
        'models/handheld/pir_m_hnd_stf_dark_d',
        'models/handheld/pir_m_hnd_stf_nature_a',
        'models/handheld/pir_m_hnd_stf_nature_b',
        'models/handheld/pir_m_hnd_stf_nature_c',
        'models/handheld/pir_m_hnd_stf_nature_d',
        'models/handheld/pir_m_hnd_stf_ward_a',
        'models/handheld/pir_m_hnd_stf_ward_b',
        'models/handheld/pir_m_hnd_stf_ward_c',
        'models/handheld/pir_m_hnd_stf_ward_d']
    effectTypeInfo = {
        ItemGlobals.GemGlowPurple: Vec4(0.5, 0.2, 1, 1),
        ItemGlobals.GemGlowGreen: Vec4(0, 1, 0, 1),
        ItemGlobals.GemGlowRed: Vec4(1, 0, 0, 1),
        ItemGlobals.GemGlowBlue: Vec4(0, 0, 1, 1),
        ItemGlobals.GemGlowMagenta: Vec4(0, 1, 1, 1),
        ItemGlobals.GemGlowOrange: Vec4(1, 0.6, 0, 1) }
