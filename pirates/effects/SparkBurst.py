...
class SparkBurst(PooledEffect, EffectController):
    ...
    def __init__(self):
        ...
        self.p0.factory.setLifespanBase(0.299)
        ...
        self.p0.emitter.setOffsetForce(Vec3(1.0, 1.0, -0.100))
        self.p0.emitter.setExplicitLaunchVector(Vec3(0.100, 0.0, 100.0))
    ...
    def createTrack(self, color = 'Yellow'):
        ...
        if color == 'Dark':
            self.p0.renderer.setInitialXScale(0.00500 * self.darkCardScale)
            self.p0.renderer.setFinalXScale(0.0001 * self.darkCardScale)
            self.p0.renderer.setInitialYScale(0.00500 * self.darkCardScale)
            ...
            self.p0.renderer.setFinalXScale(1.00e-005 * self.darkCardScale)
            self.p0.renderer.setInitialYScale(0.0015 * self.darkCardScale)
            self.p0.renderer.setFinalYScale(1.00e-005 * self.darkCardScale)
        ...
        self.track = Sequence(self.startEffect, Wait(0.200), self.endEffect)
