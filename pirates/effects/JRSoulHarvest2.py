...
class JRSoulHarvest2(PooledEffect, EffectController):
    cardScale = 128.0
    ...
    def __init__(self):
        ...
        self.card = model.find('**/effectJolly')
        ...
        self.p0.renderer.setColor(Vec4(0.800000, 1.0, 0.100, 1.0))
        ...
        self.p0.renderer.setFinalYScale(0.0149 * self.cardScale)
    ...
    def createTrack(self):
        ...
        self.track = Sequence(Func(self.p0.setBirthRate, 0.12), Func(self.p0.clearToInitial), Func(self.f.start, self, self.particleDummy), Func(self.f.reparentTo, self), Wait(3.0), Func(self.p0.setBirthRate, 100), Wait(7.0), Func(self.cleanUpEffect))
