...
objectStruct = {
    'Objects': {
        '1195522163.95gjeon': {
            'Type': 'Ship Part',
            'Name': 'shipBlackPearl',
            'Category': '50: Legendary Ship',
            'File': '',
            'Flagship': True,
            'Objects': {
                '1196379038.38piwanow': {
                    'Type': 'Spawn Node',
                    'AnimSet': 'default',
                    'Hpr': VBase3(30.0, 0.0, 0.0),
                    'Min Population': '1',
    ...
    'ObjectIds': {
        ...
        '1196379038.38piwanow': '["Objects"]["1195522163.95gjeon"]["Objects"]["1196379038.38piwanow"]',
        '1196379095.0piwanow': '["Objects"]["1195522163.95gjeon"]["Objects"]["1196379095.0piwanow"]',
