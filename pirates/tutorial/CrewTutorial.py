...
class CrewTutorial(DirectObject.DirectObject):
    ...
    def _CrewTutorial__handleOKButton1(self):
        messenger.send('closeTutorialWindow')
        self.showPart2()


    def _CrewTutorial__handleOKButton2(self):
        messenger.send('closeTutorialWindow')
        self.showPart3()


    def _CrewTutorial__handleOKButton3(self):
        messenger.send('closeTutorialWindow')
        self.showPart4()


    def _CrewTutorial__handleOKButton4(self):
        self.panelCleanup()
        self.ignoreAll()
        self.destroy()
    ...
    def showPart3(self):
        ...
        self.panel3.setYesCommand(self._CrewTutorial__handleOKButton3)
        self.stage = 3
    ...
    def showPart4(self):
        ...
        self.panel4.setYesCommand(self._CrewTutorial__handleOKButton4)
        self.stage = 4
