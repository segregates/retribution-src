...
from pirates.inventory.InventoryUISlotContainer import InventoryUISlotContainer


class InventoryUIClothingContainer(InventoryUISlotContainer):
    def __init__(self, manager, sizeX = 1.0, sizeZ = 1.0, countX = 4, countZ = 4, slotList = None):
        InventoryUISlotContainer.__init__(self, manager, sizeX, sizeZ, countX, countZ, slotList)
        ...
        self.overflowInfo = DirectLabel(parent = self, relief = None,
                                        textMayChange = 0, text = PLocalizer.OverflowHint,
