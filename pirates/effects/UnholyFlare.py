...
class UnholyFlare(PooledEffect, EffectController):
    ...
    def createTrack(self):
        ...
        self.p0.renderer.setInitialYScale(2.e-005 * self.cardScale)
        ...
        self.p0.renderer.getColorInterpolationManager().addLinear(0.0, 1.0, Vec4(1.0, 1.0, 1.0, 1.0), Vec4(0.39215686917304993, 0.39215686917304993, 0.19607843458652496, 1.0), 1)
