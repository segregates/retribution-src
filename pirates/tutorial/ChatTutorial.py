...
class ChatTutorial(DirectObject.DirectObject):
    ...
    def __init__(self):
        ...
        self.showPart1()
        self.acceptOnce('openedChat', self._ChatTutorial__handleOpenChatWindow)


    def _ChatTutorial__handleOpenChatWindow(self):
        messenger.send('closeTutorialWindow')
        self.showPart2()


    def _ChatTutorial__handleSentChat(self):
        messenger.send('closeTutorialWindow')
        self.showPart3()


    def _ChatTutorial__handleOKButton(self):
        messenger.send('closeTutorialWindow')
        self.showPart4()


    def _ChatTutorial__handleOKButton1(self):
        messenger.send('closeTutorialWindow')
        self.showPart5()


    def _ChatTutorial__handleOKButton2(self):
    ...
    def showPart2(self):
        ...
        self.acceptOnce('sentRegularChat', self._ChatTutorial__handleSentChat)
        self.stage = 2
    ...
    def showPart3(self):
        ...
        self.panel3.setYesCommand(self._ChatTutorial__handleOKButton)
        self.stage = 3
    ...
    def showPart4(self):
        ...
        self.panel4.setYesCommand(self._ChatTutorial__handleOKButton1)
        self.stage = 4
    ...
    def showPart5(self):
        ...
        self.panel5.setYesCommand(self._ChatTutorial__handleOKButton2)
        self.stage = 5
