...
__itemTypeList = {
    ...
    ItemType.FISHING_LURE: ItemTypeGroup.FISHING_GEAR,
    ItemType.FISHING_ROD: ItemTypeGroup.FISHING_GEAR }
...
class ItemId:
    ...
    HUNTER_VENGENCE = ShipGlobals.HUNTER_VENGENCE
...
__itemList = {
    ...
    ItemId.VENOMSHOT: (0.149, ItemType.AMMO, ItemType.PISTOLAMMO, None, 25, 0, None),
    ItemId.IRONSHOT: (0.200, ItemType.AMMO, ItemType.PISTOLAMMO, None, 25, 0, None),
    ItemId.GOLDENSHOT: (0.25, ItemType.AMMO, ItemType.PISTOLAMMO, None, 25, 0, None),
    ItemId.SILVERSHOT: (0.299, ItemType.AMMO, ItemType.PISTOLAMMO, None, 25, 0, None),
    ItemId.STEELSHOT: (0.348, ItemType.AMMO, ItemType.PISTOLAMMO, None, 25, 0, None),
    ItemId.ASP_DAGGER: (0.149, ItemType.AMMO, ItemType.DAGGERAMMO, None, 25, 0, None),
    ItemId.ADDER_DAGGER: (0.299, ItemType.AMMO, ItemType.DAGGERAMMO, None, 25, 0, None),
    ItemId.SIDEWINDER_DAGGER: (0.450, ItemType.AMMO, ItemType.DAGGERAMMO, None, 25, 0, None),
    ...
    ItemId.FLAME_G: (0.598, ItemType.AMMO, ItemType.GRENADEAMMO, None, 10, 0, None),
    ...
    ItemId.REMOVE_GROGGY: (0, ItemType.CONSUMABLE, ItemType.POTION, None, 1, 0, None),
    ItemId.SHIP_REPAIR_KIT: (50, ItemType.CONSUMABLE, ItemType.SHIP_REPAIR_KIT, None, 1, 0, None),
    ItemId.FISHING_ROD1: (0, ItemType.WEAPON, ItemType.FISHING_ROD, None, 1, 0, None),
    ItemId.FISHING_ROD2: (200, ItemType.WEAPON, ItemType.FISHING_ROD, None, 1, 5, None),
    ...
    ItemId.FLYING_DUTCHMAN: (0, ItemType.SHIP, ItemType.WARSHIP, None, 1, 40, InventoryType.NewShipToken),
    ItemId.JOLLY_ROGER: (0, ItemType.SHIP, ItemType.WARSHIP, None, 1, 40, InventoryType.NewShipToken),
    ItemId.SKEL_WARSHIPL3: (0, ItemType.SHIP, ItemType.WARSHIP, None, 1, 30, InventoryType.NewShipToken),
    ItemId.SKEL_INTERCEPTORL3: (0, ItemType.SHIP, ItemType.INTERCEPTOR, None, 1, 30, InventoryType.NewShipToken),
    ItemId.SHIP_OF_THE_LINE: (200000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 30, InventoryType.NewShipToken),
    ItemId.EL_PATRONS_SHIP: (100000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 10, InventoryType.NewShipToken),
    ItemId.P_SKEL_PHANTOM: (170000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 25, InventoryType.NewShipToken),
    ItemId.P_SKEL_REVENANT: (190000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 25, InventoryType.NewShipToken),
    ItemId.P_SKEL_CEREBUS: (140000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 20, InventoryType.NewShipToken),
    ItemId.P_NAVY_KINGFISHER: (120000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 20, InventoryType.NewShipToken),
    ItemId.P_EITC_WARLORD: (180000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 20, InventoryType.NewShipToken),
    ItemId.QUEEN_ANNES_REVENGE: (0, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.HUNTER_VENGENCE: (0, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.HUNTER_TALLYHO: (200000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ...
    ItemId.HMS_VICTORY: (200000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.HMS_NEWCASTLE: (200000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.HMS_INVINCIBLE: (200000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.EITC_INTREPID: (200000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.EITC_CONQUERER: (200000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.EITC_LEVIATHAN: (200000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.NAVY_FERRET: (5000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.NAVY_BULWARK: (5000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.NAVY_PANTHER: (5000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.NAVY_GREYHOUND: (5000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.NAVY_VANGUARD: (5000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.NAVY_CENTURION: (5000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.NAVY_KINGFISHER: (5000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.NAVY_MONARCH: (5000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.NAVY_MAN_O_WAR: (5000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.NAVY_PREDATOR: (5000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.NAVY_COLOSSUS: (5000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.NAVY_DREADNOUGHT: (5000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.NAVY_BASTION: (5000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.NAVY_ELITE: (5000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.EITC_SEA_VIPER: (5000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.EITC_SENTINEL: (5000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.EITC_CORVETTE: (5000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.EITC_BLOODHOUND: (5000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.EITC_IRONWALL: (5000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.EITC_MARAUDER: (5000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.EITC_BARRACUDA: (5000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.EITC_OGRE: (5000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.EITC_WARLORD: (5000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.EITC_CORSAIR: (5000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.EITC_BEHEMOTH: (5000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.EITC_JUGGERNAUT: (5000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.EITC_TYRANT: (5000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.SKEL_PHANTOM: (150000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.SKEL_REVENANT: (160000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.SKEL_STORM_REAPER: (170000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.SKEL_BLACK_HARBINGER: (180000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.SKEL_DEATH_OMEN: (190000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.SKEL_SHADOW_CROW_FR: (100000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.SKEL_HELLHOUND_FR: (125000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.SKEL_BLOOD_SCOURGE_FR: (150000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.SKEL_SHADOW_CROW_SP: (100000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.SKEL_HELLHOUND_SP: (125000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ItemId.SKEL_BLOOD_SCOURGE_SP: (150000, ItemType.SHIP, ItemType.WARSHIP, None, 1, 0, InventoryType.NewShipToken),
    ...
    ItemId.CHAIN_SHOT: (0.149, ItemType.AMMO, ItemType.CANNONAMMO, None, 25, 0, None),
    ItemId.GRAPE_SHOT: (0.200, ItemType.AMMO, ItemType.CANNONAMMO, None, 25, 0, None),
    ItemId.FIREBRAND: (0.5, ItemType.AMMO, ItemType.CANNONAMMO, None, 25, 0, None),
    ItemId.THUNDERBOLT: (0.598, ItemType.AMMO, ItemType.CANNONAMMO, None, 25, 0, None),
    ItemId.EXPLOSIVE: (15, ItemType.AMMO, ItemType.CANNONAMMO, None, 1, 0, None),
    ItemId.FURY: (0.800000, ItemType.AMMO, ItemType.CANNONAMMO, None, 25, 0, None),
    ItemId.GRAPPLE_HOOK: (0.200, ItemType.AMMO, ItemType.CANNONAMMO, None, 25, 0, None),
    ItemId.BULLET: (0.200, ItemType.AMMO, ItemType.CANNONAMMO, None, 25, 0, None),
    ItemId.GAS_CLOUD: (0.200, ItemType.AMMO, ItemType.CANNONAMMO, None, 25, 0, None),
    ItemId.SKULL_AMMO: (0.299, ItemType.AMMO, ItemType.CANNONAMMO, None, 25, 0, None),
    ItemId.FLAME_CLOUD: (0.299, ItemType.AMMO, ItemType.CANNONAMMO, None, 25, 0, None),
    ItemId.FLAMING_SKULL: (0.299, ItemType.AMMO, ItemType.CANNONAMMO, None, 25, 0, None),
...
__itemTypeNameList = {
    ItemGlobals.DAGGER: ItemType.DAGGER,
    ItemGlobals.SWORD: ItemType.SWORD,
    ItemGlobals.GUN: ItemType.PISTOL,
    ItemGlobals.DOLL: ItemType.DOLL,
    ItemGlobals.GRENADE: ItemType.GRENADE,
    ItemGlobals.STAFF: ItemType.WAND,
    ItemGlobals.POTION: ItemType.POTION }
...
__itemTrainingList = {
    ItemGlobals.DAGGER: InventoryType.DaggerToken,
    ItemGlobals.SWORD: InventoryType.CutlassToken,
    ItemGlobals.GUN: InventoryType.PistolToken,
    ItemGlobals.DOLL: InventoryType.DollToken,
    ItemGlobals.GRENADE: InventoryType.GrenadeToken,
    ItemGlobals.STAFF: InventoryType.WandToken }
...
__itemIcons = {
    ItemId.CUTLASS_L1: 'pir_t_ico_swd_cutlass_a',
    ItemId.CUTLASS_L2: 'pir_t_ico_swd_broadsword_b',
    ItemId.CUTLASS_L3: 'pir_t_ico_swd_cutlass_c',
    ...
    ItemId.PISTOL_L4: 'pir_t_ico_gun_multiBarrel_d',
    ItemId.PISTOL_L5: 'pir_t_ico_gun_multiBarrel_e',
    ItemId.PISTOL_L6: 'pir_t_ico_gun_multiBarrel_f',
    ItemId.BAYONET_L1: 'pir_t_ico_gun_pistol_a',
    ItemId.BAYONET_L2: 'pir_t_ico_gun_multiBarrel_a',
    ItemId.BAYONET_L3: 'pir_t_ico_gun_multiBarrel_c',
    ItemId.DAGGER_L1: 'pir_t_ico_knf_small',
    ItemId.DAGGER_L2: 'pir_t_ico_knf_battle',
    ItemId.DAGGER_L3: 'pir_t_ico_knf_dirk_b',
    ItemId.DAGGER_L4: 'pir_t_ico_knf_hollow_b',
    ItemId.DAGGER_L5: 'pir_t_ico_knf_dagger_b',
    ItemId.DAGGER_L6: 'pir_t_ico_knf_dagger_c',
    ItemId.GRENADE_L1: 'pir_t_ico_bom_grenade',
    ItemId.GRENADE_L2: 'pir_t_ico_bom_grenade',
    ItemId.GRENADE_L3: 'pir_t_ico_bom_grenade',
    ItemId.GRENADE_L4: 'pir_t_ico_bom_grenade',
    ItemId.GRENADE_L5: 'pir_t_ico_bom_grenade',
    ItemId.GRENADE_L6: 'pir_t_ico_bom_grenade',
    ItemId.WAND_L1: 'pir_t_ico_stf_dark_a',
    ItemId.WAND_L2: 'pir_t_ico_stf_nature_a',
    ItemId.WAND_L3: 'pir_t_ico_stf_ward_a',
    ItemId.WAND_L4: 'pir_t_ico_stf_ward_b',
    ItemId.WAND_L5: 'pir_t_ico_stf_ward_c',
    ItemId.WAND_L6: 'pir_t_ico_stf_nature_c',
    ItemId.DOLL_L1: 'pir_t_ico_dol_spirit_a',
    ItemId.DOLL_L2: 'pir_t_ico_dol_mojo_a',
    ItemId.DOLL_L3: 'pir_t_ico_dol_mojo_c',
    ItemId.DOLL_L4: 'pir_t_ico_dol_bane_c',
    ItemId.DOLL_L5: 'pir_t_ico_dol_mojo_e',
    ItemId.DOLL_L6: 'pir_t_ico_dol_bane_e',
    ItemId.CANNON_L1: 'pir_t_ico_can_single',
    ItemId.CANNON_L2: 'pir_t_ico_can_single',
    ItemId.CANNON_L3: 'pir_t_ico_can_single',
    ItemId.POTION_1: 'pit_t_ico_tonic',
    ItemId.POTION_2: 'pit_t_ico_tonic',
    ItemId.POTION_3: 'pir_t_ico_pot_holyWater',
    ItemId.POTION_4: 'pir_t_ico_pot_elixir',
    ItemId.POTION_5: 'pir_t_ico_pot_miracleWater',
    ItemId.REMOVE_GROGGY: 'pir_t_ico_pot_miracleWater',
    ItemId.PORK_CHUNK: 'pir_t_ico_pot_porkTonic',
    ItemId.SHIP_REPAIR_KIT: 'sail_come_about',
    ItemId.PISTOL_POUCH_L1: 'pir_t_ico_gun_shotPouch',
    ItemId.PISTOL_POUCH_L2: 'pir_t_ico_gun_shotPouch',
    ItemId.PISTOL_POUCH_L3: 'pir_t_ico_gun_shotPouch',
    ItemId.DAGGER_POUCH_L1: 'pir_t_ico_knf_belt',
    ItemId.DAGGER_POUCH_L2: 'pir_t_ico_knf_belt',
    ItemId.DAGGER_POUCH_L3: 'pir_t_ico_knf_belt',
    ItemId.GRENADE_POUCH_L1: 'pir_t_ico_bom_pouch',
    ItemId.GRENADE_POUCH_L2: 'pir_t_ico_bom_pouch',
    ItemId.GRENADE_POUCH_L3: 'pir_t_ico_bom_pouch',
    ItemId.CANNON_POUCH_L1: 'pir_t_ico_can_ammoBarrel',
    ItemId.CANNON_POUCH_L2: 'pir_t_ico_can_ammoBarrel',
    ItemId.CANNON_POUCH_L3: 'pir_t_ico_can_ammoBarrel',
    ItemId.FISHING_POUCH_L1: 'pir_t_ico_can_ammoBarrel',
    ItemId.FISHING_ROD1: 'pir_t_gui_fsh_smRodIcon',
    ItemId.FISHING_ROD2: 'pir_t_gui_fsh_mdRodIcon',
    ItemId.FISHING_ROD3: 'pir_t_gui_fsh_lgRodIcon',
    ItemId.FISHING_LURE1: 'pir_t_gui_fsh_lureReg',
    ItemId.FISHING_LURE2: 'pir_t_gui_fsh_lureLegend',
    ItemGlobals.TONIC: 'pir_t_ico_pot_tonic',
    ItemGlobals.REMEDY: 'pir_t_ico_pot_tonic',
    ItemGlobals.HOLY_WATER: 'pir_t_ico_pot_holyWater',
    ItemGlobals.ELIXIR: 'pir_t_ico_pot_elixir',
    ItemGlobals.MIRACLE_WATER: 'pir_t_ico_pot_miracleWater',
    ItemGlobals.ROAST_PORK: 'pir_t_ico_pot_porkTonic' }
...
FISHING_ROD_SHELF = [
    ...
    ItemId.FISHING_ROD3]
FISHING_LURE_SHELF = [
    ItemId.FISHING_LURE1,
    ItemId.FISHING_LURE2]
CollectionValues = {
    0: 10,
    1: 25,
    2: 100 }
