from panda3d.core import CardMaker, NodePath, TextGraphic, TextNode, TextProperties, TextPropertiesManager, Vec3, Vec4
# File: C (Python 2.4)
...
class ChatPanel(DirectFrame, FSM):
    ...
    def clearText(self):
        ...
        for key in self.lineDict:
            (message, nameButton, useName) = self.lineDict[key]
            nameButton.destroy()
            tpMgr.clearGraphic(useName)
