...
objectStruct = {
    ...
    'Objects': {
        '1233252608.0akelts3': {
            ...
            'Name': '',
            'AdditionalData': [
                'interior_shanty_store_barber'],
            'Instanced': True,
            'Objects': {
                '1201219525.27dxschafe': {
                ...
                '1201225541.73dxschafe': {
                    ...
                    'AnimSet': 'default',
                    'CustomModel': 'None',
                    'Hpr': VBase3(179.518, 0.0, 0.0),
                    'Patrol Radius': '12.0000',
                    'Pos': Point3(1.5149, -8.490, 0.0),
                    'PoseAnim': '',
                    'PoseFrame': '',
                    'Private Status': 'All',
                    'Respawns': True,
                    ...
                    'Start State': 'Idle',
                    'Team': 'Villager' },
                '1201560149.3dxschafe': {
                    'Type': 'Light - Dynamic',
                    'Attenuation': '0.005',
                    'ConeAngle': '60.0000',
                    'DropOff': '28.1928',
                    'FlickRate': '0.5000',
                    'Hpr': VBase3(-153.224, -19.295, 0.0),
                    'Intensity': '0.6747',
                    'LightType': 'SPOT',
                    'Pos': Point3(-8.765, -9.8360, 10.398),
                    'Scale': VBase3(1.0, 1.0, 1.0),
                    'Visual': {
                        'Color': (1, 1, 1, 1),
    ...
    'ObjectIds': {
        '1201219525.27dxschafe': '["Objects"]["1233252608.0akelts3"]["Objects"]["1201219525.27dxschafe"]',
        '1201225541.73dxschafe': '["Objects"]["1233252608.0akelts3"]["Objects"]["1201225541.73dxschafe"]',
        '1201560149.3dxschafe': '["Objects"]["1233252608.0akelts3"]["Objects"]["1201560149.3dxschafe"]',
        '1233252608.0akelts3': '["Objects"]["1233252608.0akelts3"]' } }
