from panda3d.core import MouseButton, NodePath, Point2, Point3
import random
import math
...
class RepairCareeningGame(RepairMincroGame):
    ...
    def _initVisuals(self):
        ...
        self.barnacles = []
        for i in xrange(self.config.barnacleCountRange[1]):
    ...
    def updateTask(self, task):
        ...
        elif self.scrubMeterBar.getSz() < 1:
