...
class Sword(Weapon.Weapon):
    modelTypes = [
        ...
        'models/handheld/pir_m_hnd_swd_cutlass_b',
        'models/handheld/pir_m_hnd_swd_cutlass_c',
        'models/handheld/pir_m_hnd_swd_cutlass_d',
        'models/handheld/pir_m_hnd_swd_cutlass_e',
        'models/handheld/pir_m_hnd_swd_cutlass_f',
        'models/handheld/pir_m_hnd_swd_cutlass_g',
        'models/handheld/pir_m_hnd_swd_cutlass_h',
        'models/handheld/pir_m_hnd_swd_cutlass_i',
        'models/handheld/pir_m_hnd_swd_cutlass_j',
        'models/handheld/pir_m_hnd_swd_cutlass_k',
        'models/handheld/pir_m_hnd_swd_broadsword_a',
        'models/handheld/pir_m_hnd_swd_broadsword_b',
        'models/handheld/pir_m_hnd_swd_broadsword_c',
        'models/handheld/pir_m_hnd_swd_broadsword_d',
        'models/handheld/pir_m_hnd_swd_broadsword_e',
        'models/handheld/pir_m_hnd_swd_broadsword_f',
        'models/handheld/pir_m_hnd_swd_broadsword_triton',
        'models/handheld/pir_m_hnd_swd_sabre_a',
        'models/handheld/pir_m_hnd_swd_sabre_b',
        'models/handheld/pir_m_hnd_swd_sabre_c',
        'models/handheld/pir_m_hnd_swd_sabre_d',
        'models/handheld/pir_m_hnd_swd_sabre_e',
        'models/handheld/pir_m_hnd_swd_sabre_f',
        ...
        'models/handheld/pir_m_hnd_swd_davyJones_a',
        'models/handheld/pir_m_hnd_swd_davyJones_b',
        'models/handheld/pir_m_hnd_swd_davyJones_c',
        'models/handheld/pir_m_hnd_swd_davyJones_d',
        'models/handheld/pir_m_hnd_swd_davyJones_e',
        'models/handheld/pir_m_hnd_swd_davyJones_f',
    ...
    def setupSounds(cls):
        Sword.hitSfxs = {
            ItemGlobals.CUTLASS: (loadSfx(SoundGlobals.SFX_WEAPON_CUTLASS_CLASHCLANG), loadSfx(SoundGlobals.SFX_WEAPON_CUTLASS_SWIPECLANG_01), loadSfx(SoundGlobals.SFX_WEAPON_CUTLASS_SWIPECLANG_02), loadSfx(SoundGlobals.SFX_WEAPON_CUTLASS_SWIPECLANG_03)),
            ItemGlobals.SABRE: (loadSfx(SoundGlobals.SFX_WEAPON_SABRE_CLASHCLANG), loadSfx(SoundGlobals.SFX_WEAPON_SABRE_SWIPECLANG_01), loadSfx(SoundGlobals.SFX_WEAPON_SABRE_SWIPECLANG_02), loadSfx(SoundGlobals.SFX_WEAPON_SABRE_SWIPECLANG_03)),
            ItemGlobals.BROADSWORD: (loadSfx(SoundGlobals.SFX_WEAPON_BROADSWORD_CLASHCLANG), loadSfx(SoundGlobals.SFX_WEAPON_BROADSWORD_SWIPECLANG_01), loadSfx(SoundGlobals.SFX_WEAPON_BROADSWORD_SWIPECLANG_02), loadSfx(SoundGlobals.SFX_WEAPON_BROADSWORD_SWIPECLANG_03)),
            ...
            ItemGlobals.AXE: (loadSfx(SoundGlobals.SFX_WEAPON_BROADSWORD_CLASHCLANG), loadSfx(SoundGlobals.SFX_WEAPON_BROADSWORD_SWIPECLANG_01), loadSfx(SoundGlobals.SFX_WEAPON_BROADSWORD_SWIPECLANG_02), loadSfx(SoundGlobals.SFX_WEAPON_BROADSWORD_SWIPECLANG_03)) }
        ...
        Sword.skillSfxs = {
            InventoryType.CutlassHack: loadSfx(SoundGlobals.SFX_WEAPON_CUTLASS_HACK),
            InventoryType.CutlassSlash: loadSfx(SoundGlobals.SFX_WEAPON_CUTLASS_SLASH),
            InventoryType.CutlassStab: loadSfx(SoundGlobals.SFX_WEAPON_CUTLASS_STAB),
            InventoryType.CutlassFlourish: loadSfx(SoundGlobals.SFX_WEAPON_CUTLASS_FLOURISH),
            InventoryType.CutlassCleave: loadSfx(SoundGlobals.SFX_WEAPON_CUTLASS_CLEAVE),
            InventoryType.CutlassTaunt: loadSfx(SoundGlobals.SFX_WEAPON_CUTLASS_TAUNT),
            InventoryType.CutlassBrawl: loadSfx(SoundGlobals.SFX_WEAPON_CUTLASS_BRAWL),
            InventoryType.CutlassSweep: loadSfx(SoundGlobals.SFX_WEAPON_CUTLASS_SWEEP),
            InventoryType.CutlassBladestorm: loadSfx(SoundGlobals.SFX_WEAPON_CUTLASS_BLADESTORM),
            EnemySkills.CUTLASS_BLOWBACK: loadSfx(SoundGlobals.SFX_WEAPON_CUTLASS_BLOWBACK),
            EnemySkills.CUTLASS_CAPTAINS_FURY: loadSfx(SoundGlobals.SFX_WEAPON_CUTLASS_CAPTAINS_FURY),
            EnemySkills.CUTLASS_CURSED_FIRE: loadSfx(SoundGlobals.SFX_WEAPON_CUTLASS_CURSED_FIRE),
            EnemySkills.CUTLASS_CURSED_THUNDER: loadSfx(SoundGlobals.SFX_WEAPON_CUTLASS_CURSED_THUNDER),
            EnemySkills.CUTLASS_CURSED_ICE: loadSfx(SoundGlobals.SFX_WEAPON_CUTLASS_CURSED_ICE),
            EnemySkills.CUTLASS_FIRE_BREAK: loadSfx(SoundGlobals.SFX_WEAPON_CUTLASS_CURSED_FIRE),
            EnemySkills.CUTLASS_THUNDER_BREAK: loadSfx(SoundGlobals.SFX_WEAPON_CUTLASS_CURSED_THUNDER),
            EnemySkills.CUTLASS_ICE_BREAK: loadSfx(SoundGlobals.SFX_WEAPON_CUTLASS_CURSED_ICE),
            EnemySkills.MISC_CAPTAINS_RESOLVE: loadSfx(SoundGlobals.SFX_WEAPON_SKILL_CAPTAINS_RESOLVE) }
