...
class JollyRoger(Skeleton):
    AnimList = (('idle', 'idle'), ('walk', 'walk'), ('pain', 'hit'), ('shoot_up', 'shoot_up'), ('roar_idle', 'roar_idle'), ('death', 'defeat'), ('victory', 'victory'))
    ...
    class AnimationMixer(AnimationMixer):
        ...
        AnimRankings = {
            ...
            'pain': (ACTION['INPLACE_0'], ACTION['INMOTION_1'], ACTION['INMOTION_1']),
            'shoot_up': (ACTION['INPLACE_0'], ACTION['INPLACE_0'], ACTION['INPLACE_0']),
            'roar_idle': (ACTION['INPLACE_0'], ACTION['INPLACE_0'], ACTION['INPLACE_0']),
            'death': (ACTION['MOVIE'], ACTION['MOVIE'], ACTION['MOVIE']),
            'victory': (ACTION['MOVIE'], ACTION['MOVIE'], ACTION['MOVIE']) }
