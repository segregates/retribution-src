from panda3d.core import GeomNode, LODNode, PartBundle, Point3, RenderState, Texture, TransformState, VBase3, VBase4, Vec3, Vec4
...
class DynamicHuman(HumanBase.HumanBase, Biped.Biped):
    ...
    def setGlobalScale(self, scale):
        ...
        try:
            ...
            self.notify.warning("Caught exception")
