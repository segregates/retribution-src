...
class MiniScoreItemGui(DirectFrame.DirectFrame):
    ...
    def __init__(self, scoreValue, parent = None, world = None, itemColorScale = None, blink = False, **kw):
        optiondefs = (('state', DGG.NORMAL, None),
            ...
            ('frameSize',
                (0.0,
                MiniScoreItemGui.Width,
                0.0, MiniScoreItemGui.Height),
                None))
    ...
    def shakeItUp(self, todo1):
        # This may cause issues.
        # IDK if POTCOs Python had super powers,
        # but todo1 was .2 originally
