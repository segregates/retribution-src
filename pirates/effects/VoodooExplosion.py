...
class VoodooExplosion(PooledEffect, EffectController):
    ...
    def __init__(self):
        ...
        self.p0.renderer.setUserAlpha(0.348)
        ...
        self.p0.renderer.getColorInterpolationManager().addLinear(0.0, 1.0, Vec4(0.0, 0.0, 0.0, 1.0), Vec4(0.200, 0.100, 0.598, 0.4), 1)
        ...
        self.p1.renderer.setInitialXScale(0.00300 * self.cardScale)
        self.p1.renderer.setFinalXScale(0.0250 * self.cardScale)
        self.p1.renderer.setInitialYScale(0.00300 * self.cardScale)
        self.p1.renderer.setFinalYScale(0.0400 * self.cardScale)
        ...
        self.p1.renderer.getColorInterpolationManager().addLinear(0.0, 1.0, Vec4(1.0, 1.0, 1.0, 0.200), Vec4(0.75, 0.598, 1.0, 0), 1)
        ...
        self.p1.emitter.setRadius(0.100)
    ...
    def setEffectColor(self, color):
        ...
        self.p1.renderer.getColorInterpolationManager().addLinear(0.0, 1.0, Vec4(1.0, 1.0, 1.0, 0.200), self.effectColor - Vec4(0, 0, 0, 1), 1)
