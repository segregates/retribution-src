...
class SwordFreeze(PooledEffect, EffectController):
    ...
    def __init__(self, effectParent = None):
        ...
        self.p0.renderer.setColor(Vec4(1.0, 1.0, 1.0, 0.800000))
        ...
        self.p0.renderer.getColorInterpolationManager().addLinear(0.0, 1.0, Vec4(0.25, 0.299, 1, 1), Vec4(0.696, 0.800000, 1, 1), 1)
    ...
    def setEffectScale(self, scale):
        self.p0.renderer.setInitialXScale(0.00400 * self.cardScale * scale)
