...
class FishingResults(NodePath):
    ...
    def __init__(self, fishingGame):
        ...
        self.background.setScale(0.800000, 0.75, 0.75)
        ...
        self.bAgain.setPos(0.576, 0, 0.100)
        ...
        self.message = DirectLabel(parent = self, relief = None, text = self.messageText, text_scale = PiratesGuiGlobals.TextScaleTitleSmall, text_align = TextNode.ACenter, text_fg = PiratesGuiGlobals.TextFG2, text_shadow = PiratesGuiGlobals.TextShadow, text_wordwrap = 17, pos = (0.640, 0, 1.14), textMayChange = 0)
        self.fishName = None
    ...
    def showAll(self):
        ...
        self.glow = DirectFrame(parent = self, geom = fishIcon, geom_scale = 1.0, pos = (0.640, 0.0, 0.848), image = None, relief = None)
    ...
    def updateGoldAndXpBonus(self):
        ...
        if xpBonus:
            ...
            self.fishXpBonus = DirectLabel(parent = self, relief = None, text = PLocalizer.FishingGui['XPBonusLabel'] % str(xpBonus), text_scale = PiratesGuiGlobals.TextScaleMed, text_align = TextNode.ACenter, text_fg = PiratesGuiGlobals.TextFG4, text_shadow = PiratesGuiGlobals.TextShadow, text_wordwrap = 17, pos = (0.9, 0, 0.598), textMayChange = 0)
