from panda3d.core import BitMask32, Camera, CollideMask, CollisionHandler, CollisionHandlerQueue, CollisionNode, CollisionSegment, CollisionTraverser, GeomNode, Lens, NodePath, Vec3
import math
from direct.showbase.InputStateGlobal import inputState
from direct.directnotify import DirectNotifyGlobal
from direct.interval.IntervalGlobal import *
from direct.showbase.PythonUtil import reduceAngle, fitSrcAngle2Dest, getSetter
from pirates.piratesbase.PythonUtil import clampScalar, ParamObj
...
class FPSCamera(CameraMode.CameraMode, NodePath, ParamObj):
    ...
    def _collisionCheckTask(self, task = None):
        ...
        if self._cHandlerQueue.getNumEntries():
