...
class Pistol(Weapon.Weapon):
    modelTypes = [
        'models/handheld/pir_m_hnd_gun_pistol_a',
        'models/handheld/pir_m_hnd_gun_pistol_b',
        'models/handheld/pir_m_hnd_gun_pistol_c',
        'models/handheld/pir_m_hnd_gun_pistol_d',
        'models/handheld/pir_m_hnd_gun_multiBarrel_a',
        'models/handheld/pir_m_hnd_gun_multiBarrel_b',
        'models/handheld/pir_m_hnd_gun_multiBarrel_c',
        'models/handheld/pir_m_hnd_gun_multiBarrel_d',
        'models/handheld/pir_m_hnd_gun_multiBarrel_e',
        'models/handheld/pir_m_hnd_gun_multiBarrel_f',
        'models/handheld/pir_m_hnd_gun_multiBarrel_g',
        'models/handheld/pir_m_hnd_gun_multiBarrel_h']
    walkAnim = 'walk'
    ...
    def setupSounds(cls):
        ...
        Pistol.mistimedHitSfxs = {
            ...
            InventoryType.PistolSteelShot: hpHit,
            InventoryType.PistolVenomShot: manaHit }
        Pistol.missSfxs = (loadSfx(SoundGlobals.SFX_WEAPON_PISTOL_MISS),)
        Pistol.aimSfxs = (loadSfx(SoundGlobals.SFX_WEAPON_PISTOL_AIM),)
        Pistol.skillSfxs = {
            InventoryType.PistolShoot: loadSfx(SoundGlobals.SFX_WEAPON_PISTOL_SHOOT),
            InventoryType.PistolTakeAim: loadSfx(SoundGlobals.SFX_WEAPON_PISTOL_WELL_AIMED),
            EnemySkills.PISTOL_POINT_BLANK: loadSfx(SoundGlobals.SFX_WEAPON_PISTOL_SHOOT) }
