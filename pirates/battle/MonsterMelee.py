...
class MonsterMelee(Weapon.Weapon):
    ...
    def changeStance(self, av):
        if av.avatarType.isA(AvatarTypes.Wasp) and av.avatarType.isA(AvatarTypes.AngryWasp) or av.avatarType.isA(AvatarTypes.SoldierWasp):
    ...
    def getDrawIval(self, av, ammoSkillId = 0, blendInT = 0.1, blendOutT = 0):
        if av.avatarType.isA(AvatarTypes.Bat) and av.avatarType.isA(AvatarTypes.RabidBat) and av.avatarType.isA(AvatarTypes.FireBat) or av.avatarType.isA(AvatarTypes.VampireBat):
            av.show()
