...
class GameGui(DirectButton):
    ...
    def __init__(self, **kw):
        ...
        self.repMeter.setPos(0.296, 0, 0.267)
        self.repMeter.setScale(0.813)
        self.keyFrame = gui.find('**/main_gui_game_gui_base').copyTo(self)
        self.keyFrame.setPos(0.553 , 0, 0.263)
        self.keyFrame.setScale(0.473)
        ...
        self.statusTray.setPos(0.2424, 0, 0.2493)
        self.statusTray.setScale(0.79)
        ...
        clamp.setPos(0.72, 0.50, 0.220)
        clamp.setScale(0.55)
        clamp = gui.find('**/*clamp').copyTo(NodePath(''))
        clamp.reparentTo(self.clamps, sort = 2)
        clamp.setPos(0.72, 0.50, 0.300)
        clamp.setScale(0.55)
        self.clamps.hide()
