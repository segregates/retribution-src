...
class PotionResults(GuiPanel):
    ...
    def __init__(self, potionGame):
        ...
        self.bQuit.setPos(0.149, 0, 0.050000)
        ...
        self.bAgain.setPos(1.25, 0, 0.050000)
        ...
        self.Title = DirectLabel(parent = self, relief = None, text = self.titleText, text_scale = PiratesGuiGlobals.TextScaleTitleJumbo, text_font = PiratesGlobals.getPirateOutlineFont(), text_align = TextNode.ACenter, text_fg = PiratesGuiGlobals.TextFG1, text_shadow = PiratesGuiGlobals.TextLT14, pos = (0.75, 0, 0.826), textMayChange = 0)
        self.message = DirectLabel(parent = self, relief = None, text = self.messageText, text_scale = PiratesGuiGlobals.TextScaleTitleSmall, text_align = TextNode.ACenter, text_fg = PiratesGuiGlobals.TextFG2, text_shadow = PiratesGuiGlobals.TextShadow, text_wordwrap = 17, pos = (0.75, 0, 0.71), textMayChange = 0)
    ...
    def show(self):
        if self.potionName is not None:
            self.potionName.remove_node()

        if self.potionDesc is not None:
            self.potionDesc.remove_node()

        if self.potionXp is not None:
            self.potionXp.remove_node()

        if self.potionImg is not None:
            self.potionImg.remove_node()

        self.potionName = DirectLabel(parent = self, relief = None, text = self.potionGame.currentRecipe.name, text_scale = PiratesGuiGlobals.TextScaleTitleMed, text_align = TextNode.ACenter, text_fg = PiratesGuiGlobals.TextFG2, text_shadow = PiratesGuiGlobals.TextShadow, text_wordwrap = 17, pos = (0.75, 0, 0.65), textMayChange = 0)
        ...
        self.potionXp = DirectLabel(parent = self, relief = None, text = labelTxt, text_scale = PiratesGuiGlobals.TextScaleTitleSmall, text_align = TextNode.ACenter, text_fg = PiratesGuiGlobals.TextFG2, text_shadow = PiratesGuiGlobals.TextShadow, text_wordwrap = 17, pos = (0.75, 0, 0.288), textMayChange = 0)
