from panda3d.core import BoundingVolume, CardMaker, CollideMask, CollisionNode, CollisionPlane, CollisionPolygon, GraphicsStateGuardian, InternalName, Light, NodePath, OmniBoundingVolume, Plane, Point3, Shader, ShaderInput, StencilAttrib, Texture, Vec3
import os
import math
...
class Swamp(Water):
    ...
    def delete(self):
        ...
        self.cNodePath.remove_node()
        if self.swamp_model == None:
            self.seamodel.remove_node()

        self.patchNP.remove_node()
        self.parentNP = None
        self.todMgr = None
