...
objectStruct = {
    'Objects': {
        '1233104728.03akelts0': {
            'Type': 'Building Interior',
            'Name': '',
            'AdditionalData': [
                'interior_spanish_store_barber'],
            'Instanced': True,
            'Objects': {
                '1201211566.28dxschafe': {
                ...
                '1201229350.47dxschafe': {
                    ...
                    'AnimSet': 'default',
                    'CustomModel': 'None',
                    'Hpr': VBase3(164.806, 0.0, 0.0),
                    'Patrol Radius': '12.0000',
                    'Pos': Point3(4.5940, -5.070, 0.0),
                    'PoseAnim': '',
                    'PoseFrame': '',
                    'Private Status': 'All',
                    'Respawns': True,
    ...
    'ObjectIds': {
        '1201211566.28dxschafe': '["Objects"]["1233104728.03akelts0"]["Objects"]["1201211566.28dxschafe"]',
        '1201229350.47dxschafe': '["Objects"]["1233104728.03akelts0"]["Objects"]["1201229350.47dxschafe"]',
        '1233104728.03akelts0': '["Objects"]["1233104728.03akelts0"]' } }
