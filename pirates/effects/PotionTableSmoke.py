...
class PotionTableSmoke(PooledEffect, EffectController):
    ...
    def __init__(self, parent = None):
        ...
        self.p0.factory.setLifespanBase(2.10)
    ...
    def setEffectScale(self, scale):
        self.p0.renderer.setInitialXScale(0.0149 * self.cardScale * scale)
        self.p0.renderer.setInitialYScale(0.0149 * self.cardScale * scale)
        self.p0.renderer.setFinalXScale(0.100 * self.cardScale * scale)
        self.p0.renderer.setFinalYScale(0.100 * self.cardScale * scale)
