...
objectStruct = {
        ...
        '1233252736.0akelts6': {
            ...
            'Objects': {
                '1157098184.94jasyeung': {
                    ...
                    'AnimSet': 'default',
                    'CustomModel': 'None',
                    'DNA': '1157098184.94jasyeung',
                    'Hpr': VBase3(122.364, 0.0, 0.0),
                    'Patrol Radius': '12.0000',
                    'Pos': Point3(32.932, 11.391, 0.0),
                    'PoseAnim': '',
                    'PoseFrame': '',
                    'Private Status': 'All',
                    'Respawns': True,
                ...
                '1223919703.7akelts': {
                    ...
                    'Pos': Point3(0.408, -5.6219, 0.91200),
                    'Scale': VBase3(1.0, 1.0, 1.0) },
                '1223919704.8akelts': {
                    'Type': 'Door Locator Node',
                    'Name': 'door_locator_2',
                    'Hpr': Point3(0.0, 0.0, 0.0),
                    'Pos': Point3(6.9729, 21.2368, 1.0389),
                    'Scale': VBase3(1.0, 1.0, 1.0) },
                '1223919722.81akelts': {
                    'Type': 'Light - Dynamic',
                    'Attenuation': '0.005',
                    ...
                    'Intensity': '0.1446',
                    'LightType': 'AMBIENT',
                    'Pos': Point3(14.195, -6.9660, 33.045),
                    'Scale': VBase3(1.0, 1.0, 1.0),
                    'VisSize': '',
                    'Visual': {
                        'Color': (1, 1, 1, 1),
                ...
                '1223919741.19akelts': {
                    ...
                    'DropOff': '0.0000',
                    'FlickRate': '0.5000',
                    'Hpr': VBase3(0.0, -88.417, 0.0),
                    'Intensity': '0.1446',
                    'LightType': 'DIRECTIONAL',
                    'Pos': Point3(563.729, -1197.2429999999999, 71.281),
                    'Scale': VBase3(1.0, 1.0, 1.0),
                    'VisSize': '',
                    'Visual': {
                        'Color': (0.9, 0.946, 1.0, 1.0),
                        'Model': 'models/props/light_tool_bulb' } },
                '1223919787.95akelts': {
                    'Type': 'Light - Dynamic',
                    'Attenuation': '0.005',
                    ...
                    'Intensity': '0.7229',
                    'LightType': 'POINT',
                    'Pos': Point3(555.083, -1187.883, 39.572),
                    'Scale': VBase3(1.0, 1.0, 1.0),
                    'VisSize': '',
                    'Visual': {
                        'Color': (1.0, 0.859, 0.77, 1.0),
                        'Model': 'models/props/light_tool_bulb' } } },
            'VisSize': '',
            'Visual': {
    ...
    'ObjectIds': {
        '1157098184.94jasyeung': '["Objects"]["1233252736.0akelts6"]["Objects"]["1157098184.94jasyeung"]',
        '1223919703.7akelts': '["Objects"]["1233252736.0akelts6"]["Objects"]["1223919703.7akelts"]',
        '1223919704.8akelts': '["Objects"]["1233252736.0akelts6"]["Objects"]["1223919704.8akelts"]',
        '1223919722.81akelts': '["Objects"]["1233252736.0akelts6"]["Objects"]["1223919722.81akelts"]',
        '1223919741.19akelts': '["Objects"]["1233252736.0akelts6"]["Objects"]["1223919741.19akelts"]',
        '1223919787.95akelts': '["Objects"]["1233252736.0akelts6"]["Objects"]["1223919787.95akelts"]',
        '1233252736.0akelts6': '["Objects"]["1233252736.0akelts6"]' } }
