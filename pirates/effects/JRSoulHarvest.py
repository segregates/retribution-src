...
class JRSoulHarvest(PooledEffect, EffectController):
    ...
    def __init__(self):
        ...
        self.p0.renderer.setColor(Vec4(0.800000, 1.0, 0.200, 1.0))
        ...
        self.p0.renderer.setFinalYScale(0.140 * self.cardScale)
        self.p0.renderer.setNonanimatedTheta(0.0)
        self.p0.renderer.setAlphaBlendMethod(BaseParticleRenderer.PPBLENDLINEAR)
        self.p0.renderer.setAlphaDisable(0)
        self.p0.renderer.setColorBlendMode(ColorBlendAttrib.MAdd, ColorBlendAttrib.OIncomingAlpha, ColorBlendAttrib.OOne)
        self.p0.renderer.getColorInterpolationManager().addLinear(0.0, 1.0, Vec4(1.0, 1.0, 1.0, 1.0), Vec4(0.800000, 1.0, 0.100, 0.4), 1)
