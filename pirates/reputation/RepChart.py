...
__levelUpStats = {
    InventoryType.OverallRep: (25, 3),
    InventoryType.CutlassRep: (8, 0),
    InventoryType.GrenadeRep: (8, 0),
    InventoryType.DaggerRep: (7, 1),
    InventoryType.PistolRep: (7, 1),
    InventoryType.DollRep: (4, 6),
    InventoryType.WandRep: (4, 6),
    InventoryType.CannonRep: (5, 0),
...
__levelUpSkills = {
    ...
    InventoryType.PistolRep: {
        ...
        2: ([
            InventoryType.UnspentPistol], [
            InventoryType.PistolVenomShot]),
        3: ([
            InventoryType.UnspentPistol], []),
        4: ([
            InventoryType.UnspentPistol], [
        ...
        10: ([
            InventoryType.UnspentPistol], [
            InventoryType.PistolHexEaterShot]),
        11: ([
            InventoryType.UnspentPistol], []),
        12: ([
            InventoryType.UnspentPistol], [
            InventoryType.PistolDodge]),
        13: ([
            InventoryType.UnspentPistol], []),
        14: ([
            InventoryType.UnspentPistol], [
        ...
        17: ([
            InventoryType.UnspentPistol], [
            InventoryType.PistolSilverShot]),
        18: ([
            InventoryType.UnspentPistol], []),
        19: ([
            InventoryType.UnspentPistol], []),
    ...
    InventoryType.GrenadeRep: {
        ...
        4: ([
            InventoryType.UnspentGrenade], [
            InventoryType.GrenadeLongVolley]),
        5: ([
            InventoryType.UnspentGrenade], []),
        6: ([
            InventoryType.UnspentGrenade], [
            InventoryType.GrenadeDetermination]),
        7: ([
            InventoryType.UnspentGrenade], []),
        8: ([
            InventoryType.UnspentGrenade], [
        ...
        12: ([
            InventoryType.UnspentGrenade], [
            InventoryType.GrenadeSmokeCloud]),
        13: ([
            InventoryType.UnspentGrenade], []),
        14: ([
            InventoryType.UnspentGrenade], [
        ...
        17: ([
            InventoryType.UnspentGrenade], [
            InventoryType.GrenadeIgnorePain]),
        18: ([
            InventoryType.UnspentGrenade], []),
        19: ([
            InventoryType.UnspentGrenade], []),
    ...
    InventoryType.DollRep: {
        ...
        2: ([
            InventoryType.UnspentDoll], [
            InventoryType.DollSwarm]),
        3: ([
            InventoryType.UnspentDoll], []),
        4: ([
            InventoryType.UnspentDoll], [
            InventoryType.DollHeal]),
        5: ([
            InventoryType.UnspentDoll], []),
        6: ([
            InventoryType.UnspentDoll], [
        ...
        10: ([
            InventoryType.UnspentDoll], [
            InventoryType.DollFocus]),
        11: ([
            InventoryType.UnspentDoll], []),
        12: ([
            InventoryType.UnspentDoll], [
            InventoryType.DollCure]),
        13: ([
            InventoryType.UnspentDoll], []),
        14: ([
            InventoryType.UnspentDoll], [
    ...
    InventoryType.WandRep: {
        ...
        6: ([
            InventoryType.UnspentWand], [
            InventoryType.StaffConcentration]),
        7: ([
            InventoryType.UnspentWand], []),
        8: ([
            InventoryType.UnspentWand], [
        ...
        17: ([
            InventoryType.UnspentWand], [
            InventoryType.StaffSpiritMastery]),
        18: ([
            InventoryType.UnspentWand], []),
        19: ([
            InventoryType.UnspentWand], []),
    ...
    InventoryType.SailingRep: {
        ...
        2: ([
            InventoryType.UnspentSailing], [
            InventoryType.SailFullSail]),
        3: ([
            InventoryType.UnspentSailing], []),
        4: ([
            InventoryType.UnspentSailing], [
        ...
        6: ([
            InventoryType.UnspentSailing], [
            InventoryType.SailWindcatcher]),
        7: ([
            InventoryType.UnspentSailing], []),
        8: ([
            InventoryType.UnspentSailing], [
            InventoryType.SailTacking]),
        9: ([
            InventoryType.UnspentSailing], []),
        10: ([
            InventoryType.UnspentSailing], [
            InventoryType.SailOpenFire]),
        11: ([
            InventoryType.UnspentSailing], []),
        12: ([
            InventoryType.UnspentSailing], [
        ...
        14: ([
            InventoryType.UnspentSailing], [
            InventoryType.SailTreasureSense]),
        15: ([
            InventoryType.UnspentSailing], []),
        16: ([
            InventoryType.UnspentSailing], []),
