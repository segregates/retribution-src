...
class PVPBoard(DirectObject):
    ...
    def __init__(self, holder):
        ...
        self.borderOne = BorderFrame.BorderFrame(relief = None, frameSize = (-(PiratesGuiGlobals.PVPCompletePageWidth) * 0.33, PiratesGuiGlobals.PVPCompletePageWidth * 0.33, PiratesGuiGlobals.PVPCompletePageHeight * 0.5 - 0.100 - (PiratesGuiGlobals.TMCompletePageHeight / 16.0) * len(holder.getItemList(1)), PiratesGuiGlobals.PVPCompletePageHeight * 0.5), modelName = 'pir_m_gui_frm_subframe', imageColorScale = VBase4(0.75, 0.75, 0.9, 0.75))
        self.borderOneSecondLayer = BorderFrame.BorderFrame(parent = self.borderOne, relief = None, text = '', text_scale = 0.074, text_fg = PVPGlobals.getTeamColor(1), text_pos = (-0.65, 0.640), frameSize = (-(PiratesGuiGlobals.PVPCompletePageWidth) * 0.33, PiratesGuiGlobals.PVPCompletePageWidth * 0.33, PiratesGuiGlobals.PVPCompletePageHeight * 0.5 - 0.100 - (PiratesGuiGlobals.TMCompletePageHeight / 16.0) * len(holder.getItemList(1)), PiratesGuiGlobals.PVPCompletePageHeight * 0.5), modelName = 'pir_m_gui_frm_subframe', imageColorScale = VBase4(0.75, 0.75, 0.9, 0.75))
        self.borderOne.setPos(0.0625, 0, -0.100)
        if hasTeams:
            ...
            self.one.setPos(-0.739, 0, -0.848)
        self.borderOne.hide()
        self.one.hide()
        if hasTeams:
            self.borderTwo = BorderFrame.BorderFrame(relief = None, frameSize = (-(PiratesGuiGlobals.PVPCompletePageWidth) * 0.33, PiratesGuiGlobals.PVPCompletePageWidth * 0.33, PiratesGuiGlobals.PVPCompletePageHeight * 0.5 - 0.100 - (PiratesGuiGlobals.TMCompletePageHeight / 16.0) * len(holder.getItemList(2)), PiratesGuiGlobals.PVPCompletePageHeight * 0.5), modelName = 'pir_m_gui_frm_subframe', imageColorScale = VBase4(0.75, 0.75, 0.9, 0.75))
            self.borderTwoSecondLayer = BorderFrame.BorderFrame(parent = self.borderTwo, relief = None, text = PLocalizer.PVPTeamName % 2, text_scale = 0.074, text_fg = PVPGlobals.getTeamColor(2), text_pos = (-0.65, 0.640), frameSize = (-(PiratesGuiGlobals.PVPCompletePageWidth) * 0.33, PiratesGuiGlobals.PVPCompletePageWidth * 0.33, PiratesGuiGlobals.PVPCompletePageHeight * 0.5 - 0.100 - (PiratesGuiGlobals.TMCompletePageHeight / 16.0) * len(holder.getItemList(2)), PiratesGuiGlobals.PVPCompletePageHeight * 0.5), modelName = 'pir_m_gui_frm_subframe', imageColorScale = VBase4(0.75, 0.75, 0.9, 0.75))
