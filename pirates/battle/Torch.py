...
class Torch(Weapon.Weapon):
    ...
    def setupSounds(cls):
        Torch.hitSfxs = {
            ItemGlobals.QUEST_PROP_TORCH: (loadSfx(SoundGlobals.SFX_WEAPON_CUTLASS_CLASHCLANG), loadSfx(SoundGlobals.SFX_WEAPON_CUTLASS_SWIPECLANG_01), loadSfx(SoundGlobals.SFX_WEAPON_CUTLASS_SWIPECLANG_02), loadSfx(SoundGlobals.SFX_WEAPON_CUTLASS_SWIPECLANG_03)) }
        Torch.missSfxs = (loadSfx(SoundGlobals.SFX_WEAPON_CUTLASS_SWOOSH_01), loadSfx(SoundGlobals.SFX_WEAPON_CUTLASS_SWOOSH_02))
        Torch.mistimedHitSfxs = (loadSfx(SoundGlobals.SFX_WEAPON_CUTLASS_MISTIMEDHIT),)
        Torch.skillSfxs = {
