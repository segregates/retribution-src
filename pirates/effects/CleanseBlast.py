...
class CleanseBlast(PooledEffect, EffectController):
    cardScale = 128.0
    ...
    def __init__(self):
        ...
        if not CleanseBlast.particleDummy:
            CleanseBlast.particleDummy = render.attachNewNode(ModelNode('CleanseParticleDummy'))
        ...
        self.p0.renderer.setColor(Vec4(1, 1, 1, 0.800000))
        ...
        self.p0.renderer.getColorInterpolationManager().addLinear(0.5, 1.0, Vec4(1, 1, 1, 1), Vec4(1, 0.9, 0.5, 1), 1)
    ...
    def createTrack(self):
        ...
        self.endEffect = Sequence(Func(self.p0.setBirthRate, 100), Wait(4.0), Func(self.cleanUpEffect))
