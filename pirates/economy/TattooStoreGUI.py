from panda3d.core import Camera, CardMaker, NodePath, Point3, TextNode, Texture, Vec2, Vec3, Vec4, lookAt
...
class TattooStoreGUI(DirectFrame):
    ...
    def setPage(self, pageName, startIndex = 0, refreshWardrobe = True):
        self.tabBar.unstash()
        self.titleLabel['text'] = '\x01smallCaps\x01' + self.rootTitle + ' - ' + TattooZones[pageName][1]
            ...
            if self.currentWardrobe:
                for itemInfo in self.currentWardrobe:
                    ...
                    if type == tattooType:
                        ...
                        location = location
                        if location in xrange(Locations.RANGE_EQUIP_TATTOO[0], Locations.RANGE_EQUIP_TATTOO[1]):
                            equipped = True
