from panda3d.physics import BaseParticleEmitter, BaseParticleRenderer, LinearCylinderVortexForce, LinearDistanceForce, LinearSinkForce, LinearVectorForce
...
class TeleportTwister(PooledEffect, EffectController):
    ...
    def createTrack(self):
        self.startEffect = Sequence(Func(self.p0.setBirthRate, 0.100), Func(self.p0.clearToInitial), Func(self.f.start, self, self), Func(self.f.reparentTo, self))
