...
__itemTypeRate = {
    ...
    PiratesGlobals.TREASURE_CHEST: (0.3, 0.25, 0.15, 0.1, 0.1, 0.1, 0.0),
    PiratesGlobals.RARE_CHEST: (0.3, 0.2, 0.15, 0.1, 0.1, 0.15, 0.0) }
...
__itemRarityRate = {
    PiratesGlobals.ITEM_SAC: (0.7549, 0.2, 0.045, 0.0001, 0.0),
    PiratesGlobals.TREASURE_CHEST: (0.41979, 0.48, 0.1, 0.0002, 1.00001),
    PiratesGlobals.RARE_CHEST: (0.0, 0.72415, 0.25, 0.025, 0.00085) }
...
def getMakeAPirateClothing():
    ...
    for itemId in __dropInfo:
        ...
        if item[__columnHeadings['MakeAPirate']]:
