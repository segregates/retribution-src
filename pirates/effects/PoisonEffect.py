...
class PoisonEffect(PooledEffect, EffectController):
    ...
    def __init__(self):
        ...
        force1 = LinearNoiseForce(0.100, 0)
        ...
        self.p0.renderer.getColorInterpolationManager().addLinear(0.0, 1.0, Vec4(0.4, 1, 0.299, 1), Vec4(0, 0, 0, 0.25), 1)
    ...
    def createTrack(self):
        self.p0.renderer.setInitialXScale(0.000500 * self.cardScale * self.effectScale)
        self.p0.renderer.setFinalXScale(0.0598 * self.cardScale * self.effectScale)
        self.p0.renderer.setInitialYScale(0.000500 * self.cardScale * self.effectScale)
