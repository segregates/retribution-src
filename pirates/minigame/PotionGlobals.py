...
__potionBuffs = {
    ...
    C_REP_BONUS_LVL3: {
        ...
        'xp': 300,
        'potency': 1.0,
        'potionId': ItemGlobals.POTION_REP_3,
        'haveMade': InventoryType.HaveMade_RepBonusLvl3,
        'dontStackList': [
            C_REP_BONUS_LVL1,
            C_REP_BONUS_LVL2,
            C_REP_BONUS_LVL3,
    ...
    C_REP_BONUS_LVLCOMP: {
        ...
        'xp': 300,
        'potency': 5.0,
        'potionId': ItemGlobals.POTION_REP_COMP,
        'haveMade': InventoryType.HaveMade_RepBonusLvlComp,
        'dontStackList': [
            C_REP_BONUS_LVL1,
            C_REP_BONUS_LVL2,
            C_REP_BONUS_LVL3,
    ...
    C_INVISIBILITY_LVL1: {
        'duration': 60.0,
        'xp': 150,
        'potionId': ItemGlobals.POTION_INVIS_1,
        'haveMade': InventoryType.HaveMade_InvisibilityLvl1,
        'dontStackList': [
            C_INVISIBILITY_LVL1,
            C_INVISIBILITY_LVL2,
            C_BURP,
    ...
    C_INVISIBILITY_LVL2: {
        'duration': 120.0,
        'xp': 220,
        'potionId': ItemGlobals.POTION_INVIS_2,
        'haveMade': InventoryType.HaveMade_InvisibilityLvl2,
        'dontStackList': [
            C_INVISIBILITY_LVL1,
            C_INVISIBILITY_LVL2,
            C_BURP,
    ...
    C_REMOVE_GROGGY: {
        'duration': 0.0,
        'xp': 180,
        'potionId': ItemGlobals.POTION_GROG,
        'haveMade': InventoryType.HaveMade_RemoveGroggy,
        'dontStackList': [] },
    C_REGEN_LVL1: {
        'duration': 120.0,
        'xp': 70,
    ...
    C_BURP: {
        'duration': 50.0,
        'xp': 55,
        'potionId': ItemGlobals.POTION_BURP,
        'haveMade': InventoryType.HaveMade_Burp,
        'dontStackList': [
            C_SCORPION_TRANSFORM,
            C_ALLIGATOR_TRANSFORM,
            C_CRAB_TRANSFORM,
    ...
    C_FART: {
        'duration': 50.0,
        'xp': 65,
        'potionId': ItemGlobals.POTION_FART,
        'haveMade': InventoryType.HaveMade_Fart,
        'dontStackList': [
            C_SCORPION_TRANSFORM,
            C_ALLIGATOR_TRANSFORM,
            C_CRAB_TRANSFORM,
    ...
    C_FART_LVL2: {
        'duration': 150.0,
        'xp': 65,
        'potionId': ItemGlobals.POTION_FART_2,
        'haveMade': InventoryType.HaveMade_FartLvl2,
        'dontStackList': [
            C_SCORPION_TRANSFORM,
            C_ALLIGATOR_TRANSFORM,
            C_CRAB_TRANSFORM,
    ...
    C_VOMIT: {
        'duration': 33.0,
        'xp': 75,
        'potionId': ItemGlobals.POTION_VOMIT,
        'haveMade': InventoryType.HaveMade_Vomit,
        'dontStackList': [
            C_SCORPION_TRANSFORM,
            C_ALLIGATOR_TRANSFORM,
            C_CRAB_TRANSFORM,
    ...
    C_HEAD_GROW: {
        'duration': 300.0,
        'xp': 100,
        'potionId': ItemGlobals.POTION_HEADGROW,
        'haveMade': InventoryType.HaveMade_HeadGrow,
        'dontStackList': [
            C_SCORPION_TRANSFORM,
            C_ALLIGATOR_TRANSFORM,
            C_CRAB_TRANSFORM,
    ...
    C_CRAZY_SKIN_COLOR: {
        'duration': 300.0,
        'xp': 110,
        'potionId': ItemGlobals.POTION_FACECOLOR,
        'haveMade': InventoryType.HaveMade_FaceColor,
        'dontStackList': [
            C_SCORPION_TRANSFORM,
            C_ALLIGATOR_TRANSFORM,
            C_CRAB_TRANSFORM,
    ...
    C_SIZE_REDUCE: {
        'duration': 300.0,
        'xp': 120,
        'potionId': ItemGlobals.POTION_SHRINK,
        'haveMade': InventoryType.HaveMade_SizeReduce,
        'dontStackList': [
            C_SCORPION_TRANSFORM,
            C_ALLIGATOR_TRANSFORM,
            C_CRAB_TRANSFORM,
    ...
    C_SIZE_INCREASE: {
        'duration': 300.0,
        'xp': 190,
        'potionId': ItemGlobals.POTION_GROW,
        'haveMade': InventoryType.HaveMade_SizeIncrease,
        'dontStackList': [
            C_SCORPION_TRANSFORM,
            C_ALLIGATOR_TRANSFORM,
            C_CRAB_TRANSFORM,
    ...
    C_HEAD_FIRE: {
        'duration': 300.0,
        'xp': 210,
        'potionId': ItemGlobals.POTION_HEADONFIRE,
        'haveMade': InventoryType.HaveMade_HeadFire,
        'dontStackList': [
            C_SCORPION_TRANSFORM,
            C_ALLIGATOR_TRANSFORM,
            C_CRAB_TRANSFORM,
    ...
    C_SCORPION_TRANSFORM: {
        'duration': 300.0,
        'xp': 0,
        'potionId': ItemGlobals.POTION_SCORPION,
        'haveMade': InventoryType.HaveMade_ScorpionTransform,
        'dontStackList': [
            C_SCORPION_TRANSFORM,
            C_ALLIGATOR_TRANSFORM,
            C_CRAB_TRANSFORM,
    ...
    C_ALLIGATOR_TRANSFORM: {
        'duration': 300.0,
        'xp': 0,
        'potionId': ItemGlobals.POTION_ALLIGATOR,
        'haveMade': InventoryType.HaveMade_AlligatorTransform,
        'dontStackList': [
            C_SCORPION_TRANSFORM,
            C_ALLIGATOR_TRANSFORM,
            C_CRAB_TRANSFORM,
    ...
    C_CRAB_TRANSFORM: {
        'duration': 300.0,
        'xp': 0,
        'potionId': ItemGlobals.POTION_CRAB,
        'haveMade': InventoryType.HaveMade_CrabTransform,
        'dontStackList': [
            C_SCORPION_TRANSFORM,
            C_ALLIGATOR_TRANSFORM,
            C_CRAB_TRANSFORM,
            ...
            C_INVISIBILITY_LVL1,
            C_INVISIBILITY_LVL2] },
    C_STAFF_ENCHANT_LVL1: {
        'duration': 0.0,
        'xp': 100,
        'potency': 0.0,
        'potionId': ItemGlobals.STAFF_ENCHANT_1,
        'dontStackList': [] },
    C_STAFF_ENCHANT_LVL2: {
        'duration': 0.0,
        'xp': 100,
        'potency': 0.0,
    ...
    C_SUMMON_MONKEY: {
        'duration': 300,
        'xp': 0,
        'potionId': ItemGlobals.POTION_SUMMON_MONKEY,
        'dontStackList': [
            C_SUMMON_CHICKEN,
            C_SUMMON_MONKEY,
            C_SUMMON_WASP,
    ...
    C_SUMMON_WASP: {
        'duration': 300,
        'xp': 0,
        'potionId': ItemGlobals.POTION_SUMMON_WASP,
        'dontStackList': [
            C_SUMMON_CHICKEN,
            C_SUMMON_MONKEY,
            C_SUMMON_WASP,
    ...
    C_SUMMON_DOG: {
        'duration': 300,
        'xp': 0,
        'potionId': ItemGlobals.POTION_SUMMON_DOG,
        'dontStackList': [
            C_SUMMON_CHICKEN,
            C_SUMMON_MONKEY,
            C_SUMMON_WASP,
