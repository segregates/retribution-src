from panda3d.core import Camera, Character, Fog, Light, Shader, TextProperties, TextPropertiesManager, Texture, Thread
import string
import os
import datetime
import time
...
ThreatLevel_2_text_a = 'They think can out gun us?! Open fire and plunder all you can!'
...
JewelryTypeNames = {
    ItemGlobals.BROW: BrowJewelry,
    ItemGlobals.EAR: EarJewelry,
    ItemGlobals.NOSE: NoseJewelry,
    ItemGlobals.MOUTH: MouthJewelry,
    ItemGlobals.HAND: HandJewelry }
CATALOG_HOLIDAY_ID_2_NAME = {
    3901: 'Royal Commodore',
    3902: 'Treasure Hunter',
    3903: 'Emerald Duelist',
    3904: "Town Mayor's Outfit",
    3905: 'Merchant Voyager',
    3906: 'Admiral',
    3907: 'Spanish Conquistador',
    3908: 'Crimson Captain',
    3909: 'Spanish Adventurer',
    3910: "Raven's Cove Mercenary",
    3911: 'Pilgrim Explorer',
    3912: 'French Fencer',
    3913: 'Oriental',
    3914: 'Capt. Black' }
...
TattooTypeNames = {
    ItemGlobals.CHEST: ChestTattoo,
    ItemGlobals.ARM: ArmTattoo,
    ItemGlobals.FACE: FaceTattoo }
...
LeadCrew = 'How will you lead your crew?'
...
AvatarChooserCreatePirate = 'Create'
AvatarChooserRecover = 'Recover'
AvatarChooserRemaining = '%s remaining'
AvatarChooserReady = 'Ready for recovery'
AvatarChooserLoading = 'Loading'
AvatarChooserDelete = 'Delete'
AvatarChooserConfirmDelete = 'Are you sure you want to delete %s?'
AvatarChooserCantDelete = "You can't delete %s! You need to recover another pirate first."
...
MakeAPirateFactionChoose = 'Which faction would you like to pledge your allegiance to?'
MakeAPirateFactionConfirm = 'Are you sure you want to pledge your allegiance to %s? You will not be able to change this later on!'
FactionNames = ['Pirates', 'Spain', 'France']
FactionArticulatedNames = ['the Pirates', 'Spain', 'France']
...
InventoryCategoryNames = {
    ...
    InventoryCategory.CATEGORY: 'Locatable Items',
    ...
    InventoryCategory.WEAPON_SKILL_CUTLASS: 'Sword Skill',
    InventoryCategory.WEAPON_SKILL_PISTOL: 'Shooting Skill',
    ...
    InventoryCategory.WEAPON_PISTOL_AMMO: 'Gun Ammo',
...
Minigame_Repair_Speed_Thresholds = ('\x01Igreen\x01Lightning Fast!\x02', 'Quick Work!', '\x01Iyellow\x01Pick Up The Pace!\x02', '\x01Ired\x01Faster, Landlubber!\x02')
...
Minigame_Repair_Sawing_Thresholds = ('Terrible!', 'OK', 'Great', 'Perfect!')
...
ShipLogoNames = {
    ShipLogos.Navy: 'OLD: navy skull',
    ShipLogos.BlackPearl: 'OLD: BP logo',
    ShipLogos.EITC: 'OLD: EITC',
    ShipLogos.EITC_Emblem: 'OLD: logo_eitc_emblem',
    ShipLogos.PVP_French: 'OLD: logo_french_flag',
    ShipLogos.PVP_Spanish: 'OLD: logo_spanish_flag',
    ShipLogos.Bandit_Bull: 'BANDIT: BULL',
    ShipLogos.Bandit_Dagger: 'BANDIT: DAGGER',
    ShipLogos.Bandit_Scorpion: 'BANDIT: SCORPION',
    ShipLogos.Bandit_Claw: 'BANDIT: CLAW',
    ShipLogos.Treasure_Navy: 'NAVY TREASURE',
    ShipLogos.Treasure_EITC: 'EITC TREASURE',
    ShipLogos.QueenAnnesRevenge: 'OLD: BP logo' }
ShipStyleNames = {
    ShipGlobals.Styles.Player: 'PLAYER',
    ShipGlobals.Styles.Navy: 'NAVY',
    ShipGlobals.Styles.EITC: 'EITC',
    ShipGlobals.Styles.Undead: 'UNDEAD',
    ShipGlobals.Styles.BP: 'BLACK PEARL',
    ShipGlobals.Styles.Treasure_Navy: 'NAVY TREASURE',
    ShipGlobals.Styles.Treasure_EITC: 'EITC TREASURE',
    ShipGlobals.Styles.Bandit01: 'RED BANDIT',
    ShipGlobals.Styles.Bandit02: 'GREEN BANDIT',
    ShipGlobals.Styles.Bandit03: 'BLUE BANDIT',
    ShipGlobals.Styles.Bandit04: 'SUPER BANDIT',
    ShipGlobals.Styles.QueenAnnesRevenge: 'QUEEN ANNES REVENGE',
    ShipGlobals.Styles.BountyHunter_A: 'BOUNTY HUNTER A',
    ShipGlobals.Styles.BountyHunter_B: 'BOUNTY HUNTER B',
    ShipGlobals.Styles.BountyHunter_C: 'BOUNTY HUNTER C',
    ShipGlobals.Styles.BountyHunter_D: 'BOUNTY HUNTER D',
    ShipGlobals.Styles.BountyHunter_E: 'BOUNTY HUNTER E',
    ShipGlobals.Styles.BountyHunter_F: 'BOUNTY HUNTER F',
    ShipGlobals.Styles.BountyHunter_G: 'BOUNTY HUNTER G',
    ShipGlobals.Styles.NavyHunter: 'NAVY HUNTER' }
...
ShipClassNames = {
    ...
    ShipGlobals.DAUNTLESS: 'Dauntless',
    ShipGlobals.HUNTER_VENGENCE: 'Vengence',
...
InventoryTypeNames = {
    ...
    InventoryType.ItemTypeTattoo: 'Tattoo',
    InventoryType.ItemTypeJewelry: 'Jewelry',
    InventoryType.ItemTypeMusic: 'Music',
    ...
    InventoryType.RegularLure: 'Regular Lure',
    InventoryType.LegendaryLure: 'Legendary Lure',
    ...
    InventoryType.CannonDamageLvl1: 'Cannoneer Draft I',
    InventoryType.CannonDamageLvl2: 'Cannoneer Draft II',
    InventoryType.CannonDamageLvl3: 'Cannoneer Draft III',
    InventoryType.PistolDamageLvl1: 'Marksman Draught I',
    InventoryType.PistolDamageLvl2: 'Marksman Draught II',
    InventoryType.PistolDamageLvl3: 'Marksman Draught III',
    InventoryType.CutlassDamageLvl1: 'Swashbuckler Stew I',
    InventoryType.CutlassDamageLvl2: 'Swashbuckler Stew II',
    InventoryType.CutlassDamageLvl3: 'Swashbuckler Stew III',
    InventoryType.DollDamageLvl1: 'Mystic Mixture I',
    InventoryType.DollDamageLvl2: 'Mystic Mixture II',
    InventoryType.DollDamageLvl3: 'Mystic Mixture III',
    InventoryType.HastenLvl1: 'Swift Foot I',
    InventoryType.HastenLvl2: 'Swift Foot II',
    InventoryType.HastenLvl3: 'Swift Foot III',
    InventoryType.RepBonusLvl1: 'Hardy Matey I',
    InventoryType.RepBonusLvl2: 'Hardy Matey II',
    InventoryType.RepBonusLvl3: 'Reputation Booster',
    InventoryType.RepBonusLvlComp: "Jack's Brew",
    InventoryType.GoldBonusLvl1: 'Plunder Potion I',
    InventoryType.GoldBonusLvl2: 'Plunder Potion II',
    InventoryType.InvisibilityLvl1: 'Phantom Spirits I',
    InventoryType.InvisibilityLvl2: 'Phantom Spirits II',
    InventoryType.RegenLvl1: 'Lively Bucko Brew I',
    InventoryType.RegenLvl2: 'Lively Bucko Brew II',
    InventoryType.RegenLvl3: 'Lively Bucko Brew III',
    InventoryType.RegenLvl4: 'Lively Bucko Brew IV',
    InventoryType.Burp: "Belchin' Brew",
    InventoryType.Fart: 'Flatulent Fizz',
    InventoryType.FartLvl2: 'Super Flatulent Fizz',
    InventoryType.Vomit: 'Puke Potion',
    InventoryType.HeadGrow: 'Big Head Potion',
    InventoryType.FaceColor: 'Ghastly Visage',
    InventoryType.SizeReduce: "Shrinkin' Grog",
    InventoryType.SizeIncrease: "Growin' Grog",
    InventoryType.HeadFire: 'Addled Elixir',
    InventoryType.ScorpionTransform: 'Stinger Stew',
    InventoryType.AlligatorTransform: 'Gator Grog',
    InventoryType.CrabTransform: 'Pincer Potion',
    InventoryType.AccuracyBonusLvl1: 'Deadeye I',
    InventoryType.AccuracyBonusLvl2: 'Deadeye II',
    InventoryType.AccuracyBonusLvl3: 'Deadeye III',
    ...
    InventoryType.FishingRodStall: 'Stall Lure',
    InventoryType.FishingRodPull: 'Pull Fish',
    InventoryType.FishingRodHeal: 'Heal Line',
    InventoryType.FishingRodTug: 'Tug Line',
    InventoryType.FishingRodSink: 'Sink Lure',
    InventoryType.FishingRodOceanEye: 'Ocean Eye',
    ...
    EnemySkills.CUTLASS_MIGHTYSLASH: 'Mighty Slash',
    EnemySkills.CUTLASS_SKEWER: 'Skewer',
    EnemySkills.CUTLASS_OVERHEAD: 'Overhead Slash',
    EnemySkills.CUTLASS_ROLLTHRUST: 'Rolling Attack',
    EnemySkills.CUTLASS_CURSED_FIRE: 'Cursed Fire',
    EnemySkills.CUTLASS_CURSED_ICE: 'Cursed Ice',
    EnemySkills.CUTLASS_CURSED_THUNDER: 'Cursed Thunder',
    EnemySkills.CUTLASS_FIRE_BREAK: 'Inferno Sweep',
    EnemySkills.CUTLASS_ICE_BREAK: 'Freeze Sweep',
    EnemySkills.CUTLASS_THUNDER_BREAK: 'Shock Sweep',
    EnemySkills.CUTLASS_BLOWBACK: 'Hurricane Slash',
    EnemySkills.CUTLASS_CAPTAINS_FURY: "Captain's Fury",
    EnemySkills.CUTLASS_MASTERS_RIPOSTE: "Master's Riposte",
    EnemySkills.CUTLASS_POWER_ATTACK: 'Power Slash',
    EnemySkills.BROADSWORD_HACK: 'Chop',
    EnemySkills.BROADSWORD_SLASH: 'Roundhouse',
    EnemySkills.BROADSWORD_CLEAVE: 'Spin Cut',
    EnemySkills.BROADSWORD_FLOURISH: 'Reverse Spin Cut',
    EnemySkills.BROADSWORD_STAB: 'Jumping Slash',
    EnemySkills.SABRE_HACK: 'High Cut',
    EnemySkills.SABRE_SLASH: 'Low Slash',
    EnemySkills.SABRE_CLEAVE: 'Rapid Strike',
    EnemySkills.SABRE_FLOURISH: 'Slice & Dice',
    EnemySkills.SABRE_STAB: 'Cyclone Cut',
    ...
    EnemySkills.PISTOL_SCATTERSHOT: 'Scattershot',
    EnemySkills.PISTOL_SCATTERSHOT_AIM: 'Take Aim',
    EnemySkills.PISTOL_DEADEYE: 'Deadeye',
    EnemySkills.PISTOL_RAPIDFIRE: 'Rapid Fire',
    EnemySkills.PISTOL_QUICKLOAD: 'Quick Load',
    EnemySkills.PISTOL_STUNSHOT: 'Stun Shot',
    EnemySkills.PISTOL_BREAKSHOT: 'Shrapnel Shot',
    EnemySkills.PISTOL_POINT_BLANK: 'Point Blank',
    EnemySkills.PISTOL_HOTSHOT: 'Coalfire Shot',
    ...
    EnemySkills.BAYONET_SHOOT: 'Shoot',
    EnemySkills.BAYONET_STAB: 'Bayonet Stab',
    EnemySkills.BAYONET_RUSH: 'Bayonet Rush',
    EnemySkills.BAYONET_BASH: 'Bayonet Bash',
    EnemySkills.BAYONET_PLAYER_RUSH: 'Bayonet Rush',
    EnemySkills.BAYONET_PLAYER_BASH: 'Bayonet Bash',
    EnemySkills.BAYONET_DISABLE: 'Bayonet Disable',
    EnemySkills.BAYONET_PLAYER_STAB: 'Bayonet Stab',
    ...
    EnemySkills.DAGGER_BACKSTAB: 'Backstab',
    EnemySkills.DAGGER_COUP: 'Coup',
    EnemySkills.DAGGER_DAGGERRAIN: 'Dagger Rain',
    EnemySkills.DAGGER_THROW_COMBO_1: 'Knife Throw',
    EnemySkills.DAGGER_THROW_COMBO_2: 'Left-Handed Throw',
    EnemySkills.DAGGER_THROW_COMBO_3: 'Double Throw',
    EnemySkills.DAGGER_THROW_COMBO_4: 'Twin Backhand',
    EnemySkills.DAGGER_BARRAGE: 'Dagger Whirlwind',
    EnemySkills.DAGGER_ICEBARRAGE: 'Silver Freeze',
    EnemySkills.DAGGER_VENOMSTAB: 'Venom Stab',
    EnemySkills.DAGGER_ACIDDAGGER: 'Acid Dagger',
    ...
    EnemySkills.SAIL_WRECK_HULL: 'Wreck the Hull',
    EnemySkills.SAIL_WRECK_MASTS: 'Wreck the Masts',
    EnemySkills.SAIL_SINK_HER: 'Sink Her',
    EnemySkills.SAIL_INCOMING: 'Incoming',
    EnemySkills.SAIL_FIX_IT_NOW: 'Fix It Now!',
    ...
    EnemySkills.DOLL_REGENERATION: 'Regeneration',
    EnemySkills.DOLL_SPIRIT_MEND: 'Spirit Mend',
    EnemySkills.DOLL_WIND_GUARD: 'Wind Guard',
    EnemySkills.DOLL_RED_FURY: 'Red Fury',
    EnemySkills.DOLL_SPIRIT_GUARD: 'Spirit Guard',
    EnemySkills.DOLL_HEX_GUARD: 'Hex Guard',
    EnemySkills.DOLL_EVIL_EYE: 'Evil Eye',
    ...
    EnemySkills.STAFF_TOGGLE_AURA_OFF: 'Toggle Aura Off',
    EnemySkills.STAFF_TOGGLE_AURA_WARDING: 'Warding Aura',
    EnemySkills.STAFF_TOGGLE_AURA_NATURE: 'Nature Aura',
    EnemySkills.STAFF_TOGGLE_AURA_DARK: 'Dark Aura',
    ...
    InventoryType.DefenseCannonRoundShot: 'Round Shot',
    InventoryType.DefenseCannonMine: 'Mine',
    InventoryType.DefenseCannonTargetedShot: 'Targeted Shot',
    InventoryType.DefenseCannonHotShot: 'Hot Shot',
    InventoryType.DefenseCannonScatterShot: 'Scatter Shot',
    InventoryType.DefenseCannonPowderKeg: 'Powder Keg',
    InventoryType.DefenseCannonSmokePowder: 'Smoke Powder',
    InventoryType.DefenseCannonBullet: 'Bullet',
    InventoryType.DefenseCannonColdShot: 'Cold Shot',
    InventoryType.DefenseCannonBomb: 'Bomb',
    InventoryType.DefenseCannonChumShot: 'Bait Shot',
    InventoryType.DefenseCannonFireStorm: 'Firestorm',
    InventoryType.DefenseCannonEmpty: 'Empty',
    InventoryType.UseItem: 'Use Item',
    InventoryType.UsePotion: 'Use Potion',
    ...
    EnemySkills.FLYTRAP_SPIT: 'Acid Spit',
    EnemySkills.FLYTRAP_WEAK_SPIT: 'Venom Spit',
    ...
    EnemySkills.DUALCUTLASS_COMBINATION: 'Dual Cutlass Combination',
    ...
    EnemySkills.JR_DEATH_SLASH: 'Death Slash',
    EnemySkills.JR_VOODOO_SHOT: 'Voodoo Blast',
    EnemySkills.JR_GRAVEBIND: 'Grave Bind',
    EnemySkills.JR_SOUL_HARVEST: 'Soul Storm',
    EnemySkills.JR_ANIMATE_DEAD: 'Animate Dead',
    EnemySkills.JR_PULVERIZER: 'Pulzerizer',
    EnemySkills.JR_CORRUPTION: 'Corruption',
    EnemySkills.JR_EXECUTE: 'Execute',
    EnemySkills.JR_THUNDER: 'Dark Thunderbolt',
    EnemySkills.AXE_CHOP: 'Axe Chop',
    EnemySkills.GHOST_PHANTOM_TOUCH: 'Phantom Reach',
    EnemySkills.GHOST_KILL_TOUCH: 'Somber Demise',
    EnemySkills.GHOST_SUMMON_HELP: 'Summon Help',
    EnemySkills.MISC_CLEANSE: 'Cleanse',
    EnemySkills.MISC_DARK_CURSE: 'Dark Curse',
    EnemySkills.MISC_GHOST_FORM: 'Ghost Form',
    EnemySkills.MISC_FEINT: 'Feint',
    EnemySkills.MISC_HEX_WARD: 'Hex Ward',
    EnemySkills.MISC_CAPTAINS_RESOLVE: "Captain's Resolve",
    EnemySkills.MISC_NOT_IN_FACE: 'Not in the Face!',
    EnemySkills.MISC_ACTIVATE_VOODOO_REFLECT: 'Voodoo Reflect',
    EnemySkills.MISC_VOODOO_REFLECT: 'Voodoo Reflect',
    EnemySkills.MISC_MONKEY_PANIC: 'Monkey Panic',
    EnemySkills.MISC_FIRST_AID: 'Healing Boost',
    EnemySkills.TORCH_ATTACK: 'Torch Attack',
    ...
    InventoryType.CutlassRep: 'Sword',
    InventoryType.PistolRep: 'Shooting',
    ...
    InventoryType.DefenseCannonRep: 'Navy Cannon',
    ...
    InventoryType.FishingRep: 'Fishing',
    InventoryType.PotionsRep: 'Potions',
    InventoryType.UnspentMelee: 'Melee Skill Point',
    InventoryType.UnspentCutlass: 'Sword Skill Point',
    InventoryType.UnspentPistol: 'Shooting Skill Point',
    ...
    ItemId.BLACK_PEARL: ShipClassNames.get(ShipGlobals.BLACK_PEARL),
    ItemId.GOLIATH: ShipClassNames.get(ShipGlobals.GOLIATH),
    ItemId.SHIP_OF_THE_LINE: ShipClassNames.get(ShipGlobals.SHIP_OF_THE_LINE),
    ItemId.EL_PATRONS_SHIP: ShipClassNames.get(ShipGlobals.EL_PATRONS_SHIP),
    ItemId.P_SKEL_PHANTOM: ShipClassNames.get(ShipGlobals.P_SKEL_PHANTOM),
    ItemId.P_SKEL_REVENANT: ShipClassNames.get(ShipGlobals.P_SKEL_REVENANT),
    ItemId.P_SKEL_CEREBUS: ShipClassNames.get(ShipGlobals.P_SKEL_CEREBUS),
    ItemId.P_NAVY_KINGFISHER: ShipClassNames.get(ShipGlobals.P_NAVY_KINGFISHER),
    ItemId.P_EITC_WARLORD: ShipClassNames.get(ShipGlobals.P_EITC_WARLORD),
    ItemId.HMS_VICTORY: ShipClassNames.get(ShipGlobals.HMS_VICTORY),
    ItemId.HMS_NEWCASTLE: ShipClassNames.get(ShipGlobals.HMS_NEWCASTLE),
    ItemId.HMS_INVINCIBLE: ShipClassNames.get(ShipGlobals.HMS_INVINCIBLE),
    ItemId.EITC_INTREPID: ShipClassNames.get(ShipGlobals.EITC_INTREPID),
    ItemId.EITC_CONQUERER: ShipClassNames.get(ShipGlobals.EITC_CONQUERER),
    ItemId.EITC_LEVIATHAN: ShipClassNames.get(ShipGlobals.EITC_LEVIATHAN),
    ItemId.NAVY_FERRET: ShipClassNames.get(ShipGlobals.NAVY_FERRET),
    ItemId.NAVY_BULWARK: ShipClassNames.get(ShipGlobals.NAVY_BULWARK),
    ItemId.NAVY_PANTHER: ShipClassNames.get(ShipGlobals.NAVY_PANTHER),
    ItemId.NAVY_GREYHOUND: ShipClassNames.get(ShipGlobals.NAVY_GREYHOUND),
    ItemId.NAVY_VANGUARD: ShipClassNames.get(ShipGlobals.NAVY_VANGUARD),
    ItemId.NAVY_CENTURION: ShipClassNames.get(ShipGlobals.NAVY_CENTURION),
    ItemId.NAVY_KINGFISHER: ShipClassNames.get(ShipGlobals.NAVY_KINGFISHER),
    ItemId.NAVY_MONARCH: ShipClassNames.get(ShipGlobals.NAVY_MONARCH),
    ItemId.NAVY_MAN_O_WAR: ShipClassNames.get(ShipGlobals.NAVY_MAN_O_WAR),
    ItemId.NAVY_PREDATOR: ShipClassNames.get(ShipGlobals.NAVY_PREDATOR),
    ItemId.NAVY_COLOSSUS: ShipClassNames.get(ShipGlobals.NAVY_COLOSSUS),
    ItemId.NAVY_DREADNOUGHT: ShipClassNames.get(ShipGlobals.NAVY_DREADNOUGHT),
    ItemId.NAVY_BASTION: ShipClassNames.get(ShipGlobals.NAVY_BASTION),
    ItemId.NAVY_ELITE: ShipClassNames.get(ShipGlobals.NAVY_ELITE),
    ItemId.EITC_SEA_VIPER: ShipClassNames.get(ShipGlobals.EITC_SEA_VIPER),
    ItemId.EITC_SENTINEL: ShipClassNames.get(ShipGlobals.EITC_SENTINEL),
    ItemId.EITC_CORVETTE: ShipClassNames.get(ShipGlobals.EITC_CORVETTE),
    ItemId.EITC_BLOODHOUND: ShipClassNames.get(ShipGlobals.EITC_BLOODHOUND),
    ItemId.EITC_IRONWALL: ShipClassNames.get(ShipGlobals.EITC_IRONWALL),
    ItemId.EITC_MARAUDER: ShipClassNames.get(ShipGlobals.EITC_MARAUDER),
    ItemId.EITC_BARRACUDA: ShipClassNames.get(ShipGlobals.EITC_BARRACUDA),
    ItemId.EITC_OGRE: ShipClassNames.get(ShipGlobals.EITC_OGRE),
    ItemId.EITC_WARLORD: ShipClassNames.get(ShipGlobals.EITC_WARLORD),
    ItemId.EITC_CORSAIR: ShipClassNames.get(ShipGlobals.EITC_CORSAIR),
    ItemId.EITC_BEHEMOTH: ShipClassNames.get(ShipGlobals.EITC_BEHEMOTH),
    ItemId.EITC_JUGGERNAUT: ShipClassNames.get(ShipGlobals.EITC_JUGGERNAUT),
    ItemId.EITC_TYRANT: ShipClassNames.get(ShipGlobals.EITC_TYRANT),
    ItemId.SKEL_PHANTOM: ShipClassNames.get(ShipGlobals.SKEL_PHANTOM),
    ItemId.SKEL_REVENANT: ShipClassNames.get(ShipGlobals.SKEL_REVENANT),
    ItemId.SKEL_STORM_REAPER: ShipClassNames.get(ShipGlobals.SKEL_STORM_REAPER),
    ItemId.SKEL_BLACK_HARBINGER: ShipClassNames.get(ShipGlobals.SKEL_BLACK_HARBINGER),
    ItemId.SKEL_DEATH_OMEN: ShipClassNames.get(ShipGlobals.SKEL_DEATH_OMEN),
    ItemId.SKEL_SHADOW_CROW_FR: ShipClassNames.get(ShipGlobals.SKEL_SHADOW_CROW_FR),
    ItemId.SKEL_HELLHOUND_FR: ShipClassNames.get(ShipGlobals.SKEL_HELLHOUND_FR),
    ItemId.SKEL_BLOOD_SCOURGE_FR: ShipClassNames.get(ShipGlobals.SKEL_BLOOD_SCOURGE_FR),
    ItemId.SKEL_SHADOW_CROW_SP: ShipClassNames.get(ShipGlobals.SKEL_SHADOW_CROW_SP),
    ItemId.SKEL_HELLHOUND_SP: ShipClassNames.get(ShipGlobals.SKEL_HELLHOUND_SP),
...
ItemNames = {
    ItemGlobals.RUSTY_CUTLASS: 'Rusty Cutlass',
    ItemGlobals.IRON_CUTLASS: 'Iron Cutlass',
    ItemGlobals.STEEL_CUTLASS: 'Steel Cutlass',
    ItemGlobals.FINE_CUTLASS: 'Fine Cutlass',
    ItemGlobals.PIRATE_BLADE: 'Pirate Blade',
    ItemGlobals.WORN_CUTLASS: 'Worn Cutlass',
    ItemGlobals.SWABBIE_CUTLASS: "Swabbie's Cutlass",
    ItemGlobals.DECKHAND_CUTLASS: "Deck-hand's Cutlass",
    ItemGlobals.CABIN_BOY_CUTLASS: "Cabin Boy's Cutlass",
    ItemGlobals.LIGHT_CUTLASS: 'Light Cutlass',
    ItemGlobals.HEAVY_CUTLASS: 'Heavy Cutlass',
    ItemGlobals.SAILOR_CUTLASS: "Sailor's Cutlass",
    ItemGlobals.BOARDING_CUTLASS: 'Boarding Cutlass',
    ItemGlobals.WAR_CUTLASS: 'War Cutlass',
    ItemGlobals.SHARP_CUTLASS: 'Sharp Cutlass',
    ItemGlobals.TEMPERED_CUTLASS: 'Tempered Cutlass',
    ItemGlobals.ENGRAVED_CUTLASS: 'Engraved Cutlass',
    ItemGlobals.BEJEWELED_CUTLASS: 'Bejeweled Cutlass',
    ItemGlobals.MASTERWORK_CUTLASS: 'Masterwork Cutlass',
    ItemGlobals.NAVY_SERGEANT_CUTLASS: "Navy Sergeant's Cutlass",
    ItemGlobals.EITC_MERVENARY_CUTLASS: "EITC Mercenary's Cutlass",
    ItemGlobals.BANDIT_CUTLASS: "Bandit's Cutlass",
    ItemGlobals.PIRATE_CUTLASS: "Pirate's Cutlass",
    ItemGlobals.SLASHER_CUTLASS: "Slasher's Cutlass",
    ItemGlobals.POISONED_CUTLASS: 'Poisoned Cutlass',
    ItemGlobals.VENOMED_CUTLASS: 'Venomed Cutlass',
    ItemGlobals.ASSASSIN_CUTLASS: "Assassin's Cutlass",
    ItemGlobals.MONKEY_CUTLASS: 'Monkey Cutlass',
    ItemGlobals.BABOON_CUTLASS: 'Baboon Cutlass',
    ItemGlobals.ORANGUTAN_CUTLASS: 'Orangutan Cutlass',
    ItemGlobals.GORILLA_CUTLASS: 'Gorilla Cutlass',
    ItemGlobals.VOODOO_HUNTER_CUTLASS: 'Voodoo Hunter Cutlass',
    ItemGlobals.WITCH_HUNTER_CUTLASS: 'Witch Hunter Cutlass',
    ItemGlobals.CUTLASS_OF_THE_INQUISITION: 'Cutlass of the Inquisition',
    ItemGlobals.SILVER_CUTLASS: 'Silver Cutlass',
    ItemGlobals.HOLY_CUTLASS: 'Holy Cutlass',
    ItemGlobals.SACRED_CUTLASS: 'Sacred Cutlass',
    ItemGlobals.DIVINE_CUTLASS: 'Divine Cutlass',
    ItemGlobals.BRUTE_CUTLASS: "Brute's Cutlass",
    ItemGlobals.BRAWLER_CUTLASS: "Brawler's Cutlass",
    ItemGlobals.BRUISER_CUTLASS: "Bruiser's Cutlass",
    ItemGlobals.DARK_CUTLASS: 'Dark Cutlass',
    ItemGlobals.SHADOW_CUTLASS: 'Shadow Cutlass',
    ItemGlobals.FORBIDDEN_CUTLASS: 'Forbidden Cutlass',
    ItemGlobals.MARINER_CUTLASS: "Mariner's Cutlass",
    ItemGlobals.QUARTER_MASTER_CUTLASS: "Quarter Master's Cutlass",
    ItemGlobals.FIRST_MATE_CUTLASS: "First Mate's Cutlass",
    ItemGlobals.LIEUTENANT_CUTLASS: "Lieutenant's Cutlass",
    ItemGlobals.COMMANDER_CUTLASS: "Commander's Cutlass",
    ItemGlobals.CAPTAIN_CUTLASS: "Captain's Cutlass",
    ItemGlobals.COMMODORE_CUTLASS: "Commodore's Cutlass",
    ItemGlobals.VICE_ADMIRAL_CUTLASS: "Vice Admiral's Cutlass",
    ItemGlobals.ADMIRAL_CUTLASS: "Admiral's Cutlass",
    ItemGlobals.SHARK_BLADE: 'Shark Blade',
    ItemGlobals.TIGER_SHARK_BLADE: 'Tiger Shark Blade',
    ItemGlobals.BLACK_SHARK_BLADE: 'Black Shark Blade',
    ItemGlobals.BANE_BLADE_CUTLASS: 'Bane Blade Cutlass',
    ItemGlobals.BANE_FIRE_CUTLASS: 'Bane Fire Cutlass',
    ItemGlobals.BANE_CURSE_CUTLASS: 'Bane Curse Cutlass',
    ItemGlobals.SEA_DOG_CUTLASS: "Sea Dog's Cutlass",
    ItemGlobals.SWASHBUCKLER_CUTLASS: "Swashbuckler's Cutlass",
    ItemGlobals.BUCCANEER_CUTLASS: "Buccaneer's Cutlass",
    ItemGlobals.PRIVATEER_CUTLASS: "Privateer's Cutlass",
    ItemGlobals.CORSAIR_CUTLASS: "Corsair's Cutlass",
    ItemGlobals.SEVEN_SEAS_CUTLASS: 'Seven Seas Cutlass',
    ItemGlobals.BLOODFIRE_CUTLASS: 'Bloodfire Cutlass',
    ItemGlobals.CRIMSONFIRE_CUTLASS: 'Crimsonfire Cutlass',
    ItemGlobals.EMBERFIRE_CUTLASS: 'Emberfire Cutlass',
    ItemGlobals.LIFE_STEALER_CUTLASS: 'Life Stealer Cutlass',
    ItemGlobals.SPIRIT_STEALER_CUTLASS: 'Spirit Stealer Cutlass',
    ItemGlobals.SOUL_STEALER_CUTLASS: 'Soul Stealer Cutlass',
    ItemGlobals.HEART_OF_PADRES_DEL_FUEGO: 'Heart of Padres del Fuego',
    ItemGlobals.LOST_SWORD_OF_EL_DORADO: 'Lost Sword of El Dorado',
    ItemGlobals.LOST_BLADE_OF_CALYPSO: 'Lost Blade of Calypso',
    ItemGlobals.JACK_SPARROW_BLADE: "Jack Sparrow's Blade",
    ItemGlobals.SWORD_OF_QUETZALCOATL: 'Sword of Quetzalcoatl',
    ItemGlobals.MONTEZUMA_BLADE: "Montezuma's Blade",
    ItemGlobals.SPECTRAL_CUTLASS: 'Spectral Cutlass',
    ItemGlobals.DARKFIRE_CUTLASS: 'Darkfire Cutlass',
    ItemGlobals.CONQUISTADOR_CUTLASS: "Conquistador's Cutlass",
    ItemGlobals.LOST_SWORD_OF_EL_PATRON: 'Lost Sword of El Patron',
    ItemGlobals.SHORT_CUTLASS: 'Short Cutlass',
    ItemGlobals.VOODOO_CUTLASS: 'Voodoo Cutlass',
    ItemGlobals.BATTLE_CUTLASS: 'Battle Cutlass',
    ...
    ItemGlobals.DUAL_STEEL_SCIMITAR: 'Dual Steel Scimitars',
    ItemGlobals.DUAL_IRON_CUTLASS: 'Dual Iron Cutlasses',
    ItemGlobals.DUAL_STEEL_CUTLASS: 'Dual Steel Cutlasses',
    ItemGlobals.DUAL_FINE_CUTLASS: 'Dual Fine Cutlasses',
    ItemGlobals.DUAL_PIRATE_BLADE: 'Dual Pirate Blades',
    ItemGlobals.DUAL_WORN_CUTLASS: 'Dual Worn Cutlasses',
    ItemGlobals.DUAL_SWABBIE_CUTLASS: "Dual Swabbie's Cutlasses",
    ItemGlobals.DUAL_DECKHAND_CUTLASS: "Dual Deck-hand's Cutlasses",
    ItemGlobals.DUAL_CABIN_BOY_CUTLASS: "Dual Cabin Boy's Cutlasses",
    ItemGlobals.DUAL_LIGHT_CUTLASS: 'Dual Light Cutlass',
    ItemGlobals.DUAL_HEAVY_CUTLASS: 'Dual Heavy Cutlass',
    ItemGlobals.DUAL_SAILOR_CUTLASS: "Dual Sailor's Cutlass",
    ItemGlobals.DUAL_BOARDING_CUTLASS: 'Dual Boarding Cutlass',
    ItemGlobals.DUAL_WAR_CUTLASS: 'Dual War Cutlass',
    ItemGlobals.DUAL_SHARP_CUTLASS: 'Dual Sharp Cutlass',
    ItemGlobals.DUAL_TEMPERED_CUTLASS: 'Dual Tempered Cutlass',
    ItemGlobals.DUAL_ENGRAVED_CUTLASS: 'Dual Engraved Cutlass',
    ItemGlobals.DUAL_BEJEWELED_CUTLASS: 'Dual Bejeweled Cutlass',
    ItemGlobals.DUAL_MASTERWORK_CUTLASS: 'Dual Masterwork Cutlass',
    ItemGlobals.DUAL_POISONED_CUTLASS: 'Dual Poisoned Cutlasses',
    ItemGlobals.DUAL_VENOMED_CUTLASS: 'Dual Venomed Cutlasses',
    ...
    ItemGlobals.TEMPERED_SABRE: 'Tempered Sabre',
    ItemGlobals.ENGRAVED_SABRE: 'Engraved Sabre',
    ItemGlobals.BEJEWELED_SABRE: 'Bejeweled Sabre',
    ItemGlobals.MASTERWORK_SABRE: 'Masterwork Sabre',
    ItemGlobals.NAVY_MARINE_SABRE: "Navy Marine's Sabre",
    ItemGlobals.NAVY_OFFICER_SABRE: "Navy Officer's Sabre",
    ItemGlobals.BOARDING_SABRE: 'Boarding Sabre',
    ItemGlobals.ORNATE_SABRE: 'Ornate Sabre',
    ItemGlobals.ROYAL_SABRE: 'Royal Sabre',
    ItemGlobals.FENCER_SABRE: "Fencer's Sabre",
    ItemGlobals.DUELIST_SABRE: "Duelist's Sabre",
    ItemGlobals.MUSKETEER_SABRE: "Musketeer's Sabre",
    ItemGlobals.MASTER_FENCER_SABRE: "Master Fencer's Sabre",
    ItemGlobals.SWORDSMAN_SABRE: "Swordsman's Sabre",
    ItemGlobals.SWORD_FIGHTER_SABRE: "Sword Fighter's Sabre",
    ItemGlobals.SWORD_MASTER_SABRE: "Sword Master's Sabre",
    ItemGlobals.VOODOO_HUNTER_SABRE: 'Voodoo Hunter Sabre',
    ItemGlobals.WITCH_HUNTER_SABRE: 'Witch Hunter Sabre',
    ItemGlobals.SABRE_OF_THE_INQUISITION: 'Sabre of the Inquisition',
    ItemGlobals.SILVER_SABRE: 'Silver Sabre',
    ItemGlobals.HOLY_SABRE: 'Holy Sabre',
    ItemGlobals.SACRED_SABRE: 'Sacred Sabre',
    ItemGlobals.DIVINE_SABRE: 'Divine Sabre',
    ItemGlobals.HAWK_SABRE: 'Hawk Sabre',
    ItemGlobals.FALCON_SABRE: 'Falcon Sabre',
    ItemGlobals.EAGLE_SABRE: 'Eagle Sabre',
    ItemGlobals.GREAT_HAWK_SABRE: 'Great Hawk Sabre',
    ItemGlobals.KINGFISHER_SABRE: 'Kingfisher Sabre',
    ItemGlobals.MARINER_SABRE: "Mariner's Sabre",
    ItemGlobals.QUARTER_MASTER_SABRE: "Quarter Master's Sabre",
    ItemGlobals.FIRST_MATE_SABRE: "First Mate's Sabre",
    ItemGlobals.LIEUTENANT_SABRE: "Lieutenant's Sabre",
    ItemGlobals.COMMANDER_SABRE: "Commander's Sabre",
    ItemGlobals.CAPTAIN_SABRE: "Captain's Sabre",
    ItemGlobals.COMMODORE_SABRE: "Commodore's Sabre",
    ItemGlobals.VICE_ADMIRAL_SABRE: "Vice Admiral's Sabre",
    ItemGlobals.ADMIRAL_SABRE: "Admiral's Sabre",
    ItemGlobals.BLOODFIRE_SABRE: 'Bloodfire Sabre',
    ItemGlobals.CRIMSONFIRE_SABRE: 'Crimsonfire Sabre',
    ItemGlobals.EMBERFIRE_SABRE: 'Emberfire Sabre',
    ItemGlobals.BANE_BLADE_SABRE: 'Bane Blade Sabre',
    ItemGlobals.BANE_FIRE_SABRE: 'Bane Fire Sabre',
    ItemGlobals.BANE_CURSE_SABRE: 'Bane Curse Sabre',
    ItemGlobals.LE_PORC_SABRE: "LePorc's Sabre",
    ItemGlobals.IRON_SABRE: 'Iron Sabre',
    ItemGlobals.STEEL_SABRE: 'Steel Sabre',
    ItemGlobals.FINE_SABRE: 'Fine Sabre',
    ItemGlobals.WAR_SABRE: 'War Sabre',
    ItemGlobals.MASTER_SABRE: 'Master Sabre',
    ItemGlobals.WORN_BROADSWORD: 'Worn Broadsword',
    ItemGlobals.IRON_BROADSWORD: 'Iron Broadsword',
    ItemGlobals.LIGHT_BROADSWORD: 'Light Broadsword',
    ItemGlobals.HEAVY_BROADSWORD: 'Heavy Broadsword',
    ItemGlobals.WAR_BROADSWORD: 'War Broadsword',
    ItemGlobals.ROYAL_BROADSWORD: 'Royal Broadsword',
    ItemGlobals.BRUTE_BROADSWORD: "Brute's Broadsword",
    ItemGlobals.EITC_GRUNT_BROADSWORD: "EITC Grunt's Broadsword",
    ItemGlobals.EXECUTIONER_BROADSWORD: "Executioner's Broadsword",
    ItemGlobals.SHARP_BROADSWORD: 'Sharp Broadsword',
    ItemGlobals.TEMPERED_BROADSWORD: 'Tempered Broadsword',
    ItemGlobals.ENGRAVED_BROADSWORD: 'Engraved Broadsword',
    ItemGlobals.BEJEWELED_BROADSWORD: 'Bejeweled Broadsword',
    ItemGlobals.MASTERWORK_BROADSWORD: 'Masterwork Broadsword',
    ItemGlobals.MONKEY_BROADSWORD: 'Monkey Broadsword',
    ItemGlobals.BABOON_BROADSWORD: 'Baboon Broadsword',
    ItemGlobals.GORILLA_BROADSWORD: 'Gorilla Broadsword',
    ItemGlobals.VOODOO_HUNTER_BROADSWORD: 'Voodoo Hunter Broadsword',
    ItemGlobals.WITCH_HUNTER_BROADSWORD: 'Witch Hunter Broadsword',
    ItemGlobals.BROADSWORD_OF_THE_INQUISITION: 'Broadsword of the Inquisition',
    ItemGlobals.BANE_BLADE_BROADSWORD: 'Bane Blade Broadsword',
    ItemGlobals.BANE_FIRE_BROADSWORD: 'Bane Fire Broadsword',
    ItemGlobals.BANE_CURSE_BROADSWORD: 'Bane Curse Broadsword',
    ItemGlobals.MILITARY_BROADSWORD: 'Military Broadsword',
    ItemGlobals.SOLDIER_BROADSWORD: "Soldier's Broadsword",
    ItemGlobals.CAVALRY_BROADSWORD: 'Cavalry Broadsword',
    ItemGlobals.DRAGOON_BROADSWORD: "Dragoon's Broadsword",
    ItemGlobals.BRIGADIER_BROADSWORD: "Brigadier's Broadsword",
    ItemGlobals.GENERAL_BROADSWORD: "General's Broadsword",
    ItemGlobals.DARK_BROADSWORD: 'Dark Broadsword',
    ItemGlobals.SHADOW_BROADSWORD: 'Shadow Broadsword',
    ItemGlobals.FORBIDDEN_BROADSWORD: 'Forbidden Broadsword',
    ItemGlobals.FIGHTER_BROADSWORD: "Fighter's Broadsword",
    ItemGlobals.SAVAGE_BROADSWORD: 'Savage Broadsword',
    ItemGlobals.WARMONGER_BROADSWORD: "Warmonger's Broadsword",
    ItemGlobals.WARLORD_BROADSWORD: "Warlord's Broadsword",
    ItemGlobals.WAR_MASTER_BROADSWORD: "War Master's Broadsword",
    ItemGlobals.LIEUTENANT_BROADSWORD: "Lieutenant's Broadsword",
    ItemGlobals.COMMANDER_BROADSWORD: "Commander's Broadsword",
    ItemGlobals.CAPTAIN_BROADSWORD: "Captain's Broadsword",
    ItemGlobals.COMMODORE_BROADSWORD: "Vice Admiral's Broadsword",
    ItemGlobals.BLOODFIRE_BROADSWORD: 'Bloodfire Broadsword',
    ItemGlobals.CRIMSONFIRE_BROADSWORD: 'Crimsonfire Broadsword',
    ItemGlobals.EMBERFIRE_BROADSWORD: 'Emberfire Broadsword',
    ItemGlobals.BLACK_RAVEN_BROADSWORD: 'Black Raven Broadsword',
    ItemGlobals.VULTURE_CLAW_BROADSWORD: 'Vulture Claw Broadsword',
    ItemGlobals.IGNIS_MAXIMUS: 'Ignis Maximus',
    ItemGlobals.AVARICIA_BROADSWORD: "Avaricia's Broadsword",
    ItemGlobals.BARBOSSA_EDGE: "Barbossa's Edge",
    ItemGlobals.NEMESIS_BLADE: 'Nemesis Blade',
    ItemGlobals.SWORD_OF_TRITON: 'Sword of Triton',
    ItemGlobals.SMALL_BROADSWORD: 'Small Broadsword',
    ItemGlobals.STEEL_BROADSWORD: 'Steel Broadsword',
    ItemGlobals.MIGHTY_BROADSWORD: 'Mighty Broadsword',
    ItemGlobals.ORNATE_BROADSWORD: 'Ornate Broadsword',
    ItemGlobals.GREAT_BROADSWORD: 'Great Broadsword',
    ItemGlobals.SWORD_OF_DECAY: 'Sword of Decay',
    ItemGlobals.SPINESKULL_BLADE: 'Spineskull Blade',
    ItemGlobals.GRIM_HOUND_BLADE: 'Grim Hound Blade',
    ItemGlobals.SEA_STEEL_SWORD: 'Sea Steel Sword',
    ItemGlobals.BARNACLE_BREAKER: 'Barnacle Breaker',
    ItemGlobals.DEEPWATER_BLADE: 'Deepwater Blade',
    ItemGlobals.GRAVE_REAPER: 'Grave Reaper',
    ItemGlobals.PLAGUEFIRE_BLADE: 'Plaguefire Blade',
    ItemGlobals.VIPER_BLADE: 'Viper Blade',
    ItemGlobals.DOOM_RATTLER: 'Doom Rattler',
    ItemGlobals.NAUTILUS_BLADE: 'Nautilus Blade',
    ItemGlobals.WHALEBONE_BLADE: 'Whalebone Blade',
    ItemGlobals.THE_DARK_MUTINEER: 'The Dark Mutineer',
    ItemGlobals.RAZORTOOTH_SWORD: 'Razortooth Sword',
    ItemGlobals.SPINECREST_SWORD: 'Spinecrest Sword',
    ItemGlobals.RIPSAW_BLADE: 'Ripsaw Blade',
    ItemGlobals.SHARKFANG_BLADE: 'Sharkfang Blade',
    ItemGlobals.HULL_RIPPER: 'Hull Ripper',
    ItemGlobals.BARRACUDA_BLADE: 'Barracuda Blade',
    ItemGlobals.DREAD_SPIKE: 'Dread Spike',
    ItemGlobals.BITTER_END: 'Bitter End',
    ItemGlobals.DOOM_STINGER: 'Doom Stinger',
    ItemGlobals.TREACHERYS_EDGE: "Treachery's End",
    ItemGlobals.TYRANT_BLADE: 'Tyrant Blade',
    ItemGlobals.BLIGHTFANG_EDGE: 'Blightfang Edge',
    ItemGlobals.BEHEMOTH_BLADE: 'Behemoth Blade',
    ItemGlobals.THUNDERSPINE_SWORD: 'Thunderspine Sword',
    ItemGlobals.BLADE_OF_THE_ABYSS: 'Blade of the Abyss',
    ItemGlobals.WORLD_EATER_BLADE: 'World Eater Blade',
    ItemGlobals.THE_EMERALD_CURSE: 'The Emerald Curse',
    ItemGlobals.SEAFANG_BLADE: 'Cursed Seafang Blade',
    ItemGlobals.DARKFROST_BLADE: 'Dark Frost Blade',
    ItemGlobals.SCIMITAR: 'Scimitar',
    ItemGlobals.FLINTLOCK_PISTOL: 'Flintlock Pistol',
    ItemGlobals.DOUBLE_BARREL: 'Double-Barrel',
    ItemGlobals.TRI_BARREL: 'Tri-Barrel',
    ItemGlobals.HEAVY_TRI_BARREL: 'Heavy Tri-Barrel',
    ItemGlobals.GRAND_PISTOL: 'Grand Pistol',
    ItemGlobals.WHEELLOCK_PISTOL: 'Wheellock Pistol',
    ItemGlobals.SNAPLOCK_PISTOL: 'Snaplock Pistol',
    ItemGlobals.SEA_DOG_PISTOL: 'Sea Dog Pistol',
    ItemGlobals.SWASHBUCKLER_PISTOL: "Swashbuckler's Pistol",
    ItemGlobals.BUCCANEER_PISTOL: "Buccaneer's Pistol",
    ItemGlobals.RATTLER_PISTOL: 'Rattler Pistol',
    ItemGlobals.BARBOSSA_FURY: "Barbossa's Fury",
    ItemGlobals.COBRA_PISTOL: 'Cobra Pistol',
    ItemGlobals.BUSH_MASTER_PISTOL: 'Bush Master Pistol',
    ItemGlobals.SCALLYWAG_PISTOL: "Scallywag's Pistol",
    ItemGlobals.ROBBER_PISTOL: "Robber's Pistol",
    ItemGlobals.SCOUNDREL_PISTOL: "Scoundrel's Pistol",
    ItemGlobals.NIGHT_HUNTER_PISTOL: 'Night Hunter Pistol',
    ItemGlobals.SHADOW_STALKER_PISTOL: 'Shadow Stalker Pistol',
    ItemGlobals.FOUL_BANE_PISTOL: 'Foul Bane Pistol',
    ItemGlobals.FULLMOON_SPECIAL_PISTOL: 'Fullmoon Special Pistol',
    ItemGlobals.EITC_THUG_PISTOL: "EITC Thug's Pistol",
    ItemGlobals.NAVY_SERGEANT_PISTOL: "Navy Sergeant's Pistol",
    ItemGlobals.DUELIST_PISTOL: "Duelist's Pistol",
    ItemGlobals.EXECUTIONER_PISTOL: "Executioner's Pistol",
    ItemGlobals.SILVER_PISTOL: 'Silver Pistol',
    ItemGlobals.HOLY_PISTOL: 'Holy Pistol',
    ItemGlobals.SACRED_PISTOL: 'Sacred Pistol',
    ItemGlobals.RUNIC_PISTOL: 'Runic Pistol',
    ItemGlobals.WARDING_PISTOL: 'Warding Pistol',
    ItemGlobals.ARCANE_PISTOL: 'Arcane Pistol',
    ItemGlobals.BECKETTE_PISTOL: "Beckette's Pistol",
    ItemGlobals.MERCER_PISTOL: "Mercer's Pistol",
    ItemGlobals.JACK_SPARROW_REVENGE: "Jack Sparrow's Revenge",
    ItemGlobals.IRON_PISTOL: 'Iron Pistol',
    ItemGlobals.STEEL_PISTOL: 'Steel Pistol',
    ItemGlobals.ORNATE_PISTOL: 'Ornate Pistol',
    ItemGlobals.RUSTY_BAYONET: 'Rusty Bayonet',
    ItemGlobals.HAYMAKER_PISTOL: 'Haymaker Pistol',
    ItemGlobals.FLINTLOCK_BAYONET: 'Flintlock Bayonet',
    ItemGlobals.WHEELLOCK_BAYONET: 'Wheellock Bayonet',
    ItemGlobals.SNAPLOCK_BAYONET: 'Snaplock Bayonet',
    ItemGlobals.COMBAT_BAYONET: 'Combat Bayonet',
    ItemGlobals.BATTLE_BAYONET: 'Battle Bayonet',
    ItemGlobals.WAR_BAYONET: 'War Bayonet',
    ItemGlobals.NAVY_CADET_BAYONET: "Navy Cadet's Bayonet",
    ItemGlobals.NAVY_GUARD_BAYONET: "Navy Guard's Bayonet",
    ItemGlobals.NAVY_MUSKETEER_BAYONET: "Navy Musketeer's Bayonet",
    ItemGlobals.NAVY_VETERAN_BAYONET: "Navy Veteran's Bayonet",
    ItemGlobals.NAVY_DRAGOON_BAYONET: "Navy Dragoon's Bayonet",
    ItemGlobals.CRAB_STICKER_BAYONET: 'Crab Sticker Bayonet',
    ItemGlobals.PIG_STICKER_BAYONET: 'Pig Sticker Bayonet',
    ItemGlobals.GATOR_STICKER_BAYONET: 'Gator Sticker Bayonet',
    ItemGlobals.SHARK_STICKER_BAYONET: 'Shark Sticker Bayonet',
    ItemGlobals.MILITIA_BAYONET: 'Militia Bayonet',
    ItemGlobals.MILITARY_BAYONET: 'Military Bayonet',
    ItemGlobals.SOLDIER_BAYONET: "Soldier's Bayonet",
    ItemGlobals.OFFICER_BAYONET: "Officer's Bayonet",
    ItemGlobals.BRIGADIER_BAYONET: "Brigadier's Bayonet",
    ItemGlobals.SEA_DOG_BAYONET: "Sea Dog's Bayonet",
    ItemGlobals.SWASHBUCKLER_BAYONET: "Swashbuckler's Bayonet",
    ItemGlobals.BUCCANEER_BAYONET: "Buccaneer's Bayonet",
    ItemGlobals.PRIVATEER_BAYONET: "Privateer's Bayonet",
    ItemGlobals.CORSAIR_BAYONET: "Corsair's Bayonet",
    ItemGlobals.IRON_BAYONET: 'Iron Bayonet',
    ItemGlobals.STEEL_BAYONET: 'Steel Bayonet',
    ItemGlobals.MASTER_BAYONET: 'Master Bayonet',
    ItemGlobals.ZOMBIE_KABAB_BAYONET: 'Zombie Kabab Bayonet',
    ItemGlobals.OLD_MUSKET: 'Old Musket',
    ItemGlobals.FLINTLOCK_MUSKET: 'Flintlock Musket',
    ItemGlobals.WHEELLOCK_MUSKET: 'Wheellock Musket',
    ItemGlobals.SEA_DOG_MUSKET: 'Sea Dog Musket',
    ItemGlobals.HOTSHOT_MUSKET: 'Hotshot Musket',
    ItemGlobals.BURNSHOT_MUSKET: 'Burnshot Musket',
    ItemGlobals.FLAMESHOT_MUSKET: 'Flameshot Musket',
    ItemGlobals.FIREBRAND_MUSKET: 'Firebrand Musket',
    ItemGlobals.SCALLYWAG_MUSKET: "Scallywag's Musket",
    ItemGlobals.ROBBER_MUSKET: "Robber's Musket",
    ItemGlobals.SCOUNDREL_MUSKET: "Scoundrel's Musket",
    ItemGlobals.GUNNER_MUSKET: "Gunner's Musket",
    ItemGlobals.RIFLEMAN_MUSKET: "Rifleman's Musket",
    ItemGlobals.MASTER_GUNNER_MUSKET: "Master Gunner's Musket",
    ItemGlobals.HUNTSMAN_MUSKET: "Huntsman's Musket",
    ItemGlobals.MARKSMAN_MUSKET: "Marksman's Musket",
    ItemGlobals.SNIPER_MUSKET: "Sniper's Musket",
    ItemGlobals.HEX_GUARD_MUSKET: 'Hex Guard Musket',
    ItemGlobals.HEX_STOPPER_MUSKET: 'Hex Stopper Musket',
    ItemGlobals.HEX_BREAKER_MUSKET: 'Hex Breaker Musket',
    ItemGlobals.SILVER_MUSKET: 'Silver Musket',
    ItemGlobals.HOLY_MUSKET: 'Holy Musket',
    ItemGlobals.SACRED_MUSKET: 'Sacred Musket',
    ItemGlobals.SAILOR_MUSKET: "Sailor's Musket",
    ItemGlobals.BOARDING_MUSKET: 'Boarding Musket',
    ItemGlobals.ROYAL_MUSKET: 'Royal Musket',
    ItemGlobals.CRACKED_BLUNDERBUSS: 'Cracked Blunderbuss',
    ItemGlobals.MATCHLOCK_BLUNDERBUSS: 'Matchlock Blunderbuss',
    ItemGlobals.FLINTLOCK_BLUNDERBUSS: 'Flintlock Blunderbuss',
    ItemGlobals.SCATTERGUN: 'Scattergun',
    ItemGlobals.HEAVY_SCATTERGUN: 'Heavy Scattergun',
    ItemGlobals.WAR_SCATTERGUN: 'War Scattergun',
    ItemGlobals.SEA_DOG_BLUNDERBUSS: 'Sea Dog Blunderbuss',
    ItemGlobals.SWASHBUCKLER_BLUNDERBUSS: "Swashbuckler's Blunderbuss",
    ItemGlobals.BUCCANEER_BLUNDERBUSS: "Buccaneer's Blunderbuss",
    ItemGlobals.MONKEY_BLUNDERBUSS: 'Monkey Blunderbuss',
    ItemGlobals.BABOON_BLUNDERBUSS: 'Baboon Blunderbuss',
    ItemGlobals.GORILLA_BLUNDERBUSS: 'Gorilla Blunderbuss',
    ItemGlobals.NAVY_BLUNDERBUSS: 'Navy Blunderbuss',
    ItemGlobals.EITC_BLUNDERBUSS: 'EITC Blunderbuss',
    ItemGlobals.PIRATE_BLUNDERBUSS: 'Pirate Blunderbuss',
    ItemGlobals.GRAND_BLUNDERBUSS: 'Grand Blunderbuss',
    ItemGlobals.HUNTER_BLUNDERBUSS: "Hunter's Blunderbuss",
    ItemGlobals.HIRED_GUN_BLUNDERBUSS: "Hired-gun's Blunderbuss",
    ItemGlobals.MERCENARY_BLUNDERBUSS: "Mercenary's Blunderbuss",
    ItemGlobals.BOUNTY_HUNTER_BLUNDERBUSS: "Bounty Hunter's Blunderbuss",
    ItemGlobals.NIGHT_HUNTER_BLUNDERBUSS: 'Night Hunter Blunderbuss',
    ItemGlobals.SHADOW_STALKER_BLUNDERBUSS: 'Shadow Stalker Blunderbuss',
    ItemGlobals.FOUL_BANE_BLUNDERBUSS: 'Foul Bane Blunderbuss',
    ItemGlobals.FULLMOON_SPECIAL_BLUNDERBUSS: 'Fullmoon Special Blunderbuss',
    ItemGlobals.RUNIC_BLUNDERBUSS: 'Runic Blunderbuss',
    ItemGlobals.WARDING_BLUNDERBUSS: 'Warding Blunderbuss',
    ItemGlobals.ARCANE_BLUNDERBUSS: 'Arcane Blunderbuss',
    ItemGlobals.SMALL_BLUNDERBUSS: 'Small Blunderbuss',
    ItemGlobals.FINE_BLUNDERBUSS: 'Fine Blunderbuss',
    ItemGlobals.ROYAL_BLUNDERBUSS: 'Royal Blunderbuss',
    ItemGlobals.EITC_GRUNT_REPEATER: "EITC Grunt's Repeater Pistol",
    ItemGlobals.EITC_HIRED_GUN_REPEATER: "EITC Hired-gun's Repeater Pistol",
    ItemGlobals.EITC_MERCENARY_REPEATER: "EITC Mercenary's Repeater Pistol",
    ItemGlobals.WICKED_REPEATER: 'Wicked Repeater',
    ItemGlobals.DREAD_REPEATER: 'Dread Repeater',
    ItemGlobals.BANEBLAST_REPEATER: 'Baneblast Repeater',
    ItemGlobals.SKULLBONE_REPEATER: 'Skullbone Repeater',
    ItemGlobals.NIGHT_HUNTER_REPEATER: 'Night Hunter Repeater',
    ItemGlobals.SHADOW_STALKER_REPEATER: 'Shadow Stalker Repeater',
    ItemGlobals.FOUL_BANE_REPEATER: 'Foul Bane Repeater',
    ItemGlobals.FULLMOON_SPECIAL_REPEATER: 'Fullmoon Special Repeater',
    ItemGlobals.MONKEY_REPEATER: 'Monkey Repeater',
    ItemGlobals.BABOON_REPEATER: 'Baboon Repeater',
    ItemGlobals.ORANGUTAN_REPEATER: 'Orangutan Repeater',
    ItemGlobals.GORILLA_REPEATER: 'Gorilla Repeater',
    ItemGlobals.SEA_DOG_REPEATER: 'Sea Dog Repeater',
    ItemGlobals.SWASHBUCKLER_REPEATER: "Swashbuckler's Repeater",
    ItemGlobals.BUCCANEER_REPEATER: "Buccaneer's Repeater",
    ItemGlobals.PRIVATEER_REPEATER: "Privateer's Repeater Pistol",
    ItemGlobals.CORSAIR_REPEATER: "Corsair's Repeater Pistol",
    ItemGlobals.SEVEN_SEAS_REPEATER: 'Seven Seas Repeater',
    ItemGlobals.RUNIC_REPEATER: 'Runic Repeater',
    ItemGlobals.WARDING_REPEATER: 'Warding Repeater',
    ItemGlobals.ARCANE_REPEATER: 'Arcane Repeater',
    ItemGlobals.CABAL_REPEATER: 'Cabal Repeater',
    ItemGlobals.ENHANCED_REPEATER: 'Enhanced Repeater Pistol',
    ItemGlobals.CLOCKWORK_REPEATER: 'Clockwork Repeater Pistol',
    ItemGlobals.GATLING_REPEATER: 'Gatling Repeater Pistol',
    ItemGlobals.MASTER_CRAFTED_REPEATER: 'Master Crafted Repeater Pistol',
    ItemGlobals.DARK_REPEATER_PISTOL: 'Dark Repeater Pistol',
    ItemGlobals.SHADOW_REPEATER_PISTOL: 'Shadow Repeater Pistol',
    ItemGlobals.FORBIDDEN_REPEATER_PISTOL: 'Forbidden Repeater Pistol',
    ItemGlobals.SILVER_REPEATER_PISTOL: 'Silver Repeater Pistol',
    ItemGlobals.HOLY_REPEATER_PISTOL: 'Holy Repeater Pistol',
    ItemGlobals.SACRED_REPEATER_PISTOL: 'Sacred Repeater Pistol',
    ItemGlobals.TWIN_BARREL_PISTOL: 'Twin Barrel Pistol',
    ItemGlobals.STEEL_REPEATER: 'Steel Repeater',
    ItemGlobals.ORNATE_REPEATER: 'Ornate Repeater',
    ItemGlobals.VOLLEY_PISTOL: 'Volley Pistol',
    ItemGlobals.VOODOO_DOLL: 'Voodoo Doll',
    ItemGlobals.CLOTH_DOLL: 'Cloth Doll',
    ItemGlobals.WITCH_DOLL: 'Witch Doll',
    ItemGlobals.PIRATE_DOLL: 'Pirate Doll',
    ItemGlobals.TABOO_DOLL: 'Taboo Doll',
    ItemGlobals.UGLY_DOLL: 'Ugly Voodoo Doll',
    ItemGlobals.ZOMBIE_DOLL: 'Zombie Doll',
    ItemGlobals.GHOUL_DOLL: 'Ghoul Doll',
    ItemGlobals.HYPNOTIC_DOLL: 'Hypnotic Doll',
    ItemGlobals.MANIPULATION_DOLL: 'Manipulation Doll',
    ItemGlobals.MIND_CONTROL_DOLL: 'Mind Control Doll',
    ItemGlobals.DOMINATION_DOLL: 'Domination Doll',
    ItemGlobals.EVIL_DOLL: 'Evil Doll',
    ItemGlobals.WICKED_DOLL: 'Wicked Doll',
    ItemGlobals.UNHOLY_DOLL: 'Unholy Doll',
    ItemGlobals.VILLAINY_DOLL: 'Villainy Doll',
    ItemGlobals.TYRANNY_DOLL: 'Tyranny Doll',
    ItemGlobals.SKELETON_DOLL: 'Skeleton Doll',
    ItemGlobals.CEMETERY_DOLL: 'Cemetery Doll',
    ItemGlobals.CRYPT_DOLL: 'Crypt Doll',
    ItemGlobals.CARRION_DOLL: 'Carrion Doll',
    ItemGlobals.REVENANT_DOLL: 'Revenant Doll',
    ItemGlobals.TOMB_KING_DOLL: 'Tomb King Doll',
    ItemGlobals.SWASHBUCKLER_DOLL: 'Swashbuckler Doll',
    ItemGlobals.BUCCANEER_DOLL: 'Buccaneer Doll',
    ItemGlobals.MUTINEER_DOLL: 'Mutineer Doll',
    ItemGlobals.PRIVATEER_DOLL: 'Privateer Doll',
    ItemGlobals.WARMONGER_DOLL: 'Warmonger Doll',
    ItemGlobals.BARBOSSA_DOLL: 'Barbossa Doll',
    ItemGlobals.DARK_DOLL: 'Dark Voodoo Doll',
    ItemGlobals.SHADOW_DOLL: 'Shadow Voodoo Doll',
    ItemGlobals.FORBIDDEN_DOLL: 'Forbidden Voodoo Doll',
    ItemGlobals.JOLLY_ROGER_DOLL: 'Jolly Roger Voodoo Doll',
    ItemGlobals.CURSED_DOLL: 'Cursed Doll',
    ItemGlobals.TORMENTED_DOLL: 'Tormented Voodoo Doll',
    ItemGlobals.OVERLORD_DOLL: 'Overlord Voodoo Doll',
    ItemGlobals.DAVY_JONES_DOLL: 'Davy Jones Voodoo Doll',
    ItemGlobals.FURY_DOLL: 'Fury Doll',
    ItemGlobals.RAGE_DOLL: 'Rage Doll',
    ItemGlobals.GRUDGER_DOLL: 'Grudger Doll',
    ItemGlobals.VENGEFUL_DOLL: 'Vengeful Doll',
    ItemGlobals.WRATH_DOLL: 'Wrath Doll',
    ItemGlobals.WAX_DOLL: 'Wax Doll',
    ItemGlobals.CLAY_DOLL: 'Clay Doll',
    ItemGlobals.SILK_DOLL: 'Silk Doll',
    ItemGlobals.ORIENTAL_DOLL: 'Oriental Doll',
    ItemGlobals.WARRIOR_DOLL: 'Warrior Doll',
    ItemGlobals.NOMAD_DOLL: 'Nomad Doll',
    ItemGlobals.WARLORD_DOLL: 'Warlord Doll',
    ItemGlobals.SHAO_FENG_DOLL: 'Shao Feng Doll',
    ItemGlobals.WITCH_DOCTOR_DOLL: 'Witch Doctor Doll',
    ItemGlobals.BEWITCHER_DOLL: 'Bewitcher Doll',
    ItemGlobals.SIREN_DOLL: 'Siren Doll',
    ItemGlobals.OCCULT_DOLL: 'Occult Doll',
    ItemGlobals.BANSHEE_DOLL: 'Banshee Doll',
    ItemGlobals.BLACK_MAGIC_DOLL: 'Black Magic Doll',
    ItemGlobals.MYSTIC_DOLL: 'Mystic Doll',
    ItemGlobals.PRIESTESS_DOLL: 'Priestess Doll',
    ItemGlobals.GYPSY_DOLL: 'Gypsy Doll',
    ItemGlobals.SHAMAN_DOLL: 'Shaman Doll',
    ItemGlobals.CABAL_DOLL: 'Cabal Doll',
    ItemGlobals.TIA_DALMA_DOLL: "Tia Dalma's Doll",
    ItemGlobals.STRAW_DOLL: 'Straw Doll',
    ItemGlobals.WARDING_DOLL: 'Warding Doll',
    ItemGlobals.HEX_WATCHER_DOLL: 'Hex Watcher Doll',
    ItemGlobals.SPELL_BINDER_DOLL: 'Spell Binder Doll',
    ItemGlobals.CURSE_BREAKER_DOLL: 'Curse Breaker Doll',
    ItemGlobals.JACK_SPARROW_DOLL: "Jack Sparrow's Voodoo Doll",
    ItemGlobals.HEX_REFLECTER_DOLL: 'Hex Reflecter Doll',
    ItemGlobals.HEX_REBOUND_DOLL: 'Hex Rebound Doll',
    ItemGlobals.HEX_GUARDIAN_DOLL: 'Hex Guardian Doll',
    ItemGlobals.CALYPSO_RADIANCE: "Calypso's Radiance",
    ItemGlobals.COTTON_SOLL: 'Cotton Doll',
    ItemGlobals.ORNATE_DOLL: 'Ornate Doll',
    ItemGlobals.ENCHANTED_DOLL: 'Enchanted Doll',
    ItemGlobals.MAGIC_DOLL: 'Magic Doll',
    ItemGlobals.MYSTERIOUS_DOLL: 'Mysterious Doll',
    ItemGlobals.RAG_DOLL: 'Rag Doll',
    ItemGlobals.CUPIE_DOLL: 'Cupie Doll',
    ItemGlobals.GAZE_BINDER_DOLL: 'Gaze Binder Doll',
    ItemGlobals.SIGHT_BINDER_DOLL: 'Sight Binder Doll',
    ItemGlobals.FAR_BINDER_DOLL: 'Far Binder Doll',
    ItemGlobals.SPIRIT_BINDER_DOLL: 'Spirit Binder Doll',
    ItemGlobals.SOUL_BINDER_DOLL: 'Soul Binder Doll',
    ItemGlobals.MONKEY_DOLL: 'Monkey Doll',
    ItemGlobals.CHIMPANZEE_DOLL: 'Chimpanzee Doll',
    ItemGlobals.BABOON_DOLL: 'Baboon Doll',
    ItemGlobals.ORANGUTAN_DOLL: 'Orangutan Doll',
    ItemGlobals.GORILLA_DOLL: 'Gorilla Doll',
    ItemGlobals.JACK_THE_MONKEY_DOLL: 'Jack the Monkey Doll',
    ItemGlobals.DOLL_OF_CLEANSING: 'Doll of Cleansing',
    ItemGlobals.DOLL_OF_PURIFICATION: 'Doll of Purification',
    ItemGlobals.DOLL_OF_SACRED_RITUALS: 'Doll of Sacred Rituals',
    ItemGlobals.SAILOR_DOLL: 'Sailor Doll',
    ItemGlobals.SEAFARER_DOLL: 'Seafarer Doll',
    ItemGlobals.TRAVELER_DOLL: 'Traveler Doll',
    ItemGlobals.VOYAGER_DOLL: 'Voyager Doll',
    ItemGlobals.EXPLORER_DOLL: 'Explorer Doll',
    ItemGlobals.ADVENTURER_DOLL: 'Adventurer Doll',
    ItemGlobals.ELIZABETH_SWAN_DOLL: 'Elizabeth Swan Doll',
    ItemGlobals.SOLDIER_DOLL: 'Soldier Doll',
    ItemGlobals.HERO_DOLL: 'Hero Doll',
    ItemGlobals.FENCER_DOLL: 'Fencer Doll',
    ItemGlobals.SWORDSMAN_DOLL: 'Swordsman Doll',
    ItemGlobals.CONQUISTADOR_DOLL: 'Conquistador Doll',
    ItemGlobals.TREASURE_HUNTER_DOLL: 'Treasure Hunter Doll',
    ItemGlobals.WILL_TURNER_DOLL: 'Will Turner Doll',
    ItemGlobals.HEALING_DOLL: 'Healing Doll',
    ItemGlobals.MENDING_DOLL: 'Mending Doll',
    ItemGlobals.RESTORATION_DOLL: 'Restoration Doll',
    ItemGlobals.RENEWAL_DOLL: 'Renewal Doll',
    ItemGlobals.LIFE_DOLL: 'Life Doll',
    ItemGlobals.BASIC_DAGGER: 'Dagger',
    ItemGlobals.BATTLE_DIRK: 'Battle Dirk',
    ItemGlobals.MAIN_GAUCHE: 'Main Gauche',
    ItemGlobals.COLTELLO: 'Coltello',
    ItemGlobals.BLOODLETTER: 'Bloodletter',
    ItemGlobals.GRAVEDIGGER_DAGGER: "Gravedigger's Dagger",
    ItemGlobals.MUTINEER_DAGGER: "Mutineer's Dagger",
    ItemGlobals.BRIGAND_DAGGER: "Brigand's Dagger",
    ItemGlobals.DUELIST_DAGGER: "Duelist's Dagger",
    ItemGlobals.EITC_THUG_DAGGER: "EITC Thug's Dagger",
    ItemGlobals.EITC_HIRED_GUN_DAGGER: "EITC Hiredgun's Dagger",
    ItemGlobals.EITC_ASSASSIN_DAGGER: "EITC Assassin's Dagger",
    ItemGlobals.SURVIVAL_DAGGER: 'Survival Dagger',
    ItemGlobals.WILDERNESS_DAGGER: 'Wilderness Dagger',
    ItemGlobals.JUNGLE_DAGGER: 'Jungle Dagger',
    ItemGlobals.SWAMP_DAGGER: 'Swamp Dagger',
    ItemGlobals.BAYOU_DAGGER: 'Bayou Dagger',
    ItemGlobals.BACKSTABBER_DAGGER: 'Backstabber Dagger',
    ItemGlobals.BACK_BITER_DAGGER: 'Back Biter Dagger',
    ItemGlobals.DEAL_BREAKER_DAGGER: 'Deal Breaker Dagger',
    ItemGlobals.DOUBLE_CROSS_DAGGER: 'Double Cross Dagger',
    ItemGlobals.TRAITOR_DAGGER: "Traitor's Dagger",
    ItemGlobals.CUTTHROAT_DAGGER: "Cutthroat's Dagger",
    ItemGlobals.SEA_DOG_DAGGER: "Sea Dog's Dagger",
    ItemGlobals.SWASHBUCKLER_DAGGER: "Swashbuckler's Dagger",
    ItemGlobals.BUCCANEER_DAGGER: "Buccaneer's Dagger",
    ItemGlobals.PRIVATEER_DAGGER: "Privateer's Dagger",
    ItemGlobals.CORSAIR_DAGGER: "Corsair's Dagger",
    ItemGlobals.SEVEN_SEAS_DAGGER: 'Seven Seas Dagger',
    ItemGlobals.DAGGER_OF_THE_SUN_IDOL: 'Dagger of the Sun Idol',
    ItemGlobals.DAGGER_OF_THE_MOON_IDOL: 'Dagger of the Moon Idol',
    ItemGlobals.DAGGER_OF_THE_HAWK_IDOL: 'Dagger of the Hawk Idol',
    ItemGlobals.DAGGER_OF_THE_BEAR_IDOL: 'Dagger of the Bear Idol',
    ItemGlobals.DAGGER_OF_THE_GOLDEN_IDOL: 'Dagger of the Golden Idol',
    ItemGlobals.DAGGER_OF_THE_DARK_IDOL: 'Dagger of the Dark Idol',
    ItemGlobals.SMALL_DAGGER: 'Small Dagger',
    ItemGlobals.STEEL_DAGGER: 'Steel Dagger',
    ItemGlobals.COMBAT_DAGGER: 'Combat Dagger',
    ItemGlobals.BATTLE_DAGGER: 'Battle Dagger',
    ItemGlobals.WAR_DAGGER: 'War Dagger',
    ItemGlobals.RUSTY_THROWING_KNIVES: 'Rusty Throwing Knives',
    ItemGlobals.BALANCED_THROWING_KNIVES: 'Balanced Throwing Knives',
    ItemGlobals.CUTLERY_SET: 'Cutlery Set',
    ItemGlobals.RAIDER_THROWING_KNIVES: "Raider's Throwing Knives",
    ItemGlobals.ASP_DEN_KNIVES: "Asp's Den Knives",
    ItemGlobals.ADDER_DEN_KNIVES: "Adder's Den Knives",
    ItemGlobals.SIDEWINDER_DEN_KNIVES: "Sidewinder's Den Knives",
    ItemGlobals.VIPER_DEN_KNIVES: "Viper's Den Knives",
    ItemGlobals.SCALLYWAG_KNIVES: "Scallywag's Knives",
    ItemGlobals.ROBBER_KNIVES: "Robber's Knives",
    ItemGlobals.SCOUNDREL_KNIVES: "Scoundrel's Knives",
    ItemGlobals.BLACK_FANG_KNIVES: 'Black Fang Knives',
    ItemGlobals.GRIM_FANG_KNIVES: 'Grim Fang Knives',
    ItemGlobals.RAVEN_FANG_KNIVES: 'Raven Fang Knives',
    ItemGlobals.SHARK_FANG_KNIVES: 'Shark Fang Knives',
    ItemGlobals.DEMON_FANG_KNIVES: 'Demon Fang Knives',
    ItemGlobals.KNIVES_OF_THE_SUN_IDOL: 'Knives of the Sun Idol',
    ItemGlobals.KNIVES_OF_THE_HAWK_IDOL: 'Knives of the Hawk Idol',
    ItemGlobals.KNIVES_OF_THE_GOLDEN_IDOL: 'Knives of the Golden Idol',
    ItemGlobals.SURVIVAL_THROWING_KNIVES: 'Survival Throwing Knives',
    ItemGlobals.WILDERNESS_THROWING_KNIVES: 'Wilderness Throwing Knives',
    ItemGlobals.JUNGLE_THROWING_KNIVES: 'Jungle Throwing Knives',
    ItemGlobals.SWAMP_THROWING_KNIVES: 'Swamp Throwing Knives',
    ItemGlobals.BAYOU_THROWING_KNIVES: 'Bayou Throwing Knives',
    ItemGlobals.HUNTER_THROWING_KNIVES: "Hunter's Throwing Knives",
    ItemGlobals.AZTEC_THROWING_KNIVES: 'Aztec Throwing Knives',
    ItemGlobals.MARKSMAN_THROWING_KNIVES: "Marksman's Throwing Knives",
    ItemGlobals.AMAZON_THROWING_KNIVES: 'Amazon Throwing Knives',
    ItemGlobals.ASSASSIN_THROWING_KNIVES: "Assassin's Throwing Knives",
    ItemGlobals.SILVER_FREEZE: 'Silver Freeze',
    ItemGlobals.SMALL_THROWING_KNIVES: 'Small Throwing Knives',
    ItemGlobals.IRON_THROWING_KNIVES: 'Iron Throwing Knives',
    ItemGlobals.TRIBAL_THROWING_KNIVES: 'Tribal Throwing Knives',
    ItemGlobals.FINE_THROWING_KNIVES: 'Fine Throwing Knives',
    ItemGlobals.MASTER_THROWING_KNIVES: 'Master Throwing Knives',
    ItemGlobals.CEREMONIAL_KNIVE: 'Ceremonial Knife',
    ItemGlobals.TRIBAL_KNIFE: 'Tribal Knife',
    ItemGlobals.RITUAL_KNIFE: 'Ritual Knife',
    ItemGlobals.KNIFE_OF_THE_BLOOD_IDOL: 'Knife of the Blood Idol',
    ItemGlobals.KNIFE_OF_THE_JACKAL_IDOL: 'Knife of the Jackal Idol',
    ItemGlobals.KNIFE_OF_THE_RAVEN_IDOL: 'Knife of the Raven Idol',
    ItemGlobals.KNIFE_OF_THE_WAR_IDOL: 'Knife of the War Idol',
    ItemGlobals.KNIFE_OF_THE_DEMON_IDOL: 'Knife of the Demon Idol',
    ItemGlobals.KNIFE_OF_THE_DEATH_IDOL: 'Knife of the Death Idol',
    ItemGlobals.GRIM_STRIKE_KNIFE: 'Grim Strike Knife',
    ItemGlobals.BLIGHT_STRIKE_KNIFE: 'Blight Strike Knife',
    ItemGlobals.DECAY_STRIKE_KNIFE: 'Decay Strike Knife',
    ItemGlobals.FATAL_STRIKE_KNIFE: 'Fatal Strike Knife',
    ItemGlobals.DEATH_STRIKE_KNIFE: 'Death Strike Knife',
    ItemGlobals.NIGHT_HUNTER_KNIFE: 'Night Hunter Knife',
    ItemGlobals.NIGHT_CHASER_KNIFE: 'Night Chaser Knife',
    ItemGlobals.NIGHT_STALKER_KNIFE: 'Night Stalker Knife',
    ItemGlobals.NIGHT_PREDATOR_KNIFE: 'Night Predator Knife',
    ItemGlobals.SNAKE_VENOM_KNIFE: 'Snake Venom Knife',
    ItemGlobals.VIPER_VENOM_KNIFE: 'Viper Venom Knife',
    ItemGlobals.COPPERHEAD_VENOM_KNIFE: 'Copperhead Venom Knife',
    ItemGlobals.MAMBA_VENOM_KNIFE: 'Mamba Venom Knife',
    ItemGlobals.COBRA_VENOM_KNIFE: 'Cobra Venom Knife',
    ItemGlobals.POISONED_KNIFE: 'Poisoned Knife',
    ItemGlobals.VENOM_KNIFE: 'Venomous Knife',
    ItemGlobals.TOXIC_KNIFE: 'Toxic Knife',
    ItemGlobals.PLAGUE_KNIFE: 'Plague Knife',
    ItemGlobals.DIRE_KNIFE: 'Dire Knife',
    ItemGlobals.CURSED_STAFF: 'Cursed Staff',
    ItemGlobals.WARPED_STAFF: 'Warped Staff',
    ItemGlobals.REND_STAFF: 'Rend Staff',
    ItemGlobals.HARROW_STAFF: 'Harrow Staff',
    ItemGlobals.VILE_STAFF: 'Vile Staff',
    ItemGlobals.DREAD_STAFF: 'Dread Staff',
    ItemGlobals.HAUNTED_STAFF: 'Haunted Staff',
    ItemGlobals.POSSESSED_STAFF: 'Possessed Staff',
    ItemGlobals.PHANTOM_STAFF: 'Phantom Staff',
    ItemGlobals.SKULL_STAFF: 'Skull Staff',
    ItemGlobals.DIRE_STAFF: 'Dire Staff',
    ItemGlobals.DIABOLIC_STAFF: 'Diabolic Staff',
    ItemGlobals.DEMON_SKULL_STAFF: 'Demon Skull Staff',
    ItemGlobals.SINGED_STAFF: 'Singed Staff',
    ItemGlobals.BURNT_STAFF: 'Burnt Staff',
    ItemGlobals.CHARRED_STAFF: 'Charred Staff',
    ItemGlobals.CAJUN_STAFF: 'Cajun Staff',
    ItemGlobals.SPIRIT_CALLER_STAFF: 'Spirit Caller Staff',
    ItemGlobals.SPIRIT_BINDER_STAFF: 'Spirit Burner Staff',
    ItemGlobals.SPIRIT_SHREDDER_STAFF: 'Spirit Shredder Staff',
    ItemGlobals.SOUL_HARVESTER_STAFF: 'Soul Harvester Staff',
    ItemGlobals.SOUL_REAPER_STAFF: 'Soul Reaper Staff',
    ItemGlobals.SOUL_EATER_STAFF: 'Soul Eater Staff',
    ItemGlobals.DARK_OMEN: 'Dark Omen',
    ItemGlobals.BONE_STAFF: 'Bone Staff',
    ItemGlobals.GRIM_STAFF: 'Grim Staff',
    ItemGlobals.SKELETAL_STAFF: 'Skeletal Staff',
    ItemGlobals.UNDEAD_STAFF: 'Undead Staff',
    ItemGlobals.DEATH_STAFF: 'Death Staff',
    ItemGlobals.ROTTEN_STAFF: 'Rotten Staff',
    ItemGlobals.JUJU_STAFF: 'Juju Staff',
    ItemGlobals.ANTIVENOM_STAFF: 'Anti-venom Staff',
    ItemGlobals.RESISTANCE_STAFF: 'Resistance Staff',
    ItemGlobals.REGROWTH_STAFF: 'Regrowth Staff',
    ItemGlobals.STAFF_OF_MISTS: 'Staff of Mists',
    ItemGlobals.STAFF_OF_RAIN: 'Staff of Rain',
    ItemGlobals.STAFF_OF_STORMS: 'Staff of Storms',
    ItemGlobals.BOA_STAFF: 'Boa Staff',
    ItemGlobals.PYTHON_STAFF: 'Python Staff',
    ItemGlobals.SERPENT_STAFF: 'Serpent Staff',
    ItemGlobals.MISSHAPEN_STAFF: 'Misshapen Staff',
    ItemGlobals.TWISTED_STAFF: 'Twisted Staff',
    ItemGlobals.GNARLED_STAFF: 'Gnarled Staff',
    ItemGlobals.ANCIENT_STAFF: 'Ancient Staff',
    ItemGlobals.STONE_GUARD_STAFF: 'Stone Guard Staff',
    ItemGlobals.GRANITE_GUARD_STAFF: 'Granite Guard Staff',
    ItemGlobals.EARTH_GUARD_STAFF: 'Earth Guard Staff',
    ItemGlobals.HEALING_STAFF: 'Healing Staff',
    ItemGlobals.MENDING_STAFF: 'Mending Staff',
    ItemGlobals.RESTORATION_STAFF: 'Restoration Staff',
    ItemGlobals.RENEWAL_STAFF: 'Renewal Staff',
    ItemGlobals.LIFE_STAFF: 'Life Staff',
    ItemGlobals.TRIBAL_STAFF: 'Tribal Staff',
    ItemGlobals.STAFF_OF_CLEANSING: 'Staff of Cleansing',
    ItemGlobals.STAFF_OF_PURIFICATION: 'Staff of Purification',
    ItemGlobals.STAFF_OF_SACRED_RITUALS: 'Staff of Sacred Rituals',
    ItemGlobals.STAFF_OF_PROTECTION: 'Staff of Protection',
    ItemGlobals.STAFF_OF_WARDING: 'Staff of Warding',
    ItemGlobals.STAFF_OF_SHIELDING: 'Staff of Shielding',
    ItemGlobals.STAFF_OF_DEFIANCE: 'Staff of Defiance',
    ItemGlobals.STAFF_OF_SANCTUARY: 'Staff of Sanctuary',
    ItemGlobals.SAGE_STAFF: 'Sage Staff',
    ItemGlobals.RITUAL_STAFF: 'Ritual Staff',
    ItemGlobals.BANISHING_STAFF: 'Banishing Staff',
    ItemGlobals.TABOO_STAFF: 'Taboo Staff',
    ItemGlobals.EXORCISM_STAFF: 'Exorcism Staff',
    ItemGlobals.STAFF_OF_THE_SACRED_OWL: 'Staff of the Sacred Owl',
    ItemGlobals.STAFF_OF_THE_SACRED_MOON: 'Staff of the Sacred Moon',
    ItemGlobals.STAFF_OF_THE_SACRED_STARS: 'Staff of the Sacred Stars',
    ItemGlobals.STAFF_OF_THE_SACRED_SUN: 'Staff of the Sacred Sun',
    ItemGlobals.DEFENDER_STAFF: 'Defender Staff',
    ItemGlobals.WARDEN_STAFF: 'Warden Staff',
    ItemGlobals.OVERSEER_STAFF: 'Overseer Staff',
    ItemGlobals.GUARDIAN_STAFF: 'Guardian Staff',
    ItemGlobals.TRIBAL_CHIEF_STAFF: 'Tribal Chief Staff',
    ItemGlobals.GRENADE_POUCH: 'Grenade Pouch',
    ItemGlobals.OLD_CANNON_RAM: 'Old Cannon Ram',
    ItemGlobals.HASTY_CANNON_RAM: 'Hasty Cannon Ram',
    ItemGlobals.GUNNERS_CANNON_RAM: "Gunner's Cannon Ram",
    ItemGlobals.MASTER_GUNNERS_CANNON_RAM: "Master Gunner's Cannon Ram",
    ItemGlobals.GREYHOUND_CANNON_RAM: 'Greyhound Cannon Ram',
    ItemGlobals.BLOODHOUND_CANNON_RAM: 'Bloodhound Cannon Ram',
    ItemGlobals.MAKESHIFT_CANNON_RAM: 'Makeshift Cannon Ram',
    ItemGlobals.MANOWAR_CANNON_RAM: 'Man-o-War Cannon Ram',
    ItemGlobals.JUGGERNAUT_CANNON_RAM: 'Juggernaut Cannon Ram',
    ItemGlobals.MARAUDER_CANNON_RAM: 'Marauder Cannon Ram',
    ItemGlobals.CERBERUS_CANNON_RAM: 'Cerberus Cannon Ram',
    ItemGlobals.PHANTOM_CANNON_RAM: 'Phantom Cannon Ram',
    ItemGlobals.STORMREAPER_CANNON_RAM: 'Storm Reaper Cannon Ram',
    ItemGlobals.REVENANT_CANNON_RAM: 'Revenant Cannon Ram',
    ItemGlobals.SHADOW_CROW_CANNON_RAM: 'Shadow Crow Cannon Ram',
    ItemGlobals.BRONZE_CANNON_RAM: 'Bronze Cannon Ram',
    ItemGlobals.IRON_CANNON_RAM: 'Iron Cannon Ram',
    ItemGlobals.STEEL_CANNON_RAM: 'Steel Cannon Ram',
    ItemGlobals.COTTON_CANNON_RAM: 'Cotton Cannon Ram',
    ItemGlobals.WOOL_CANNON_RAM: 'Wool Cannon Ram',
    ItemGlobals.SPONGE_CANNON_RAM: 'Sponge Cannon Ram',
    ItemGlobals.FLEECE_CANNON_RAM: 'Fleece Cannon Ram',
    ItemGlobals.FIERY_CANNON_RAM: 'Fiery Cannon Ram',
    ItemGlobals.SEARING_CANNON_RAM: 'Searing Cannon Ram',
    ItemGlobals.CAJUN_CANNON_RAM: 'Cajun Cannon Ram',
    ItemGlobals.HAUNTED_CANNON_RAM: 'Haunted Cannon Ram',
    ItemGlobals.SPECTRAL_CANNON_RAM: 'Spectral Cannon Ram',
    ItemGlobals.POSSESSED_CANNON_RAM: 'Possessed Cannon Ram',
    ItemGlobals.LADLE_CANNON_RAM: 'Ladle Cannon Ram',
    ItemGlobals.COPPER_LADLE_CANNON_RAM: 'Copper Ladle Cannon Ram',
    ItemGlobals.CLOTH_CANNON_RAM: 'Cloth Cannon Ram',
    ItemGlobals.PADDED_CANNON_RAM: 'Padded Cannon Ram',
    ItemGlobals.PRIMING_RAM: 'Priming Ram',
    ItemGlobals.IRON_PRIMING_RAM: 'Iron Priming Ram',
    ItemGlobals.BURNT_CANNON_RAM: 'Burnt Cannon Ram',
    ItemGlobals.CHARRED_CANNON_RAM: 'Charred Cannon Ram',
    ItemGlobals.ROTTEN_CANNON_RAM: 'Rotten Cannon Ram',
    ItemGlobals.WICKED_CANNON_RAM: 'Wicked Cannon Ram',
    ItemGlobals.ORIENTAL_SPYGLASS: 'Oriental Spyglass',
    ItemGlobals.GOLDEN_SPYGLASS: 'Golden Spyglass',
    ItemGlobals.SINGAPOREAN_SPYGLASS: 'Singaporean Spyglass',
    ItemGlobals.SEADOG_SPYGLASS: "Sea Dog's Spyglass",
    ItemGlobals.PIRATE_SPYGLASS: "Pirate's Spyglass",
    ItemGlobals.RAIDER_SPYGLASS: "Raider's Spyglass",
    ItemGlobals.MERCHANT_SPYGLASS: "Mechant's Spyglass",
    ItemGlobals.SMUGGLER_SPYGLASS: "Smuggler's Spyglass",
    ItemGlobals.RUMRUNNER_SPYGLASS: "Rumrunner's Spyglass",
    ItemGlobals.THIEVES_SPYGLASS: 'Thieves Spyglass',
    ItemGlobals.QUARTER_MASTER_SPYGLASS: "Quarter Master's Spyglass",
    ItemGlobals.FIRST_MATE_SPYGLASS: "First Mate's Spyglass",
    ItemGlobals.CAPTAIN_SPYGLASS: "Captain's Spyglass",
    ItemGlobals.COMMODORE_SPYGLASS: "Commodore's Spyglass",
    ItemGlobals.MARINER_SPYGLASS: "Mariner's Spyglass",
    ItemGlobals.LIEUTENANT_SPYGLASS: "Lieutenant's Spyglass",
    ItemGlobals.COMMANDER_SPYGLASS: "Commander's Spyglass",
    ItemGlobals.ADMIRAL_SPYGLASS: "Admiral's Spyglass",
    ItemGlobals.SWASHBUCKLER_SPYGLASS: "Swashbuckler's Spyglass",
    ItemGlobals.BUCCANEER_SPYGLASS: "Buccaneer's Spyglass",
    ItemGlobals.PRIVATEER_SPYGLASS: "Privateer's Spyglass",
    ItemGlobals.CORSAIR_SPYGLASS: "Corsair's Spyglass",
    ItemGlobals.CONQUISTADOR_SPYGLASS: "Conquistador's Spyglass",
    ItemGlobals.MERCENARY_SPYGLASS: "Mercenary's Spyglass",
    ItemGlobals.BOUNTY_HUNTER_SPYGLASS: "Bounty Hunter's Spyglass",
    ItemGlobals.WARMONGER_SPYGLASS: "Warmonger's Spyglass",
    ItemGlobals.NAVY_SPYGLASS: 'Navy Spyglass',
    ItemGlobals.TRADING_CO_SPYGLASS: 'Trading Company Spyglass',
    ItemGlobals.OFFICER_SPYGLASS: "Officer's Spyglass",
    ItemGlobals.BLACK_GUARD_SPYGLASS: "Black Guard's Spyglass",
    ItemGlobals.DAVY_JONES_SPYGLASS: "Davy Jones's Spyglass",
    ItemGlobals.BECKETTE_SPYGLASS: "Beckette's Spyglass",
    ItemGlobals.NORRINGTON_SPYGLASS: "Norrington's Spyglass",
    ItemGlobals.BARBOSSA_SPYGLASS: "Barbossa's Spyglass",
    ItemGlobals.JACK_SPARROW_SPYGLASS: "Jack Sparrow's Spyglass",
    ItemGlobals.FADED_SEA_CHART: 'Faded Sea Chart',
    ItemGlobals.MERCHANT_SEA_CHART: "Mechant's Sea Chart",
    ItemGlobals.SMUGGLER_SEA_CHART: "Smuggler's Sea Chart",
    ItemGlobals.RUMRUNNER_SEA_CHART: "Rumrunner's Sea Chart",
    ItemGlobals.LANDLUBBER_SEA_CHART: "Landlubber's Sea Chart",
    ItemGlobals.SAILOR_SEA_CHART: "Sailor's Sea Chart",
    ItemGlobals.FREEBOOTER_SEA_CHART: "Freebooter's Sea Chart",
    ItemGlobals.VOYAGER_SEA_CHART: "Voyager's Sea Chart",
    ItemGlobals.EXPLORER_SEA_CHART: "Explorer's Sea Chart",
    ItemGlobals.TREASURE_HUNTER_SEA_CHART: "Treasure Hunter's Sea Chart",
    ItemGlobals.OLD_WORLD_SEA_CHART: 'Old World Sea Chart',
    ItemGlobals.NEW_WORLD_SEA_CHART: 'New World Sea Chart',
    ItemGlobals.LOST_WORLD_SEA_CHART: 'Lost World Sea Chart',
    ItemGlobals.THIEVE_SEA_GLOBE: "Thieve's Sea Globe",
    ItemGlobals.BANDIT_SEA_GLOBE: "Bandit's Sea Globe",
    ItemGlobals.ROBBER_SEA_GLOBE: "Robber's Sea Globe",
    ItemGlobals.PRIVATEER_SEA_GLOBE: "Privateer's Sea Globe",
    ItemGlobals.CORSAIR_SEA_GLOBE: "Corsair's Sea Globe",
    ItemGlobals.SEVEN_SEAS_SEA_GLOBE: 'Seven Seas Sea Globe',
    ItemGlobals.WOODEN_CHARM: 'Wooden Charm',
    ItemGlobals.LUCKY_CHARM: 'Lucky Charm',
    ItemGlobals.GOLDEN_CHARM: 'Golden Charm',
    ItemGlobals.FORTUNE_CHARM: 'Fortune Charm',
    ItemGlobals.EL_DORODO_CHARM: "El Dorodo's Charm",
    ItemGlobals.MUTINEERS_CHARM: "Mutineer's Charm",
    ItemGlobals.TONIC: 'Tonic',
    ItemGlobals.REMEDY: 'Remedy',
    ItemGlobals.HOLY_WATER: 'Holy Water',
    ItemGlobals.ELIXIR: 'Elixir',
    ItemGlobals.MIRACLE_WATER: 'Miracle Water',
    ItemGlobals.SHIP_REPAIR_KIT: 'Ship Repair Kit',
    ItemGlobals.ROAST_PORK: 'Roast Pork',
    ItemGlobals.POTION_CUTLASS_1: 'Swashbuckler Stew I',
    ItemGlobals.POTION_CUTLASS_2: 'Swashbuckler Stew II',
    ItemGlobals.POTION_CUTLASS_3: 'Swashbuckler Stew III',
    ItemGlobals.POTION_PISTOL_1: 'Marksman Draught I',
    ItemGlobals.POTION_PISTOL_2: 'Marksman Draught II',
    ItemGlobals.POTION_PISTOL_3: 'Marksman Draught III',
    ItemGlobals.POTION_CANNON_1: 'Cannoneer Draft I',
    ItemGlobals.POTION_CANNON_2: 'Cannoneer Draft II',
    ItemGlobals.POTION_CANNON_3: 'Cannoneer Draft III',
    ItemGlobals.POTION_DOLL_1: 'Mystic Mixture I',
    ItemGlobals.POTION_DOLL_2: 'Mystic Mixture II',
    ItemGlobals.POTION_DOLL_3: 'Mystic Mixture III',
    ItemGlobals.POTION_SPEED_1: 'Swift Foot I',
    ItemGlobals.POTION_SPEED_2: 'Swift Foot II',
    ItemGlobals.POTION_SPEED_3: 'Swift Foot III',
    ItemGlobals.POTION_REP_1: 'Hardy Matey I',
    ItemGlobals.POTION_REP_2: 'Hardy Matey II',
    ItemGlobals.POTION_REP_3: 'Reputation Booster',
    ItemGlobals.POTION_REP_COMP: "Jack's Brew",
    ItemGlobals.POTION_GOLD_1: 'Plunder Potion I',
    ItemGlobals.POTION_GOLD_2: 'Plunder Potion II',
    ItemGlobals.POTION_INVIS_1: 'Phantom Spirits I',
    ItemGlobals.POTION_INVIS_2: 'Phantom Spirits II',
    ItemGlobals.POTION_REGEN_1: 'Lively Bucko Brew I',
    ItemGlobals.POTION_REGEN_2: 'Lively Bucko Brew II',
    ItemGlobals.POTION_REGEN_3: 'Lively Bucko Brew III',
    ItemGlobals.POTION_REGEN_4: 'Lively Bucko Brew IIII',
    ItemGlobals.POTION_BURP: "Belchin' Brew",
    ItemGlobals.POTION_FART: 'Flatulent Fizz',
    ItemGlobals.POTION_FART_2: 'Super Flatulent Fizz',
    ItemGlobals.POTION_VOMIT: 'Puke Potion',
    ItemGlobals.POTION_HEADGROW: 'Ginko Glug',
    ItemGlobals.POTION_FACECOLOR: 'Ghastly Visage',
    ItemGlobals.POTION_SHRINK: "Shrinkin' Grog",
    ItemGlobals.POTION_GROW: "Growin' Grog",
    ItemGlobals.POTION_HEADONFIRE: 'Addled Elixir',
    ItemGlobals.POTION_SCORPION: 'Stinger Stew',
    ItemGlobals.POTION_ALLIGATOR: 'Gator Grog',
    ItemGlobals.POTION_CRAB: 'Pincer Potion',
    ItemGlobals.POTION_ACC_1: 'Deadeye I',
    ItemGlobals.POTION_ACC_2: 'Deadeye II',
    ItemGlobals.POTION_ACC_3: 'Deadeye III',
    ItemGlobals.POTION_GROG: "Clap o'Thunder",
    ItemGlobals.STAFF_ENCHANT_1: 'Staff Enchant I',
    ItemGlobals.STAFF_ENCHANT_2: 'Staff Enchant II',
    ItemGlobals.POTION_SUMMON_CHICKEN: 'Summon Chicken',
    ItemGlobals.HIGH_WING_HAT: 'High Wing Hat',
    ItemGlobals.ROUGH_TRICORNE: 'Rough Tricorne',
    ItemGlobals.ORANGE_TRICORNE: 'Orange Tricorne',
    ItemGlobals.SKULL_TRICORNE: 'Skull Tricorne',
    ItemGlobals.NAVY_TRIM_TRICORNE: 'Navy Trim Tricorne',
    ItemGlobals.EITC_HAT: 'EITC Hat',
    ItemGlobals.ADMIRAL_HAT: 'Admiral Hat',
    ItemGlobals.PATCHED_BANDANA: 'Patched Bandana',
    ItemGlobals.ZIGZAG_BANDANA: 'Zigzag Bandana',
    ItemGlobals.PATCHED_BAND: 'Patched Band',
    ItemGlobals.ZIGZAG_BAND: 'Zigzag Band',
    ItemGlobals.CAP: 'Cap',
    ItemGlobals.CROSSBONES_CAP: 'Crossbones Cap',
    ItemGlobals.CROSSBONE_BEANIE: 'Crossbone Beanie',
    ItemGlobals.DARK_OSTRICH_HAT: 'Dark Ostrich Hat',
    ...
    ItemGlobals.TRAVELERS_OSTRICH_HAT: 'Travelers Ostrich Hat',
    ItemGlobals.GREEN_SILK_BEANIE: 'Green Silk Beanie',
    ItemGlobals.PURPLE_BANDANA: 'Purple Bandana',
    ItemGlobals.BOHEMIAN_BANDANA: 'Bohemian Bandana',
    ItemGlobals.PURPLE_BAND: 'Purple Band',
    ItemGlobals.BOHEMIAN_BAND: 'Bohemian Band',
    ItemGlobals.BROWN_CAVALRY_HAT: 'Brown Cavalry Hat',
    ItemGlobals.BLUE_CAVALRY_HAT: 'Blue Cavalry Hat',
    ItemGlobals.GREEN_CAVALRY_HAT: 'Green Cavalry Hat',
    ItemGlobals.PURPLE_CAVALRY_HAT: 'Purple Cavalry Hat',
    ItemGlobals.BUTTERFLY_CAVALRY_HAT: 'Butterfly Cavalry Hat',
    ItemGlobals.ADVENTURE_CAVALRY_HAT: 'Adventure Cavalry Hat',
    ItemGlobals.TRAVELERS_CAVALRY_HAT: 'Travelers Cavalry Hat',
    ItemGlobals.DINGHY_HAT: 'Dinghy Hat',
    ItemGlobals.SIMPLE_BONNET: 'Simple Bonnet',
    ItemGlobals.RED_SILK_BANDANA: 'Red Silk Bandana',
    ItemGlobals.REDCOAT_HAT: 'Redcoat Hat',
    ItemGlobals.BANDANA: 'Bandana',
    ItemGlobals.BLUE_BANDANA: 'Blue Bandana',
    ItemGlobals.CROSSBONES_BANDANA: 'Crossbones Bandana',
    ItemGlobals.RECRUIT_BANDANA: 'Recruit Bandana',
    ItemGlobals.LOYALTY_BANDANA: 'Loyalty Bandana',
    ItemGlobals.HEAD_BAND: 'Head Band',
    ItemGlobals.BLUE_BAND: 'Blue Band',
    ItemGlobals.CROSSBONES_BAND: 'Crossbones Band',
    ItemGlobals.FRENCH_TRICORNE: 'French Tricorne',
    ItemGlobals.SPANISH_OSTRICH_HAT: 'Spanish Ostrich Hat',
    ItemGlobals.BLUE_FRENCH_HAT: 'Blue French Hat',
    ItemGlobals.GREEN_FRENCH_HAT: 'Green French Hat',
    ItemGlobals.VIOLET_FRENCH_HAT: 'Violet French Hat',
    ItemGlobals.BLACK_BICORNE: 'Black Bicorne',
    ItemGlobals.BROWN_BICORNE: 'Brown Bicorne',
    ItemGlobals.BLACK_CHAPEAU: 'Black Chapeau',
    ItemGlobals.NAVY_CHAPEAU: 'Navy Chapeau',
    ItemGlobals.BLACK_GAUCHO: 'Black Gaucho',
    ItemGlobals.BROWN_GAUCHO: 'Brown Gaucho',
    ItemGlobals.RED_GAUCHO: 'Red Gaucho',
    ItemGlobals.BRONZE_CABASET: 'Bronze Cabaset',
    ItemGlobals.STEEL_CABASET: 'Steel Cabaset',
    ItemGlobals.EMBOSSED_CABASET: 'Embossed Cabaset',
    ItemGlobals.RUSTED_CABASET: 'Rusted Cabaset',
    ItemGlobals.BLACK_CAVALIER: 'Black Cavalier',
    ItemGlobals.LEATHER_CAVALIER: 'Leather Cavalier',
    ItemGlobals.BURGUNDY_CAVALIER: 'Burgundy Cavalier',
    ItemGlobals.GRAY_CAVALIER: 'Gray Cavalier',
    ItemGlobals.BLACK_EXPLORER_HAT: 'Black Explorer Hat',
    ItemGlobals.LEATHER_EXPLORER_HAT: 'Leather Explorer Hat',
    ItemGlobals.STRAW_EXPLORER_HAT: 'Straw Explorer Hat',
    ItemGlobals.BLACK_PARADE_HAT: 'Black Parade Hat',
    ItemGlobals.RED_PARADE_HAT: 'Red Parade Hat',
    ItemGlobals.STEEL_CONQUISTADOR: 'Steel Conquistador',
    ItemGlobals.GOLD_CONQUISTADOR: 'Gold Conquistador',
    ItemGlobals.BLUE_STOCKING_CAP: 'Blue Stocking Cap',
    ItemGlobals.GREEN_STOCKING_CAP: 'Green Stocking Cap',
    ItemGlobals.GOLD_STOCKING_CAP: 'Gold Stocking Cap',
    ItemGlobals.RED_STOCKING_CAP: 'Red Stocking Cap',
    ItemGlobals.POLAR_STOCKING_CAP: 'Polar Stocking Cap',
    ItemGlobals.XMAS_CAP: 'Winter Festival Cap',
    ItemGlobals.MARDI_GRAS_TRICORNE: 'Mardi Gras Hat',
    ItemGlobals.SAINT_PATRICKS_STOVE_HAT: "St. Patrick's Hat",
    ItemGlobals.VALENTINES_TRICORNE: "Valentine's Hat",
    ItemGlobals.VIOLET_STOCKING_CAP: 'Violet Stocking Cap',
    ItemGlobals.COTTON_STOCKING_CAP: 'Cotton Stocking Cap',
    ItemGlobals.YELLOW_STOCKING_CAP: 'Yellow Stocking Cap',
    ItemGlobals.BLUE_RED_PARTY_HAT: 'Blue Red Party Hat',
    ItemGlobals.GREEN_ORANGE_PARTY_HAT: 'Green Orange Party Hat',
    ItemGlobals.PINK_PARTY_HAT: 'Pink Party Hat',
    ItemGlobals.ORANGE_GREEN_PARTY_HAT: 'Orange Green Party Hat',
    ItemGlobals.SKY_BLUE_PARTY_HAT: 'Sky Blue Party Hat',
    ItemGlobals.PURPLE_YELLOW_PARTY_HAT: 'Purple Yellow Party Hat',
    ItemGlobals.BLACK_STOVE_HAT: 'Black Stove Hat',
    ItemGlobals.BLUE_STOVE_HAT: 'Blue Stove Hat',
    ItemGlobals.BROWN_STOVE_HAT: 'Brown Stove Hat',
    ItemGlobals.GREEN_STOVE_HAT: 'Green Stove Hat',
    ItemGlobals.BLACK_BUCCANEER_HAT: 'Black Buccaneer Hat',
    ItemGlobals.GREEN_BUCCANEER_HAT: 'Green Buccaneer Hat',
    ItemGlobals.FANCY_BUCCANEER_HAT: 'Fancy Buccaneer Hat',
    ItemGlobals.CRIMSON_BUCCANEER_HAT: 'Scoundrel Hat',
    ItemGlobals.MOTTLED_BUCCANEER_HAT: 'Mottled Buccanner Hat',
    ItemGlobals.ROSE_BUCCANEER_HAT: 'Rose Buccaneer Hat',
    ItemGlobals.ROSE_BUCCANEER_HAT: 'Rose Buccaneer Hat',
    ItemGlobals.DINGY_LONG_COAT: 'Dingy Long Coat',
    ItemGlobals.EMBROIDERED_LONG_COAT: 'Embroidered Long Coat',
    ItemGlobals.TOURIST_LONG_COAT: 'Tourist Long Coat',
    ItemGlobals.TRADER_LONG_COAT: 'Trader Long Coat',
    ItemGlobals.FOREST_LONG_COAT: 'Forest Long Coat',
    ItemGlobals.WOOLEN_LONG_COAT: 'Woolen Long Coat',
    ItemGlobals.LEATHERCRAFT_LONG_COAT: 'Leathercraft Long Coat',
    ItemGlobals.DARKHEART_LONG_COAT: 'Darkheart Long Coat',
    ItemGlobals.WEATHERED_LONG_COAT: 'Weathered Long Coat',
    ItemGlobals.MERCHANT_LONG_COAT: 'Merchant Long Coat',
    ItemGlobals.FLEET_LONG_COAT: 'Fleet Long Coat',
    ItemGlobals.KEELHAUL_LONG_COAT: 'Keelhaul Long Coat',
    ItemGlobals.LUCKY_LONG_COAT: 'Lucky Long Coat',
    ItemGlobals.CLUB_COAT: 'Club Coat',
    ItemGlobals.ADVENTURE_LONG_COAT: 'Adventure Long Coat',
    ItemGlobals.SWABBIE_JACKET: "Swabby's Jacket",
    ItemGlobals.MONEY_JACKET: 'Money Jacket',
    ItemGlobals.COTTON_JACKET: 'Cotton Jacket',
    ItemGlobals.EVENING_JACKET: 'Evening Jacket',
    ItemGlobals.SHIPWRIGHT_JACKET: 'Shipwright Jacket',
    ItemGlobals.BOUNCER_JACKET: "Bouncer's Jacket",
    ItemGlobals.WHALING_JACKET: 'Whaling Jacket',
    ItemGlobals.MATEY_JACKET: "Matey's Jacket",
    ItemGlobals.ROYAL_LONG_COAT: 'Royal Long Coat',
    ItemGlobals.BLACK_GOLD_LONG_COAT: 'Black Gold Long Coat',
    ItemGlobals.PATCHWORK_RIDING_COAT: 'Patchwork Riding Coat',
    ItemGlobals.LEATHER_RIDING_COAT: 'Leather Riding Coat',
    ItemGlobals.HIGHWAY_COAT: 'Highway Coat',
    ItemGlobals.MILITIA_RIDING_COAT: 'Militia Riding Coat',
    ItemGlobals.GOLD_THREAD_RIDING_COAT: 'Gold Thread Riding Coat',
    ItemGlobals.IMPROVISED_RIDING_COAT: 'Improvised Riding Coat',
    ItemGlobals.VALHALLA_RIDING_COAT: 'Valhalla Riding Coat',
    ItemGlobals.VICTORIAN_RIDING_COAT: 'Victorian Riding Coat',
    ItemGlobals.ROYALIST_RIDING_COAT: 'Royalist Riding Coat',
    ItemGlobals.ADVENTURE_RIDING_COAT: 'Adventure Riding Coat',
    ItemGlobals.CROCODILE_FROCK_COAT: 'Crocodile Frock Coat',
    ItemGlobals.WOOLEN_FROCK_COAT: 'Woolen Frock Coat',
    ItemGlobals.LEATHER_FROCK_COAT: 'Leather Frock Coat',
    ItemGlobals.SUEDE_FROCK_COAT: 'Suede Frock Coat',
    ItemGlobals.HARBOR_FROCK_COAT: 'Harbor Frock Coat',
    ItemGlobals.TOURIST_FROCK_COAT: 'Tourist Frock Coat',
    ItemGlobals.BORROWED_FROCK_COAT: '"Borrowed" Frock Coat',
    ItemGlobals.TAILORED_FROCK_COAT: 'Tailored Frock Coat',
    ItemGlobals.GOLD_FAD_FROCK_COAT: 'Gold Fad Frock Coat',
    ItemGlobals.ROYAL_RIDING_COAT_TRIM: 'Royal Riding Coat with Trim',
    ItemGlobals.ADVENTURE_RIDING_COAT_TRIM: 'Adventure Riding Coat with Trim',
    ItemGlobals.VICTORIAN_RIDING_COAT_GOLD: 'Victorian Riding Coat with Gold',
    ItemGlobals.NAVY_RED_COAT: 'Navy Red Coat',
    ItemGlobals.EITC_BLACK_COAT: 'EITC Black Coat',
    ItemGlobals.LEATHER_VEST: 'Leather Vest',
    ItemGlobals.PATCHWORK_VEST: 'Patchwork Vest',
    ItemGlobals.BELTED_VEST: 'Belted Vest',
    ItemGlobals.DRESSY_VEST: 'Dressy Vest',
    ItemGlobals.SUIT_VEST: 'Suit Vest',
    ItemGlobals.UNIFORM_VEST: 'Uniform Vest',
    ItemGlobals.MERCHANT_VEST: 'Merchant Vest',
    ItemGlobals.SCARF_VEST: 'Scarf Vest',
    ItemGlobals.PERFORMER_VEST: "Performer's Vest",
    ItemGlobals.HUNTING_VEST: 'Hunting Vest',
    ItemGlobals.SILK_VEST: 'Silk Vest',
    ItemGlobals.WOODLAND_VEST: 'Woodland Vest',
    ItemGlobals.CARPENTER_VEST: 'Carpenter Vest',
    ItemGlobals.NIGHT_VEST: 'Night Vest',
    ItemGlobals.OPEN_ADVENTURE_VEST: 'Open Adventure Vest',
    ItemGlobals.EMBELLISHED_VEST: 'Embellished Vest',
    ItemGlobals.SHOP_VEST: 'Shop Vest',
    ItemGlobals.LONGSHOREMAN_VEST: "Longshoreman's Vest",
    ItemGlobals.SACK_VEST: 'Sack Vest',
    ItemGlobals.BANK_VEST: 'Bank Vest',
    ItemGlobals.TRAVELERS_VEST: "Traveler's Vest",
    ItemGlobals.EMBELLISHED_BLACK_GOLD_VEST: 'Embellished Black Gold Vest',
    ItemGlobals.BUTTONED_VEST: 'Buttoned Vest',
    ItemGlobals.COTTON_VEST: 'Cotton Vest',
    ItemGlobals.DECK_VEST: 'Deck Vest',
    ItemGlobals.LACED_VEST: 'Laced Vest',
    ItemGlobals.YEOMAN_VEST: 'Yeoman Vest',
    ItemGlobals.CORSETED_VEST: 'Corseted Vest',
    ItemGlobals.FOREST_VEST: 'Forest Vest',
    ItemGlobals.COUNTESS_VEST: 'Countess Vest',
    ItemGlobals.CITY_VEST: 'City Vest',
    ItemGlobals.COUNTRY_VEST: 'Country Vest',
    ItemGlobals.ADVENTURE_VEST: 'Adventure Vest',
    ItemGlobals.LOOSE_BUTTONED_VEST: 'Loose Buttoned Vest',
    ItemGlobals.LOOSE_LEATHER_VEST: 'Loose Leather Vest',
    ItemGlobals.ORCHARD_VEST: 'Orchard Vest',
    ItemGlobals.MESSENGER_VEST: 'Messenger Vest',
    ItemGlobals.COURT_VEST: 'Court Vest',
    ItemGlobals.BAND_VEST: 'Band Vest',
    ItemGlobals.CLOVER_VEST: 'Clover Vest',
    ItemGlobals.GARDEN_VEST: 'Garden Vest',
    ItemGlobals.PETAL_VEST: 'Petal Vest',
    ItemGlobals.DARKNESS_VEST: 'Darkness Vest',
    ItemGlobals.TRAVELERS_LOOSE_VEST: 'Travelers Loose Vest',
    ItemGlobals.ROYAL_CHEST_CORSET: 'Royal Chest Corset',
    ItemGlobals.ROSE_PETAL_CORSET: 'Rose Petal Corset',
    ItemGlobals.OLD_GROVE_CORSET: 'Old Grove Corset',
    ItemGlobals.GAS_LAMP_CORSET: 'Gas Lamp Corset',
    ItemGlobals.HIGH_TIDE_CORSET: 'High Tide Corset',
    ItemGlobals.MORNING_DEW_CORSET: 'Morning Dew Corset',
    ItemGlobals.RAWHIDE_CORSET: 'Rawhide Corset',
    ItemGlobals.EMBROIDERED_CORSET: 'Embroidered Corset',
    ItemGlobals.COTTON_CORSET: 'Cotton Corset',
    ItemGlobals.CHRISTENING_CORSET: 'Christening Corset',
    ItemGlobals.SEAFOAM_CORSET: 'Seafoam Corset',
    ItemGlobals.FAIRDAY_CORSET: 'Fairday Corset',
    ItemGlobals.BROWN_PILLOW_VEST: 'Brown Pillow Loose Vest',
    ItemGlobals.RED_BROWN_VEST: 'Red Brown Loose Vest',
    ItemGlobals.DARK_BLUE_GOLD_VEST: 'Dark Blue Gold Loose Vest',
    ItemGlobals.OLD_TANK: 'Old Tank',
    ItemGlobals.STRIPED_TANK: 'Striped Tank',
    ItemGlobals.COTTON_TANK: 'Cotton Tank',
    ItemGlobals.TRIMMED_TANK: 'Trimmed Tank',
    ItemGlobals.SUSPENDER_TANK: 'Suspender Tank',
    ItemGlobals.CREW_TANK: 'Crew Tank',
    ItemGlobals.HOOKED_TANK: 'Hooked Tank',
    ItemGlobals.REINFORCED_TANK: 'Reinforced Tank',
    ItemGlobals.SEAMED_TANK: 'Seamed Tank',
    ItemGlobals.MARINER_TANK: 'Mariner Tank',
    ItemGlobals.IMPROVISED_TANK: 'Improvised Tank',
    ItemGlobals.MANLY_TANK: 'Manly Tank',
    ItemGlobals.INDENTURED_TANK: 'Indentured Tank',
    ItemGlobals.STITCHED_TANK: 'Stitched Tank',
    ItemGlobals.FRILLY_TANK: 'Frilly Tank',
    ItemGlobals.SHIELD_TANK: 'Shield Tank',
    ItemGlobals.CRESTED_TANK: 'Crested Tank',
    ItemGlobals.ADVANCED_TANK: 'Adventure Tank',
    ItemGlobals.LAYERD_SHIRTS: 'Layered Shirts',
    ItemGlobals.PUB_SHIRT: 'Pub Shirt',
    ItemGlobals.SWABBIE_SHIRT: 'Swabbie Shirt',
    ItemGlobals.PANELED_SHIRT: 'Paneled Shirt',
    ItemGlobals.GOVERNORS_EX_SHIRT: "Governor's Ex-Shirt",
    ItemGlobals.BIG_BUTTON_SHIRT: 'Big Button Shirt',
    ItemGlobals.MAYORS_SHIRT: "Mayor's Shirt",
    ItemGlobals.TRIMMED_JERKIN: 'Trimmed Jerkin',
    ItemGlobals.GREEN_GOLD_WHITE_COLLAR: 'Green Gold Shirt White Collar',
    ItemGlobals.TREASURE_SHORT_SLEEVE: 'Treasure Short Sleeve',
    ItemGlobals.COTTON_SHORT_SLEEVE: 'Cotton Short Sleeve',
    ItemGlobals.LINEN_SHORT_SLEEVE: 'Linen Short Sleeve',
    ItemGlobals.LACED_SHORT_SLEEVE: 'Laced Short Sleeve',
    ...
    ItemGlobals.OPEN_COTTON_SHIRT: 'Open Cotton Shirt',
    ItemGlobals.OPEN_LINEN_SHIRT: 'Open Linen Shirt',
    ItemGlobals.OPEN_LACED_SHIRT: 'Open Laced Shirt',
    ItemGlobals.OPEN_FLEET_SHIRT: 'Open Fleet Shirt',
    ItemGlobals.LACED_PUFFY_SHIRT: 'Laced Puffy Shirt',
    ItemGlobals.REINFORCED_PUFFY_SHIRT: 'Reinforced Puffy Shirt',
    ItemGlobals.COTTON_PUFFY_SHIRT: 'Cotton Puffy Shirt',
    ItemGlobals.LINEN_PUFFY_SHIRT: 'Linen Puffy Shirt',
    ItemGlobals.RENAISSANCE_SHIRT: 'Renaissance Shirt',
    ItemGlobals.PADDED_SHIRT: 'Padded Shirt',
    ItemGlobals.LEATHER_PUFFY_SHIRT: 'Leather Puffy Shirt',
    ItemGlobals.MERCHANT_SHIRT: 'Merchant Shirt',
    ItemGlobals.TRAVELERS_PUFFY_SHIRT: "Traveler's Shirt",
    ItemGlobals.LONG_TREASURE_SHIRT: 'Long Treasure Shirt',
    ItemGlobals.COTTON_LONG_SLEEVE: 'Cotton Long Sleeve',
    ItemGlobals.LINEN_LONG_SLEEVE: 'Linen Long Sleeve',
    ItemGlobals.LACED_LONG_SLEEVE: 'Laced Long Sleeve',
    ItemGlobals.TIED_LONG_SLEEVE: 'Tied Long Sleeve',
    ItemGlobals.FLAP_LONG_SLEEVE: 'Flap Long Sleeve',
    ItemGlobals.FLEET_LONG_SLEEVE: 'Fleet Long Sleeve',
    ItemGlobals.RECRUIT_LONG_SLEEVE: 'Recruit Long Sleeve',
    ItemGlobals.OPEN_TREASURE_LONG_SLEEVE: 'Open Treasure Long Sleeve',
    ItemGlobals.COTTON_OPEN_LONG_SLEEVE: 'Cotton Open Long Sleeve',
    ItemGlobals.LINEN_OPEN_LONG_SLEEVE: 'Linen Open Long Sleeve',
    ItemGlobals.DEALER_SHIRT: 'Dealer Shirt',
    ItemGlobals.CINCO_DE_MAYO_SHIRT: 'Cinco De Mayo Shirt',
    ItemGlobals.HALLOWEEN_SHIRT: 'Halloween Shirt',
    ItemGlobals.THANKSGIVING_SHIRT: 'Thanksgiving Shirt',
    ItemGlobals.GUY_FAWKES_SHIRT: 'Guy Fawkes Shirt',
    ItemGlobals.VALENTINES_SHIRT: "Valentine's Shirt",
    ItemGlobals.WINTER_HOLIDAY_SHIRT: 'Winter Holiday Shirt',
    ItemGlobals.CARIBBEAN_DAY_SHIRT: 'Caribbean Day Shirt',
    ItemGlobals.CARNIVAL_SHIRT: 'Carnival Shirt',
    ItemGlobals.CHINESE_NEWYEAR_SHIRT: 'Chinese NewYear Shirt',
    ItemGlobals.AUTUMN_SHIRT: 'Autumn Shirt',
    ItemGlobals.NEW_YEARS_EVE_SHIRT: 'Purple Emblem Shirt',
    ItemGlobals.SAINT_PATRICKS_SHIRT: "Saint Patrick's Shirt",
    ItemGlobals.SUMMER_SOLSTICE_SHIRT: 'Summer Solstice Shirt',
    ItemGlobals.WINTER_SOLSTICE_SHIRT: 'Winter Solstice Shirt',
    ItemGlobals.SPRING_SHIRT: 'Spring Shirt',
    ItemGlobals.GREEN_GOLD_WHITE_COLLAR: 'Green Gold White Collar',
    ItemGlobals.MERCHANT_SHIRT_GOLD_TRIM: 'Merchant Shirt Gold Trim',
    ItemGlobals.XMAS_SHIRT: 'Winter Festival Shirt',
    ItemGlobals.MARDI_GRAS_SHIRT: 'Mardi Gras Shirt',
    ItemGlobals.STITCHED_BLOUSE: 'Stitched Blouse',
    ItemGlobals.BURLAP_BLOUSE: 'Burlap Blouse',
    ItemGlobals.TRIMMED_BLOUSE: 'Trimmed Blouse',
    ItemGlobals.DINGY_BLOUSE: 'Dingy Blouse',
    ItemGlobals.COURT_BLOUSE: 'Court Blouse',
    ItemGlobals.TAVERN_BLOUSE: 'Tavern Blouse',
    ItemGlobals.EMBROIDERED_BLOUSE: 'Embroidered Blouse',
    ItemGlobals.DINGY_PUFF_BLOUSE: 'Dingy Puff Blouse',
    ItemGlobals.COTTON_PUFF_BLOUSE: 'Cotton Puff Blouse',
    ItemGlobals.FLAPPED_PUFF_BLOUSE: 'Flapped Puff Blouse',
    ItemGlobals.FRILLY_BLOUSE: ' Frilly Blouse',
    ItemGlobals.COLLAR_PUFF_BLOUSE: 'Collar Puff Blouse',
    ItemGlobals.SKY_BLOUSE: 'Sky Blouse',
    ItemGlobals.FESTIVAL_BLOUSE: ' Festival Blouse',
    ItemGlobals.DINGY_TOP: 'Dingy Top',
    ItemGlobals.SKULL_BROACH_TOP: 'Skull Broach Top',
    ItemGlobals.COTTON_TOP: 'Cotton Top',
    ItemGlobals.PANEL_TOP: 'Panel Top',
    ItemGlobals.CITY_TOP: 'City Top',
    ItemGlobals.WOODLAND_TOP: 'Woodland Top',
    ItemGlobals.VILLA_TOP: 'Villa Top',
    ItemGlobals.TAILORED_PUFFY_SHIRT: 'Tailored Puffy Shirt',
    ItemGlobals.SWASHBUCKLER_TOP: 'Swashbuckler Top',
    ItemGlobals.RUFFLE_SHIRT: 'Ruffle Shirt',
    ItemGlobals.FINE_PUFFY_SHIRT: 'Fine Puffy Shirt',
    ItemGlobals.MERCHANT_TOP: 'Merchant Top',
    ItemGlobals.FLORID_TOP: 'Florid Top',
    ItemGlobals.LACE_TRIM_TOP: 'Lace Trim Top',
    ItemGlobals.RECRUIT_TOP: 'Recruit Top',
    ItemGlobals.TRAVELERS_TOP: "Traveler's Top",
    ItemGlobals.ADVENTURE_TOP: 'Adventure Top',
    ItemGlobals.HIGH_SEAS_BLOUSE: 'High Seas Blouse',
    ItemGlobals.DARK_WATER_BLOUSE: 'Dark Water Blouse',
    ItemGlobals.BOARDING_BLOUSE: 'Boarding Blouse',
    ItemGlobals.DARK_CLOUD_BLOUSE: 'Dark Cloud Blouse',
    ItemGlobals.ROUGH_WATER_BLOUSE: 'Rough Water Blouse',
    ItemGlobals.OPERA_BLOUSE: 'Opera Blouse',
    ItemGlobals.MUSKETEER_BLOUSE: 'Musketeer Blouse',
    ItemGlobals.CARIBBEAN_DAY_BLOUSE: 'Caribbean Day Blouse',
    ItemGlobals.CINCO_DE_MAYO_BLOUSE: 'Cinco De Mayo Blouse',
    ItemGlobals.GUY_FAWKES_BLOUSE: 'Guy Fawkes Blouse',
    ItemGlobals.HALLOWEEN_BLOUSE: 'Halloween Blouse',
    ItemGlobals.SUMMER_SOLSTICE_BLOUSE: 'Summer Solstice Blouse',
    ItemGlobals.THANKSGIVING_BLOUSE: 'Thanksgiving Blouse',
    ItemGlobals.WINTER_HOLIDAY_BLOUSE: 'Winter Holiday Blouse',
    ItemGlobals.CARNIVAL_BLOUSE: 'Carnival Blouse',
    ItemGlobals.CHINESE_NEWYEAR_BLOUSE: 'Chinese New Year Blouse',
    ItemGlobals.VALENTINES_BLOUSE: "Valentine's Day Blouse",
    ItemGlobals.AUTUMN_BLOUSE: 'Autumn Blouse',
    ItemGlobals.SPRING_BLOUSE: 'Spring Blouse',
    ItemGlobals.NEW_YEARS_EVE_BLOUSE: 'Purple Emblem Blouse',
    ItemGlobals.SAINT_PATRICKS_BLOUSE: "Saint Patrick's Blouse",
    ItemGlobals.WINTER_SOLSTICE_BLOUSE: 'Winter Solstice Blouse',
    ItemGlobals.FLEUR_BLOUSE: 'Fleur Blouse',
    ItemGlobals.TEACHERS_BLOUSE: "Teacher's Blouse",
    ItemGlobals.RIDING_BLOUSE: 'Riding Blouse',
    ItemGlobals.COTTON_BLOUSE: 'Cotton Blouse',
    ItemGlobals.GARDEN_BLOUSE: 'Garden Blouse',
    ItemGlobals.DAY_DREAM_BLOUSE: 'Day Dream Blouse',
    ItemGlobals.MORNING_BLOUSE: 'Morning Blouse',
    ItemGlobals.FESTIVAL_BLOUSE_GOLD_TRIM: 'Festival Blouse Gold Trim',
    ItemGlobals.BLUE_WHITE_BLOUSE: 'Blue Blouse White Ruff',
    ItemGlobals.XMAS_BLOUSE: 'Winter Festival Blouse',
    ItemGlobals.MARDI_GRAS_BLOUSE: 'Mardi Gras Blouse',
    ItemGlobals.BROWN_APRON: 'Brown Apron',
    ItemGlobals.DIRTY_APRON: 'Dirty Apron',
    ItemGlobals.GYPSY_BLOUSE: 'Gypsy Blouse',
    ItemGlobals.BARTENDER_BLOUSE: 'Bartender Blouse',
    ItemGlobals.BARMAID_BLOUSE: 'Barmaid Blouse',
    ItemGlobals.SHOPKEEPER_BLOUSE: 'Shopkeeper Blouse',
    ItemGlobals.RECRUIT_SASH: 'Recruit Sash',
    ItemGlobals.BASIC_SASH: 'Basic Sash',
    ItemGlobals.BUCKLED_SASH: 'Buckled Sash',
    ItemGlobals.FIERCE_SASH: 'Fierce Sash',
    ItemGlobals.TRIMMED_SASH: 'Trimmed Sash',
    ItemGlobals.PINK_SASH: 'Pink Sash',
    ItemGlobals.BLOOD_SASH: 'Red Sash',
    ItemGlobals.GOLD_SKULL_BELT: 'Gold Skull Belt',
    ItemGlobals.JOLLY_BONES_BELT: 'Jolly Bones Belt',
    ItemGlobals.BOX_BELT: 'Box Belt',
    ItemGlobals.TOP_SKULL_BELT: 'Top Skull Belt',
    ItemGlobals.PROUD_BELT: 'Proud Belt',
    ItemGlobals.ROUND_BELT: 'Round Belt',
    ItemGlobals.KNOCKOFF_PROUD__BELT: 'Knockoff Proud Belt',
    ItemGlobals.TOP_SKULL_KNOCKOFF_BELT: 'Top Skull Knockoff Belt',
    ItemGlobals.ENGRAVED_BOX_BELT: 'Engraved Box Belt',
    ItemGlobals.INSPECTOR_BELT: "Inspector's Belt",
    ItemGlobals.SQUARE_ADVENTURE_BELT: 'Adventure Belt',
    ItemGlobals.SQUARE_TRAVELERS_BELT: "Traveler's Belt",
    ItemGlobals.BUCKLE_SASH: 'Buckle Sash',
    ItemGlobals.PATTERNED_SASH: 'Patterned Sash',
    ItemGlobals.TASSLES_SASH: 'Tassles Sash',
    ItemGlobals.GOLD_BUCKLE_SASH: 'Gold Buckle Sash',
    ItemGlobals.BLUE_SASH: 'Blue Sash',
    ItemGlobals.RED_FUR_SASH: 'Red Fur Sash',
    ItemGlobals.BRASS_SQUARE_BELT: 'Brass Square Belt',
    ItemGlobals.GOLD_SQUARE_BELT: 'Gold Square Belt',
    ItemGlobals.WOODLAND_BELT: 'Woodland Belt',
    ItemGlobals.GOLD_BOX_BELT: 'Gold Box Belt',
    ItemGlobals.LACED_BELT: 'Laced Belt',
    ItemGlobals.SIDE_BELT: 'Side Belt',
    ItemGlobals.ADVENTURE_BELT: 'Adventure Belt',
    ItemGlobals.TRAVELERS_BELT: 'Travelers Belt',
    ItemGlobals.MARDI_GRAS_SASH: 'Mardi Gras Sash',
    ItemGlobals.LEATHER_HIGHWATERS: 'Leather Highwaters',
    ItemGlobals.COTTON_HIGHWATERS: 'Cotton Highwaters',
    ItemGlobals.DENIM_HIGHWATERS: 'Denim Highwaters',
    ItemGlobals.LINEN_HIGHWATERS: 'Linen Highwaters',
    ItemGlobals.CIRCUS_BREECHES: 'Circus Breeches',
    ItemGlobals.BUTTONED_BREECHES: 'Buttoned Breeches',
    ItemGlobals.GOLD_TRIM_BREECHES: 'Gold Trim Breeches',
    ItemGlobals.BARD_BREECHES: 'Bard Breeches',
    ItemGlobals.F44_DUBLOON_BREECHES: '44 Dubloon Breeches',
    ItemGlobals.DEPUTYS_EX_BREECHES: "Deputy's Ex-Breeches",
    ItemGlobals.FESTIVAL_BREECHES: 'Festival Breeches',
    ItemGlobals.MATADOR_BREECHES: 'Matador Breeches',
    ItemGlobals.ADVENTURE_BREECHES: 'Adventure Breeches',
    ItemGlobals.COTTON_TROUSERS: 'Cotton Trousers',
    ItemGlobals.CELTIC_TROUSERS: 'Celtic Trousers',
    ItemGlobals.SAIL_TROUSERS: 'Sail Trousers',
    ItemGlobals.LINEN_TROUSERS: 'Linen Trousers',
    ItemGlobals.POTATO_SACK_TROUSERS: 'Potato Sack Trousers',
    ItemGlobals.KAKI_SKULL_SNAP_TROUSERS: 'Kaki Skullsnap Trousers',
    ItemGlobals.DENIM_SKULL_SNAP_TROUSERS: 'Denim Skullsnap Trousers',
    ItemGlobals.FADED_SKULL_SNAP_TROUSERS: 'Faded Skullsnap Trousers',
    ItemGlobals.STOWAWAY_TROUSERS: 'Stowaway Trousers',
    ItemGlobals.DENIM_TROUSERS: 'Denim Trousers',
    ItemGlobals.SWAB_THE_DECK_TROUSERS: 'Swab the Deck Trousers',
    ItemGlobals.ZOMBIE_TROUSERS: 'Zombie Trousers',
    ItemGlobals.ARABIAN_TROUSERS: 'Arabian Trousers',
    ItemGlobals.SMITHY_TROUSERS: 'Smithy Trousers',
    ItemGlobals.RECRUIT_TROUSERS: 'Recruit Trousers',
    ItemGlobals.TRAVELERS_TROUSERS: 'Travelers Trousers',
    ItemGlobals.DINGY_SHORTS: 'Dingy Shorts',
    ItemGlobals.BEACH_SHORTS: 'Beach Shorts',
    ItemGlobals.COTTON_SHORTS: 'Cotton Shorts',
    ItemGlobals.BUCKLED_SHORTS: 'Buckled Shorts',
    ItemGlobals.SACK_SHORTS: 'Sack Shorts',
    ItemGlobals.SWIM_SHORTS: 'Swim Shorts',
    ItemGlobals.EXPLORER_SHORTS: 'Explorer Shorts',
    ItemGlobals.CANVAS_SHORTS: 'Canvas Shorts',
    ItemGlobals.BEACH_COMBER_SHORTS: 'Beach Comber Shorts',
    ItemGlobals.OCEAN_SHORTS: 'Ocean Shorts',
    ItemGlobals.BAG_SHORTS: 'Bag Shorts',
    ItemGlobals.BOXERS: 'Boxers',
    ItemGlobals.SWAMP_SHORTS: 'Swamp Shorts',
    ItemGlobals.BUTTONED_SHORTS: 'Buttoned Shorts',
    ItemGlobals.VIOLET_YELLOW_BREECHES: 'Violet Yellow Breeches',
    ItemGlobals.GREY_GREEN_BREECHES: 'Side Stripe Breeches',
    ItemGlobals.GREEN_EMBROIDERED_TROUSERS: 'Green Embroidered Trousers',
    ItemGlobals.CHAPS_TROUSERS: 'Loose Chaps',
    ItemGlobals.BROWN_PATCHED_TROUSERS: 'Patched Trousers',
    ItemGlobals.GREEN_SILK_TROUSERS: 'Green Silk Trousers',
    ItemGlobals.BLACK_GOLD_TROUSERS: 'Black Gold Trousers',
    ItemGlobals.FANCY_LIGHT_BROWN_SHORTS: 'Fancy Light Brown Shorts',
    ItemGlobals.XMAS_TROUSERS: 'Winter Festival Trousers',
    ItemGlobals.MARDI_GRAS_TROUSERS: 'Mardi Gras Trousers',
    ItemGlobals.SAINT_PATRICKS_BREECHES: "St. Patrick's Breeches",
    ItemGlobals.VALENTINES_BREECHES: "Valentine's Breeches",
    ItemGlobals.PATCHWORK_CAPRIS: 'Patchwork Capris',
    ItemGlobals.TAILORED_CAPRIS: 'Tailored Capris',
    ItemGlobals.MISFITTED_CAPRIS: 'Misfitted Capris',
    ItemGlobals.SIDE_STRIPE_CAPRIS: 'Sidestripe Capris',
    ItemGlobals.IMPROVISED_CAPRIS: 'Improvised Capris',
    ItemGlobals.CANDYSTRIPE_CAPRIS: 'Candystripe Capris',
    ItemGlobals.PARADE_CAPRIS: 'Parade Capris',
    ItemGlobals.RUNNERS_CAPRIS: "Runner's Capris",
    ItemGlobals.RED_VELVET_CAPRIS: 'Red Velvet Capris',
    ItemGlobals.CASUAL_CAPRIS: 'Casual Capris',
    ItemGlobals.PATTYS_CAPRIS: "Patty's Capris",
    ItemGlobals.COURT_CAPRIS: 'Court Capris',
    ItemGlobals.PIN_CAPRIS: 'Pin Capris',
    ItemGlobals.RECRUIT_CAPRIS: 'Recruit Capris',
    ItemGlobals.ADVENTURE_CAPRIS: 'Adventure Capris',
    ItemGlobals.TRAVELERS_CAPRIS: "Traveler's Capris",
    ItemGlobals.PATCHWORK_SHORTS: 'Patchwork Shorts',
    ItemGlobals.TIE_SHORTS: 'Tie Shorts',
    ItemGlobals.LINEN_SHORTS: 'Linen Shorts',
    ItemGlobals.FOREST_SHORTS: 'Forest Shorts',
    ItemGlobals.SIDELACE_SHORTS: 'Sidelace Shorts',
    ItemGlobals.ZOMBIE_SHORTS: 'Zombie Shorts',
    ItemGlobals.JUNGLE_SHORTS: 'Jungle Shorts',
    ItemGlobals.LAGOON_SHORTS: 'Lagoon Shorts',
    ItemGlobals.CASUAL_SHORTS: 'Casual Shorts',
    ItemGlobals.OLD_ROYAL_SHORTS: 'Old Royal Shorts',
    ItemGlobals.EMPRESS_SHORTS: 'Empress Shorts',
    ItemGlobals.MIDNIGHT_SHORTS: 'Midnight Shorts',
    ItemGlobals.CHERRY_SHORTS: 'Cherry Shorts',
    ItemGlobals.LINEN_SKIRT: 'Linen Skirt',
    ItemGlobals.HAND_ME_DOWN_SKIRT: 'Hand me down Skirt',
    ItemGlobals.LAYERED_SKIRT: 'Layerd Skirt',
    ItemGlobals.POTATO_SACK_SKIRT: 'Potato Sack Skirt',
    ItemGlobals.SILK_SKIRT: 'Silk Skirt',
    ItemGlobals.DENIM_SKIRT: 'Denim Skirt',
    ItemGlobals.WOODLAND_SKIRT: 'Woodland Skirt',
    ItemGlobals.CANDYBOX_SKIRT: 'Candybox Skirt',
    ItemGlobals.OBLIQUE_SKIRT: 'Oblique Skirt',
    ItemGlobals.PEA_SOUP_SKIRT: 'Pea Soup Skirt',
    ItemGlobals.TROPIC_SKIRT: 'Tropic Skirt',
    ItemGlobals.PRINCESS_SKIRT: 'Princess Skirt',
    ItemGlobals.DECK_SKIRT: 'Deck Skirt',
    ItemGlobals.JEWELED_SKIRT: 'Jeweled Skirt',
    ItemGlobals.BROWN_SILVER_SHORTS: 'Brown Silver Shorts',
    ItemGlobals.GREEN_PURPLE_SHORTS: 'Green Purple Shorts',
    ItemGlobals.GREEN_EMBROIDERY_SHORTS: 'Green Embroidery Shorts',
    ItemGlobals.PINK_GOLD_TRIM_SHORTS: 'Gold Trim Shorts',
    ItemGlobals.BROWN_SILVER_BUTTON_SHORTS: 'Brown Silver Button Shorts',
    ItemGlobals.RED_SILK_SHORTS: 'Red Silk Shorts',
    ItemGlobals.GOLD_TRIM_CAPRIS: 'Gold Trim Capris',
    ItemGlobals.GREEN_PURPLE_SKIRT: 'Green Purple Skirt',
    ItemGlobals.GREEN_EMBROIDERY_SKIRT: 'Green Embroidery Skirt',
    ItemGlobals.XMAS_SKIRT: 'Winter Festival Skirt',
    ItemGlobals.MARDI_GRAS_SHORTS: 'Mardi Gras Shorts',
    ItemGlobals.SAINT_PATRICKS_SKIRT: "St. Patrick's Skirt",
    ItemGlobals.VALENTINES_SKIRT: "Valentine's Skirt",
    ItemGlobals.TAVERN_APRON: 'Tavern Apron',
    ItemGlobals.DARK_APRON: 'Dark Apron',
    ItemGlobals.NAVY_PANTS: 'Navy Pants',
    ItemGlobals.EITC_PANTS: 'EITC Pants',
    ItemGlobals.GYPSY_SKIRT: 'Gypsy Skirt',
    ItemGlobals.GYPSY_GRUNGE_SKIRT: 'Gypsy Grunge Skirt',
    ItemGlobals.BARTENDER_SKIRT: 'Bartender Skirt',
    ItemGlobals.SHOPKEEPER_SKIRT: 'Shopkeeper Skirt',
    ItemGlobals.COMFY_BOOTS: 'Comfy Boots',
    ItemGlobals.WALLOP_BOOTS: 'Wallop Boots',
    ItemGlobals.WORN_IN_BOOTS: 'Worn in Boots',
    ItemGlobals.HARD_LEATHER_BOOTS: 'Hard Leather',
    ItemGlobals.PURSUIT_BOOTS: 'Pursuit Boots',
    ItemGlobals.INDOOR_BOOTS: 'Indoor Boots',
    ItemGlobals.MOUNTAIN_BOOTS: 'Mountain Boots',
    ItemGlobals.SERIOUS_BOOTS: 'Serious Boots',
    ItemGlobals.ADVENTURE_BOOTS: 'Adventure Boots',
    ItemGlobals.TRAVELERS_BOOTS: 'Travelers Boots',
    ItemGlobals.BUCKET_BOOTS: 'Bucket Boots',
    ItemGlobals.BUCKLE_BOOTS: 'Buckle Boots',
    ItemGlobals.FISHING_TROPHY_BOOTS: 'Fishing Trophy Boots',
    ItemGlobals.OLD_BOOTS: 'Old Boots',
    ItemGlobals.SPIFFY_BOOTS: 'Spiffy Boots',
    ItemGlobals.HIKING_BOOTS: 'Hiking Boots',
    ItemGlobals.RAWHIDE_BOOTS: 'Rawhide Boots',
    ItemGlobals.RECRUIT_BOOTS: 'Recruit Boots',
    ItemGlobals.ROYAL_BOOTS: 'Royal Boots',
    ItemGlobals.EMERALD_BOOTS: 'Emerald Boots',
    ItemGlobals.BLUE_FUR_TOP_BOOTS: 'Blue Fur Top Boots',
    ItemGlobals.SPUR_BOOTS: 'Spur Boots',
    ItemGlobals.ROUND_BUCKLE_SHORT_BOOTS: 'Round Buckle Short Boots',
    ItemGlobals.XMAS_MED_BOOTS: 'Winter Festival Boots',
    ItemGlobals.MARDI_GRAS_MED_BOOTS: 'Mardi Gras Boots',
    ItemGlobals.SAINT_PATRICKS_TALL_BOOTS: "St. Patrick's Boots",
    ItemGlobals.VALENTINES_TALL_BOOTS: "Valentine's Boots",
    ItemGlobals.DECK_SLAPPER_BOOTS: 'Deck Slapper Boots',
    ItemGlobals.DEER_SKIN_ANKLE_BOOTS: 'Deer Skin Ankle Boots',
    ItemGlobals.LEATHER_ANKLE_BOOTS: 'Leather Ankle Boots',
    ItemGlobals.CLOPPER_ANKLE_BOOTS: 'Clopper Ankle Boots',
    ItemGlobals.BOARDWALK_BOOTS: 'Boardwalk Boots',
    ItemGlobals.SHOP_BOOTS: 'Shop Boots',
    ItemGlobals.CORINTHIAN_ANKLE_BOOTS: 'Corinthian Ankle Boots',
    ItemGlobals.PEASANT_BOOTS: 'Peasant Boots',
    ItemGlobals.RECRUIT_SHORT_BOOTS: 'Recruit Short Boots',
    ItemGlobals.ADVENTURE_SHORT_BOOTS: 'Adventure Short Boots',
    ItemGlobals.BUCKLE_SHORT_BOOTS: 'Buckle Short Boots',
    ItemGlobals.RAMPART_BOOTS: 'Rampart Boots',
    ItemGlobals.GANGPLANK_BOOTS: 'Gangplank Boots',
    ItemGlobals.SIDEWALK_BOOTS: 'Sidewalk Boots',
    ItemGlobals.STITCH_BOOTS: 'Stitch Boots',
    ItemGlobals.FIELD_BOOTS: 'Field Boots',
    ItemGlobals.PLANTATION_BOOTS: 'Plantation Boots',
    ItemGlobals.TRYST_BOOTS: 'Tryst Boots',
    ItemGlobals.GREEN_PURPLE_BOOTS: 'Green Purple Boots',
    ItemGlobals.GOLD_BUTTONS_BOOTS: 'Gold Buttons Boots',
    ItemGlobals.VIOLET_SILVER_BOOTS: 'Violet Silver Boots',
    ItemGlobals.SILVER_TALL_BOOTS: 'Dusk Boots',
    ItemGlobals.XMAS_SHORT_BOOTS: 'Winter Festival Boots',
    ItemGlobals.MARDI_GRAS_SHORT_BOOTS: 'Mardi Gras Boots',
    ItemGlobals.SAINT_PATRICKS_KNEE_BOOTS: "St. Patrick's Boots",
    ItemGlobals.VALENTINES_SHORT_BOOTS: "Valentine's Boots",
    ItemGlobals.NAVY_SHOES: 'Navy Boots',
    ItemGlobals.EITC_SHOES: 'EITC Boots',
    ItemGlobals.LEATHER_KNEE_BOOTS: 'Leather Knee Boots',
    ItemGlobals.PLANKWALKER_BOOTS: 'Plank Walker Boots',
    ItemGlobals.CASTLE_BOOTS: 'Castle Boots',
    ItemGlobals.STROLL_BOOTS: 'Stroll Boots',
    ItemGlobals.STITCHED_KNEE_BOOTS: 'Stitched Knee Boots',
    ItemGlobals.CHILL_BOOTS: 'Chill Boots',
    ItemGlobals.RICH_KNEE_BOOTS: 'Rich Knee Boots',
    ItemGlobals.FOREST_KNEE_BOOTS: 'Forest Knee Boots',
    ItemGlobals.HARD_KNEE_BOOTS: 'Hard Knee Boots',
    ItemGlobals.CELTIC_TALL_BOOTS: 'Celtic Tall Boots',
    ItemGlobals.FENCER_BOOTS: "Fencer's Boots",
    ItemGlobals.DEER_SKIN_TALL_BOOTS: 'Deer Skin Tall Boots',
    ItemGlobals.SUEDE_TALL_BOOTS: 'Suede Tall Boots',
    ItemGlobals.BLUE_SILVER_BOOTS: 'Blue Silver Tall Boots',
    ItemGlobals.SUN_RIDER_TALL_BOOTS: 'Sun Rider Boots',
    ItemGlobals.TALL_COURT_BOOTS: 'Tall Court Boots',
    ItemGlobals.TRAVELERS_TALL_BOOTS: "Traveler's Tall Boots",
    ItemGlobals.GOLDEN_BROW_SPIKE: 'Golden Brow Spike',
    ItemGlobals.SILVER_BROW_SPIKE: 'Silver Brow Spike',
    ItemGlobals.GOLDEN_BROW_RING: 'Golden Brow Ring',
    ItemGlobals.SILVER_BROW_RING: 'Silver Brow Ring',
    ItemGlobals.GOLDEN_BROW_RING_SPIKE: 'Golden Brow Ring Spike',
    ItemGlobals.SILVER_BROW_RING_SPIKE: 'Silver Brow Ring Spike',
    ItemGlobals.TURQUOISE_BROW_SPIKE: 'Turquoise Brow Spike',
    ItemGlobals.SAPPHIRE_BROW_RING: 'Sapphire Brow Ring',
    ItemGlobals.GOLDEN_EAR_STUD: 'Golden Ear Stud',
    ItemGlobals.SILVER_EAR_STUD: 'Silver Ear Stud',
    ItemGlobals.GOLDEN_EAR_SMALL_LOOP: 'Golden Ear Small Loop',
    ItemGlobals.SILVER_EAR_SMALL_LOOP: 'Silver Ear Small Loop',
    ItemGlobals.GOLDEN_EAR_DOUBLE_LOOP: 'Golden Ear Double Loop',
    ItemGlobals.SILVER_EAR_DOUBLE_LOOP: 'Silver Ear Double Loop',
    ItemGlobals.GOLD_AND_SILVER_EAR_DOUBLE_LOOP: 'Gold and Silver Ear Double Loop',
    ItemGlobals.GOLDEN_SMALL_EAR_SPIKE: 'Golden Small Ear Spike',
    ItemGlobals.SILVER_SMALL_EAR_SPIKE: 'Silver Small Ear Spike',
    ItemGlobals.GOLDEN_LARGE_EAR_LOOP: 'Golden Large Ear Loop',
    ItemGlobals.SILVER_LARGE_EAR_LOOP: 'Silver Large Ear Loop',
    ItemGlobals.GOLDEN_LARGE_EAR_LOOP_WITH_DOUBLE: 'Golden Large Ear Loop With Double Top Ring',
    ItemGlobals.SILVER_LARGE_EAR_LOOP_WITH_DOUBLE: 'Silver Large Ear Loop With Double Top Ring',
    ItemGlobals.GOLDEN_EAR_CUFFS: 'Golden Ear Cuffs',
    ItemGlobals.SILVER_EAR_CUFFS: 'Silver Ear Cuffs',
    ItemGlobals.ONYX_LARGE_EAR_LOOP: 'Onyx Large Ear Loop',
    ItemGlobals.RUBY_AND_AMETHYST_EAR_STUD_AND_RING: 'Ruby and Amethyst Ear Stud and Ring',
    ItemGlobals.GOLDEN_NOSE_LOOP: 'Golden Nose Loop',
    ItemGlobals.SILVER_NOSE_LOOP: 'Silver Nose Loop',
    ItemGlobals.GOLDEN_NOSE_CENTER_LOOP: 'Golden Nose Center Loop',
    ItemGlobals.SILVER_NOSE_CENTER_LOOP: 'Silver Nose Center Loop',
    ItemGlobals.GOLDEN_NOSE_SPIKE: 'Golden Nose Spike',
    ItemGlobals.SILVER_NOSE_SPIKE: 'Silver Nose Spike',
    ItemGlobals.GOLDEN_DOUBLE_NOSE_SPIKE: 'Golden Double Nose Spike',
    ItemGlobals.SILVER_DOUBLE_NOSE_SPIKE: 'Silver Double Nose Spike',
    ItemGlobals.GOLDEN_NOSE_SPIKE_WITH_LOOP: 'Golden Nose Spike with Loop',
    ItemGlobals.SILVER_NOSE_SPIKE_WITH_LOOP: 'Silver Nose Spike with Loop',
    ItemGlobals.GOLDEN_DOUBLE_NOSE_SPIKE_WITH_LOOP: 'Golden Double Nose Spike with Loop',
    ItemGlobals.SILVER_DOUBLE_NOSE_SPIKE_WITH_LOOP: 'Silver Double Nose Spike with Loop',
    ItemGlobals.EMERALD_DOUBLE_NOSE_SPIKE: 'Emerald Double Nose Spike',
    ItemGlobals.GOLDEN_LIP_RING: 'Golden Lip Ring',
    ItemGlobals.SILVER_LIP_RING: 'Silver Lip Ring',
    ItemGlobals.GOLDEN_LIP_SPIKE: 'Golden Lip Spike',
    ItemGlobals.SILVER_LIP_SPIKE: 'Silver Lip Spike',
    ItemGlobals.GOLDEN_DOUBLE_LIP_RING: 'Golden Double Lip Ring',
    ...
    ItemGlobals.SILVER_BAND: 'Silver Band',
    ItemGlobals.GOLDEN_RUBY_RING: 'Golden Ruby Ring',
    ItemGlobals.SILVER_RUBY_RING: 'Silver Ruby Ring',
    ItemGlobals.GOLDEN_AMETHIST_RING: 'Golden Amethist Ring',
    ItemGlobals.SILVER_AMETHIST_RING: 'Silver Amethist Ring',
    ItemGlobals.GOLDEN_SAPPHIRE_RING: 'Golden Sapphire Ring',
    ItemGlobals.SILVER_SAPPHIRE_RING: 'Silver Sapphire Ring',
    ItemGlobals.GOLDEN_TURQUOISE_RING: 'Golden Turquoise Ring',
    ItemGlobals.SILVER_TURQUOISE_RING: 'Silver Turquoise Ring',
    ItemGlobals.GOLDEN_EMERALD_RING: 'Golden Emerald Ring',
    ItemGlobals.SILVER_EMERALD_RING: 'Silver Emerald Ring',
    ItemGlobals.GOLDEN_ONYX_RING: 'Golden Onyx Ring',
    ItemGlobals.SILVER_ONYX_RING: 'Silver Onyx Ring',
    ItemGlobals.GOLDEN_DOUBLE_BAND: 'Golden Double Band',
    ItemGlobals.SILVER_DOUBLE_BAND: 'Silver Double Band',
    ItemGlobals.GOLDEN_KNUCKLES: 'Golden Knuckles',
    ItemGlobals.SILVER_KNUCKLES: 'Silver Knuckles',
    ItemGlobals.TATTOO_CHEST_DAGGER: 'Dagger Chest Tattoo',
    ItemGlobals.TATTOO_CHEST_HEART_TORCH: 'Heart Chest Tattoo',
    ItemGlobals.TATTOO_CHEST_LOCK_KEY: 'Lock and Key Chest Tattoo',
    ItemGlobals.TATTOO_CHEST_SKULL_DAGGER: 'Skull and Dagger Chest Tattoo',
    ItemGlobals.TATTOO_CHEST_SMALL_SKULL_CROSS: 'Small Skull and Cross Chest Tattoo',
    ItemGlobals.TATTOO_CHEST_ANCHOR: 'Anchor Chest Tattoo',
    ItemGlobals.TATTOO_CHEST_COMPASS: 'Compass Chest Tattoo',
    ItemGlobals.TATTOO_CHEST_DAGGER_SCROLL: 'Dagger Scroll Chest Tattoo',
    ItemGlobals.TATTOO_CHEST_SHIP_ANCHOR: 'Ship Anchor Chest Tattoo',
    ItemGlobals.TATTOO_CHEST_SMALL_SKULL_CROSSBONES: 'Skull and Crossbones Chest Tattoo',
    ItemGlobals.TATTOO_CHEST_SQUID_AND_SHIP: 'Squid and Ship Chest Tattoo',
    ItemGlobals.TATTOO_CHEST_SAINT_PATRICKS_DAY: "Saint Patrick's Day Chest Tattoo",
    ItemGlobals.TATTOO_CHEST_CELTIC_LEAF: 'Celtic Leaf Chest Tattoo',
    ItemGlobals.TATTOO_CHEST_SMALL_ETHNIC_EAGLE: 'Small Ethnic Eagle Chest Tattoo',
    ItemGlobals.TATTOO_CHEST_SMALL_CROSSED_FLINTLOCKS: 'Crossed Flintlocks Chest Tattoo',
    ItemGlobals.TATTOO_CHEST_SHAMROCK: 'Shamrock Chest Tattoo',
    ItemGlobals.TATTOO_CHEST_SMALL_THAI_MONKEY: 'Thai Monkey Small Chest Tattoo',
    ItemGlobals.TATTOO_CHEST_HAWAIIAN_PECTORAL: 'Hawaiin Pectoral Chest Tattoo',
    ItemGlobals.TATTOO_CHEST_SMALL_TRIBALYAKUZA: 'Tribal Yakuza Small Chest Tattoo',
    ItemGlobals.TATTOO_CHEST_SPANISH_SHIP_PVP: 'Spanish Chest Tattoo',
    ItemGlobals.TATTOO_CHEST_FRENCH_SHIP_PVP: 'French Chest Tattoo',
    ItemGlobals.TATTOO_CHEST_CLASSIC_MOTHERS_DAY: "Mother's Day Chest Tattoo",
    ItemGlobals.TATTOO_CHEST_HEALED_BULLET_HOLES: 'Bullet Chest Wound',
    ItemGlobals.TATTOO_CHEST_PIRATE_BRAND: 'Pirate Chest Brand',
    ItemGlobals.TATTOO_CHEST_LARGE_STITCHED_SCAR: 'Stitched Chest Scar',
    ItemGlobals.TATTOO_CHEST_STITCHED_BULLET_HOLES: 'Stitched Bullet Chest Wound',
    ItemGlobals.TATTOO_CHEST_LARGE_X_STITCH: 'X Chest Scar',
    ItemGlobals.TATTOO_CHEST_LARGE_Y_STITCH: 'Y Chest Scar',
    ItemGlobals.TATTOO_CHEST_FULL_CROSSED_FLINTLOCKS: 'Crossed Flintlocks Full Chest Tattoo',
    ItemGlobals.TATTOO_CHEST_FULL_TRIBAL_YAKUZA: 'Tribal Yakuza Full Chest Tattoo',
    ItemGlobals.TATTOO_CHEST_FULL_SKULL_CROSSBONES: 'Skull and Crossbones Full Chest Tattoo',
    ItemGlobals.TATTOO_CHEST_FULL_SKULL_CROSS: 'Skull Cross Full Chest Tattoo',
    ItemGlobals.TATTOO_CHEST_FULL_THAI_MONKEY: 'Thai Monkey Full Chest Tattoo',
    ItemGlobals.TATTOO_CHEST_FULL_ETHNIC_EAGLE: 'Ethnic Eagle Full Chest Tattoo',
    ItemGlobals.TATTOO_ARM_SHARK: 'Shark Arm Tattoo',
    ItemGlobals.TATTOO_ARM_SKULL_PIRATE: 'Pirate Skull Arm Tattoo',
    ItemGlobals.TATTOO_ARM_SKULL_SHIELD: 'Skull Shield Arm Tattoo',
    ItemGlobals.TATTOO_ARM_SKULL_STAB: 'Skull Dagger Arm Tattoo',
    ItemGlobals.TATTOO_ARM_SNAKES_DAGGER: 'Snakes and Dagger Arm Tattoo',
    ItemGlobals.TATTOO_ARM_FANCY_DAGGER: 'Fancy Dagger Arm Tattoo',
    ItemGlobals.TATTOO_ARM_SKULL_FLAG: 'Skull Flag Arm Tattoo',
    ItemGlobals.TATTOO_ARM_FANCY_KEY: 'Fancy Key Arm Tattoo',
    ItemGlobals.TATTOO_ARM_SKULL_IRON_CROSS: 'Iron Cross Arm Tattoo',
    ItemGlobals.TATTOO_ARM_SKULL_SCROLL: 'Skull Scroll Arm Tattoo',
    ItemGlobals.TATTOO_ARM_NAUTICAL_STAR: 'Nautical Star Arm Tattoo',
    ItemGlobals.TATTOO_ARM_MAYAN_FACE: 'Mayan Face Arm Tattoo',
    ItemGlobals.TATTOO_ARM_OCTOPUS: 'Octopus Arm Tattoo',
    ItemGlobals.TATTOO_ARM_TRIBAL_SKULL: 'Tribal Skull Arm Tattoo',
    ItemGlobals.TATTOO_ARM_SAINT_PATRICK: "Saint Patrick's Day Arm Tattoo",
    ItemGlobals.TATTOO_ARM_NATIVE_LIZARDS: 'Native Lizards Arm Tattoo',
    ItemGlobals.TATTOO_ARM_TRIBAL_SWIRL: 'Tribal Swirl Arm Tattoo',
    ItemGlobals.TATTOO_ARM_TRIBAL_BIRD: 'Tribal Bird Arm Tattoo',
    ItemGlobals.TATTOO_ARM_TRIBAL_JELLYFISH: 'Tribal Jellyfish Arm Tattoo',
    ItemGlobals.TATTOO_ARM_TRIBAL_JELLYFISHES: 'Tribal Jellyfish Arm Tattoo',
    ItemGlobals.TATTOO_ARM_ASIAN_LEAF: 'Asian Leaf Arm Tattoo',
    ItemGlobals.TATTOO_ARM_ETHNIC: 'Ethnic Arm Tattoo',
    ItemGlobals.TATTOO_ARM_MAORI_MAN: 'Maori Man Arm Tattoo',
    ItemGlobals.TATTOO_ARM_NATIVE_LEAF: 'Native Leaf Arm Tattoo',
    ItemGlobals.TATTOO_ARM_THAI: 'Thai Arm Tattoo',
    ItemGlobals.TATTOO_ARM_CELTIC_LEAF: 'Celtic Leaf Arm Tattoo',
    ItemGlobals.TATTOO_ARM_SHAMROCK: 'Shamrock Arm Tattoo',
    ItemGlobals.TATTOO_ARM_TIKI: 'Tiki Arm Tattoo',
    ItemGlobals.TATTOO_ARM_CELTIC_KNOT: 'Celtic Knot Arm Tattoo',
    ItemGlobals.TATTOO_ARM_TRIBAL_WAVES: 'Tribal Waves Arm Tattoo',
    ItemGlobals.TATTOO_ARM_SHARKS: 'Shark Arm Tattoo',
    ItemGlobals.TATTOO_ARM_CHINESE_KNOT: 'Chinese Knot Arm Tattoo',
    ItemGlobals.TATTOO_ARM_WAVE_FAN: 'Wave Fan Arm Tattoo',
    ItemGlobals.TATTOO_ARM_CELTIC_DEER: 'Celtic Deer Arm Tattoo',
    ItemGlobals.TATTOO_ARM_HAWAIIAN: 'Hawaiian Arm Tattoo',
    ItemGlobals.TATTOO_ARM_PETROGLYPH: 'Petroglyph Arm Tattoo',
    ItemGlobals.TATTOO_ARM_RAVENS: 'Ravens Arms Tattoo',
    ItemGlobals.TATTOO_ARM_SPANISH: 'Spanish Arm Tattoo',
    ItemGlobals.TATTOO_ARM_FRENCH: 'French Arm Tattoo',
    ItemGlobals.TATTOO_ARM_MOTHERS_DAY_FLOWERS_COLOR: "Mother's Day Flower Arm Tattoo",
    ItemGlobals.TATTOO_ARM_MOTHERS_DAY_SPARROWS: "Mother's Day Sparrows Arm Tattoo",
    ItemGlobals.TATTOO_ARM_OCTOPUS_SLEEVES: 'Octopus Arm Tattoo',
    ItemGlobals.TATTOO_ARM_HEALED_BULLET_HOLES: 'Bullet Arm Wound',
    ItemGlobals.TATTOO_ARM_PIRATE_BRAND: 'Pirate Arm Brand',
    ItemGlobals.TATTOO_ARM_STITCHED_SCAR: 'Stitched Arm Scar',
    ItemGlobals.TATTOO_ARM_STITCHED_BULLET_HOLES: 'Stitched Bullet Arm Wound',
    ItemGlobals.TATTOO_ARM_STITCHED_X: 'X Arm Scar',
    ItemGlobals.TATTOO_ARM_STITCHED_Y: 'Y Arm Scar',
    ItemGlobals.TATTOO_FACE_SKULL: 'Skull Face Paint',
    ItemGlobals.TATTOO_FACE_TWO_CLOVERS: 'Clover Face Paint',
    ItemGlobals.TATTOO_FACE_HORSE_SHOES: 'Horseshoe Face Paint',
    ItemGlobals.TATTOO_FACE_TRIBAL_FOREHEAD: 'Tribal Forehead Tattoo',
    ItemGlobals.TATTOO_FACE_TRIBAL_CHEEK: 'Tribal Cheek Tattoo',
    ItemGlobals.TATTOO_FACE_TRIBAL_CHIN: 'Tribal Chin Tattoo',
    ItemGlobals.TATTOO_FACE_JACK_EYES: "Jack's Eyes Face Paint",
    ItemGlobals.TATTOO_FACE_TRIBAL_GOATEE: 'Tribal Goatee Face Tattoo',
    ItemGlobals.TATTOO_FACE_MAORI_NOSE: 'Maori Nose Face Tattoo',
    ItemGlobals.TATTOO_FACE_MAORI_CHIN: 'Maori Nose Face Tattoo',
    ItemGlobals.TATTOO_FACE_NATIVE_EYE: 'Native Eye Face Tattoo',
    ItemGlobals.TATTOO_FACE_MOTHERS_DAY_FLOWER: "Mother's Day Flower Face Paint",
    ItemGlobals.TATTOO_FACE_MOTHERS_DAY_HEARTS: "Mother's Day Hearts Face Paint",
    ItemGlobals.TATTOO_FACE_PIRATE_BRAND: 'Pirate Face Brand',
    ItemGlobals.TATTOO_FACE_STITCHED_SCAR: 'Stiched Face Scar',
    ItemGlobals.TATTOO_FACE_STITCHED_X: 'X Face Scar',
    ItemGlobals.TATTOO_FACE_STITCHED_Y: 'Y Face Scar',
    ItemGlobals.TATTOO_FACE_COLOR_EYE_01: 'Eye Tattoo',
    ItemGlobals.TATTOO_FACE_COLOR_CHEEK: 'Cheek Tattoo',
    ItemGlobals.TATTOO_FACE_COLOR_TRIBAL_MOUTH: 'Tribal Mouth Tattoo',
    ItemGlobals.TATTOO_FACE_COLOR_VOODOO_01: 'Voodoo Goggles Tattoo',
    ItemGlobals.TATTOO_FACE_COLOR_VOODOO_02: 'Voodoo Circlet Tattoo',
    ItemGlobals.TATTOO_FACE_COLOR_VOODOO_03: 'Voodoo Thorns Tattoo',
...
ItemFlavorText = {
    ...
    ItemGlobals.PIRATE_BLADE: 'A Pirate Blade, a clear warning sign to any EITC or Navy blokes.',
    ItemGlobals.SHORT_CUTLASS: 'A shorter cutlass meant for close quarters.',
    ItemGlobals.VOODOO_CUTLASS: 'Enchanted with a voodoo hex that heals the user.',
    ItemGlobals.BATTLE_CUTLASS: 'A powerful fighting weapon.',
    ItemGlobals.ORNATE_CUTLASS: 'A strong cutlass with a golden hilt.',
    ItemGlobals.GRAND_CUTLASS: 'A long cutlass with a mighty swing.',
    ItemGlobals.ROYAL_CUTLASS: 'A mighty cutlass used by the Royal Guard.',
    ItemGlobals.RUSTY_SABRE: 'A rusty sabre, able to make fast attacks!',
    ItemGlobals.LIGHT_SABRE: 'Sabres are quick swords able to deal rapid fast attacks.',
    ItemGlobals.IRON_SABRE: 'A plain sabre, able to deal fast rapid strikes!',
    ItemGlobals.STEEL_SABRE: 'A plain steel sabre.  Strong and fast.',
    ItemGlobals.FINE_SABRE: 'A well-balanced and swift blade.',
    ItemGlobals.WAR_SABRE: 'A powerful military sabre used in wars.',
    ItemGlobals.MASTER_SABRE: 'A masterful sabre used by the best fighters.',
    ItemGlobals.WORN_BROADSWORD: 'Broadswords can hit multiple enemies in one slash.',
    ItemGlobals.IRON_BROADSWORD: 'Broadswords are heavy swords that can cut through many enemies at once.',
    ItemGlobals.LIGHT_BROADSWORD: 'Broadswords can hit multiple enemies in one slash.',
    ItemGlobals.SMALL_BROADSWORD: 'Its powerful slashes can hit all nearby enemies!',
    ItemGlobals.STEEL_BROADSWORD: 'A heavy steel sword used by the military.',
    ItemGlobals.MIGHTY_BROADSWORD: 'A heavy sword able to hit many foes at once.',
    ItemGlobals.ORNATE_BROADSWORD: 'A hefty sword forged by a master blacksmith.',
    ...
    ItemGlobals.DUAL_RUSTY_SCIMITAR: 'They are a bit crude, but they still has an edge.',
    ItemGlobals.DUAL_STEEL_SCIMITAR: 'A set of ornate steel scimitars. Well balanced and sharp!',
    ...
    ItemGlobals.DUAL_FINE_CUTLASS: "A set of Fine Cutlass. They were crafted with pride by the Caribbean's best blacksmiths.",
    ItemGlobals.DUAL_PIRATE_BLADE: 'A set of Pirate Blades, a clear warning sign to any EITC or Navy blokes.',
    ...
    ItemGlobals.HEAVY_TRI_BARREL: 'A Heavy Tri-Barrel Pistol, a fine piece of weaponry.',
    ItemGlobals.GRAND_PISTOL: 'A Grand Pistol, equipped with three deadly barrels.',
    ItemGlobals.IRON_PISTOL: 'Fires one shot before it needs to be reloaded.',
    ItemGlobals.STEEL_PISTOL: 'A well-crafted steel pistol.  Fires one shot.',
    ItemGlobals.ORNATE_PISTOL: 'A fancy pistol created by a master Gunsmith.',
    ItemGlobals.IRON_BAYONET: 'Looks like it once belonged to a Navy Cadet.',
    ItemGlobals.STEEL_BAYONET: 'A powerful rifle that can fight up-close or from far away.',
    ItemGlobals.MASTER_BAYONET: 'A master-crafted weapon, made by the best rifle makers.',
    ItemGlobals.SAILOR_MUSKET: 'Has great range, but cannot fire if you are too close to the enemy.',
    ItemGlobals.BOARDING_MUSKET: 'Often used by pirates when boarding an enemy ship.',
    ItemGlobals.ROYAL_MUSKET: 'A gold musket used by the Royal Guard.',
    ItemGlobals.SMALL_BLUNDERBUSS: 'Fires a powerful spread-shot  Short range only.',
    ItemGlobals.FINE_BLUNDERBUSS: 'Short ranged attack, but can hit a group of enemies.',
    ItemGlobals.ROYAL_BLUNDERBUSS: 'A mighty hand-cannon decorated with gold.',
    ItemGlobals.TWIN_BARREL_PISTOL: 'A pistol with two barrels. Each barrel can be fired separately before reloading.',
    ItemGlobals.STEEL_REPEATER: 'A repeater pistol! This gun can fire three times before reloading.',
    ItemGlobals.ORNATE_REPEATER: 'An expert gun! This gun can fire three times before reloading.',
    ItemGlobals.VOLLEY_PISTOL: 'A three-barreled gun! This gun can fire three times before reloading.',
    ItemGlobals.VOODOO_DOLL: 'A mystical doll said to be able to bind to the spirit of anything it touches.',
    ItemGlobals.CLOTH_DOLL: 'A powerful doll able to bind to the spirits of the living and the dead.',
    ItemGlobals.WITCH_DOLL: 'An elaborate oriental doll able to strongly bind to the spirits of others.',
    ItemGlobals.PIRATE_DOLL: 'A Pirate Doll. Bind to the spirits of the Caribbean with this rare doll.',
    ItemGlobals.TABOO_DOLL: 'A Taboo Doll. Many pirates fear the power and unknowns of this legendary doll.',
    ItemGlobals.FURY_DOLL: 'This dark doll can give other pirates berserk power.',
    ItemGlobals.RAGE_DOLL: 'An evil voodoo doll filled with anger.',
    ItemGlobals.GRUDGER_DOLL: 'A dark doll shaped like a tough pirate.',
    ItemGlobals.VENGEFUL_DOLL: 'A grim doll that increases the battle fury in others.',
    ItemGlobals.WRATH_DOLL: 'A doll shaped like an infamous pirate.',
    ItemGlobals.COTTON_SOLL: 'A mystical doll able to protect others from evil voodoo.',
    ItemGlobals.ORNATE_DOLL: 'A fancy doll which protects others from harmful voodoo.',
    ItemGlobals.ENCHANTED_DOLL: 'Enchanted with strong hexes to ward off evil.',
    ItemGlobals.MAGIC_DOLL: 'A rare doll that pulses with voodoo magic.',
    ItemGlobals.MYSTERIOUS_DOLL: 'A mysterious voodoo doll with powerful protection spells on it.',
    ItemGlobals.HEALING_DOLL: 'Spirit Dolls increase the power of your Healing Voodoo skills.',
    ItemGlobals.MENDING_DOLL: 'Increases your ability to heal others.',
    ItemGlobals.RESTORATION_DOLL: 'A doll filled with good voodoo power.',
    ItemGlobals.RENEWAL_DOLL: 'A festive doll that glows with good voodoo magic.',
    ItemGlobals.LIFE_DOLL: 'A powerful voodoo doll with mighty healing powers.',
    ItemGlobals.BASIC_DAGGER: 'A sharp dagger. Small but deadly.',
    ItemGlobals.BATTLE_DIRK: 'A long knife. Well balanced for fighting.',
    ItemGlobals.MAIN_GAUCHE: 'A fancy blade that is useful for keeping your opponent off guard.',
    ItemGlobals.COLTELLO: "A Coltello dagger, it is a pirate's best friend in the right fight.",
    ItemGlobals.BLOODLETTER: 'A Bloodletter dagger. It is meticulously designed to fend off even the largest of foes.',
    ItemGlobals.SMALL_DAGGER: 'Daggers cause more damage when attacking enemies in the back.',
    ItemGlobals.STEEL_DAGGER: 'A sneaky blade.  Deals more damage when attacking enemies in the back.',
    ItemGlobals.COMBAT_DAGGER: 'A fighting knife.  Deals more damage when attacking enemies in the back.',
    ItemGlobals.BATTLE_DAGGER: 'Often used in duels.  Deals more damage when attacking enemies in the back.',
    ItemGlobals.WAR_DAGGER: 'Forged for combat.  Deals more damage when attacking enemies in the back.',
    ItemGlobals.SMALL_THROWING_KNIVES: 'Throwing Knives are great ranged weapons. Faster recharge on Throwing Skills.',
    ItemGlobals.IRON_THROWING_KNIVES: 'Sturdy throwing weapon. Faster recharge on Throwing Skills.',
    ItemGlobals.TRIBAL_THROWING_KNIVES: 'Tribal hunting weapon. Faster recharge on Throwing Skills.',
    ItemGlobals.FINE_THROWING_KNIVES: 'Golden throwing knives. Faster recharge on Throwing Skills.',
    ItemGlobals.MASTER_THROWING_KNIVES: 'Master crafted throwing knives. Faster recharge on Throwing Skills.',
    ItemGlobals.POISONED_KNIFE: 'Coated with poison. Increases the damage on all your Debuffs.',
    ItemGlobals.VENOM_KNIFE: 'Laced with venom. Increases the damage on all your Debuffs.',
    ItemGlobals.TOXIC_KNIFE: 'Covered in toxic venom. Increases the damage on all your Debuffs.',
    ItemGlobals.PLAGUE_KNIFE: 'A deadly knife. Increases the damage on all your Debuffs.',
    ItemGlobals.DIRE_KNIFE: 'Coated in strong poison. Increases the damage on all your Debuffs.',
    ItemGlobals.CURSED_STAFF: 'A tribal fetish used for summoning evil spirits.',
    ItemGlobals.WARPED_STAFF: 'A powerful fetish used for summoning and controlling spirits.',
    ItemGlobals.REND_STAFF: 'Sought after by many, this fetish allows the bearer to speak to the spirits of the dead.',
    ItemGlobals.HARROW_STAFF: 'Harrow Staff. Inflict the secrets of the dead upon your enemies with this rare staff.',
    ItemGlobals.VILE_STAFF: 'Vile Staff. Summon the plagues of the dead and unknown against your foes.',
    ItemGlobals.BONE_STAFF: 'Radiates a strong aura that increases the Attack Power of nearby friends.',
    ItemGlobals.GRIM_STAFF: 'A grim staff filled with dark power.',
    ItemGlobals.SKELETAL_STAFF: 'Made from the bones of animals.  Pulses with dark power.',
    ItemGlobals.UNDEAD_STAFF: 'A frightening staff that pulses with hostile energy.',
    ItemGlobals.DEATH_STAFF: 'A cursed staff used to channel dark energy.',
    ItemGlobals.HEALING_STAFF: 'Pulses with an aura that heals all friendly pirates slowly.',
    ItemGlobals.MENDING_STAFF: 'This wooden staff is filled with healing voodoo energy.',
    ItemGlobals.RESTORATION_STAFF: 'Glows with healing energy that can heal others nearby.',
    ItemGlobals.RENEWAL_STAFF: "Uses the earth's elements to heal others.",
    ItemGlobals.LIFE_STAFF: 'This staff glows with healing power.',
    ItemGlobals.DEFENDER_STAFF: 'Has a protective aura that increases defense for nearby pirates.',
    ItemGlobals.WARDEN_STAFF: 'Covered in defensive wards and trinkets.',
    ItemGlobals.OVERSEER_STAFF: 'A tribal voodoo staff with strong defensive magic.',
    ItemGlobals.GUARDIAN_STAFF: "Protects nearby friends when using it's aura.",
    ItemGlobals.TRIBAL_CHIEF_STAFF: 'Glows with protective voodoo energy.',
    ItemGlobals.GRENADE_POUCH: 'Grenades are highly lethal explosives. They are effective against large crowds of enemies!',
    ItemGlobals.TONIC: 'Eases pain. Smells kinda strong too.',
    ItemGlobals.REMEDY: 'An exotic remedy. Said to cure all maladies.',
    ItemGlobals.HOLY_WATER: 'Water blessed by the angels and gods.',
    ItemGlobals.ELIXIR: 'The one and only, legendary Elixir of Life!',
    ItemGlobals.MIRACLE_WATER: 'A miracle potion said to cure all sicknesses and regrow hair!',
    ItemGlobals.ROAST_PORK: 'A tasty chunk of pork.',
    ItemGlobals.POTION_CANNON_1: 'Increases cannon damage by 10% for 180 seconds',
    ItemGlobals.POTION_CANNON_2: 'Increases cannon damage by 15% for 240 seconds',
    ItemGlobals.POTION_CANNON_3: 'Increases cannon damage by 20% for 300 seconds',
    ItemGlobals.POTION_PISTOL_1: 'Increases pistol damage by 10% for 180 seconds',
    ItemGlobals.POTION_PISTOL_2: 'Increases pistol damage by 15% for 240 seconds',
    ItemGlobals.POTION_PISTOL_3: 'Increases pistol damage by 20% for 300 seconds',
    ItemGlobals.POTION_CUTLASS_1: 'Increases cutlass damage by 10% for 180 seconds',
    ItemGlobals.POTION_CUTLASS_2: 'Increases cutlass damage by 15% for 240 seconds',
    ItemGlobals.POTION_CUTLASS_3: 'Increases cutlass damage by 20% for 300 seconds',
    ItemGlobals.POTION_DOLL_1: 'Increases voodoo damage by 10% for 180 seconds',
    ItemGlobals.POTION_DOLL_2: 'Increases voodoo damage by 15% for 240 seconds',
    ItemGlobals.POTION_DOLL_3: 'Increases voodoo damage by 20% for 300 seconds',
    ItemGlobals.POTION_SPEED_1: 'Increases run speed by 30% for 60 seconds',
    ItemGlobals.POTION_SPEED_2: 'Increases run speed by 30% for 180 seconds',
    ItemGlobals.POTION_SPEED_3: 'Increases run speed by 30% for 360 seconds',
    ItemGlobals.POTION_REP_1: 'Increases reputation gained by 15% for 180 seconds',
    ItemGlobals.POTION_REP_2: 'Increases reputation gained by 30% for 180 seconds',
    ItemGlobals.POTION_REP_COMP: 'Increases reputation gained by 500% for an hour!',
    ItemGlobals.POTION_GOLD_1: 'Increases gold earned by 10% for 180 seconds',
    ItemGlobals.POTION_GOLD_2: 'Increases gold earned by 20% for 180 seconds',
    ItemGlobals.POTION_INVIS_1: 'Grants invisibility for 60 seconds',
    ItemGlobals.POTION_INVIS_2: 'Grants invisibility for 60 seconds',
    ItemGlobals.POTION_REGEN_1: 'Restores 3% of health every 2 seconds for 120 seconds',
    ItemGlobals.POTION_REGEN_2: 'Restores 3% of health every 2 seconds for 180 seconds',
    ItemGlobals.POTION_REGEN_3: 'Restores 3% of health every 2 seconds for 240 seconds',
    ItemGlobals.POTION_REGEN_4: 'Restores 3% of health every 2 seconds for 300 seconds',
    ItemGlobals.POTION_BURP: 'This fizzy drink will make you belch!',
    ItemGlobals.POTION_FART: 'A spicy concoction meant for pirate chili. Warning: drinking this straight may make you fart.',
    ItemGlobals.POTION_VOMIT: 'This potion will make you puke!',
    ItemGlobals.POTION_HEADGROW: 'This potion makes your head huge!',
    ItemGlobals.POTION_FACECOLOR: 'This potion changes your color!',
    ItemGlobals.POTION_SHRINK: "Either the world is getting bigger or you're shrinking!",
    ItemGlobals.POTION_GROW: 'Makes you huge! Careful not to step on any garrisons',
    ItemGlobals.POTION_HEADONFIRE: 'This potion lights your head on fire!',
    ItemGlobals.POTION_SCORPION: 'This potion transforms you into a scorpion!',
    ItemGlobals.POTION_ALLIGATOR: 'This potion transforms you into an alligator!',
    ItemGlobals.POTION_CRAB: 'This potion transforms you into a crab!',
    ItemGlobals.POTION_ACC_1: 'Increases weapon accuracy by 10% for 180 seconds',
    ItemGlobals.POTION_ACC_2: 'Increases weapon accuracy by 15% for 240 seconds',
    ItemGlobals.POTION_ACC_3: 'Increases weapon accuracy by 20% for 300 seconds',
    ItemGlobals.POTION_GROG: 'Grogg-away removes groggy effects in pirates and chickens.',
    ItemGlobals.POTION_REP_3: 'Increases reputation gained by 30% for 180 seconds',
    ItemGlobals.POTION_FART_2: 'This potion will make you fart, a lot!',
    ItemGlobals.STAFF_ENCHANT_1: 'Assists in staff creation',
    ItemGlobals.STAFF_ENCHANT_2: 'Assists in staff enchantment',
    ItemGlobals.POTION_SUMMON_CHICKEN: 'Summons a mighty chicken to smite your foes!' }
...
ItemRarityNames = {
    ItemGlobals.CRUDE: 'Crude',
    ItemGlobals.COMMON: 'Common',
    ItemGlobals.RARE: 'Rare',
    ItemGlobals.FAMED: 'Famed',
    ItemGlobals.LEGENDARY: 'Legendary' }
...
ItemTypeNames = {
    ItemGlobals.SWORD: 'Sword',
    ItemGlobals.GUN: 'Gun',
    ItemGlobals.DOLL: 'Doll',
    ItemGlobals.DAGGER: 'Dagger',
    ItemGlobals.GRENADE: 'Grenade',
    ItemGlobals.STAFF: 'Staff',
    ItemGlobals.CANNON: 'Cannon',
    ItemGlobals.SAILING: 'Sailing',
    ItemGlobals.AXE: 'Axe',
    ItemGlobals.FENCING: 'Fencing',
    ItemGlobals.POTION: 'Potions',
    ItemGlobals.ODDS_AND_ENDS: 'Odds and Ends' }
...
ItemSubtypeNames = {
    ItemGlobals.CUTLASS: 'Cutlass',
    ItemGlobals.SABRE: 'Sabre',
    ItemGlobals.BROADSWORD: 'Broadsword',
    ItemGlobals.PISTOL: 'Pistol',
    ItemGlobals.REPEATER: 'Repeater Pistol',
    ItemGlobals.BLUNDERBUSS: 'Blunderbuss',
    ItemGlobals.MUSKET: 'Musket',
    ItemGlobals.BAYONET: 'Bayonet',
    ItemGlobals.BASIC_DOLL: 'Voodoo Doll',
    ItemGlobals.BASIC_STAFF: 'Voodoo Staff',
    ItemGlobals.BANE: 'Bane Doll',
    ItemGlobals.MOJO: 'Mojo Doll',
    ItemGlobals.SPIRIT: 'Spirit Doll',
    ItemGlobals.DAGGER_SUBTYPE: 'Dagger',
    ItemGlobals.DIRK: 'Throwing Knives',
    ItemGlobals.KRIS: 'Dark Blades',
    ItemGlobals.DARK: 'Dark Staff',
    ItemGlobals.NATURE: 'Nature Staff',
    ItemGlobals.WARDING: 'Warding Staff',
    ItemGlobals.RAM: 'Cannon Ram',
    ...
    ItemGlobals.NAVIGATION_TOOL: 'Navigation Tool',
    ItemGlobals.SEA_CHARM: 'Sea Charm',
    ItemGlobals.POTION_BUFF: 'Potion',
    ItemGlobals.CURSED_CUTLASS: 'Cursed Blade',
    ItemGlobals.CURSED_SABRE: 'Cursed Blade',
    ItemGlobals.CURSED_BROADSWORD: 'Cursed Blade',
    ItemGlobals.GRENADE_SUBTYPE: 'Grenades' }

def getItemSubtypeName(itemId):
    return ItemSubtypeNames.get(itemId, '')

ItemSpeedNames = {
    ItemGlobals.SLOW: 'Slow',
    ItemGlobals.NORMAL: 'Normal',
    ItemGlobals.FAST: 'Fast' }

def getItemSpeedName(itemId):
    return ItemSpeedNames.get(itemId, '')

ItemRangeNames = {
    ItemGlobals.SHORT: 'Short',
    ItemGlobals.MEDIUM: 'Medium',
    ItemGlobals.LONG: 'Long' }

def getItemRangeName(itemId):
    return ItemRangeNames.get(itemId, '')

ItemAttributeNames = {
    ItemGlobals.CRITICAL: 'Critical Strike',
    ItemGlobals.VENOM: 'Venom Strike',
    ItemGlobals.POWERFUL: 'Powerful',
    ItemGlobals.PROTECT_COMBAT: 'Combat Protection',
    ItemGlobals.PROTECT_MISSILE: 'Projectile Protection',
    ItemGlobals.PROTECT_MAGIC: 'Magic Protection',
    ItemGlobals.PROTECT_GRENADE: 'Grenade Protection',
    ItemGlobals.DAMAGE_MANA: 'Voodoo Damage',
    ItemGlobals.SURE_FOOTED: 'Sure Footed',
    ItemGlobals.BLOOD_FIRE: 'Blood Fire',
    ItemGlobals.INFINITE_VENOM_SHOT: 'Infinite Venom Shot',
    ItemGlobals.INFINITE_BANE_SHOT: 'Infinite Bane Shot',
    ItemGlobals.INFINITE_HEX_EATER_SHOT: 'Infinite Hex Eater Shot',
    ItemGlobals.INFINITE_SILVER_SHOT: 'Infinite Silver Shot',
    ItemGlobals.INFINITE_STEEL_SHOT: 'Infinite Steel Shot',
    ItemGlobals.INFINITE_ASP: 'Infinite Asp',
    ItemGlobals.INFINITE_ADDER: 'Infinite Adder',
    ItemGlobals.INFINITE_SIDEWINDER: 'Infinite Sidewinder',
    ItemGlobals.INFINITE_VIPER_NEST: "Infinite Viper's Nest",
    ItemGlobals.INFINITE_CHAIN_SHOT: 'Infinite Chain Shot',
    ItemGlobals.INFINITE_EXPLOSIVE: 'Infinite Explosive',
    ItemGlobals.INFINITE_GRAPE_SHOT: 'Infinite Grape Shot',
    ItemGlobals.INFINITE_FIREBRAND: 'Infinite Firebrand',
    ItemGlobals.INFINITE_THUNDERBOLT: 'Infinite Thunderbolt',
    ItemGlobals.INFINITE_FURY: 'Infinite Fury',
    ItemGlobals.LEECH_HEALTH: 'Drain Health',
    ItemGlobals.LEECH_VOODOO: 'Drain Voodoo',
    ItemGlobals.CRITICAL_ROUND_SHOT: 'Critical Round Shot',
    ItemGlobals.CRITICAL_CHAIN_SHOT: 'Critical Chain Shot',
    ItemGlobals.CRITICAL_EXPLOSIVE: 'Critical Explosive',
    ItemGlobals.CRITICAL_GRAPE_SHOT: 'Critical Grape Shot',
    ItemGlobals.CRITICAL_FIREBRAND: 'Critical Firebrand',
    ItemGlobals.CRITICAL_FURY: 'Critical Fury',
    ItemGlobals.RANGE_ROUND_SHOT: 'Extra Round Shot Range',
    ItemGlobals.RANGE_CHAIN_SHOT: 'Extra Chain Shot Range',
    ItemGlobals.RANGE_EXPLOSIVE: 'Extra Explosive Range',
    ItemGlobals.RANGE_GRAPE_SHOT: 'Extra Grape Shot Range',
    ItemGlobals.RANGE_FIREBRAND: 'Extra Firebrand Range',
    ItemGlobals.RANGE_FURY: 'Extra Fury Range',
    ItemGlobals.IMMUNITY_POISON: 'Poison Immunity',
    ItemGlobals.IMMUNITY_ACID: 'Acid Immunity',
    ItemGlobals.IMMUNITY_BLIND: 'Blindness Immunity',
    ItemGlobals.IMMUNITY_FIRE: 'Fire Immunity',
    ItemGlobals.IMMUNITY_HOLD: 'Snare Immunity',
    ItemGlobals.IMMUNITY_STUN: 'Stun Immunity',
    ItemGlobals.IMMUNITY_PAIN: 'Pain Immunity',
    ItemGlobals.IMMUNITY_CURSE: 'Cursed Immunity',
    ItemGlobals.IMMUNITY_WEAKEN: 'Weaken Immunity',
    ItemGlobals.IMMUNITY_LIFEDRAIN: 'Life Drain Immunity',
    ItemGlobals.HALF_DURATION_POISON: 'Poison Resistance',
    ItemGlobals.HALF_DURATION_ACID: 'Acid Resistance',
    ItemGlobals.HALF_DURATION_BLIND: 'Blindness Resistance',
    ItemGlobals.HALF_DURATION_FIRE: 'Fire Resistance',
    ItemGlobals.HALF_DURATION_HOLD: 'Snare Resistance',
    ItemGlobals.HALF_DURATION_STUN: 'Stun Resistance',
    ItemGlobals.HALF_DURATION_CURSE: 'Cursed Resistance',
    ItemGlobals.HALF_DURATION_PAIN: 'Pain Resistance',
    ItemGlobals.HALF_DURATION_WOUND: 'Wounded Resistance',
    ItemGlobals.HALF_DAMAGE_LIFEDRAIN: 'Life Drain Resistance',
    ItemGlobals.HALF_DAMAGE_SOULTAP: 'Desolation Resistance',
    ItemGlobals.NAVIGATION: 'Navigation',
...
ItemAttributeDescriptions = {
    ItemGlobals.CRITICAL: 'High chance to deal Critical Damage!',
    ItemGlobals.VENOM: 'Poisons the target.',
    ItemGlobals.POWERFUL: 'Increases the damage of the weapon.',
    ItemGlobals.PROTECT_COMBAT: 'Combat Protection',
    ItemGlobals.PROTECT_MISSILE: 'Projectile Protection',
    ItemGlobals.PROTECT_MAGIC: 'Magic Protection',
    ItemGlobals.PROTECT_GRENADE: 'Grenade Protection',
    ItemGlobals.DAMAGE_MANA: "Damages the enemy's Voodoo Power.",
    ItemGlobals.SURE_FOOTED: 'You cannot be Knocked Down.',
    ItemGlobals.BLOOD_FIRE: 'Defeating enemies makes your sword burn and deal more damage!',
    ItemGlobals.INFINITE_VENOM_SHOT: 'Unlimited gun ammo',
    ItemGlobals.INFINITE_BANE_SHOT: 'Unlimited gun ammo',
    ItemGlobals.INFINITE_HEX_EATER_SHOT: 'Unlimited gun ammo',
    ItemGlobals.INFINITE_SILVER_SHOT: 'Unlimited gun ammo',
    ItemGlobals.INFINITE_STEEL_SHOT: 'Unlimited gun ammo',
    ItemGlobals.INFINITE_ASP: 'Unlimited dagger ammo',
    ItemGlobals.INFINITE_ADDER: 'Unlimited dagger ammo',
    ItemGlobals.INFINITE_SIDEWINDER: 'Unlimited dagger ammo',
    ItemGlobals.INFINITE_VIPER_NEST: 'Unlimited dagger ammo',
    ItemGlobals.INFINITE_CHAIN_SHOT: 'Unlimited cannon ammo',
    ItemGlobals.INFINITE_EXPLOSIVE: 'Unlimited cannon ammo',
    ItemGlobals.INFINITE_GRAPE_SHOT: 'Unlimited cannon ammo',
    ItemGlobals.INFINITE_FIREBRAND: 'Unlimited cannon ammo',
    ItemGlobals.INFINITE_THUNDERBOLT: 'Unlimited cannon ammo',
    ItemGlobals.INFINITE_FURY: 'Unlimited cannon ammo',
    ItemGlobals.LEECH_HEALTH: 'Steals health when damaging the enemy.',
    ItemGlobals.LEECH_VOODOO: 'Steals voodoo when damaging the enemy.',
    ItemGlobals.CRITICAL_ROUND_SHOT: 'Chance for Critical Damage with this ammo',
    ItemGlobals.CRITICAL_CHAIN_SHOT: 'Chance for Critical Damage with this ammo',
    ItemGlobals.CRITICAL_EXPLOSIVE: 'Chance for Critical Damage with this ammo',
    ItemGlobals.CRITICAL_GRAPE_SHOT: 'Chance for Critical Damage with this ammo',
    ItemGlobals.CRITICAL_FIREBRAND: 'Chance for Critical Damage with this ammo',
    ItemGlobals.CRITICAL_FURY: 'Chance for Critical Damage with this ammo',
    ItemGlobals.RANGE_ROUND_SHOT: 'Increased Range for this ammo',
    ItemGlobals.RANGE_CHAIN_SHOT: 'Increased Range for this ammo',
    ItemGlobals.RANGE_EXPLOSIVE: 'Increased Range for this ammo',
    ItemGlobals.RANGE_GRAPE_SHOT: 'Increased Range for this ammo',
    ItemGlobals.RANGE_FIREBRAND: 'Increased Range for this ammo',
    ItemGlobals.RANGE_FURY: 'Increased Range for this ammo',
    ItemGlobals.IMMUNITY_POISON: '',
    ItemGlobals.IMMUNITY_ACID: '',
    ItemGlobals.IMMUNITY_BLIND: '',
    ItemGlobals.IMMUNITY_FIRE: '',
    ItemGlobals.IMMUNITY_HOLD: '',
    ItemGlobals.IMMUNITY_STUN: '',
    ItemGlobals.IMMUNITY_PAIN: '',
    ItemGlobals.IMMUNITY_CURSE: '',
    ItemGlobals.IMMUNITY_WEAKEN: '',
    ItemGlobals.IMMUNITY_LIFEDRAIN: '',
    ItemGlobals.HALF_DURATION_POISON: 'Half duration from Poison',
    ItemGlobals.HALF_DURATION_ACID: 'Half duration from Acid',
    ItemGlobals.HALF_DURATION_BLIND: 'Half duration from Blindness',
    ItemGlobals.HALF_DURATION_FIRE: 'Half duration from Fire',
    ItemGlobals.HALF_DURATION_HOLD: 'Half duration from Snare',
    ItemGlobals.HALF_DURATION_STUN: 'Half duration from Stun',
    ItemGlobals.HALF_DURATION_CURSE: 'Half duration from Curse',
    ItemGlobals.HALF_DURATION_PAIN: 'Half duration from Pain',
    ItemGlobals.HALF_DURATION_WOUND: 'Half duration from Wound',
    ItemGlobals.HALF_DAMAGE_LIFEDRAIN: 'Half damage from Life Drain',
    ItemGlobals.HALF_DAMAGE_SOULTAP: 'Half damage from Desolation',
    ItemGlobals.NAVIGATION: 'Faster Recharge on Full Sail, Come About, and Ramming Speed' }
...
And = 'and'
SkillDescriptions = {
    InventoryType.MeleeJab: ('A quick move which deals damage to your opponent!', '', '', '', 0),
    InventoryType.MeleePunch: ('A basic fighting technique known by all infamous pirates!', '', '', '', 0),
    InventoryType.MeleeKick: ('Knock down yerr foes!', '', '', '', 0),
    InventoryType.MeleeRoundhouse: ('A finishing move known only by the most skilled!', '', '', '', 0),
    InventoryType.MeleeHeadbutt: ('Enough damage can be done doing this...', '', '', '', 0),
    InventoryType.MeleeHaymaker: ('A forceful blow!', '', '', '', 0),
    InventoryType.MeleeThrowDirt: ('Fight dirty!', '', '', '', 0),
    InventoryType.MeleeToughness: ('Stay strong infront of your toughest enemies!', '', '', '', 0),
    InventoryType.MeleeIronSkin: ('Nothing can pierce you! Or can it...?', '', '', '', 0),
    InventoryType.MeleeDetermination: ('Nothing is impossible!', '', '', '', 0),
    InventoryType.CutlassHack: (ComboSkill, 'A quick opening attack!', '', ClickToLearnCombo, 0),
    InventoryType.CutlassSlash: (ComboSkill, 'A broad slash!', '', ClickToLearnCombo, 0),
    InventoryType.CutlassCleave: (ComboSkill, 'A mighty overhead cleave!', '', ClickToLearnCombo, 0),
    InventoryType.CutlassFlourish: (ComboSkill, 'A series of fast slashes!', '', ClickToLearnCombo, 0),
    InventoryType.CutlassStab: (ComboSkill, 'A fancy finishing thrust!', '', ClickToLearnCombo, 0),
    InventoryType.CutlassParry: (PassiveSkill, 'Parry enemy attacks! %d%% chance to block incoming Combat Attacks!', 'Upgrade to increase your chance to Parry!', '', 1),
    InventoryType.CutlassEndurance: (PassiveSkill, 'Increases your maximum Health by %d%%!', 'Upgrade to increase your maximum Health!', '', 1),
    InventoryType.CutlassTaunt: (CombatSkill, 'Pulls enemy Aggression!', '', '', 0),
    InventoryType.CutlassBrawl: (CombatSkill, 'Fight dirty!', '', '', 0),
    InventoryType.CutlassSweep: (CombatSkill, 'A wide circular slash! Hits all nearby enemies!', '', '', 0),
    InventoryType.CutlassBladestorm: (CombatSkill, 'Delivers a barrage of sword slashes!', '', '', 0),
    EnemySkills.CUTLASS_ROLLTHRUST: (CombatSkill, 'A quick rolling strike!', '', '', 0),
    EnemySkills.CUTLASS_CURSED_FIRE: (CombatSkill, 'Uses Voodoo to burn the enemy!', '', '', 0),
    EnemySkills.CUTLASS_CURSED_ICE: (CombatSkill, 'Uses Voodoo to freeze the enemy in their tracks!', '', '', 0),
    EnemySkills.CUTLASS_CURSED_THUNDER: (CombatSkill, 'Uses Voodoo to strike the enemy with lightning!', '', '', 0),
    EnemySkills.CUTLASS_BLOWBACK: (CombatSkill, 'Knocks down all nearby foes!', '', '', 0),
    EnemySkills.CUTLASS_CAPTAINS_FURY: (CombatSkill, 'Powerful spinning attack!', '', '', 0),
    EnemySkills.CUTLASS_MASTERS_RIPOSTE: (CombatSkill, 'Increased Parry rate for a short time.', '', '', 0),
    EnemySkills.CUTLASS_POWER_ATTACK: (CombatSkill, 'A strong jumping slice!', '', '', 0),
    EnemySkills.CUTLASS_SKEWER: (CombatSkill, 'Pierce through enemies in a row! Causes Wounding.', '', '', 0),
    EnemySkills.CUTLASS_FIRE_BREAK: (CombatSkill, 'Release a wave of cursed burning flames!', '', '', 0),
    EnemySkills.CUTLASS_ICE_BREAK: (CombatSkill, 'Freezes all nearby enemies in place!', '', '', 0),
    EnemySkills.CUTLASS_THUNDER_BREAK: (CombatSkill, 'Strikes all nearby enemies with lightning!', '', '', 0),
    EnemySkills.BROADSWORD_HACK: (ComboSkill, 'A broad opening swing!', '', ClickToLearnCombo, 0),
    EnemySkills.BROADSWORD_SLASH: (ComboSkill, 'A mighty slash that hits nearby enemies!', '', ClickToLearnCombo, 0),
    EnemySkills.BROADSWORD_CLEAVE: (ComboSkill, 'A spinning cut that hits all nearby enemies!', '', ClickToLearnCombo, 0),
    EnemySkills.BROADSWORD_FLOURISH: (ComboSkill, 'A reverse spinning slash that hits all nearby enemies!', '', ClickToLearnCombo, 0),
    ...
    InventoryType.PistolShoot: (AttackSkill, 'Basic shooting skill.', '', '', 0),
    InventoryType.PistolTakeAim: (AttackSkill, 'Hold down the attack button for an Aimed Shot! Increases the accuracy, range, and damage of the shot!', '', '', 0),
    InventoryType.PistolEagleEye: (PassiveSkill, 'Increases the maximum range for Firearms and ranged Dagger attacks by %d%%!', 'Upgrade to increase Range bonus of this Skill!', '', 1),
    InventoryType.PistolDodge: (PassiveSkill, '%d%% chance to Dodge incoming Ranged Attacks.', 'Upgrade to increase your chance to Dodge!', '', 1),
    InventoryType.PistolSharpShooter: (PassiveSkill, 'Increases accuracy for Firearms and ranged Dagger attacks by %d%%!', 'Upgrade Accuracy boost for Firearms and ranged Dagger attacks!', '', 1),
    InventoryType.PistolLeadShot: (AmmoSkill, 'Standard Ammunition.', '', ClickToLearnAmmo, 0),
    InventoryType.PistolBaneShot: (AmmoSkill, 'A cursed bullet.', '', ClickToLearnAmmo, 0),
    InventoryType.PistolSilverShot: (AmmoSkill, 'Made from solid silver.', '', ClickToLearnAmmo, 0),
    InventoryType.PistolHexEaterShot: (AmmoSkill, 'Damages ' + ManaName + ' as well as Health.', '', ClickToLearnAmmo, 0),
    InventoryType.PistolSteelShot: (AmmoSkill, 'The strongest metal shot.', '', ClickToLearnAmmo, 0),
    InventoryType.PistolVenomShot: (AmmoSkill, 'Coated with deadly venom.', '', ClickToLearnAmmo, 0),
    EnemySkills.PISTOL_SCATTERSHOT: (AttackSkill, 'Standard Blunderbuss spread-shot!', '', '', 0),
    EnemySkills.PISTOL_SCATTERSHOT_AIM: (AttackSkill, 'Hold down the attack button for an Aimed Shot! Increases the accuracy, range, and damage of the shot!', '', '', 0),
    EnemySkills.PISTOL_DEADEYE: (AttackSkill, 'Snipe your enemies from afar!', '', '', 0),
    EnemySkills.PISTOL_QUICKLOAD: (AttackSkill, 'Fire without reloading for a short time!', '', '', 0),
    EnemySkills.PISTOL_STUNSHOT: (AttackSkill, 'One deafening gun blast!', '', '', 0),
    EnemySkills.PISTOL_BREAKSHOT: (AttackSkill, 'A devastating canister shot!', '', '', 0),
    EnemySkills.PISTOL_POINT_BLANK: (AttackSkill, 'Deals one powerful attack that is more powerful up close!', '', '', 0),
    EnemySkills.PISTOL_HOTSHOT: (AttackSkill, 'Heated fiery ammunition!', '', '', 0),
    EnemySkills.PISTOL_RAPIDFIRE: (AttackSkill, 'Fire a blaze of bullets at the enemy!', '', '', 0),
    EnemySkills.BAYONET_PLAYER_RUSH: (AttackSkill, 'A standard Navy combo!', '', '', 0),
    EnemySkills.BAYONET_PLAYER_BASH: (AttackSkill, 'A crippling attack!', '', '', 0),
    EnemySkills.BAYONET_RUSH: (AttackSkill, 'A standard Navy combo!', '', '', 0),
    EnemySkills.BAYONET_BASH: (AttackSkill, 'A crippling attack!', '', '', 0),
    EnemySkills.BAYONET_DISABLE: (AttackSkill, 'Knockdown and disables one enemy!', '', '', 0),
    InventoryType.MusketShoot: ('', '', '', '', 0),
    InventoryType.MusketTakeAim: ('', '', '', '', 0),
    InventoryType.MusketDeadeye: ('', '', '', '', 0),
    InventoryType.MusketEagleEye: ('', '', '', '', 0),
    InventoryType.MusketCrackShot: ('', '', '', '', 0),
    InventoryType.MusketMarksman: ('', '', '', '', 0),
    InventoryType.MusketLeadShot: ('', '', '', ClickToLearnAmmo, 0),
    InventoryType.MusketScatterShot: ('', '', '', ClickToLearnAmmo, 0),
    InventoryType.MusketCursedShot: ('', '', '', ClickToLearnAmmo, 0),
    InventoryType.MusketCoalfireShot: ('', '', '', ClickToLearnAmmo, 0),
    InventoryType.MusketHeavySlug: ('', '', '', ClickToLearnAmmo, 0),
    InventoryType.MusketExploderShot: ('', '', '', ClickToLearnAmmo, 0),
    InventoryType.SailBroadsideLeft: (ShipSkill, 'Fire left broadside.', 'Upgrade to increase Left Broadside Cannonball damage!', ClickToLearnManeuver, 1),
    InventoryType.SailBroadsideRight: (ShipSkill, 'Fire right broadside.', 'Upgrade to increase Right Broadside Cannonball damage!', ClickToLearnManeuver, 1),
    InventoryType.SailFullSail: (ShipSkill, "Coaxes a short burst of speed out of the ship. Interrupts the 'Come About' Maneuver.", 'Upgrade to increase Maneuver duration!', ClickToLearnManeuver, 0),
    InventoryType.SailComeAbout: (ShipSkill, "Allows your ship to make a hard sudden turn. Interrupts the 'Full Sail' Maneuver.", 'Upgrade to increase Maneuver duration!', ClickToLearnManeuver, 0),
    InventoryType.SailOpenFire: (OrderSkill, 'Call upon your shipmates to fire cannons for great effect!', 'Upgrade to increase Open Fire duration!', '', 0),
    InventoryType.SailRammingSpeed: (ShipSkill, 'Bear down upon an enemy vessel and ram it into splinters! Interrupts all other Sailing Maneuvers.', 'Upgrade to improve ship ramming damage!', ClickToLearnManeuver, 0),
    InventoryType.SailTakeCover: (OrderSkill, 'Protect your ship and shipmates from incoming fire.', 'Upgrade to increase Take Cover duration!', '', 0),
    InventoryType.SailPowerRecharge: (ShipSkill, 'Temporarily increases the rate of recharging sailing and cannon skills for the ship.', 'Unlocked after you recover the Black Pearl!', '', 0),
    InventoryType.SailWindcatcher: (PassiveSkill, 'A master of the sail, you know how to catch the wind in your sails for maximum speed. Increases ship speed by %d%%!', 'Upgrade to increase Speed bonus!', '', 1),
    InventoryType.SailTacking: (PassiveSkill, 'Superior knowledge of the rigging allows you to turn more rapidly. Improves ship turning radius by %d%%!', 'Upgrade to increase Maneuverability bonus!', '', 1),
    InventoryType.SailTreasureSense: (PassiveSkill, 'Your endeavours always seem to uncover more gold. Increases the quality of cargo drops by %d%%!', 'Upgrade to increase Cargo Drop bonus!', '', 1),
    InventoryType.SailTaskmaster: (PassiveSkill, 'A harsh taskmaster can get his shipmates to reload his cannons faster. Decreases cooldown time for Broadsides by %d%%!', 'Upgrade to decrease Broadside cooldown time!', '', 1),
    EnemySkills.SAIL_WRECK_HULL: (OrderSkill, 'Call upon your shipmates to fire cannons at hulls for great effect!', 'Upgrade to increase Wreck the Hull duration!', '', 0),
    EnemySkills.SAIL_WRECK_MASTS: (OrderSkill, 'Call upon your shipmates to fire cannons at sail and masts for great effect!', 'Upgrade to increase Wreck the Masts duration!', '', 0),
    EnemySkills.SAIL_SINK_HER: (OrderSkill, 'Call upon your shipmates to fire cannons at broken hull panels for great effect!', 'Upgrade to increase Sink Her duration!', '', 0),
    EnemySkills.SAIL_INCOMING: (OrderSkill, 'Protect your ship from incoming fire! Decreses ship damage but lowers broadside damage.', 'Upgrade to increase Incoming duration!', '', 0),
    EnemySkills.SAIL_FIX_IT_NOW: (OrderSkill, 'Call upon your shipmates to fix the ship! Increases ship repair effect.', 'Upgrade to increase Fix It Now duration!', '', 0),
    InventoryType.DaggerCut: (ComboSkill, 'An opening cut! Deals extra damage when striking a foe in the back!', '', ClickToLearnCombo, 0),
    InventoryType.DaggerSwipe: (ComboSkill, 'A whirling dagger attack! Deals extra damage when striking a foe in the back!', '', ClickToLearnCombo, 0),
    InventoryType.DaggerGouge: (ComboSkill, 'A powerful downward slice! Deals extra damage when striking a foe in the back!', '', ClickToLearnCombo, 0),
    InventoryType.DaggerEviscerate: (ComboSkill, 'Delivers three quick cuts! Deals extra damage when striking a foe in the back!', '', ClickToLearnCombo, 0),
    InventoryType.DaggerFinesse: (PassiveSkill, 'Decreases cooldown time for Dagger and Sword Skills by %d%%!', 'Upgrade to decrease Dagger and Sword Skill cooldown times!', '', 1),
    InventoryType.DaggerBladeInstinct: (PassiveSkill, 'Increases Sword and Dagger Combat damage by %d%%!', 'Upgrade to increase Sword and Dagger damage!', '', 1),
    InventoryType.DaggerAsp: (ThrowSkill, 'Basic dagger throw!', '', '', 0),
    InventoryType.DaggerAdder: (ThrowSkill, 'Poisoned dagger throw!', '', '', 0),
    InventoryType.DaggerThrowDirt: (CombatSkill, 'Fight dirty!', '', '', 0),
    InventoryType.DaggerSidewinder: (ThrowSkill, 'Sidearm dagger throw!', '', '', 0),
    InventoryType.DaggerViperNest: (ThrowSkill, 'Throw a brace of daggers!', '', '', 0),
    EnemySkills.DAGGER_COUP: (CombatSkill, 'A graceful finishing move!', '', '', 0),
    EnemySkills.DAGGER_DAGGERRAIN: (ThrowSkill, 'Throw a trio of daggers!', '', '', 0),
    EnemySkills.DAGGER_THROW_COMBO_1: (ComboSkill, 'Opening dagger toss.', '', '', 0),
    EnemySkills.DAGGER_THROW_COMBO_2: (ComboSkill, 'Left-hand dagger throw.', '', '', 0),
    EnemySkills.DAGGER_THROW_COMBO_3: (ComboSkill, 'Double dagger throw!', '', '', 0),
    EnemySkills.DAGGER_THROW_COMBO_4: (ComboSkill, 'Double backhanded dagger throw!', '', '', 0),
    EnemySkills.DAGGER_BARRAGE: (ThrowSkill, 'Strikes all nearby enemies with flying daggers!', '', '', 0),
    EnemySkills.DAGGER_ICEBARRAGE: (ThrowSkill, 'Freezes all nearby targets with icy daggers!', '', '', 0),
    EnemySkills.DAGGER_BACKSTAB: (CombatSkill, 'One powerful slash. Usable only when behind the enemy.', '', '', 0),
    EnemySkills.DAGGER_VENOMSTAB: (CombatSkill, 'A venomous dagger slash!', '', '', 0),
    EnemySkills.DAGGER_ACIDDAGGER: (ThrowSkill, 'A potent acidic throwing knife!', '', '', 0),
    InventoryType.GrenadeThrow: (AttackSkill, 'Fire in the hole! Basic grenade throwing skill.', '', '', 0),
    InventoryType.GrenadeExplosion: (AmmoSkill, 'A hefty grenade!', '', ClickToLearnAmmo, 0),
    InventoryType.GrenadeShockBomb: (AmmoSkill, 'A weak but stunning grenade!', '', ClickToLearnAmmo, 0),
    InventoryType.GrenadeFireBomb: (AmmoSkill, 'A flammable concoction!', '', ClickToLearnAmmo, 0),
    InventoryType.GrenadeSmokeCloud: (AmmoSkill, 'A smoke grenade that can used to obscure vision.', '', ClickToLearnAmmo, 0),
    InventoryType.GrenadeSiege: (AmmoSkill, 'A powerful siege bomb! Watch out, it is heavy!', '', ClickToLearnAmmo, 0),
    InventoryType.GrenadeLongVolley: (CombatSkill, 'Hold down the attack button to throw the grenade farther!  The longer you hold down the button, the further it will go!', '', '', 0),
    InventoryType.GrenadeDemolitions: (PassiveSkill, 'Increases the area of effect for your Grenade and Cannonball explosions!', 'Upgrade to increase Area of Effect bonus!', '', 0),
    InventoryType.GrenadeDetermination: (PassiveSkill, 'Increases your Health Recovery rate by %d%%!', 'Upgrade to increase your Health Recovery rate!', '', 1),
    InventoryType.GrenadeToughness: (PassiveSkill, 'Decreases damage suffered by incoming Grenades and Cannonballs by %d%%', 'Upgrade to increase your damage resistance to Grenades and Cannonballs!', '', 1),
    InventoryType.GrenadeIgnorePain: (PassiveSkill, 'Stun and Slow effect durations are reduced by %d%%!', 'Upgrade to increase Slow recovery speed!', '', 1),
    InventoryType.DollAttune: (AttackSkill, 'Attune the doll to a target in order to cast Hexes!', 'Upgrade to gain the ability to Attune the doll to 1 additional friend or enemy!', '', 0),
    InventoryType.DollPoke: (HexSkill, 'Poke attack!', '', '', 0),
    InventoryType.DollSwarm: (HexSkill, 'Summon insects to attack the enemy!', '', '', 0),
    InventoryType.DollHeal: (HexSkill, 'Heals a friendly pirate!', '', '', 0),
    InventoryType.DollBurn: (HexSkill, 'Sets enemies on fire!', '', '', 0),
    InventoryType.DollShackles: (HexSkill, 'Chains from the grave wrap around the enemy!', '', '', 0),
    InventoryType.DollCure: (HexSkill, 'Heals a friendly pirate and removes hostile effect Buffs from a friendly pirate!', '', '', 0),
    InventoryType.DollCurse: (HexSkill, 'Curses your opponent!', '', '', 0),
    InventoryType.DollLifeDrain: (HexSkill, 'Drain vitality from the victim.', '', '', 0),
    InventoryType.DollFocus: (PassiveSkill, 'Increases your maximum ' + ManaName + ' amount by %d%%!', 'Upgrade to increase your maximum ' + ManaName + '!', '', 1),
    InventoryType.DollSpiritWard: (PassiveSkill, '%d%% chance to Resist enemy Voodoo!', 'Upgrade to increase your chance to Resist enemy Voodoo!', '', 1),
    EnemySkills.DOLL_REGENERATION: (HexSkill, 'Heals health over time.', '', '', 0),
    EnemySkills.DOLL_SPIRIT_MEND: (HexSkill, 'Heals all targets without splitting the healing!', '', '', 0),
    EnemySkills.DOLL_WIND_GUARD: (HexSkill, 'Protects other pirates from ranged attacks!', '', '', 0),
    EnemySkills.DOLL_RED_FURY: (HexSkill, 'Increases the strength of friendly pirates!', '', '', 0),
    EnemySkills.DOLL_SPIRIT_GUARD: (HexSkill, 'Protects other pirates from combat attacks!', '', '', 0),
    EnemySkills.DOLL_HEX_GUARD: (HexSkill, 'Protects other pirates from voodoo attacks!', '', '', 0),
    EnemySkills.DOLL_EVIL_EYE: (AttackSkill, 'Attune targets from a distance!', '', '', 0),
    InventoryType.StaffBlast: (AttackSkill, '', '', '', 0),
    InventoryType.StaffWither: (HexSkill, '', '', '', 0),
    InventoryType.StaffSoulFlay: (HexSkill, '', '', '', 0),
    InventoryType.StaffPestilence: (HexSkill, '', '', '', 0),
    InventoryType.StaffHellfire: (HexSkill, '', '', '', 0),
    InventoryType.StaffBanish: (HexSkill, '', '', '', 0),
    InventoryType.StaffDesolation: (HexSkill, '', '', '', 0),
    InventoryType.StaffConcentration: (PassiveSkill, 'Increases your ' + ManaName + ' Recovery rate by %d%%!', 'Upgrade to increase your ' + ManaName + ' Recovery rate!', '', 1),
    InventoryType.StaffSpiritLore: (PassiveSkill, 'Increases Casting Speed for the Voodoo Staff by %d%%!', 'Upgrade to increase Casting Speed for the Voodoo Staff!', '', 1),
    InventoryType.StaffConservation: (PassiveSkill, 'Decreases ' + ManaName + ' used by Voodoo Staff and Voodoo Doll by %d%%!', 'Upgrade to decrease ' + ManaName + ' usage for Voodoo Staff and Voodoo Doll!', '', 1),
    InventoryType.StaffSpiritMastery: (PassiveSkill, 'Increases damage of Voodoo Doll and Staff Voodoo Hexes by %d%%!', 'Upgrade to increase Staff and Doll Voodoo Hex damage!', '', 1),
    EnemySkills.STAFF_TOGGLE_AURA_WARDING: (HexSkill, 'Boosts defense on all nearby Pirates.', '', '', 0),
    EnemySkills.STAFF_TOGGLE_AURA_NATURE: (HexSkill, 'Slowly heals all nearby Pirates.', '', '', 0),
    EnemySkills.STAFF_TOGGLE_AURA_DARK: (HexSkill, 'Boosts attack on all nearby Pirates.', '', '', 0),
    InventoryType.CannonShoot: (AttackSkill, 'Basic Cannoneering Skill!', 'Upgrade to increase Cannon firing rate!', '', 1),
    InventoryType.CannonRoundShot: (AmmoSkill, 'Medium ranged shot! Effective against ship hulls!', '', ClickToLearnAmmo, 0),
    InventoryType.CannonChainShot: (AmmoSkill, 'Short ranged shot! Effective against masts & sails!', '', ClickToLearnAmmo, 0),
    InventoryType.CannonExplosive: (AmmoSkill, 'Explodes and damages a large area!', '', ClickToLearnAmmo, 0),
    InventoryType.CannonBullet: (AmmoSkill, '', '', ClickToLearnAmmo, 0),
    InventoryType.CannonGasCloud: (AmmoSkill, '', '', ClickToLearnAmmo, 0),
    InventoryType.CannonGrapeShot: (AmmoSkill, 'Short ranged spread-shot! Slows enemy Ship Repair during PvP. Effective against Sea Monsters!', '', ClickToLearnAmmo, 0),
    InventoryType.CannonSkull: (AmmoSkill, '', '', ClickToLearnAmmo, 0),
    InventoryType.CannonFirebrand: (AmmoSkill, 'Flaming cannonballs set fire to enemy ships.', '', ClickToLearnAmmo, 0),
    InventoryType.CannonFlameCloud: (AmmoSkill, '', '', ClickToLearnAmmo, 0),
    InventoryType.CannonFlamingSkull: (AmmoSkill, 'Flaming cannonballs set fire to enemy ships.', '', ClickToLearnAmmo, 0),
    InventoryType.CannonBarShot: (AmmoSkill, '', '', ClickToLearnAmmo, 0),
    InventoryType.CannonKnives: (AmmoSkill, '', '', ClickToLearnAmmo, 0),
    InventoryType.CannonMine: (AmmoSkill, '', '', ClickToLearnAmmo, 0),
    InventoryType.CannonBarnacles: (AmmoSkill, '', '', ClickToLearnAmmo, 0),
    InventoryType.CannonThunderbolt: (AmmoSkill, 'Summons a thunderbolt to strike the enemy ship!', '', ClickToLearnAmmo, 0),
    InventoryType.CannonFury: (AmmoSkill, 'A spectral cannonball!', '', ClickToLearnAmmo, 0),
    InventoryType.CannonComet: (AmmoSkill, '', '', ClickToLearnAmmo, 0),
    InventoryType.CannonGrappleHook: (AmmoSkill, 'Used for grappling enemy ships for boarding actions!', '', ClickToLearnAmmo, 0),
    InventoryType.CannonRapidReload: (PassiveSkill, 'Increases Cannon reloading speed by %d%%!', 'Upgrade to increase Cannon reloading speed!', '', 1),
    InventoryType.CannonBarrage: (PassiveSkill, 'Increases damage for Cannon and Grenade attacks by %d%%!', 'Upgrade to increase Cannon and Grenade damage!', '', 1),
    InventoryType.CannonShrapnel: (PassiveSkill, 'Upgrade your Cannonballs and Grenades to explode in a cloud of shrapnel!', 'Upgrade to increase Shrapnel Wounding duration!', '', 0),
    InventoryType.Potion1: (Consumable, '', '', '', 0),
    InventoryType.Potion2: (Consumable, '', '', '', 0),
    InventoryType.Potion3: (Consumable, '', '', '', 0),
    InventoryType.Potion4: (Consumable, '', '', '', 0),
    InventoryType.Potion5: (Consumable, '', '', '', 0),
    InventoryType.CannonDamageLvl1: (Consumable, '', '', '', 0),
    InventoryType.CannonDamageLvl2: (Consumable, '', '', '', 0),
    InventoryType.CannonDamageLvl3: (Consumable, '', '', '', 0),
    InventoryType.PistolDamageLvl1: (Consumable, '', '', '', 0),
    InventoryType.PistolDamageLvl2: (Consumable, '', '', '', 0),
    InventoryType.PistolDamageLvl3: (Consumable, '', '', '', 0),
    InventoryType.CutlassDamageLvl1: (Consumable, '', '', '', 0),
    InventoryType.CutlassDamageLvl2: (Consumable, '', '', '', 0),
    InventoryType.CutlassDamageLvl3: (Consumable, '', '', '', 0),
    InventoryType.DollDamageLvl1: (Consumable, '', '', '', 0),
    InventoryType.DollDamageLvl2: (Consumable, '', '', '', 0),
    InventoryType.DollDamageLvl3: (Consumable, '', '', '', 0),
    InventoryType.HastenLvl1: (Consumable, '', '', '', 0),
    InventoryType.HastenLvl2: (Consumable, '', '', '', 0),
    InventoryType.HastenLvl3: (Consumable, '', '', '', 0),
    InventoryType.RepBonusLvl1: (Consumable, '', '', '', 0),
    InventoryType.RepBonusLvl2: (Consumable, '', '', '', 0),
    InventoryType.RepBonusLvl3: (Consumable, '', '', '', 0),
    InventoryType.RepBonusLvlComp: (Consumable, '', '', '', 0),
    InventoryType.GoldBonusLvl1: (Consumable, '', '', '', 0),
    InventoryType.GoldBonusLvl2: (Consumable, '', '', '', 0),
    InventoryType.InvisibilityLvl1: (Consumable, '', '', '', 0),
    InventoryType.InvisibilityLvl2: (Consumable, '', '', '', 0),
    InventoryType.RegenLvl1: (Consumable, '', '', '', 0),
    InventoryType.RegenLvl2: (Consumable, '', '', '', 0),
    InventoryType.RegenLvl3: (Consumable, '', '', '', 0),
    InventoryType.RegenLvl4: (Consumable, '', '', '', 0),
    InventoryType.Burp: (Consumable, '', '', '', 0),
    InventoryType.Fart: (Consumable, '', '', '', 0),
    InventoryType.FartLvl2: (Consumable, '', '', '', 0),
    InventoryType.Vomit: (Consumable, '', '', '', 0),
    InventoryType.HeadGrow: (Consumable, '', '', '', 0),
    InventoryType.FaceColor: (Consumable, '', '', '', 0),
    InventoryType.SizeReduce: (Consumable, '', '', '', 0),
    InventoryType.SizeIncrease: (Consumable, '', '', '', 0),
    InventoryType.HeadFire: (Consumable, '', '', '', 0),
    InventoryType.ScorpionTransform: (Consumable, '', '', '', 0),
    InventoryType.AlligatorTransform: (Consumable, '', '', '', 0),
    InventoryType.CrabTransform: (Consumable, '', '', '', 0),
    InventoryType.AccuracyBonusLvl1: (Consumable, '', '', '', 0),
    InventoryType.AccuracyBonusLvl2: (Consumable, '', '', '', 0),
    InventoryType.AccuracyBonusLvl3: (Consumable, '', '', '', 0),
    InventoryType.RemoveGroggy: (Consumable, '', '', '', 0),
    InventoryType.ShipRepairKit: (ShipRepairSkill, '', '', '', 0),
    InventoryType.PorkChunk: (Consumable, '', '', '', 0),
    EnemySkills.MISC_CLEANSE: (AttackSkill, 'Removes all negative status effects!', '', '', 0),
    EnemySkills.MISC_DARK_CURSE: (AttackSkill, 'Dark Form prevents half damage from ranged and combat attacks!', '', '', 0),
    EnemySkills.MISC_GHOST_FORM: (AttackSkill, 'Ghost Form prevents half damage from ranged and combat attacks!', '', '', 0),
    EnemySkills.MISC_FEINT: (AttackSkill, 'Auto-dodges one melee attack.', '', '', 0),
    EnemySkills.MISC_HEX_WARD: (AttackSkill, 'Auto-resists one voodoo attack.', '', '', 0),
    EnemySkills.MISC_CAPTAINS_RESOLVE: (AttackSkill, 'Heals all nearby pirates!', '', '', 0),
    EnemySkills.MISC_NOT_IN_FACE: (AttackSkill, 'This might make the enemy stop attacking you.', '', '', 0),
    EnemySkills.MISC_ACTIVATE_VOODOO_REFLECT: (AttackSkill, 'Reflects all voodoo magic back to the caster.', '', '', 0),
    EnemySkills.MISC_MONKEY_PANIC: (AttackSkill, 'Go bananas! Increases health and attack power!', '', '', 0),
    EnemySkills.MISC_FIRST_AID: (AttackSkill, 'Uses Voodoo Power to heal yourself!', '', '', 0) }
...
WeaponDescriptions = {
    ...
    InventoryType.PorkChunk: 'A tasty chunk of pork.',
    ...
    InventoryType.RegularLure: 'Use it to catch everything from trout to tiger sharks',
    InventoryType.LegendaryLure: 'An ancient Mayan lure used to hunt the legends of the sea' }
ShipDescriptions = {
    ...
    ItemId.P_NAVY_KINGFISHER: SloopDescription,
    ItemId.P_EITC_WARLORD: WarshipDescription,
    ItemId.HMS_VICTORY: WarshipDescription,
    ItemId.HMS_NEWCASTLE: WarshipDescription,
    ItemId.HMS_INVINCIBLE: WarshipDescription,
    ItemId.EITC_INTREPID: WarshipDescription,
    ItemId.EITC_CONQUERER: WarshipDescription,
    ItemId.EITC_LEVIATHAN: WarshipDescription,
    ItemId.NAVY_FERRET: SloopDescription,
    ItemId.NAVY_BULWARK: MerchantDescription,
    ItemId.NAVY_PANTHER: WarshipDescription,
    ItemId.NAVY_GREYHOUND: SloopDescription,
    ItemId.NAVY_VANGUARD: MerchantDescription,
    ItemId.NAVY_CENTURION: WarshipDescription,
    ItemId.NAVY_KINGFISHER: SloopDescription,
    ItemId.NAVY_MONARCH: MerchantDescription,
    ItemId.NAVY_MAN_O_WAR: WarshipDescription,
    ItemId.NAVY_PREDATOR: SloopDescription,
    ItemId.NAVY_COLOSSUS: MerchantDescription,
    ItemId.NAVY_DREADNOUGHT: WarshipDescription,
    ItemId.NAVY_BASTION: WarshipDescription,
    ...
    ItemId.EITC_BARRACUDA: SloopDescription,
    ItemId.EITC_OGRE: MerchantDescription,
    ItemId.EITC_WARLORD: WarshipDescription,
    ItemId.EITC_CORSAIR: SloopDescription,
    ItemId.EITC_BEHEMOTH: MerchantDescription,
    ItemId.EITC_JUGGERNAUT: WarshipDescription,
    ItemId.EITC_TYRANT: WarshipDescription,
    ItemId.SKEL_PHANTOM: WarshipDescription,
    ItemId.SKEL_REVENANT: WarshipDescription,
    ItemId.SKEL_STORM_REAPER: WarshipDescription,
    ItemId.SKEL_BLACK_HARBINGER: WarshipDescription,
    ItemId.SKEL_DEATH_OMEN: WarshipDescription,
    ItemId.SKEL_SHADOW_CROW_FR: SloopDescription,
    ItemId.SKEL_HELLHOUND_FR: SloopDescription,
    ItemId.SKEL_BLOOD_SCOURGE_FR: SloopDescription,
    ItemId.SKEL_SHADOW_CROW_SP: SloopDescription,
    ItemId.SKEL_HELLHOUND_SP: SloopDescription,
    ItemId.SKEL_BLOOD_SCOURGE_SP: SloopDescription }
...
InventoryItemClassNames = {
    ...
    ItemType.FISHING_ROD: 'Fishing',
    ItemType.FISHING_LURE: 'Fishing Lure' }
ItemGroupNames = {
    ItemTypeGroup.CUTLASS: 'Swords',
    ItemTypeGroup.DAGGER: 'Daggers',
    ItemTypeGroup.PISTOL: 'Guns',
    ...
    ItemTypeGroup.FISHING_GEAR: 'Fishing Gear' }
VoodooNames = {
    0: 'Heartiness',
    1: 'Strength',
    2: 'Swiftness',
...
HeavyFogWarning = 'You cannot dock on this island! The fog is too dense to see!'
...
MaroonNPCTaskDesc = 'Maroon \x01questObj\x01%(npcName)s\x02 at \x01questObj\x01%(location)s\02'
...
QuestPropUpdateMessages = {
    '1274825998.85caoconno': [
        'Quest Scenario Start!',
        'Quest Scenario Complete!',
        'Quest Scenario Failed!'] }
...
def enumerateShipNames():
    ...
    return (firstPirate, lastPirate, firstNavy, lastNavy, firstTrading, lastTrading, firstSkeleton, lastSkeleton)
...
def enumeratePirateNames():
    ...
    lastMale = []
    lastFemale = []
    for i in PirateNames_LastNamePrefixesGeneric + PirateNames_LastNamePrefixesCapped:
        pre = None

    for i in PirateNames_LastNamePrefixesGeneric + PirateNames_LastNamePrefixesCapped:
        pre = None

    for i in PirateNames_LastNamePrefixesMale:
        pre = None
    ...
    for i in PirateNames_LastNamePrefixesFemale:
        pre = None
...
UndeadPokerCommentLose = [
    'UndeadPokerCommentLose1',
    'UndeadPokerCommentLose2',
    'UndeadPokerCommentLose3',
    'UndeadPokerCommentLose4']
UndeadPokerCommentWin = [
    'UndeadPokerCommentWin1',
    'UndeadPokerCommentWin2',
    'UndeadPokerCommentWin3',
    'UndeadPokerCommentWin4']
UndeadPokerCommentExit = [
    'Run away and forfeit your winnings',
    'There is a penalty for running away']
...
__TakeCover = [
    "She's gonna broadside! Take cover!!!",
    'Incoming! Take cover!!!',
...
GuildAskCreate = 'Would you like to create a new guild?\n\nIt will cost you %s gold!'
GuildAskCreateGold = 'You need %s gold to create a guild!'
GuildCreated = 'You have created a new guild! Make sure to give it a new name!'
...
GuildNameNotGM = 'Sorry, but only Guild Masters can rename a guild!'
GuildNameAlreadySubmitted = 'A guild name has already been submitted for approval.'
...
PlayerChats = ['Whitelisted Chat', 'Blacklisted Chat', 'Muted']
...
ChatTypeLater = 'Later'
ChatTypeNames = ['Whitelist', 'Blacklist']
ChatTypeWarnings = [
    '',
...
FriendSecretIntro = "If you are playing Pirates Online Retribution with someone you know in the real world, you can become Player Friends.  You can chat using the keyboard with your Player Friends.  Other Pirates won't understand what you're saying.\n\nYou do this by getting a Player Friend Code.  Tell the Player Friend Code to your friend, but not to anyone else.  When your friend types in your Player Friend Code on his or her screen, you'll be Player Friends in Pirates!"
...
ChatWarningFirst = 'Final Warning \e2\x80\x93 If you continue using inappropriate language you will be suspended. You said"%s"'
...
guildName.setGlyphScale(0.800000)
...
ContextPanelTypes = {
    ...
    InventoryType.TutTypeIntermediate: 'Intermediate',
    InventoryType.TutTypeAdvanced: 'Advanced' }
ContextPanelTitles = {
    InventoryType.RepairShip: 'Repair Your Ship',
    InventoryType.SailCommands: {
        ...
        9: 'Travel Speed' },
    InventoryType.FireBroadside: 'Fire a Broadside!',
    InventoryType.AimBroadsides: 'Aim Broadsides',
    InventoryType.DockToSellCargo: 'Dock to Sell Cargo',
    InventoryType.LostCargo: 'Lost Cargo',
    InventoryType.LowShipHealth: 'Low Ship Health!',
    InventoryType.BuyNewShip: 'Buy a New %s',
    InventoryType.AimForHull: 'Aim for the Hull!',
    InventoryType.ExitCannon: 'Exiting a Cannon',
    InventoryType.LowHealth: 'Low Health!',
    InventoryType.OutOfTonics: 'Out of Tonics',
    InventoryType.SwitchWeapons: 'Switch Weapons',
    InventoryType.AimPistol: 'Aim Your Pistol',
    InventoryType.NewSkillPoint: 'New %s Skill Point!',
    InventoryType.UpgradeSkills: 'Upgrading Skills',
    InventoryType.CutlassCombos: 'Sword Combos',
    InventoryType.NewComboMove: 'New Combo Move!',
    InventoryType.NewTakeAimSkill: 'New Take-Aim Skill!',
    InventoryType.AttuneVoodooDoll: 'Attune Voodoo Doll',
    InventoryType.FollowLight: 'Follow the Light',
    InventoryType.QuestJournal: 'Quest Journal',
    InventoryType.ChangeQuestTracking: 'Change Quest Tracking',
    InventoryType.NewWeaponQuest: 'New Weapon Quest!',
    InventoryType.MoreWeaponQuests: 'More Weapon Quests',
    InventoryType.IslandTeleport: 'Island Teleport',
    InventoryType.PlayerChat: 'Player Chat',
    InventoryType.PlayerProfiles: 'Player Profiles',
    InventoryType.PlayerInvites: 'Player Invites',
    InventoryType.NewCrew: 'New Crew!',
    InventoryType.CrewBonus: 'Crew Bonus',
    InventoryType.NewFriend: 'New Friend!',
    InventoryType.NewGuild: 'New Guild!',
    InventoryType.BrokenHull: 'Broken %s Hull',
    InventoryType.BrokenMast: 'Broken Mast',
    InventoryType.RearHullDamage: 'Rear Hull Damage!',
    InventoryType.AttuneFriend: 'Attune a Friend',
    InventoryType.RestAndHeal: 'Rest & Heal',
    InventoryType.GoToJail: 'Going to Jail',
    InventoryType.Disengage: 'Disengage',
    InventoryType.EarnMoreSkillPoints: 'Earn More Skill Points',
    InventoryType.NotorietyLevelUp: 'Notoriety Level Up!',
    InventoryType.MerchantStores: 'Merchant Stores',
    InventoryType.WeaponTraining: 'Weapon Training',
    InventoryType.NewAmmoSkill: 'New Ammo Skill!',
    InventoryType.OutOfAmmo: 'Out of Ammo',
    InventoryType.HardEnemies: 'Hard Enemies',
    InventoryType.IslandMap: 'Island Map',
    ...
    InventoryType.DockCrewCommands: {
        1: 'Leaving a Crew' },
    InventoryType.TeleportToFriends: 'Teleporting to Friends',
    InventoryType.Flagships: 'Flagships',
    InventoryType.BackStrike: 'Back-strike',
    InventoryType.Interrupt: 'Interrupt',
    InventoryType.BossEnemy: 'Boss Enemy',
    InventoryType.TreasureCollection: 'Treasure Collection',
    InventoryType.SearchableContainers: '%s',
    InventoryType.UseEmotes: 'Use Emotes!',
    InventoryType.SpanishPrivateers: 'Spanish Privateers',
    InventoryType.FrenchPrivateers: 'French Privateers',
    InventoryType.Groggy: 'Groggy',
    InventoryType.ChatPreferences: 'Chat Preferences',
    InventoryType.SailShip: 'Sail the Ship',
    InventoryType.FishingTutorial: 'Fishing Tutorial',
    InventoryType.FishingEnterGame: 'Fishing',
    InventoryType.FishingAfterCast: 'Fishing',
    InventoryType.FishingAboutToBite: 'Fishing',
    InventoryType.FishingFishOnLine: 'Fishing',
    InventoryType.FishingLineHealth: 'Fishing',
    InventoryType.FishingLineBroken: 'Fishing',
    InventoryType.FishingNoMoreLures: 'Fishing',
    InventoryType.FishingCaughtFish: 'Fishing',
    InventoryType.FishingLevelGain: 'Fishing',
    InventoryType.FishingOceanEye: 'Ocean Eye',
    InventoryType.FishingSink: 'Sink',
    InventoryType.FishingStall: 'Stall',
    InventoryType.FishingPull: 'Pull',
    InventoryType.FishingHealLine: 'Heal Line',
    InventoryType.FishingLegendAppear: 'Legendary Fish',
    InventoryType.FishingLegendStruggle: 'Legendary Fish',
    InventoryType.FishingLegendReel: 'Legendary Fish',
    InventoryType.FishingLegendCaught: 'Legendary Fish',
    InventoryType.FishingLevel10: 'Fishing',
    InventoryType.FishingCaughtAllFish: 'Fishing',
    InventoryType.FishingLineBroken2: 'Fishing',
    InventoryType.FirstLootContainer: 'Loot Container',
    InventoryType.GunTrainingRequired: 'Gun Training',
    InventoryType.DollTrainingRequired: 'Voodoo Doll Training',
    InventoryType.DaggerTrainingRequired: 'Dagger Training',
    InventoryType.StaffTrainingRequired: 'Voodoo Staff Training',
    InventoryType.EquippingWeapons: 'Equipping Weapons',
    InventoryType.InventoryFull: 'Inventory Full',
    InventoryType.FirstSailingItem: 'Sailing Item',
    InventoryType.CursedBlades: 'Cursed Blades!' }
ContextPanelMessages = {
    InventoryType.RepairShip: 'Repair your ship at the \x01Dred\x01Shipwright\x02 near the docks in town. Otherwise, you cannot sail it.',
    InventoryType.SailCommands: {
    ...
    InventoryType.FireBroadside: '\x01Dred\x01Press 1 or 2\x02 to fire a Broadside! You can also click on the Skill Icons.',
    InventoryType.AimBroadsides: '\x01Dred\x01Point the side of your ship at the enemy\x02 to aim your Broadsides! Then FIRE!',
    InventoryType.DockToSellCargo: 'Your Cargo Hold is full. \x01Dred\x01Dock at port\x02 to sell the plunder!',
    InventoryType.LostCargo: 'If your ship sinks, you lose all your Cargo from the voyage!',
    InventoryType.LowShipHealth: 'Your ship is damaged! You can \x01Dred\x01repair\x02 it at the \x01Dred\x01Shipwright\x02 in town.',
    InventoryType.BuyNewShip: 'You have earned enough gold to purchase a \x01Dred\x01%s\x02! You can purchase New Ships from the \x01Dred\x01Shipwright\x02 in town.',
    InventoryType.AimForHull: '\x01Dred\x01Aim for the Hull\x02 of a ship to sink it.',
    InventoryType.ExitCannon: '\x01Dred\x01Press Escape (ESC)\x02 to stop using the Cannon.',
    InventoryType.LowHealth: '\x01Dred\x01Press T\x02 to drink a Tonic! Tonics restore lost Health.',
    InventoryType.OutOfTonics: 'You have used up all your healing tonics! Purchase more from the \x01Dred\x01Gypsy Wagons\x02 in town.',
    InventoryType.SwitchWeapons: '\x01Dred\x01Press F1 or F2\x02 to switch between the Sword and the Pistol.',
    InventoryType.AimPistol: '\x01Dred\x01Hold down\x02 the \x01Dred\x01Right Mouse Button\x02 to aim your pistol.',
    InventoryType.NewSkillPoint: 'You got 1 new %s Skill Point! \x01Dred\x01Press K\x02 to see your Skill Page and \x01Dred\x01unlock\x02 new skills or \x01Dred\x01upgrade\x02 current skills.',
    ...
    InventoryType.CutlassCombos: '\x01Dred\x01Time your Sword Attacks\x02 to form a Combo. Combos deal more damage over time than button-mashing.',
    InventoryType.NewComboMove: 'You unlocked a \x01Dred\x01new Combo Move\x02! You can now form longer Combo Chains for greater damage',
    InventoryType.NewTakeAimSkill: 'You unlocked the Take Aim Skill! \x01Dred\x01Hold down\x02 the \x01Dred\x01Left Mouse Button\x02 to Aim with your pistol.',
    InventoryType.AttuneVoodooDoll: 'Touch an enemy with the Voodoo Doll using your \x01Dred\x01Left Mouse Button\x02. Then you can cast Hexes on him from a distance!',
    InventoryType.FollowLight: 'Follow the Ray-of-Light. It leads you to your \x01Dred\x01Quest target\x02!',
    InventoryType.QuestJournal: 'You have a New Quest! \x01Dred\x01Press J\x02 to open your \x01Dred\x01Quest Journal\x02 and read it.',
    InventoryType.ChangeQuestTracking: 'You can change which Quest is being tracked by the Ray-of-Light in your \x01Dred\x01Quest Journal (J)\x02.',
    InventoryType.NewWeaponQuest: 'You received a New Weapon Quest! If you complete this Quest, you will unlock the \x01Dred\x01Voodoo Doll weapon\x02!',
    InventoryType.MoreWeaponQuests: 'As your Notoriety Level increases, you will unlock more Weapon Quests.',
    InventoryType.IslandTeleport: 'Use the \x01Dred\x01Map page (M)\x02 to Teleport from one island to another.',
    InventoryType.PlayerChat: '\x01Dred\x01Press ENTER\x02 to begin typing to nearby players.',
    InventoryType.PlayerProfiles: '\x01Dred\x01Click on other players\x02 to see their Player Profile. You must \x01Dred\x01put away your weapon first\x02 though.',
    InventoryType.PlayerInvites: 'You can invite another player to join your \x01Dred\x01Crew\x02 or \x01Dred\x01Guild\x02 from their \x01Dred\x01Player Profile\x02.',
    ...
    InventoryType.CrewBonus: 'When you fight near your Crewmates, you gain \x01Dred\x01bonus Reputation\x02 and level up faster!',
    InventoryType.NewFriend: "You made a new Friend! You can use your \x01Dred\x01Friend's List (F)\x02 to contact or teleport to your friend.",
    InventoryType.NewGuild: "You have joined a Guild! Guilds help you stay in contact with friends and meet other Pirates! View your Guild's status using the \x01Dred\x01Friend's List (F)\x02.",
    InventoryType.BrokenHull: 'You have lost all your Hull Points on your %s side. Further damage would be dangerous! You can \x01Dred\x01repair\x02 this at the \x01Dred\x01Shipwright\x02 in town.',
    InventoryType.BrokenMast: 'You have lost a Mast and move slower now. You can \x01Dred\x01repair\x02 this at the \x01Dred\x01Shipwright\x02 in town.',
    InventoryType.RearHullDamage: 'Attacking enemy ships in the \x01Dred\x01Rear Hull\x02 deals extra damage!',
    InventoryType.AttuneFriend: 'You can attune a friendly Pirate and \x01Dred\x01cast Healing Voodoo\x02 on him.',
    InventoryType.RestAndHeal: '\x01Dred\x01Wait in a safe place\x02 to heal after a battle. Over time, your Health will be restored.',
    ...
    InventoryType.EarnMoreSkillPoints: '\x01Dred\x01Level up your Weapons\x02 to earn more Skill Points for that weapon.',
    ...
    InventoryType.WeaponTraining: 'You will \x01Dred\x01unlock new weapons\x02 like the Voodoo Doll, Dagger, Grenades, and Voodoo Staff when you reach \x01Dred\x01higher Notoriety Levels\x02.',
    InventoryType.MerchantStores: 'You can purchase new Weapons, Clothing, Tattoos, Jewelry, and Haircuts in town.',
    InventoryType.NewAmmoSkill: 'You unlocked a new Ammo Skill! Switching to this skill allows you to fire new ammo, but you must \x01Dred\x01purchase Ammo\x02 from the \x01Dred\x01Gunsmith\x02 in town.',
    InventoryType.OutOfAmmo: 'You ran out of ammo. \x01Dred\x01Purchase more\x02 from the \x01Dred\x01Gunsmith\x02 in town.',
    InventoryType.HardEnemies: 'Enemies with a \x01Dred\x01red Level tag\x02 are at a much \x01Dred\x01higher level\x02 than you! Be careful!',
    InventoryType.IslandMap: '\x01Dred\x01Press F8\x02 to show the Map for the island.',
    InventoryType.DockCommands: {
    ...
    InventoryType.TeleportToFriends: 'You can teleport to a Crewmate, Friend, or Guild Member by using the \x01Dred\x01Go To Button\x02 on their \x01Dred\x01Player Profiles\x02.',
    InventoryType.Flagships: 'Ships with a flag icon overhead are Flagships. They \x01Dred\x01must be boarded\x02 to be sunk!',
    InventoryType.BackStrike: 'Attacking enemies in the back with a Dagger deals extra damage!',
    InventoryType.Interrupt: "You can use the \x01Dred\x01new Asp Skill\x02 to interrupt a target's Voodoo Doll Attunement.",
    ...
    InventoryType.TreasureCollection: 'You unlocked a Treasure Collection Set! Complete the collection for a Reputation reward. \x01Dred\x01Press U\x02 to see your collections.',
    InventoryType.SearchableContainers: 'These searchable items are used for Quests later on.',
    InventoryType.UseEmotes: 'Ever wanted to express yourself to other players? Try typing \x01Dred\x01/wave\x02 or \x01Dred\x01/dance\x02 in chat!',
    ...
    InventoryType.Groggy: 'You are Groggy! While groggy, your \x01Dred\x01Maximum Health is reduced\x02 for a short time.',
    InventoryType.ChatPreferences: '%s',
    InventoryType.SailShip: 'Grab the \x01Dred\x01Steering Wheel\x02 to sail the ship around.',
    ...
    InventoryType.GunTrainingRequired: "Before you can use this weapon, you must \x01Dred\x01visit Barbossa\x02 on Devil's Anvil to learn how to use Guns!",
    InventoryType.DollTrainingRequired: 'The Voodoo Doll Training Quest \x01Dred\x01unlocks at Notoriety Level 5.\x02 You must complete it before you can use Voodoo Doll weapons.',
    InventoryType.DaggerTrainingRequired: 'The Dagger Training Quest \x01Dred\x01unlocks at Notoriety Level 10.\x02 You must complete it before you can use Dagger weapons.',
    InventoryType.StaffTrainingRequired: 'The Voodoo Staff Training Quest \x01Dred\x01unlocks at Notoriety Level 30.\x02 You must complete it before you can use Voodoo Staff weapons.',
    InventoryType.EquippingWeapons: 'Open your Inventory (I) to equip weapons! Click on the Weapon Tab and \x01Dred\x01drag the Weapon to the equip slots\x02 marked F1, F2, F3, & F4.',
    InventoryType.InventoryFull: 'One of your Inventory bags is full! Open your Inventory (I) and drag items to the \x01Dred\x01Trash Bin\x02 to remove them. You can also \x01Dred\x01sell items\x02 to Shopkeepers in town for Gold.',
    InventoryType.FirstSailingItem: 'You just received a \x01Dred\x01Sailing Item!\x02 These are equipped into the Item Slot and give you bonuses while \x01Dred\x01Sailing\x02 or on a \x01Dred\x01Cannon\x02!',
...
Collections = {
    ...
    InventoryType.Collection_Set7: 'Treasured Chess Set',
    ...
    InventoryType.Collection_Set10: 'Fish',
    InventoryType.Collection_Set10_Part1: 'Yellow Tang',
    InventoryType.Collection_Set10_Part2: 'Bermuda Chub',
    InventoryType.Collection_Set10_Part3: 'Blue Chromis',
    InventoryType.Collection_Set10_Part4: 'Anthias',
    InventoryType.Collection_Set10_Part5: 'Tuna',
    InventoryType.Collection_Set10_Part6: 'Parrot Fish',
    InventoryType.Collection_Set10_Part7: 'Barracuda',
    InventoryType.Collection_Set10_Part8: 'Marlin',
    InventoryType.Collection_Set10_Part9: 'Sand Tiger Shark',
    InventoryType.Collection_Set10_Part10: 'Grouper',
    InventoryType.Collection_Set10_Part11: 'Coelacanth',
    InventoryType.Collection_Set10_Part12: 'Hatchet Fish',
    InventoryType.Collection_Set10_Part13: 'Lion Fish',
    InventoryType.Collection_Set10_Part14: 'Atlantic Wolffish',
    InventoryType.Collection_Set10_Part15: 'Black Chimera',
    InventoryType.Collection_Set10_Part16: 'Dragon Fish',
    InventoryType.Collection_Set10_Part17: 'Goblin Shark',
    InventoryType.Collection_Set10_Part18: 'Angler',
    InventoryType.Collection_Set10_Part19: 'Lump Fish',
    InventoryType.Collection_Set10_Part20: 'Mega Mouth',
    InventoryType.Collection_Set11: 'Legendary Fish',
    InventoryType.Collection_Set11_Part1: 'Fogbell',
    InventoryType.Collection_Set11_Part2: 'Fire Dragon',
    InventoryType.Collection_Set11_Part3: 'Glittering Girl',
    InventoryType.Collection_Set11_Part4: 'Mossy Moses',
    InventoryType.Collection_Set11_Part5: 'Speedy Lou' }
...
GameOptionsSaved = 'Your settings have been saved!'
...
LocationNamesNotIsland = {
    LocationIds.PORT_ROYAL_ISLAND: 'Port Royal Town',
    LocationIds.TORTUGA_ISLAND: 'Tortuga Town',
    LocationIds.DEL_FUEGO_ISLAND: 'Padres Del Fuego Town',
    LocationIds.ANVIL_ISLAND: 'Anvil Island Beach',
    LocationIds.CUBA_ISLAND: 'Cuba Beach' }
PropTypeNames = {
    PropIds.ANY_PROP: ('a storage container', 'storage containers'),
    PropIds.ANY_BARREL: ('a barrel', 'barrels'),
    PropIds.ANY_CRATE: ('a crate', 'crates'),
    PropIds.ANY_DESK: ('a desk', 'desks'),
    PropIds.ANY_SHELF: ('a shelf', 'shelves'),
    PropIds.ANY_CABINET: ('a cabinet', 'cabinets'),
    PropIds.ANY_CLOCK: ('a clock', 'clocks'),
    PropIds.ANY_HAYSTACK: ('a haystack', 'haystacks'),
    PropIds.ANY_WELL: ('a well', 'wells'),
    PropIds.ANY_GRAVE: ('a grave', 'graves'),
    PropIds.WATER_GRAVE: ('a watery grave', 'watery graves'),
    PropIds.SOUTH_GRAVE: ('the southern grave', 'southern graves'),
    PropIds.ANY_CHEST: ('a treasure chest', 'treasure chests'),
    PropIds.ANY_MINE_SHAFT: ('a mine shaft', 'mine shafts') }
...
HintMap_Locations = {
    LocationIds.PORT_ROYAL_ISLAND: (),
    LocationIds.PORT_ROYAL_PORT: (),
    LocationIds.PORT_ROYAL_JUNGLE_B: (),
    LocationIds.PORT_ROYAL_JUNGLE_C: (),
    LocationIds.PORT_ROYAL_CAVE_A: (),
    LocationIds.PORT_ROYAL_CAVE_B: (),
    LocationIds.PORT_ROYAL_JUNGLE_A: (),
    LocationIds.JUNEGREER_RESIDENCE: (),
    LocationIds.SMITTYS_JEWELRY: (),
    LocationIds.GOVERNORS_MANSION: (),
    LocationIds.ROWDYROOSTER_TAVERN: (),
    LocationIds.ROYALANCHOR_TAVERN: (),
    LocationIds.GRAHAM_IMPORTS: (),
    LocationIds.EWANS_WEAPONS: (),
    LocationIds.OLD_WAREHOUSE: (),
    LocationIds.RSMITH_PEWTERER: (),
    LocationIds.SOLOMONS_TATTOOS: (),
    LocationIds.TORTUGA_ISLAND: (),
    LocationIds.TORTUGA_PORT: (),
    LocationIds.TORTUGA_JUNGLE_A_GRAVEYARD: (),
    LocationIds.TORTUGA_CAVE: (),
    LocationIds.TORTUGA_JUNGLE_C: (),
    LocationIds.TORTUGA_SWAMP: (),
    LocationIds.TORTUGA_JUNGLE_B_SWAMPY: (),
    LocationIds.FAITHFULBRIDE_TAVERN: (),
    LocationIds.KINGSARM_TAVERN: (),
    LocationIds.BOWDASH_MANSION: (),
    LocationIds.ORINDAS_SHACK: (),
    LocationIds.FLATTS_WEAPONS: (),
    LocationIds.MILLIES_COTTAGE: (),
    LocationIds.SEAMSTRESS_TAILOR: (),
    LocationIds.DOCTOR_GROGS: (),
    LocationIds.FLINTYS_BLACKSMITH: (),
    LocationIds.DEL_FUEGO_ISLAND: (),
    LocationIds.ANVIL_ISLAND: (),
    LocationIds.ANVIL_CAVE_BARBOSA: (),
    LocationIds.DRIFTWOOD_ISLAND: ('Crabs have been known to infest Driftwood island.',),
    LocationIds.RUMRUNNER_ISLE: (),
    LocationIds.ISLA_PERDIDA: (),
    LocationIds.PERDIDA_JUNGLE_B: (),
    LocationIds.OUTCAST_ISLE: (),
    LocationIds.CUBA_ISLAND: (),
    LocationIds.CUBA_SWAMP: (),
    ...
    LocationIds.CUTTHROAT_JUNGLE: (),
    LocationIds.RAVENS_COVE_ISLAND: (RavensCoveTip1, RavensCoveTip2, RavensCoveTip3, RavensCoveTip4, RavensCoveTip5, RavensCoveTip6),
    LocationIds.RAVENS_COVE_MINE: (),
    LocationIds.WINDWARD_PASSAGE: (),
    LocationIds.BRIGAND_BAY: (),
    LocationIds.BLOODY_BAYOU: (),
    LocationIds.SCURVY_SHALLOWS: (),
    LocationIds.BLACKHEART_STRAIT: (),
    LocationIds.SALTY_FLATS: (),
    LocationIds.MAR_DE_PLATA: (),
    LocationIds.SMUGGLERS_RUN: (),
    LocationIds.THE_HINTERSEAS: (),
    LocationIds.DEAD_MANS_TROUGH: (),
    LocationIds.LEEWARD_PASSAGE: (),
    LocationIds.BOILING_BAY: (),
    LocationIds.MARINERS_REEF: (),
    LocationIds.PEARL_ISLAND: (),
    LocationIds.ANY_LARGE_ISLAND: (),
...
WeaponUnlockText = {
    ...
    InventoryType.FishingRep: 'Unlocked at Notoreity Level 10' }
...
ReportPlayerConfirmBadName = "You are about to report that \x01Ired\x01%s\x02 has created a name that does not follow The Pirates Online Retribution Rules."
...
DoubleGoldStart = makeHeadingString('Double Gold Event In Progress!', 2) + '\nPlayers will earn double gold rewards from quests, battles, and minigames.'
...
HalfOffCustomizationStart = 'Half-Off Customization Event: %s hours, and %s minutes'
HalfOffCustomizationEnd = 'The 50%% off all customization items event has ended.'
HalfOffCustomizationUnlimited = 'Visit any of the shops for 50% off all customization items such as Clothing, Tattoos and Jewelry.'
HalfOffCustomizationStatus = 'Half-Off Customization Event:\nTime Remaining: %s Hour(s), %s Minute(s)'
...
HalloweenStatus = 'Halloween Holiday:\nTime Remaining: %s Hours, %s Minutes'
...
ThanksgivingFeastStartChat = 'Brethren Thanksgiving Feast is in progress! Come to the shores of Tortuga to join the festivities. Be sure to also join the official Pirates Forums by visiting piratesforums.com!'
...
WinterFestivalStartChat = 'The Winter Holiday is in progress! Pirates all over the Caribbean have decorated the streets of Port Royal, Tortuga, and Padres del Fuego in holiday cheer. Join us in celebration!'
...
NewYearsStart = makeHeadingString('Happy New Year! ', 2) + '\nGo to the shores of Port Royal, Tortuga or Padres del Fuego to watch fireworks light up the night sky.'
NewYearsStartChat = 'Happy New Year!\nGo to the shores of Port Royal, Tortuga or Padres del Fuego to watch fireworks light up the night sky.'
NewYearsEnd = "New Year's festivities have ended. Best wishes for a bountiful new year."
...
InvasionWarn30min = [
    "Jolly Roger's Army is on the move towards %s and spies tell us they're 30 minutes away.",
    "Spies have seen Jolly's army on the move towards %s and they will arrive in 30 minutes.",
    'The spirits report that the Undead army is about to invade %s in 30 minutes.']
InvasionWarn20min = [
    'The Undead hordes are sailing quickly towards %s and will make land in 20 minutes.',
    'The Undead army of Jolly Roger will attack %s in 20 minutes',
    'Prepare yourselves, mates!  The Undead invasion of %s begins in 20 minutes.']
InvasionWarn10min = [
    'Beware the invasions - they are coming to %s in only 10 minutes!',
    'Look lively mates, reports suggest the %s invasion is only 10 minutes away!',
    'Last chance to get your ammo and potions, the invasion of %s starts in 10 minutes!']
InvasionWarn5min = [
    'Sharpen your steel and steady your nerves, the %s invasion is 5 minutes away!',
    'Tell all your friends and guild members join in - %s invasion in 5 minutes!',
    "Don't dilly dally - get ready to battle as the Undead will arrive in %s in 5 minutes!"]
InvasionWarn1min = [
    'Time to fight or flee for the invading army is only 1 minute away from %s!',
    "Jolly's Undead army arrives in %s in only 1 minute!",
    'Time to fight or flee, mates!  The %s invasion starts in 1 minute!']
...
FleetHolidayMsgs = {
    ...
    FHMsgs.TF_EitcWarn10min: [
        'The EITC Treasure Fleets will weigh anchor in 10 minutes.',
        'Prepare the sail!  EITC Treasure fleets leave port in 10 minutes.',
        'Arm your cannons, mates.  EITC Treasure fleets set sail in 10 minutes.'],
    FHMsgs.TF_EitcWarn5min: [
        'The EITC Treasure Fleets are filled with loot and leaving in 5 minutes.',
        '5 minutes until the EITC Treasure Fleets embark from port.',
        'Ready your cannons and sails, EITC Treasure Fleets sail in 5 Minutes.'],
    FHMsgs.TF_EitcWarn0min: [
        'Scouts have seen EITC Treasure Fleets leaving port - sink them now!',
        'Get on the water, mates!  EITC Treasure fleets are under full sail!',
        'Prepare to do battle mates!  The EITC Treasure Fleets are sailing now!'],
    FHMsgs.TF_NavyWarn10min: [
        'The Navy Treasure Fleets will weigh anchor in 10 minutes.',
        'Prepare the sail!  Navy Treasure fleets leave port in 10 minutes.',
        'Arm your cannons, mates.  Navy Treasure fleets set sail in 10 minutes.'],
    FHMsgs.TF_NavyWarn5min: [
        'The Navy Treasure Fleets are filled with loot and leaving in 5 minutes.',
        '5 minutes until the Navy Treasure Fleets embark from port.',
        'Ready your cannons and sails, Navy Treasure Fleets sail in 5 Minutes.'],
    FHMsgs.TF_NavyWarn0min: [
        'Scouts have seen Navy Treasure Fleets leaving port - sink them now!',
        'Get on the water, mates!  Navy Treasure fleets are under full sail!',
...
KrakenHolidayMsgs = {
    ...
    KHMsgs.Escaped: [
        "That's one slippery squid",
        'Pesky jellyfish swam away!'],
    KHMsgs.Defeated: [
        'Why do I suddenly have the hankering for fried calamari???'] }
QueenAnnesHolidayMsgs = {
    60: [
        "The Queen Anne's Revenge has been seen in the Caribbean under the command of a vile and mutinous crew. Keep an ear open for rumors of her whereabouts."],
    61: [
        "The Queen Anne's Revenge has vanished mysteriously. Keep a sharp eye and an even sharper sword. Legend has it that she will strike again soon."],
    62: [
        "The Queen Anne's Revenge has gone down. Be warned! This reprieve is only temporary. The Queen Anne's Revenge will set sail again with her vicious crew in tow."],
    63: [
        "The Queen Anne's Revenge has been spotted circling Isla Tormenta! Disable, grapple and board the ship then prepare to battle Her undead crew!"],
    64: [
        "The Queen Anne's Revenge has been spotted circling Isla Perdida! Disable, grapple and board the ship then prepare to battle Her undead crew!"],
    65: [
        "The Queen Anne's Revenge has been spotted circling Isla Cangrejos! Disable, grapple and board the ship then prepare to battle Her undead crew!"] }
...
holidayMessages = {
    ...
    HolidayGlobals.CURSEDNIGHT: {
        ...
        MSG_ICON: 'admin' },
    HolidayGlobals.JOLLYCURSEAUTO: { },
    HolidayGlobals.FOUNDERSFEAST: {
    ...
    HolidayGlobals.INVASIONPORTROYAL: {
        ...
        MSG_ICON: 'admin' },
    HolidayGlobals.WRECKEDGOVERNORSMANSION: { },
    HolidayGlobals.INVASIONTORTUGA: {
        MSG_START_ALL: (InvasionTortugaStart, InvasionTortugaStart),
        MSG_CHAT_STATUS: InvasionTortugaStatus,
        MSG_ICON: 'admin' },
    HolidayGlobals.WRECKEDFAITHFULBRIDE: { },
    HolidayGlobals.INVASIONDELFUEGO: {
    ...
    HolidayGlobals.FLEETHOLIDAY: {
        None: {
            MSG_ICON: 'ship' } },
    HolidayGlobals.FEASTOFSTRENGTH: { },
    HolidayGlobals.EITCMOBILIZATION: {
    ...
    HolidayGlobals.QUEENANNES: {
        ...
        MSG_ICON: 'admin' } }
JollyRogerTaunts = [
    'I love the smell of fresh souls.',
    'Ha ha ha! This really is a laugh!',
    'You fear me now, eh?',
    'Jack Sparrow will need to find someone else to do his dirty work.',
    "Why don't you just submit to my power?",
    "This is child's play!",
    'Submit to me!',
    "I've not had so much fun in days!",
    'Nothing beats a good fight before a meal.',
    'Your weapons are but a nuisance to me.',
    'Bring me a real opponent!',
    'Being dead has its benefits. Care to try it out?',
    "Is that all you've got?",
    'Ha ha ha!',
    'Ready to meet your maker?',
    "Let me show ye how it's done!",
    "Out of me way! I've got some souls to devour!",
    "Now I'm angry! And everyone will pay!",
    'A pox on your town!',
    'Ahhhhhh!',
    'Ha ha ha!',
...
InvasionMainZoneNames = {
    HolidayGlobals.getHolidayName(HolidayGlobals.INVASIONPORTROYAL): "Governor's Mansion",
    HolidayGlobals.getHolidayName(HolidayGlobals.INVASIONTORTUGA): 'Faithful Bride Tavern',
    HolidayGlobals.getHolidayName(HolidayGlobals.INVASIONDELFUEGO): 'Padres Del Fuego Town' }
...
EmoteMessagesSelf = {
    EmoteGlobals.EMOTE_COIN_FLIP: 'You flip a coin.',
    EmoteGlobals.EMOTE_COIN_HEADS: 'You flip a coin... Heads',
    EmoteGlobals.EMOTE_COIN_TAILS: 'You flip a coin... Tails',
    EmoteGlobals.EMOTE_CHANT_A: 'You dance.',
    EmoteGlobals.EMOTE_CHANT_B: 'You dance.',
    EmoteGlobals.EMOTE_DANCE: 'You dance.',
    EmoteGlobals.EMOTE_DANCE_JIG: 'You dance a jig.',
    EmoteGlobals.EMOTE_FLEX: 'You flex mightily.',
    EmoteGlobals.EMOTE_CRAZY: "You're going crazy!",
    EmoteGlobals.EMOTE_SEARCHING: 'You look around, searching for something.',
    EmoteGlobals.EMOTE_SWEEP: 'You sweep the ground clean.',
    EmoteGlobals.EMOTE_PRIMP: 'You check your nails.',
    EmoteGlobals.EMOTE_AGREE: 'You agree.',
    EmoteGlobals.EMOTE_AMAZED: 'You are amazed!',
    EmoteGlobals.EMOTE_ANGRY: 'You look angry.',
    EmoteGlobals.EMOTE_CELEBRATE: 'You celebrate!',
    EmoteGlobals.EMOTE_SLEEP: 'You look sleepy.',
    EmoteGlobals.EMOTE_ARRR: 'Arrrrrrr!',
    EmoteGlobals.EMOTE_BARK: 'You bark like a wild dog!',
    EmoteGlobals.EMOTE_BLINK: 'You blink.',
    EmoteGlobals.EMOTE_BORED: 'You look bored.',
    EmoteGlobals.EMOTE_BOW: 'You bow politely.',
    EmoteGlobals.EMOTE_CACKLE: 'You cackle!',
    EmoteGlobals.EMOTE_CHEER: 'You cheer!',
    EmoteGlobals.EMOTE_CHUCKLE: 'You chuckle softly.',
    EmoteGlobals.EMOTE_CLAP: 'You clap!',
    EmoteGlobals.EMOTE_CONFUSED: 'You look confused.',
    EmoteGlobals.EMOTE_CONGRATS: 'You congratulate everyone.',
    EmoteGlobals.EMOTE_CRY: 'You cry.',
    EmoteGlobals.EMOTE_CURIOUS: 'You look curious.',
    EmoteGlobals.EMOTE_DRINK: 'You pour a drink.',
    EmoteGlobals.EMOTE_EAT: 'You munch on some food.',
    EmoteGlobals.EMOTE_FEAR: 'You cower in fear.',
    EmoteGlobals.EMOTE_FLEE: 'You flee in terror!',
    EmoteGlobals.EMOTE_FROWN: 'You frown.',
    EmoteGlobals.EMOTE_GASP: 'You gasp!',
    EmoteGlobals.EMOTE_GIGGLE: 'You giggle.',
    EmoteGlobals.EMOTE_GLARE: 'You glare angrily.',
    EmoteGlobals.EMOTE_GOODBYE: 'You wave goodbye.',
    EmoteGlobals.EMOTE_GREET: 'You greet everyone around you.',
    EmoteGlobals.EMOTE_GRIN: 'You grin.',
    EmoteGlobals.EMOTE_GROWL: 'You growl angrily.',
    EmoteGlobals.EMOTE_HAIL: 'You hail everyone around you.',
    EmoteGlobals.EMOTE_HALLOWEEN: "You're dancing like a zombie!",
    EmoteGlobals.EMOTE_HAPPY: 'You are happy!',
    EmoteGlobals.EMOTE_HELLO: 'You say hello!',
    EmoteGlobals.EMOTE_HELP: 'You call out for help!',
    EmoteGlobals.EMOTE_HISS: 'You hiss menacingly.',
    EmoteGlobals.EMOTE_HUNGRY: 'You look hungry.',
    EmoteGlobals.EMOTE_IMPATIENT: 'You tap your foot impatiently.',
    EmoteGlobals.EMOTE_JK: "You let everyone know you're just kidding!",
    EmoteGlobals.EMOTE_LAUGH: 'You laugh!',
    EmoteGlobals.EMOTE_MEOW: 'You meow like a cat.',
    EmoteGlobals.EMOTE_MOO: 'You moo.  Moooooooo!',
    EmoteGlobals.EMOTE_NO: 'You say, NO.',
    EmoteGlobals.EMOTE_NOD: 'You nod.',
    EmoteGlobals.EMOTE_POWERFUL: 'You are far too mighty for these weaklings!',
    EmoteGlobals.EMOTE_READY: 'You are ready!',
    EmoteGlobals.EMOTE_ROAR: 'You roar loudly!',
    EmoteGlobals.EMOTE_ROFL: 'You roll on the floor laughing.',
    EmoteGlobals.EMOTE_SAD: 'You look sad.',
    EmoteGlobals.EMOTE_SALUTE: 'You salute.',
    EmoteGlobals.EMOTE_SCARED: 'You are scared!',
    EmoteGlobals.EMOTE_SHRUG: 'You shrug.',
    EmoteGlobals.EMOTE_SIGH: 'You sigh softly.',
    EmoteGlobals.EMOTE_SMILE: 'You smile.',
    EmoteGlobals.EMOTE_SORRY: 'You apologize.  Sorry!',
    EmoteGlobals.EMOTE_THIRSTY: 'You look thirsty.',
    EmoteGlobals.EMOTE_TIRED: 'You look tired.',
    EmoteGlobals.EMOTE_VALENTINES: 'You wink.',
    EmoteGlobals.EMOTE_VALENTINES_A: 'You wink A!',
    EmoteGlobals.EMOTE_VALENTINES_B: 'You wink B!',
    EmoteGlobals.EMOTE_VALENTINES_C: 'You wink C!',
    EmoteGlobals.EMOTE_VALENTINES_D: 'You wink D!',
    EmoteGlobals.EMOTE_VALENTINES_E: 'You wink E!',
    EmoteGlobals.EMOTE_VITTLES: 'You ask around for something to eat.',
    EmoteGlobals.EMOTE_WAIT: 'You ask everyone to wait.',
    EmoteGlobals.EMOTE_WAVE: 'You wave.',
    EmoteGlobals.EMOTE_WINK: 'You wink.',
    EmoteGlobals.EMOTE_YAWN: 'You yawn.',
    EmoteGlobals.EMOTE_YES: 'You say, Yes!',
    EmoteGlobals.EMOTE_NOISEMAKER: 'You make some noise!',
    EmoteGlobals.EMOTE_BLACKHAND: "Your hand doesn't look like it contains an Evil Curse of Doom..." }
EmoteMessagesThirdPerson = {
    EmoteGlobals.EMOTE_COIN_FLIP: '%s flips a coin.',
    EmoteGlobals.EMOTE_COIN_HEADS: '%s flips a coin... Heads',
    EmoteGlobals.EMOTE_COIN_TAILS: '%s flips a coin... Tails',
    EmoteGlobals.EMOTE_CHANT_A: '%s dances.',
    EmoteGlobals.EMOTE_CHANT_B: '%s dances.',
    EmoteGlobals.EMOTE_DANCE: '%s dances.',
    EmoteGlobals.EMOTE_DANCE_JIG: '%s dances a jig.',
    EmoteGlobals.EMOTE_FLEX: '%s flexes mightily.',
    EmoteGlobals.EMOTE_LUTE: '%s pulls out a lute and begins to play.',
    EmoteGlobals.EMOTE_FLUTE: '%s pulls out a flute and begins to play.',
    EmoteGlobals.EMOTE_CRAZY: '%s is going crazy!',
    EmoteGlobals.EMOTE_SEARCHING: '%s looks around, searching for something.',
    EmoteGlobals.EMOTE_SWEEP: '%s sweeps the ground clean.',
    EmoteGlobals.EMOTE_PRIMP: '%s checks her nails.',
    EmoteGlobals.EMOTE_AGREE: '%s agrees.',
    EmoteGlobals.EMOTE_AMAZED: '%s is amazed!',
    EmoteGlobals.EMOTE_ANGRY: '%s looks angry.',
    EmoteGlobals.EMOTE_CELEBRATE: '%s celebrates.',
    EmoteGlobals.EMOTE_SLEEP: '%s looks sleepy.',
    EmoteGlobals.EMOTE_ARRR: '%s says, "Arrrrrrr!"',
    EmoteGlobals.EMOTE_BARK: '%s barks like a wild dog!',
    EmoteGlobals.EMOTE_BLINK: '%s blinks.',
    EmoteGlobals.EMOTE_BORED: '%s looks bored.',
    EmoteGlobals.EMOTE_BOW: '%s bows politely.',
    EmoteGlobals.EMOTE_CACKLE: '%s cackles!',
    EmoteGlobals.EMOTE_CHEER: '%s cheers!',
    EmoteGlobals.EMOTE_CHUCKLE: '%s chuckles softly.',
    EmoteGlobals.EMOTE_CLAP: '%s claps!',
    EmoteGlobals.EMOTE_CONFUSED: '%s looks confused.',
    EmoteGlobals.EMOTE_CONGRATS: '%s congratulates everyone.',
    EmoteGlobals.EMOTE_CRY: '%s cries.',
    EmoteGlobals.EMOTE_CURIOUS: '%s looks curious.',
    EmoteGlobals.EMOTE_DRINK: '%s pours a drink.',
    EmoteGlobals.EMOTE_EAT: '%s munches on some food.',
    EmoteGlobals.EMOTE_FEAR: '%s cowers in fear.',
    EmoteGlobals.EMOTE_FLEE: '%s flees in terror!',
    EmoteGlobals.EMOTE_FROWN: '%s frowns.',
    EmoteGlobals.EMOTE_GASP: '%s gasps!',
    EmoteGlobals.EMOTE_GIGGLE: '%s giggles.',
    EmoteGlobals.EMOTE_GLARE: '%s glares angrily.',
    EmoteGlobals.EMOTE_GOODBYE: '%s waves goodbye.',
    EmoteGlobals.EMOTE_GREET: '%s greets everyone nearby.',
    EmoteGlobals.EMOTE_GRIN: '%s grins.',
    EmoteGlobals.EMOTE_GROWL: '%s growls angrily.',
    EmoteGlobals.EMOTE_HAIL: '%s hails everyone nearby.',
    EmoteGlobals.EMOTE_HALLOWEEN: '%s is dancing like a zombie!',
    EmoteGlobals.EMOTE_HAPPY: '%s is happy!',
    EmoteGlobals.EMOTE_HELLO: '%s says hello!',
    EmoteGlobals.EMOTE_HELP: '%s calls out for help!',
    EmoteGlobals.EMOTE_HISS: '%s hisses menacingly.',
    EmoteGlobals.EMOTE_HUNGRY: '%s looks hungry.',
    EmoteGlobals.EMOTE_IMPATIENT: '%s waits impatiently.',
    EmoteGlobals.EMOTE_JK: '%s is just kidding!',
    EmoteGlobals.EMOTE_LAUGH: '%s laughs!',
    EmoteGlobals.EMOTE_MEOW: '%s meows like a cat.',
    EmoteGlobals.EMOTE_MOO: '%s moos.  Moooooooo!',
    EmoteGlobals.EMOTE_NO: '%s says, NO.',
    EmoteGlobals.EMOTE_NOD: '%s nods.',
    EmoteGlobals.EMOTE_POWERFUL: '%s is far too mighty for these weaklings!',
    EmoteGlobals.EMOTE_READY: '%s is ready!',
    EmoteGlobals.EMOTE_ROAR: '%s roars loudly!',
    EmoteGlobals.EMOTE_ROFL: '%s rolls on the floor laughing.',
    EmoteGlobals.EMOTE_SAD: '%s looks sad.',
    EmoteGlobals.EMOTE_SALUTE: '%s salutes.',
    EmoteGlobals.EMOTE_SCARED: '%s is scared!',
    EmoteGlobals.EMOTE_SHRUG: '%s shrugs.',
    EmoteGlobals.EMOTE_SIGH: '%s sighs softly.',
    EmoteGlobals.EMOTE_SMILE: '%s smiles.',
    EmoteGlobals.EMOTE_SORRY: '%s apologizes.  Sorry!',
    EmoteGlobals.EMOTE_THIRSTY: '%s looks thirsty.',
    EmoteGlobals.EMOTE_TIRED: '%s looks tired.',
    EmoteGlobals.EMOTE_VALENTINES: '%s winks.',
    EmoteGlobals.EMOTE_VALENTINES_A: '%s winks A!',
    EmoteGlobals.EMOTE_VALENTINES_B: '%s winks B!',
    EmoteGlobals.EMOTE_VALENTINES_C: '%s winks C!',
    EmoteGlobals.EMOTE_VALENTINES_D: '%s winks D!',
    EmoteGlobals.EMOTE_VALENTINES_E: '%s winks E!',
    EmoteGlobals.EMOTE_VITTLES: '%s asks around for something to eat.',
    EmoteGlobals.EMOTE_WAIT: '%s asks everyone to wait.',
    EmoteGlobals.EMOTE_WAVE: '%s waves.',
    EmoteGlobals.EMOTE_WINK: '%s winks.',
    EmoteGlobals.EMOTE_YAWN: '%s yawns.',
    EmoteGlobals.EMOTE_YES: '%s says, Yes!',
    EmoteGlobals.EMOTE_NOISEMAKER: '%s is making some noise!',
    EmoteGlobals.EMOTE_BLACKHAND: '%s looks almost completely Evil Curse of Doom free.' }
...
CodeRedemptionGoldenKnuckles = 'Golden Knuckles'
CodeRedemptionNorringtonsSpyglass = 'Norringtons Spyglass'
CodeRedemptionElixir = 'Elixir'
CodeRedemptionPotionHeadOnFire = 'Potion Head On Fire'
CodeRedemptionPotionInvis2 = 'Potion Invis2'
CodeRedemptionJackSparrowBlade = 'Jack Sparrow Blade'
CodeRedemptionJackSparrowRevenge = 'Jack Sparrow Revenge'
CodeRedemptionHeartOfPadres = 'Heart Of Padres'
CodeRedemptionAmmoFury = 'Ammo Fury'
...
CodeRedemptionSanta = 'Santa'
CodeRedemptionWinter = 'Winter'
CodeRedemptionWonderland = 'Wonderland'
CodeRedemptionSavvy20k = 'Savvy20k'
...
SeasAreClosed = 'Sorry, the seas appear to be closed at this time. Try again later.'
...
TownfolkGoodbyes = {
    0: [
        ...
        ('Farewell.', 'emote_wave')],
    HolidayGlobals.WINTERFESTIVAL: [
        ('Aye mate, wishing ye a fine holiday season!', 'emote_wink'),
        ('Farewell, have a great festive season!', 'emote_wink'),
        ('Happy Holidays!', 'emote_smile'),
        ('Goodbye, now back to celebrating...', 'emote_dance_jig')] }
TownfolkEncourage = [
    'Keep at it, mate!',
    "Come back when you're finished"]
TownfolkBrushoff = {
    0: [
        ('Ahoy there - have ye spoken to the new Peddler merchants?', None),
        ("Thought I'd remind you, Peddler merchants offer brand new clothes on the first of every month.", None),
        ('Better save some coin if ye be wanting new clothes.', 'emote_wave'),
        ("Raven's Cove spirits need help. Find yer way there now! ", 'emote_smile'),
        ("Been to Raven's Cove?", 'emote_yes'),
        ("Blimey, rumors of the Queen Anne's Revenge stalking ships at sea be too much for m'nerves!", 'emote_scared'),
        ("Don't stand there chattin' with me, El Patron and his weapons be out there! ", None),
        ...
        ('Got any new weapons? Like the Sword of Triton?', 'emote_smile'),
        ("Bandits be slowly stealing our island's wealth. Get to the Cannon Defense towers! ", None),
        ('Have ye noticed the gunsmiths have more weapons these days?', 'emote_yes'),
        ("Go to Raven's Cove, if ye dare.", 'emote_scared'),
        ("Best be believin' in ghost stories mates. ", None),
        ('Be wary of Rage Ghosts. Deadly things they are. ', None),
        ("I hear sailors telling tales of other wordly encounters on the black rock they call Raven's Cove. ", None),
        ...
        ("Invasions, Fleets and now the Queen Anne's Revenge! 'Tis a time of great conflict in the Caribbean.", 'emote_angry'),
        ('Jolly will NOT stop invading until he rules the islands!', 'emote_angry'),
        ("Legend tells us the Sword of Triton holds special abilities when used against the crew of the Queen Anne's Revenge.", None),
        ("Legendary fish are ready to be caught, but only by someone who's fishing reputation is high.", None),
        ...
        ("Jolly has decimated Raven's Cove but I hear there is a lone survivor. Find him and learn what you can.", 'emote_no'),
        ("Our spies say that Jolly's furious so expect more invasions.", 'emote_yes'),
        ('Pssst - I hear more invasions are coming, sharpen your steel, mate.', 'emote_smile'),
        ('Rumor has it that loot can be found in the belly of fish some Pirates are catching. ', None),
        ('Rumor has it that rescuing the Black Pearl can yield unique rewards. ', None),
        ("Seen Blackbeard's Sword of Triton? Its jeweled hilt is one to admire.", 'emote_yes'),
        ('The Navy has the Black Pearl! Retrieve it and reap the rewards. ', None),
        ("The Undead invasions will only end when Jolly's defeated...permanently.", 'emote_angry'),
        ('Think Jolly will stop invading because he got some Lost Weapons? No way!', 'emote_no'),
        ("I've seen Pirates strolling with feathered sidekicks, I couldn't believe m'eyes. ", None),
        ('Truth is mate, if ye wants new weapons, ye must defeat the Undead. ', None),
        ('Pirates looking for work should think about becoming fishermen, shipwrights or potion brewers.', None),
        ...
        ('I would not dare challenge the Queen Anne and her mighty crew!', 'emote_scared')],
    HolidayGlobals.WINTERFESTIVAL: [
        ("Hope you're having a fine, festive season!", 'emote_yes'),
        ("Why are you standing here when there's celebrating to be done?!", 'emote_dance_jig'),
        ('Celebrate that the undead have retreated... for now.', 'emote_celebrate'),
        ('Fire work, all ye pirates for fighting off Jolly - Happy Holidays!', 'emote_smile'),
        ("We can still celebrate the season, in spite of Jolly's best efforts, ey?", 'emote_wink'),
        ('Happy Holidays, mate! Now back to plundering...', 'emote_laugh'),
        ("I hear rumor that Jolly's regrouping and will return soon.", 'emote_yes'),
        ('I heard from a friend who heard from an undead scab that Jolly will return.', 'emote_scared'),
        ("Don't be fooled by this quiet time - Jolly's not defeated. He's rebuilding.", 'emote_no'),
        ("The holiday's are so festive... makes me wanna dance the jig!", 'emote_dance_jig'),
        ("Enjoy the festive season mate for it won't last long.", 'emote_smile'),
        ("The Caribbean's the best place to endure winter, ey?", 'emote_wink'),
        ('Fine weather, ey? Poor blokes back in England are freezing their backsides off!', 'emote_laugh'),
        ("Celebrate now mates - for soon Jolly will return and it's back to battle!", 'emote_dance_jig'),
        ("Don't stand there gawking, grab some cards and let's make merry, ey?", 'emote_smile'),
        ("Glad I'm here instead of jolly old England right now, even with the invasions!", 'emote_laugh'),
        ("Don't bother me mate, I'm making merry!", 'emote_dance_jig'),
        ("Take some time off a plunderin' to enjoy the festive season!", None),
        ('Ahoy mate, too much festive-ness, gotta get more sleep!', 'emote_sleep'),
        ('I love this festive season... makes me wanna laugh out loud!', 'emote_laugh'),
        ("Yes! 'Tis the season to celebrate, mate!", 'emote_celebrate'),
        ("Celebrate the season... while Jolly's off regrouping.", 'emote_dance_jig'),
        ("Hard for me to celebrate when I fear Jolly's return any day now!", 'emote_no')] }
PirateGreetings = [
    'Ahoy!',
    'Ahoy there!',
    'Avast me hearties!',
...
PirateGoodbyes = {
    0: [
        ('Arrr!', 'emote_wave'),
        ('Arrr matey!', 'emote_wave'),
        ("Back to plunderin'!", 'emote_wave'),
        ('Best be watchin yer back matey!', 'emote_wink')] }
PirateEncourage = [
    'Keep at it, mate!',
    "Ye're not done yet"]
PirateBrushoff = [
    ...
    'Nothing here for ye',
    "Bug off mate, I'm busy",
    "Don't stare at the sun, mate, it'll blind ye",
    'Word to the wise -- keep your steel sharp and a sharp eye',
...
StowawayGreetings = [
    "Lookin' to steal away to another island quickly, ey?  I am the right man.",
    'Need to get to another port fast?  No worries, mate.  But...it will cost ye.',
    'I can get ye to another place, anyplace in the islands fast...for a fee.',
    'Get somewhere fast, huh?  I can help.  For a fee.',
    "Needin' to leave quickly? I understand.  I'll make it happen...for a price.",
    "I'll get ye to another island, but don't tell a soul about me side business, ey?",
    'Ye need to get out of town, I need some extra gold...we can work something out.',
    "Halo mate, I've got a crate just your size...if ye can offer me a tip, savvy?"]
StowawayGoodbyes = {
    0: [
...
FishmasterGreetings = [
    "I've got rods, lures, and more than one tale to tell."]
...
CannonmasterGreetings = [
    "You there, can you man a cannon? Drive off these treasure-stealin' bandits and I'll pay ye well!",
    "The treasure's under attack again! I've an unmanned Navy Cannon for yeh and some coin for yer trouble.",
    "Bandits 're after the treasure! There's coin in 't for the cannoneer who sends 'em down to Davy Jones'!"]
...
ScrimmageMasterGreetings = [
    'Feel like you can show us your strength? Come and join the Navy!']
...
CannonDefenseAmmoTypeDesc = {
    InventoryType.DefenseCannonRoundShot: 'Basic Navy ammo',
    InventoryType.DefenseCannonMine: 'They float and explode!',
    InventoryType.DefenseCannonTargetedShot: 'Guaranteed accurate!',
    InventoryType.DefenseCannonHotShot: 'Sets ships on fire!',
    InventoryType.DefenseCannonScatterShot: 'Fires a clustershot',
    InventoryType.DefenseCannonPowderKeg: 'Shoot it for massive damage!',
    InventoryType.DefenseCannonSmokePowder: 'Confuse ships to slow them!',
    InventoryType.DefenseCannonBullet: 'Flies straight, hits hard!',
    InventoryType.DefenseCannonColdShot: 'Freeze the sea, and ships!',
    InventoryType.DefenseCannonBomb: 'BOOM!!!',
    InventoryType.DefenseCannonChumShot: 'Sharks love bait!',
    InventoryType.DefenseCannonFireStorm: 'Burn the ocean!',
    InventoryType.DefenseCannonEmpty: 'Empty' }
PotionGui = {
    'ExitButton': 'Exit',
