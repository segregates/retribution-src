...
burstSfxNames = [
    SoundGlobals.SFX_FX_FIREWORK_EXPLODE_01,
    SoundGlobals.SFX_FX_FIREWORK_EXPLODE_02,
    SoundGlobals.SFX_FX_FIREWORK_EXPLODE_03,
    SoundGlobals.SFX_FX_FIREWORK_DISTANT_01,
    SoundGlobals.SFX_FX_FIREWORK_DISTANT_02,
    SoundGlobals.SFX_FX_FIREWORK_DISTANT_03]
