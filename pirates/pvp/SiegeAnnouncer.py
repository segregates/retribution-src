...
class SiegeAnnouncer(DistributedObject):
    ...
    def announceSink(self, team, shipName, sunkTeam, sunkShipName):
        ...
        stringDict = {
            'teamName': PVPGlobals.siegeTeamNames[team],
            'shipName': shipName,
            'sunkTeamName': PVPGlobals.siegeTeamNames[sunkTeam],
    ...
    def announceSinkWithAssist(self, team, shipName, assistTeam, assistShipName, sunkTeam, sunkShipName):
        ...
        stringDict = {
            'teamName': PVPGlobals.siegeTeamNames[team],
            'shipName': shipName,
            'assistTeamName': PVPGlobals.siegeTeamNames[assistTeam],
            'assistShipName': assistShipName,
            'sunkTeamName': PVPGlobals.siegeTeamNames[sunkTeam],
            'sunkShipName': sunkShipName }
