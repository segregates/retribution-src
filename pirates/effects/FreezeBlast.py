...
class FreezeBlast(PooledEffect, EffectController):
    cardScale = 128.0
    ...
    def __init__(self):
        ...
        self.p0.renderer.getColorInterpolationManager().addLinear(0.0, 1.0, Vec4(0.450, 0.5, 1, 1), Vec4(1, 1, 1, 1), 1)
        self.p0.emitter.setEmissionType(BaseParticleEmitter.ETRADIATE)
        self.p0.emitter.setAmplitude(1.25)
