...
class BlackPearlCrew(DirectFrame):
    crewData = [
        {
            'uniqueId': NPCIds.HENDRY_CUTTS,
            'image': 'crew_3_HendryCutts',
            'ladder': 'c3r2r3Cutts' },
        {
            'uniqueId': NPCIds.CARVER,
            'image': 'crew_1_CarverPidgeley',
            'ladder': 'c3r2r1Carver' },
        {
            'uniqueId': NPCIds.LE_CERDO,
            'image': 'crew_5_LeCerdo',
            'ladder': 'c3r2r5Grog' },
        {
            'uniqueId': NPCIds.GUNNER,
            'image': 'crew_6_Gunner',
            'ladder': 'c3r3r1Gunner' },
        {
            'uniqueId': NPCIds.GORDON_GREER,
            'image': 'crew_2_GordenGreer',
            'ladder': 'c3r2r2Greer' },
        {
            'uniqueId': NPCIds.JOHN_SMITH,
            'image': 'crew_9_JohnSmith',
            'ladder': 'c3r3r4Smith' },
        {
            'uniqueId': NPCIds.NILL_OFFRILL,
            'image': 'crew_4_NillOffrill',
            'ladder': 'c3r2r4Offrill' },
        {
            'uniqueId': NPCIds.SCARY_MARY,
            'image': 'crew_7_ScaryMary',
            'ladder': 'c3r3r2Mary' },
        {
            'uniqueId': NPCIds.GILADOGA,
            'image': 'crew_8_Giladoga',
            'ladder': 'c3r3r3Giladoga' }]
