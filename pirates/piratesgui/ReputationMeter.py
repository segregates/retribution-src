...
class ReputationMeter(DirectFrame):
    ...
    def __init__(self, category, width = 0.4):
        ...
        self.meterFrame = DirectFrame(parent = self.meter, relief = None, image = gui.find('**/ship_battle_speed_bar*'), image_scale = (width * 0.75, 1.0, 0.598), pos = (0, 0, 0.0))
        self.clamp1 = DirectFrame(parent = self.meter, relief = None, image = guiModel.find('**/groggy_clamp'), image_scale = (0.149, 1.0, 0.4), image_color = (0.800000, 0.800000, 0.800000, 1.0), pos = (-width * 0.333, 0, 0))
        self.clamp2 = DirectFrame(parent = self.meter, relief = None, image = guiModel.find('**/groggy_clamp'), image_scale = (0.149, 1.0, 0.4), image_color = (0.800000, 0.800000, 0.800000, 1.0), pos = (-width * 0.167, 0, 0))
        self.clamp3 = DirectFrame(parent = self.meter, relief = None, image = guiModel.find('**/groggy_clamp'), image_scale = (0.149, 1.0, 0.4), image_color = (0.800000, 0.800000, 0.800000, 1.0), pos = (0, 0, 0))
        self.clamp4 = DirectFrame(parent = self.meter, relief = None, image = guiModel.find('**/groggy_clamp'), image_scale = (0.149, 1.0, 0.4), image_color = (0.800000, 0.800000, 0.800000, 1.0), pos = (width * 0.167, 0, 0))
        self.clamp5 = DirectFrame(parent = self.meter, relief = None, image = guiModel.find('**/groggy_clamp'), image_scale = (0.149, 1.0, 0.4), image_color = (0.800000, 0.800000, 0.800000, 1.0), pos = (width * 0.333, 0, 0))
        self.valueLabel = DirectLabel(parent = self.meter, relief = None, text = '', text_scale = PiratesGuiGlobals.TextScaleMed, text_align = TextNode.ACenter, text_fg = PiratesGuiGlobals.TextFG2, text_shadow = PiratesGuiGlobals.TextShadow, text_font = PiratesGlobals.getInterfaceFont(), text_pos = (0, 0.0320), pos = (0, 0, -0.01), textMayChange = 1)
        ...
        self.levelCapScroll.setScale(0.115, 1.0, 0.050000)
        self.levelCapScroll.hide()
        self.levelCapIcon = DirectFrame(parent = self.meter, relief = None, image = logoModel.find('**/skull'))
        self.levelCapIcon.setPos(0.0, 0.0, 0.0250)
        self.levelCapIcon.setScale(0.4)
        self.levelCapIcon.setBin('gui-popup', 0)
        self.levelCapIcon.hide()
        self.masteredLabel = DirectLabel(parent = self.meter, relief = None, text = PLocalizer.RepCapText_Skill, text_scale = 0.0448, text_align = TextNode.ACenter, text_fg = PiratesGuiGlobals.TextFG1, text_shadow = PiratesGuiGlobals.TextShadow, text_font = PiratesGlobals.getInterfaceFont())
