from panda3d.core import Light, TextNode
# File: C (Python 2.4)
...
HUD_ICONS = {
    ...
    2: 'pir_t_ico_gun_pistol_a',
    3: 'pir_t_ico_doll_spirit_a',
    4: 'pir_t_ico_knf_small',
    5: 'pir_t_ico_bom_grenade',
    6: 'pir_t_ico_stf_dark_a',
    7: 'pir_t_ico_can_single',
    8: 'sail_come_about',
    9: 'topgui_icon_ship',
    10: 'lookout_win_parlor_game_icon',
    11: 'lookout_win_pvp_game_icon',
    12: None,
    13: 'pir_t_gui_gen_medical' }
        ...
        if DistributedBandMember.DistributedBandMember.IsLocalAvatarHeadOfBand() and flag:
            ...
            for (avId, hudButton) in self.crew.iteritems():
                if not (hudButton[0].potentialMember):
                    if not (hudButton[0].hudOnline) and hudButton[0].inPvp or hudButton[0].inParlorGame:
                        hudButton[10].show()
                        hudButton[11].show()
                        continue
