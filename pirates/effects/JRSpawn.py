from panda3d.core import ColorBlendAttrib, NodePath, StencilAttrib, Texture, TextureStage, VBase3, VBase4
# File: J (Python 2.4)
...
class JRSpawn(PooledEffect, EffectController):
    ...
    def createTrack(self):
        ...
        fadeInRays = LerpColorScaleInterval(self.rays, 1.0, VBase4(0.800000, 1, 0.100, 1), startColorScale = VBase4(0.800000, 1, 0.100, 0))
        fadeOutRays = LerpColorScaleInterval(self.rays, 2.0, VBase4(0.800000, 1, 0.100, 0), startColorScale = VBase4(0.800000, 1, 0.100, 1))
        scaleUpRays = LerpScaleInterval(self.rays, 2.0, VBase3(1, 1, 1.5), startScale = VBase3(0.5, 0.5, 0.200), blendType = 'easeInOut')
        scaleDownRays = LerpScaleInterval(self.rays, 2.0, VBase3(0.5, 0.5, 0.200), startScale = VBase3(1, 1, 1.5), blendType = 'easeInOut')
