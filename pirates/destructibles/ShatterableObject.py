...
class ShatterableObject(DirectObject):
    ...
    def initializeDebris(self, wantHidden = 0, wantRotate = 1, wantColl = 0, bounce = 0):
        ...
        for i in xrange(len(self.break1High)):
        ...
        for i in xrange(len(self.break2High)):
    ...
    def resetDebris(self):
        self.findDebris()
        for i in xrange(len(self.debrisA)):
        ...
        for i in xrange(len(self.debrisB)):
