...
InteractOptionNames = {
    ...
    SELL_ITEMS: PLocalizer.InteractSellItems,
    ...
    CATALOG_STORE: PLocalizer.InteractCatalogStore,
    ...
    PVP_REWARDS_COATS: PLocalizer.InteractPvPCoat,
    PVP_REWARDS_HATS: PLocalizer.InteractPvPHat,
    STOWAWAY: PLocalizer.InteractStowaway,
    PLAY_CANNON_DEFENSE: PLocalizer.InteractCannonDefense,
    POTION_TUTORIAL: PLocalizer.InteractPotionTutorial,
    LAUNCH_FISHING_BOAT: PLocalizer.InteractLaunchFishingBoat,
    LEGENDARY_FISH_STORY: PLocalizer.InteractLegendaryFishStory,
    UPGRADE_ROD: PLocalizer.InteractUpgradeRod,
    PLAY_SCRIMMAGE: PLocalizer.InteractScrimmage }
InteractOptionHelpText = {
    ...
    SELL_ITEMS: PLocalizer.InteractSellItemsHelp,
    ...
    CATALOG_STORE: PLocalizer.InteractStoreHelp,
    ...
    PVP_REWARDS_COATS: PLocalizer.InteractPvPCoatHelp,
    PVP_REWARDS_HATS: PLocalizer.InteractPvPHatHelp,
    STOWAWAY: PLocalizer.InteractStowawayHelp,
    PLAY_CANNON_DEFENSE: PLocalizer.InteractCannonDefenseHelp,
    POTION_TUTORIAL: PLocalizer.InteractPotionTutorialHelp,
    LAUNCH_FISHING_BOAT: PLocalizer.InteractLaunchFishingBoatHelp,
    LEGENDARY_FISH_STORY: PLocalizer.InteractLegendaryFishStory,
...
__NPCInteractMenus = {
    ...
    AvatarTypes.Peasant: (PLocalizer.PeasantMenuTitle, [
        ...
        HEAL_HP,
        CANCEL]),
    AvatarTypes.Kudgel: (PLocalizer.CommonerMenuTitle, [
        QUEST,
        BRIBE,
        HEAL_HP,
        CANCEL]),
    ...
    AvatarTypes.Gypsy: (PLocalizer.GypsyMenuTitle, [
        ...
        HEAL_MOJO,
        CANCEL]),
    AvatarTypes.Fishmaster: (PLocalizer.FishmasterMenuTitle, [
        STORE,
        UPGRADE_ROD,
        LAUNCH_FISHING_BOAT,
        LEGENDARY_FISH_STORY,
        CANCEL]),
    AvatarTypes.Cannonmaster: (PLocalizer.CannonmasterMenuTitle, [
        PLAY_CANNON_DEFENSE,
        CANCEL]),
    ...
    AvatarTypes.PvPRewards: (PLocalizer.ShopPvP, [
        ...
        BRIBE,
        CANCEL]),
    AvatarTypes.Stowaway: (PLocalizer.ShopStowaway, [
        STOWAWAY,
        CANCEL]),
    AvatarTypes.CatalogRep: (PLocalizer.ShopCatalogRep, [
        CATALOG_STORE,
        SELL_ITEMS,
        CANCEL]),
    AvatarTypes.ScrimmageMaster: (PLocalizer.ScrimmageMasterMenuTitle, [
        PLAY_SCRIMMAGE,
        CANCEL]) }
if wantPotionGame:
    __NPCInteractMenus[AvatarTypes.Gypsy] = (PLocalizer.GypsyMenuTitle, [
        QUEST,
        STORE,
        POTION_TUTORIAL,
        BRIBE,
...
__NPCTutorialDict = {
    ...
    FishmasterTutorial1: 'quest_tut_gypsy_intro_100' }
...
__NPCSalutations = {
    AvatarTypes.Townfolk: {
        'greetings': PLocalizer.TownfolkGreetings,
        'goodbyes': PLocalizer.TownfolkGoodbyes,
        'durings': PLocalizer.TownfolkEncourage,
        'brushoffs': PLocalizer.TownfolkBrushoff },
    AvatarTypes.Cast: { },
    AvatarTypes.Commoner: { },
    AvatarTypes.Peasant: { },
    AvatarTypes.Kudgel: { },
    AvatarTypes.StoreOwner: {
        'greetings': PLocalizer.FormalGreetings,
        'goodbyes': PLocalizer.FormalGoodbyes,
        'durings': PLocalizer.TownfolkEncourage },
    AvatarTypes.Gypsy: {
        'greetings': PLocalizer.GypsyGreetings,
        'goodbyes': PLocalizer.GypsyGoodbyes,
        'durings': PLocalizer.GypsyEncourage,
        'brushoffs': PLocalizer.GypsyBrushoff },
    AvatarTypes.Fishmaster: {
        'greetings': PLocalizer.FishmasterGreetings,
        'goodbyes': PLocalizer.FishmasterGoodbyes,
        'durings': PLocalizer.FishmasterEncourage,
        'brushoffs': PLocalizer.FishmasterBrushoff },
    AvatarTypes.Cannonmaster: {
        'greetings': PLocalizer.CannonmasterGreetings,
        'goodbyes': PLocalizer.CannonmasterGoodbyes,
        'durings': PLocalizer.CannonmasterEncourage,
        'brushoffs': PLocalizer.CannonmasterBrushoff },
    AvatarTypes.Blacksmith: {
        'greetings': PLocalizer.FormalGreetings,
        'goodbyes': PLocalizer.FormalGoodbyes,
        'durings': PLocalizer.TownfolkEncourage,
        'brushoffs': PLocalizer.TownfolkBrushoff },
    AvatarTypes.Shipwright: {
        'greetings': PLocalizer.PirateGreetings,
        'goodbyes': PLocalizer.PirateGoodbyes,
        'durings': PLocalizer.TownfolkEncourage,
        'brushoffs': PLocalizer.TownfolkBrushoff },
    AvatarTypes.Merchant: {
        'greetings': PLocalizer.FormalGreetings,
        'goodbyes': PLocalizer.FormalGoodbyes,
        'durings': PLocalizer.TownfolkEncourage,
        'brushoffs': PLocalizer.TownfolkBrushoff },
    AvatarTypes.Bartender: {
        'greetings': PLocalizer.PirateGreetings,
        'goodbyes': PLocalizer.PirateGoodbyes,
        'durings': PLocalizer.TownfolkEncourage,
        'brushoffs': PLocalizer.TownfolkBrushoff },
    AvatarTypes.Gunsmith: {
        'greetings': PLocalizer.PirateGreetings,
        'goodbyes': PLocalizer.PirateGoodbyes,
        'durings': PLocalizer.TownfolkEncourage,
        'brushoffs': PLocalizer.TownfolkBrushoff },
    AvatarTypes.Grenadier: {
        'greetings': PLocalizer.FormalGreetings,
        'goodbyes': PLocalizer.FormalGoodbyes,
        'durings': PLocalizer.TownfolkEncourage,
        'brushoffs': PLocalizer.TownfolkBrushoff },
    AvatarTypes.Cannoneer: {
        'greetings': PLocalizer.PirateGreetings,
        'goodbyes': PLocalizer.PirateGoodbyes,
        'durings': PLocalizer.TownfolkEncourage,
        'brushoffs': PLocalizer.TownfolkBrushoff },
    AvatarTypes.MedicineMan: {
        'greetings': PLocalizer.GypsyGreetings,
        'goodbyes': PLocalizer.GypsyGoodbyes,
        'durings': PLocalizer.TownfolkEncourage,
        'brushoffs': PLocalizer.TownfolkBrushoff },
    ...
    AvatarTypes.Trainer: {
        ...
        'durings': PLocalizer.TownfolkEncourage,
        'brushoffs': PLocalizer.TownfolkBrushoff },
    AvatarTypes.Musician: {
        'greetings': PLocalizer.FormalGreetings,
        'goodbyes': PLocalizer.FormalGoodbyes,
        'durings': PLocalizer.TownfolkEncourage,
        'brushoffs': PLocalizer.TownfolkBrushoff },
    AvatarTypes.PvPRewards: {
        'greetings': PLocalizer.PirateGreetings,
        'goodbyes': PLocalizer.PirateGoodbyes,
        'durings': PLocalizer.TownfolkEncourage,
        'brushoffs': PLocalizer.TownfolkBrushoff },
    AvatarTypes.Stowaway: {
        'greetings': PLocalizer.StowawayGreetings,
        'goodbyes': PLocalizer.StowawayGoodbyes,
        'durings': PLocalizer.TownfolkEncourage,
        'brushoffs': PLocalizer.StowawayBrushoff },
    AvatarTypes.CatalogRep: {
        'greetings': PLocalizer.FormalGreetings,
        'goodbyes': PLocalizer.FormalGoodbyes,
        'durings': PLocalizer.TownfolkEncourage,
        'brushoffs': PLocalizer.TownfolkBrushoff },
    AvatarTypes.ScrimmageMaster: {
        'greetings': PLocalizer.ScrimmageMasterGreetings,
        'goodbyes': PLocalizer.ScrimmageMasterGoodbyes,
        'durings': PLocalizer.ScrimmageMasterEncourage,
        'brushoffs': PLocalizer.ScrimmageMasterBrushoff },
    NPCIds.PIERRE_LE_PORC: {
        'brushoffs': PLocalizer.ShipPVPLordBrushoff },
    NPCIds.GARCIA_DE_AVARCIA: {
        'brushoffs': PLocalizer.ShipPVPLordBrushoff },
    NPCIds.SAM_SEABONES: {
        'goodbyes': PLocalizer.SamSeabonesGoodbye,
        'brushoffs': PLocalizer.SamSeabonesBrushoff },
    NPCIds.JOSIE_MCREEDY: {
        'greetings': PLocalizer.JosieMcReedyGreeting,
        'groodbyes': PLocalizer.JosieMcReedyGoodbye,
        'brushoffs': PLocalizer.JosieMcReedyBrushoff },
    NPCIds.PETER_CHIPPARR: {
        'greetings': PLocalizer.PeterChipparrGreeting,
        'groodbyes': PLocalizer.PeterChipparrGoodbye,
        'brushoffs': PLocalizer.PeterChipparrBrushoff },
    NPCIds.BARTHOLOMEW_WATKINS: {
        'greetings': PLocalizer.BWatkinsGreeting,
        'groodbyes': PLocalizer.BWatkinsGoodbye,
        'brushoffs': PLocalizer.BWatkinsBrushoff },
    NPCIds.SHANE_MCGREENY: {
        'greetings': PLocalizer.ShaneMcGreenyGreeting,
        'groodbyes': PLocalizer.ShaneMcGreenyGoodbye,
        'brushoffs': PLocalizer.ShaneMcGreenyBrushoff },
    NPCIds.TIA_DALMA: {
        'greetings': PLocalizer.TiaDalmaGreeting,
    ...
    NPCIds.THOMAS_FISHMEISTER: {
        'brushoffs': PLocalizer.ThomasFishmeisterBrushoff },
    NPCIds.MADAM_ZIGANA: {
        'brushoffs': PLocalizer.MadamZiganaBrushoff },
    NPCIds.WIDOW_THREADBARREN: {
        'brushoffs': PLocalizer.ThreadbarrenBrushoff },
    NPCIds.BEN_CLUBHEART: {
        'brushoffs': PLocalizer.ClubheartsBrushoff },
    NPCIds.SANDIE_CLUBHEART: {
        'brushoffs': PLocalizer.ClubheartsBrushoff },
    NPCIds.SENOR_FANTIFICO: {
        'brushoffs': PLocalizer.FantificoBrushoff } }

def getStringsForLocalAvatar(npc, type):
    list = []
    if npc.getUniqueId() in __NPCSalutations:
        list = __NPCSalutations.get(npc.getUniqueId()).get(type)

    if not list and npc.avatarType in __NPCSalutations:
