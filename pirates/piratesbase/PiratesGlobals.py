...
preLoadSet = [
    ...
    'phase_2/models/char/fp_500',
    'phase_2/models/char/mp_2000',
    'phase_2/models/char/mp_1000',
    'phase_2/models/char/mp_500',
    'phase_2/models/misc/male_clothes',
    'phase_2/models/misc/female_clothes',
    'phase_2/models/misc/male_body',
    'phase_2/models/gui/char_gui',
    'phase_2/models/gui/gui_main',
    'phase_2/models/misc/female_body',
    'phase_2/models/misc/male_face',
    'phase_2/models/misc/female_face',
    'phase_2/models/char/fp_idle',
    'phase_2/models/char/mp_idle',
    ...
    'phase_2/models/gui/toplevel_gui',
    ...
    'phase_3/models/vegetation/bush_d',
    'phase_3/models/vegetation/bush_e',
    'phase_3/models/vegetation/bush_f',
    'phase_3/models/vegetation/bush_g',
    'phase_3/models/vegetation/bush_i',
    ...
    'phase_4/models/char/pig_hi',
    'phase_4/models/char/pig_med',
    'phase_4/models/char/pig_low',
...
QUEST_PROP_MODELS = {
    QUEST_PROP_AZT_IDOL_A_DESTR: 'models/props/pir_r_prp_azt_idol_a_destructible',
    QUEST_PROP_AZT_IDOL_B_DESTR: 'models/props/pir_r_prp_azt_idol_b_destructible',
    QUEST_PROP_AZT_SKELETON_A_DESTR: 'models/props/pir_r_prp_azt_skeleton_a_destructible',
    QUEST_PROP_AZT_SKELETON_B_DESTR: 'models/props/pir_r_prp_azt_skeleton_b_destructible',
    QUEST_PROP_WPN_AMMOPILE: 'models/props/pir_m_prp_wpn_ammoPile',
    QUEST_PROP_ROK_RUBBLE_DIGSPOT: 'models/props/pir_m_prp_rok_rubble_digspot',
    QUEST_PROP_ROK_RUBBLE_TUNNEL: 'models/props/pir_m_prp_rok_rubble_tunnel',
    QUEST_PROP_WPN_WEAPONRACK: 'models/props/pir_m_prp_wpn_weaponRack',
    QUEST_PROP_LIT_TORCHSTAND: 'models/props/pir_m_prp_lit_torchStand',
    QUEST_PROP_CEM_TOMB_INTER: 'models/props/pir_r_prp_cem_tomb_interact',
    QUEST_PROP_CAV_WEBWALL: 'models/props/pir_m_prp_cav_webWall',
    QUEST_PROP_FRT_TENT_NAVY: 'models/props/pir_m_prp_frt_tent_navy',
    QUEST_PROP_BON_SKULL_SHRINE: 'models/props/pir_r_prp_bon_skullShrine_destructible',
    QUEST_PROP_SET_CHAIR_DESTR: 'models/props/pir_m_prp_set_chair_destructible',
    QUEST_PROP_ENM_HIVE_SCORPION: 'models/props/pir_m_prp_enm_hive_scorpion',
    QUEST_PROP_ENM_HIVE_WASP: 'models/props/pir_m_prp_enm_hive_wasp',
    QUEST_PROP_FRM_PEN_LIVESTOCK: 'models/props/pir_m_prp_frm_pen_livestock',
    QUEST_PROP_SHP_WRK_GALLEON: 'models/props/pir_m_shp_wrk_galleon',
    QUEST_PROP_SHP_WRK_MAST_A: 'models/props/pir_m_shp_wrk_mastA',
    QUEST_PROP_SHP_WRK_MAST_B: 'models/props/pir_m_shp_wrk_mastB',
    QUEST_PROP_SHP_WRK_MAST_C: 'models/props/pir_m_shp_wrk_mastC',
    QUEST_PROP_OCN_ROCK_A: 'models/props/pir_m_prp_ocn_rock_a',
    QUEST_PROP_OCN_ROCK_B: 'models/props/pir_m_prp_ocn_rock_b',
    QUEST_PROP_OCN_ROCK_C: 'models/props/pir_m_prp_ocn_rock_c',
    QUEST_PROP_OCN_ROCK_D: 'models/props/pir_m_prp_ocn_rock_d',
    QUEST_PROP_OCN_ROCK_E: 'models/props/pir_m_prp_ocn_rock_e',
    QUEST_PROP_OCN_ROCK_F: 'models/props/pir_m_prp_ocn_rock_f',
    QUEST_PROP_OCN_FORTISLAND: 'models/props/pir_m_prp_ocn_fortIsland',
    QUEST_PROP_CAV_FORTDOOR: 'models/props/pir_m_prp_cav_fortDoor',
    QUEST_PROP_OCN_WATCHTOWER_EITC: 'models/props/pir_m_prp_ocn_watchtower_eitc',
    QUEST_PROP_OCN_WATCHTOWER_NAVY: 'models/props/pir_m_prp_ocn_watchtower_navy',
    QUEST_PROP_FRT_CAGE_INTER: 'models/props/pir_r_prp_frt_cage_interact',
    QUEST_PROP_CEM_COFFIN_INTER: 'models/props/pir_r_prp_cem_coffin_interact',
    QUEST_PROP_TOL_SLEDGE: 'models/props/pir_m_hnd_tol_sledge',
    QUEST_PROP_VOO_CRYSTALBALL: 'models/props/pir_m_prp_voo_crystalBall',
    QUEST_PROP_HSW_BOTTLE_DESTR: 'models/props/pir_m_prp_hsw_bottle_destructible',
    QUEST_PROP_SET_BENCH_DESTR: 'models/props/pir_m_prp_set_bench_destructible',
    QUEST_PROP_FRM_SUGARCANE: 'models/props/pir_m_prp_frm_sugarCane',
    QUEST_PROP_POWDER_KEG: 'models/handheld/pir_m_hnd_bom_barrelDynamite',
    QUEST_PROP_DIG_SPOT: 'models/misc/smiley',
    QUEST_PROP_MNG_ELEVATOR_BASKET: 'models/props/pir_m_prp_mng_elevator_basket',
    QUEST_PROP_TRS_CHEST_02: 'models/props/pir_m_prp_trs_chest_02',
    QUEST_PROP_CAV_DOOR_EL_PATRON: 'models/props/pir_m_prp_cav_door_elPatron',
    QUEST_PROP_SHP_GANGPLANK_RAILS_WEATHERED: 'models/props/pir_m_prp_shp_gangplankRails_weathered' }
QUEST_PROP_ANIMS = {
    QUEST_PROP_AZT_IDOL_A_DESTR: {
        'break': 'models/props/pir_a_prp_azt_idol_a_destructible_break' },
    QUEST_PROP_AZT_IDOL_B_DESTR: {
        'break': 'models/props/pir_a_prp_azt_idol_b_destructible_break' },
    QUEST_PROP_AZT_SKELETON_A_DESTR: {
        'break': 'models/props/pir_a_prp_azt_skeleton_a_destructible_break' },
    QUEST_PROP_AZT_SKELETON_B_DESTR: {
        'break': 'models/props/pir_a_prp_azt_skeleton_b_destructible_break' },
    QUEST_PROP_CEM_TOMB_INTER: {
        'open': 'models/props/pir_a_prp_cem_tomb_open' },
    QUEST_PROP_BON_SKULL_SHRINE: {
        'break': 'models/props/pir_a_prp_bon_skullShrine_break' } }
TFFlag = 0
...
TFNoTeleportReasons = {
    ...
    TFInjured: PLocalizer.NoTeleportInjured,
    ...
    TFSameArea: PLocalizer.NoTeleportSameArea,
    TFFishing: PLocalizer.NoTeleportFishing,
    TFPotionCrafting: PLocalizer.NoTeleportPotionCrafting,
    TFInScrimmage: PLocalizer.NoTeleportInScrimmage }
TFNoTeleportToReasons = {
    ...
    TFCannonDefense: PLocalizer.NoTeleportCannonDefense,
    TFInScrimmage: PLocalizer.NoTeleportToInScrimmage }
