...
class DistributedTreasureMap(DistributedObject.DistributedObject, DistributedInventory, QuestHolder):
    ...
    def __init__(self, cr):
        ...
        self.mapId = None
        self._DistributedTreasureMap__enabled = 1
        self.quests = []
    ...
    def requestTreasureMapGo(self, quick = True):
        if quick:
            ...
            localAvatar.guiMgr.lookoutPage.displayLookout(gameStyle = self.mapId, inviteOptions = [
                PiratesGlobals.LOOKOUT_INVITE_CREW], additionalOptions = [
                [
    ...
    def getOptions(self):
        ...
        if numPlayers:
            for currPlayer in xrange(numPlayers[0], numPlayers[1] + 1):
    ...
    def setIsEnabled(self, enabled):
        self._DistributedTreasureMap__enabled = enabled


    def getIsEnabled(self):
        return self._DistributedTreasureMap__enabled
