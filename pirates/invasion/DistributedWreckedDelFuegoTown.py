...
OBJ_EFFECT_PARAMS = {
    0: ('1233963904.0akelts', Point3(8, -6, 2.5), 1.0, Point3(8, -6, 7.5), 0.6),
    1: ('1233964160.0akelts0', Point3(10, -7, 5), 0.75, Point3(10, -10, 6), 0.35),
    2: ('1234209408.0akelts', Point3(4, -8, 1), 1.1, Point3(4, -8, 4), 0.4),
    3: ('1233696000.0akelts0', Point3(4, 2, 13), 0.8, Point3(4, 2, 14), 0.4) }
...
class DistributedWreckedDelFuegoTown(DistributedPostInvasionObject.DistributedPostInvasionObject):
    ...
    def startBurning(self):
        ...
        for id in OBJ_EFFECT_PARAMS:
            ...
            if not id in self.smokeEffects:
