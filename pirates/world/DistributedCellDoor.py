from panda3d.core import Camera, NodePath, Vec3, lookAt
...
class DistributedCellDoor(DistributedInteractive.DistributedInteractive):
    ...
    def setupDoor(self):
        ...
        self.kickEvents = (self.uniqueName('kickStart'), self.uniqueName('kickEnd'))
    ...
    def doorShut(self):
        ...
        self.proximityText = PLocalizer.InteractKickDoor
