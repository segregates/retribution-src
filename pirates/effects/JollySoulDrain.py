...
class JollySoulDrain(PooledEffect, EffectController):
    ...
    def createTrack(self):
        ...
        self.p0.renderer.setFinalYScale(0.000500 * self.cardScale)
        ...
        self.p0.renderer.getColorInterpolationManager().addConstant(0.0, 1.0, Vec4(0.78431373834609985, 1.0, 1.0, 1.0), 1)
        self.p0.emitter.setEmissionType(BaseParticleEmitter.ETRADIATE)
        self.p0.emitter.setAmplitude(1.0)
        self.p0.emitter.setAmplitudeSpread(0.0)
        self.p0.emitter.setOffsetForce(Vec3(0.0, 0.696, 0.0))
