...
class NPCGUI(DirectFrame, StateData.StateData):
    ...
    def setupButtons(self):
        ...
        self.sp4Button = self._makeButton(text = PLocalizer.SkeletonSP4, command = self.handlesp4, pos = (1.05, 0, -2.5), parent = self.shapeFrameTitle)
        self.fr1Button = self._makeButton(text = PLocalizer.SkeletonFR1, command = self.handlefr1, pos = (1.05, 0, -3.5), parent = self.shapeFrameTitle)
        self.fr2Button = self._makeButton(text = PLocalizer.SkeletonFR2, command = self.handlefr2, pos = (1.05, 0, -4), parent = self.shapeFrameTitle)
        self.fr3Button = self._makeButton(text = PLocalizer.SkeletonFR3, command = self.handlefr3, pos = (1.05, 0, -4.5), parent = self.shapeFrameTitle)
        self.fr4Button = self._makeButton(text = PLocalizer.SkeletonFR4, command = self.handlefr4, pos = (1.05, 0, -5), parent = self.shapeFrameTitle)
