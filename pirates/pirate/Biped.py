from panda3d.core import GeomNode, ModelNode, NodePath, TextNode, TransparencyAttrib, Vec3, Vec4, lookAt
...
msfCustomAnimList = [
    ...
    'repairfloor_into',
    'repairfloor_outof',
    'rifle_fight_forward_diagonal_left',
    'rifle_fight_forward_diagonal_right',
    'rifle_fight_run_strafe_left',
    'rifle_fight_run_strafe_right',
    'rifle_fight_shoot_high',
    'rifle_fight_walk',
    'rifle_fight_walk_strafe_left',
    'rifle_fight_walk_strafe_right',
    'run',
    'run_with_weapon',
    'sit',
    'sleep_idle',
...
ftpCustomAnimList = [
    'run']
ftmCustomAnimList = []
jsCustomAnimList = (('idle', 'idle'), ('emote_bow', 'emote_bow'), ('emote_hands_on_hips', 'js_emote_hands_on_hips'), ('emote_scared', 'emote_scared'), ('run', 'run'), ('run_diagonal_left', 'run_diagonal_left'), ('run_diagonal_right', 'run_diagonal_right'), ('run_with_weapon', 'run_with_weapon'), ('strafe_left', 'strafe_left'), ('strafe_right', 'strafe_right'), ('turn_left', 'turn_left'), ('turn_right', 'turn_right'), ('walk', 'walk'), ('walk_back_diagonal_left', 'walk_back_diagonal_left'), ('walk_back_diagonal_right', 'walk_back_diagonal_right'), ('sit_idle', 'js_playing_cards_idle'), ('into_sit_speak_idle', 'js_playing_cards_into_look'), ('sit_speak_idle', 'js_playing_cards_look_idle'), ('outof_sit_speak_idle', 'js_playing_cards_outof_look'), ('hands_on_hips', 'js_handsOnHips'), ('idle_to_bow', 'js_idleToBow'), ('special_bow', 'js_tv_bow'), ('walk_camera', 'js_walk_camera'), ('marketing_fight_jr', 'js_marketing_fight_jr'))
djCustomAnimList = (('idle', 'idle'), ('idle_hit', 'hit'), ('hit', 'hit'), ('defeat', 'defeat'), ('walk', 'fwalk'), ('attack01', 'attack01'), ('attack02', 'attack02'), ('attack03', 'attack03'), ('jump_attack', 'attack04'))
...
class Biped(UsesAnimationMixer, Avatar, UsesEffectNode):
    ...
    def initializeNametag3d(self):
        ...
        self.iconNodePath = NodePath(self.nametag.getNameIcon())
        if self.iconNodePath.isEmpty():
            self.notify.warning('empty iconNodePath in initializeNametag3d')
            return 0

        if not self.nameText:
            self.nameText = OnscreenText(fg=(1, 1, 1, 1), bg=(0, 0, 0, 0), scale=1.4,
                                         align=TextNode.ACenter, pos=(0, -1.5, -5.2),
    ...
    def setChatAbsolute(self, chatString, chatFlags, dialogue = None, interrupt = 1):
        ...
        base.talkAssistant.receiveOpenTalk(avId, self.getName(), chatString, self.hasGMChat())
