...
class GuildMember(DirectFrame):
    ...
    def __init__(self, avId, avName, guildId, canpromote, candemote, cankick):
        ...
        DirectFrame.__init__(self, relief = None, pos = (-0.6, 0, 0.42), image = guiMain.find('**/general_frame_e'), image_pos = (0.25, 0, 0.24), image_scale = (0.3, 0.0, 0.34))
        ...
        self.message = DirectLabel(parent = self, relief = None, text = avName, text_scale = PiratesGuiGlobals.TextScaleLarge, text_align = TextNode.ACenter, text_fg = (0.9, 1, 0.9, 1), text_shadow = PiratesGuiGlobals.TextShadow, text_wordwrap = 11, pos = (0.25, 0, 0.345), textMayChange = 1)
        self.avocateMessage = DirectLabel(parent = self, relief = None, text = OTPLocalizer.GuildMemberGMMessage % avName, text_scale = PiratesGuiGlobals.TextScaleLarge, text_align = TextNode.ALeft, text_fg = (0.9, 1, 0.9, 1), text_shadow = PiratesGuiGlobals.TextShadow, text_wordwrap = 11, pos = (0.05, 0, 0.345), textMayChange = 1)
