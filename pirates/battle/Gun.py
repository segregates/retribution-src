...
class Gun(Weapon.Weapon):
    modelTypes = [
        'models/handheld/pir_m_hnd_gun_blunderbuss_a',
        'models/handheld/pir_m_hnd_gun_blunderbuss_b',
        'models/handheld/pir_m_hnd_gun_blunderbuss_c',
        'models/handheld/pir_m_hnd_gun_blunderbuss_d',
        'models/handheld/pir_m_hnd_gun_blunderbuss_e',
        'models/handheld/pir_m_hnd_gun_musket_a',
        'models/handheld/pir_m_hnd_gun_musket_b',
        'models/handheld/pir_m_hnd_gun_musket_c',
        'models/handheld/pir_m_hnd_gun_musket_d',
        'models/handheld/pir_m_hnd_gun_musket_e']
    ...
    def setupSounds(cls):
        ...
        Gun.aimSfxs = (loadSfx(SoundGlobals.SFX_WEAPON_PISTOL_AIM),)
        Gun.skillSfxs = {
            InventoryType.PistolShoot: loadSfx(SoundGlobals.SFX_WEAPON_BLUNDERBUSS_SHOOT),
            InventoryType.PistolTakeAim: loadSfx(SoundGlobals.SFX_WEAPON_BLUNDERBUSS_SHOOT),
            EnemySkills.PISTOL_DEADEYE: loadSfx(SoundGlobals.SFX_WEAPON_BLUNDERBUSS_SHOOT),
            EnemySkills.PISTOL_STUNSHOT: loadSfx(SoundGlobals.SFX_WEAPON_BLUNDERBUSS_SHOOT),
            EnemySkills.PISTOL_BREAKSHOT: loadSfx(SoundGlobals.SFX_WEAPON_BLUNDERBUSS_SHOOT),
            EnemySkills.PISTOL_HOTSHOT: loadSfx(SoundGlobals.SFX_WEAPON_BLUNDERBUSS_SHOOT),
            EnemySkills.PISTOL_SCATTERSHOT_AIM: loadSfx(SoundGlobals.SFX_WEAPON_BLUNDERBUSS_SHOOT) }
