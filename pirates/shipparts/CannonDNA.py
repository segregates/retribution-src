...
CannonDict = {
    ...
    ShipGlobals.Cannons.Tutorial: 'models/shipparts/cannon',
    ShipGlobals.Cannons.Skel_L1: 'models/shipparts/GP_cannon',
    ShipGlobals.Cannons.Skel_L2: 'models/shipparts/GP_cannon',
