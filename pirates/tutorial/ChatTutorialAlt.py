...
class ChatTutorialAlt(DirectObject.DirectObject):
    ...
    def _ChatTutorialAlt__handleOKButton(self):
        messenger.send('closeTutorialWindow')
        self.showPart2()


    def _ChatTutorialAlt__handleOpenSpeedChatWindow(self):
        messenger.send('closeTutorialWindow')
        self.showPart3()


    def _ChatTutorialAlt__handleSentSpeedChat(self):
        messenger.send('closeTutorialWindow')
        self.showPart4()


    def _ChatTutorialAlt__handleOKButton1(self):
        messenger.send('closeTutorialWindow')
        self.showPart5()


    def _ChatTutorialAlt__handleOKButton2(self):
        messenger.send('closeTutorialWindow')
        self.showPart6()


    def _ChatTutorialAlt__handleOKButton3(self):
    ...
    def showPart1(self):
        ...
        self.panel1.setYesCommand(self._ChatTutorialAlt__handleOKButton)
        self.stage = 1
    ...
    def showPart2(self):
        ...
        self.acceptOnce('openedSpeedChat', self._ChatTutorialAlt__handleOpenSpeedChatWindow)
        self.stage = 2
    ...
    def showPart3(self):
        ...
        self.acceptOnce('sentSpeedChat', self._ChatTutorialAlt__handleSentSpeedChat)
        self.stage = 3
    ...
    def showPart4(self):
        ...
        self.panel4.setYesCommand(self._ChatTutorialAlt__handleOKButton1)
        self.stage = 4
    ...
    def showPart6(self):
        ...
        self.panel6 = NewTutorialPanel.NewTutorialPanel([
            self.contentPart6,
            'test4'])
        self.panel6.activate()
        self.panel6.setYesCommand(self._ChatTutorialAlt__handleOKButton3)
        self.stage = 6
