...
class DarkAura(PooledEffect, EffectController):
    ...
    def __init__(self):
        ...
        self.p0.factory.setMassSpread(0.800000)
        ...
        self.p0.emitter.setRadius(0.800000)


    def createTrack(self):
        self.startEffect = Sequence(Func(self.p0.setBirthRate, 0.200), Func(self.p0.setPoolSize, 32), Func(self.p0.clearToInitial), Func(self.f.start, self, self.particleDummy), Func(self.f.reparentTo, self))
