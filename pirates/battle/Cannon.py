from panda3d.core import Camera, LODNode, Mat3, ModelNode, ModelRoot, NodePath, Point3, RopeNode, Texture, Vec3
...
cannonTypes = {
    ...
    ShipGlobals.Cannons.L3: 'plain',
    ShipGlobals.Cannons.Tutorial: 'plain',
    ShipGlobals.Cannons.Skel_L1: 'skeleton',
    ShipGlobals.Cannons.Skel_L2: 'skeleton',
    ShipGlobals.Cannons.Skel_L3: 'skeleton',
...
class CannonCache:
    ...
    def getCannon(self):
        ...
        return (root, char, lod, animControl, collisions)
