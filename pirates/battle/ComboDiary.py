...
class ComboDiary:
    ...
    COMBO_ORDER = {
        ...
        ItemGlobals.CURSED_CUTLASS: [
            InventoryType.CutlassHack,
            InventoryType.CutlassSlash,
            InventoryType.CutlassCleave,
            InventoryType.CutlassFlourish,
            InventoryType.CutlassStab],
        ItemGlobals.CURSED_BROADSWORD: [
            EnemySkills.BROADSWORD_HACK,
            EnemySkills.BROADSWORD_SLASH,
            EnemySkills.BROADSWORD_CLEAVE,
            EnemySkills.BROADSWORD_FLOURISH,
            EnemySkills.BROADSWORD_STAB],
        ItemGlobals.CURSED_SABRE: [
            EnemySkills.SABRE_HACK,
            EnemySkills.SABRE_SLASH,
            EnemySkills.SABRE_CLEAVE,
            EnemySkills.SABRE_FLOURISH,
    ...
    SPECIAL_SKILLS = {
        InventoryType.CutlassRep: [
            ...
            EnemySkills.CUTLASS_CURSED_FIRE,
            EnemySkills.CUTLASS_CURSED_ICE,
            EnemySkills.CUTLASS_CURSED_THUNDER,
            EnemySkills.CUTLASS_BLOWBACK,
            EnemySkills.CUTLASS_CAPTAINS_FURY,
            EnemySkills.CUTLASS_POWER_ATTACK],
        InventoryType.DaggerRep: [
            ...
            EnemySkills.DAGGER_BACKSTAB,
            EnemySkills.DAGGER_VENOMSTAB,
            EnemySkills.DAGGER_BARRAGE,
            EnemySkills.DAGGER_ICEBARRAGE,
            EnemySkills.DAGGER_ACIDDAGGER,
