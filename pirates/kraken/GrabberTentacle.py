from panda3d.core import BitMask32, CollideMask, CollisionNode, CollisionTube, GeomNode, ModelRoot, NodePath, Point3, VBase3
    ...
    def l_grabAvatar(self, av):
        ...
        def moveComplete(completed):
            if completed:
                ...
                taskMgr.doMethodLater(2, self.setAvatarToGrabbedState, self.uniqueName('grabDelay'), extraArgs = [
                    av])
            else:
        ...
        if av.isLocal():
            ...
            av.setGameState('TentacleTargeted', [
                self], localChange = 1)
