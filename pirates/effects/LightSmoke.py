...
from panda3d.core import Light, ModelNode, Point3, Vec3, Vec4
# File: L (Python 2.4)
...
class LightSmoke(PooledEffect, EffectController):
    ...
    def __init__(self, parent = None):
        ...
        if not LightSmoke.particleDummy:
            LightSmoke.particleDummy = render.attachNewNode(ModelNode('BlackSmokeParticleDummy'))
        ...
        self.p0.renderer.setFinalXScale(0.348 * self.cardScale)
        self.p0.renderer.setFinalYScale(0.348 * self.cardScale)
        ...
        self.p0.emitter.setOffsetForce(Vec3(2.0, 2.0, 13.0))
