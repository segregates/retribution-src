...
class AnchorButton(BlinkButton.BlinkButton):
    ...
    def __init__(self, hotkeys = (), hotkeyLabel = None, helpText = PLocalizer.AnchorButtonHelp, parent = None, **kw):
        ...
        seq.node().loop(True)
        optiondefs = (('image', (seq, base3, base2), None), ('image_scale', 0.195, None), ('geom', iconTexture, None), ('geom_scale', 0.149, None), ('sortOrder', 1, None), ('relief', None, None))
        self.defineoptions(kw, optiondefs)
        BlinkButton.BlinkButton.__init__(self, hotkeys = hotkeys, hotkeyLabel = hotkeyLabel, helpText = helpText, helpPos = (0.050000, 0, -0.100), parent = parent)
