from panda3d.core import Camera, CullBinManager, GraphicsStateGuardian, Light, LineSegs, MouseButton, NodePath, Point3, ShaderInput, TextNode, Vec2, Vec4, lookAt
# File: F (Python 2.4)
...
class FishingGame(DirectObject.DirectObject):
    ...
    def delete(self):
        ...
        self.lfgGui.destroy()
        self.lfgGui = None
        self.fishingSpot.remove_node()
        self.backdrop.remove_node()
        self.lure.destroy()
        self.fishingLine.remove_node()
    ...
    def setupScene(self):
        ...
        if self.distributedFishingSpot.onABoat:
            ...
            self.backdrop.setPos(25.0, 8.0, -86.0)#self.backdrop.setPos(25.0, 8.0, -86.0 - self.distributedFishingSpot.oceanOffset)
