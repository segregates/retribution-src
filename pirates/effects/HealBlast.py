from panda3d.physics import BaseParticleEmitter, BaseParticleRenderer, LinearCylinderVortexForce
...
class HealBlast(PooledEffect, EffectController):
    ...
    def __init__(self):
        ...
        self.p0.renderer.setColor(Vec4(0.299, 1, 1, 0.5))
        ...
        self.p0.renderer.setFinalYScale(0.00500 * self.cardScale)
    ...
    def createTrack(self):
        ...
        self.p0.emitter.setAmplitude(8.5)
        self.p0.emitter.setOffsetForce(Vec3(0.0, 0.0, -6.5))
        self.startEffect = Sequence(Wait(0.348), Func(self.p0.setBirthRate, 0.0299), Func(self.p0.clearToInitial), Func(self.f.start, self, self))
