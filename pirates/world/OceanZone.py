...
def getOceanZone(xc, yc):
    ...
    if (xcoord >= -15 or xcoord < -7) and ycoord >= 4 and ycoord < 11:
        return BRIGAND_BAY
    elif (xcoord >= -7 or xcoord < -2) and ycoord >= 4 and ycoord < 11:
    ...
    elif (xcoord >= -15 or xcoord < 1) and ycoord >= -3 and ycoord < 4:
        return BLOODY_BAYOU
        ...
        return BOILING_BAY
    elif (xcoord >= -15 or xcoord < -6) and ycoord >= -8 and ycoord < -3:
