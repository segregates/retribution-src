...
class Grenade(Weapon.Weapon):
    ...
    def setupSounds(cls):
        ...
        Grenade.reloadSfxs = (loadSfx(SoundGlobals.SFX_WEAPON_GRENADE_RELOAD),)
        Grenade.skillSfxs = {
            InventoryType.GrenadeThrow: loadSfx(SoundGlobals.SFX_WEAPON_GRENADE_THROW),
            InventoryType.GrenadeSiege: loadSfx(SoundGlobals.SFX_WEAPON_GRENADE_SEIGE),
            InventoryType.GrenadeLongVolley: loadSfx(SoundGlobals.SFX_WEAPON_GRENADE_LONG_VOLLEY) }
