...
class PotionInstructionPanel(GuiPanel):
    ...
    def __init__(self):
        ...
        self.bQuit.setPos(0.450, 0, 0.0299)
        self.message = None
        self.callBack = None
    ...
    def show(self, onInstructionsComplete):
        ...
        self.message = DirectLabel(parent = self, relief = None, text = self.messageText, text_scale = PiratesGuiGlobals.TextScaleLarge, text_align = TextNode.ACenter, text_fg = PiratesGuiGlobals.TextFG2, text_shadow = PiratesGuiGlobals.TextShadow, text_wordwrap = 22, pos = (0.5, 0, 0.27), textMayChange = 0)
        self.unstash()
