from panda3d.core import Buffer, CardMaker, DisplayRegion, Lens, NodePath, Point2, Point3, Texture, TransformState, Vec2, Vec3, Vec4
...
class WorldMap(DirectFrame):
    ...
    def destroy(self):
        ...
        self.buffer.destroy()
        self.stopLocalAvShipPosHprTask()
        self.mapBall.remove_node()
        del self.mapBall
        self.worldRoot.remove_node()
        del self.render
        del self.worldRoot
