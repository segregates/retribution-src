...
class RewardItemGui(DirectFrame):
    ...
    def __init__(self, item, parent = None, textScale = None, itemHeight = None, **kw):
        ...
        optiondefs = (('state', DGG.NORMAL, None), ('frameColor', (0.1, 0.1, 1, 0.08), None), ('borderWidth', PiratesGuiGlobals.BorderWidth, None), ('frameSize', (0.0, RewardItemGui.Width, 0.0, itemHeight), None))
