from panda3d.core import Point3, TextNode, VBase3, VBase4
...
class QuestDetailBase(DirectFrame):
    ...
    def __init__(self, parent = aspect2d, pos = (0, 0, 0), *args, **kw):
        ...
        topGui.remove_node()
        optiondefs = (('relief', None, None), ('pos', pos, None), ('image', questScroll, None), ('image_scale', VBase3(0.48, 0.48, 0.66), None), ('image_color', VBase4(0.9, 0.9, 0.9, 1), None), ('text', '', None), ('text_align', TextNode.ALeft, None), ('text_fg', PiratesGuiGlobals.TextFG0, None), ('text_scale', PiratesGuiGlobals.TextScaleLarge, None), ('text_pos', (-0.45, 0.215), None), ('text_shadow', (1, 1, 1, 0.01), None), ('text_wordwrap', 23, None))
...
class QuestDetailGUI(QuestDetailBase):
    ...
    def setupTitleLabel(self):
        ...
        self.titleLabel = DirectLabel(parent = self, pos = (0, 0, 0.218), text = '', text_scale = 0.041, text_shadow = (0, 0, 0, 1), text_align = TextNode.ACenter, text_wordwrap = 24.0, textMayChange = 1)
