...
class FlamingSkull(PooledEffect, EffectController):
    ...
    def createTrack(self):
        ...
        skullFadeIn = self.icon.colorScaleInterval(3.0, Vec4(0.100, 0.100, 0, 0.25), startColorScale = Vec4(0, 0, 0, 0))
        skullFadeOut = self.icon.colorScaleInterval(1.0, Vec4(0, 0, 0, 0), startColorScale = Vec4(0.100, 0.100, 0, 0.25))
        skullPulseUp = self.icon.scaleInterval(0.050000, 1.25, startScale = 1.0)
        skullPulseDown = self.icon.scaleInterval(0.050000, 1.0, startScale = 1.25)
        skullPulse = Sequence(skullPulseUp, skullPulseDown)
        skullColorPulseUp = self.icon.colorScaleInterval(0.100, Vec4(0.100, 0.100, 0, 0.5), startColorScale = Vec4(0, 0, 0, 0.25))
        skullColorPulseDown = self.icon.colorScaleInterval(0.100, Vec4(0, 0, 0, 0.25), startColorScale = Vec4(0.100, 0.100, 0, 0.5))
