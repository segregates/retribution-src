...
objectStruct = {
    'Objects': {
        '1231376610.68caoconno0': {
            'Type': 'Building Interior',
            'Name': '',
            'AdditionalData': [
                'interior_spanish_doctor'],
            'Instanced': True,
            'Objects': {
                '1169068641.66mike': {
                    'Type': 'Townsperson',
    ...
    'Layers': { },
    'ObjectIds': {
        '1169068641.66mike': '["Objects"]["1231376610.68caoconno0"]["Objects"]["1169068641.66mike"]',
        '1169069336.52mike': '["Objects"]["1231376610.68caoconno0"]["Objects"]["1169069336.52mike"]',
        '1169078025.53mike': '["Objects"]["1231376610.68caoconno0"]["Objects"]["1169078025.53mike"]',
        '1180115072.0dchiappe1': '["Objects"]["1231376610.68caoconno0"]["Objects"]["1180115072.0dchiappe1"]',
        '1231376610.68caoconno0': '["Objects"]["1231376610.68caoconno0"]' } }
