...
class InventoryType:
    ...
    FishingRod = 11399
    FishingLures = (RegularLure, LegendaryLure)
    ...
    _InventoryType__islandToTeleportTokenMap = {
    ...
    def getIslandTeleportToken(cls, islandUid):
        return cls._InventoryType__islandToTeleportTokenMap.get(islandUid)
    ...
    Collection_Sets = (
      Collection_Set1, Collection_Set2, Collection_Set3,
      Collection_Set4, Collection_Set5, Collection_Set6,
      Collection_Set7, Collection_Set8, Collection_Set9,
      Collection_Set10, Collection_Set11
    )
    ...
    HaveMadeList = [
        ...
        HaveMade_CannonDamageLvl3,
        HaveMade_PistolDamageLvl1,
        HaveMade_PistolDamageLvl2,
        HaveMade_PistolDamageLvl3,
        HaveMade_CutlassDamageLvl1,
        HaveMade_CutlassDamageLvl2,
        HaveMade_CutlassDamageLvl3,
        HaveMade_DollDamageLvl1,
        HaveMade_DollDamageLvl2,
        HaveMade_DollDamageLvl3,
        HaveMade_HastenLvl1,
        HaveMade_HastenLvl2,
        HaveMade_HastenLvl3,
        HaveMade_RepBonusLvl1,
        HaveMade_RepBonusLvl2,
        HaveMade_GoldBonusLvl1,
        HaveMade_GoldBonusLvl2,
        HaveMade_InvisibilityLvl1,
        HaveMade_InvisibilityLvl2,
        HaveMade_RegenLvl1,
        HaveMade_RegenLvl2,
        HaveMade_RegenLvl3,
        HaveMade_RegenLvl4,
        ...
        HaveMade_FaceColor,
        HaveMade_SizeReduce,
        HaveMade_SizeIncrease,
        HaveMade_HeadFire,
        HaveMade_ScorpionTransform,
        HaveMade_AlligatorTransform,
        HaveMade_CrabTransform,
        HaveMade_AccuracyBonusLvl1,
        HaveMade_AccuracyBonusLvl2,
        HaveMade_AccuracyBonusLvl3,
        HaveMade_RemoveGroggy,
        HaveMade_RepBonusLvl3,
        HaveMade_FartLvl2,
        HaveMade_RepBonusLvlComp]
...
__tutorialId2Type = {
    InventoryType.RepairShip: InventoryType.TutTypeBasic,
    InventoryType.SailCommands: {
        0: InventoryType.TutTypeBasic,
        1: InventoryType.TutTypeIntermediate,
        2: InventoryType.TutTypeBasic,
        3: InventoryType.TutTypeIntermediate,
        4: InventoryType.TutTypeIntermediate,
        6: InventoryType.TutTypeAdvanced,
        9: InventoryType.TutTypeAdvanced },
    InventoryType.FireBroadside: InventoryType.TutTypeBasic,
    InventoryType.AimBroadsides: InventoryType.TutTypeBasic,
    InventoryType.DockToSellCargo: InventoryType.TutTypeBasic,
    InventoryType.LostCargo: InventoryType.TutTypeBasic,
    InventoryType.LowShipHealth: InventoryType.TutTypeBasic,
    InventoryType.BuyNewShip: InventoryType.TutTypeIntermediate,
    InventoryType.AimForHull: InventoryType.TutTypeBasic,
    InventoryType.ExitCannon: InventoryType.TutTypeBasic,
    InventoryType.LowHealth: InventoryType.TutTypeBasic,
    InventoryType.OutOfTonics: InventoryType.TutTypeBasic,
    InventoryType.SwitchWeapons: InventoryType.TutTypeBasic,
    InventoryType.AimPistol: InventoryType.TutTypeBasic,
    InventoryType.NewSkillPoint: InventoryType.TutTypeIntermediate,
    InventoryType.UpgradeSkills: InventoryType.TutTypeIntermediate,
    InventoryType.CutlassCombos: InventoryType.TutTypeBasic,
    InventoryType.NewComboMove: InventoryType.TutTypeIntermediate,
    InventoryType.NewTakeAimSkill: InventoryType.TutTypeAdvanced,
    InventoryType.AttuneVoodooDoll: InventoryType.TutTypeIntermediate,
    InventoryType.FollowLight: InventoryType.TutTypeBasic,
    InventoryType.QuestJournal: InventoryType.TutTypeBasic,
    InventoryType.ChangeQuestTracking: InventoryType.TutTypeBasic,
    InventoryType.NewWeaponQuest: InventoryType.TutTypeIntermediate,
    InventoryType.MoreWeaponQuests: InventoryType.TutTypeAdvanced,
    InventoryType.IslandTeleport: InventoryType.TutTypeIntermediate,
    InventoryType.PlayerChat: InventoryType.TutTypeBasic,
    InventoryType.PlayerProfiles: InventoryType.TutTypeIntermediate,
    InventoryType.PlayerInvites: InventoryType.TutTypeIntermediate,
    InventoryType.NewCrew: InventoryType.TutTypeBasic,
    InventoryType.CrewBonus: InventoryType.TutTypeAdvanced,
    InventoryType.NewFriend: InventoryType.TutTypeBasic,
    InventoryType.NewGuild: InventoryType.TutTypeBasic,
    InventoryType.BrokenHull: InventoryType.TutTypeAdvanced,
    InventoryType.BrokenMast: InventoryType.TutTypeAdvanced,
    InventoryType.RearHullDamage: InventoryType.TutTypeIntermediate,
    InventoryType.AttuneFriend: InventoryType.TutTypeAdvanced,
    InventoryType.RestAndHeal: InventoryType.TutTypeBasic,
    InventoryType.GoToJail: InventoryType.TutTypeBasic,
    InventoryType.Disengage: InventoryType.TutTypeAdvanced,
    InventoryType.EarnMoreSkillPoints: InventoryType.TutTypeBasic,
    InventoryType.NotorietyLevelUp: InventoryType.TutTypeBasic,
    InventoryType.MerchantStores: InventoryType.TutTypeBasic,
    InventoryType.WeaponTraining: InventoryType.TutTypeBasic,
    InventoryType.NewAmmoSkill: InventoryType.TutTypeIntermediate,
    InventoryType.OutOfAmmo: InventoryType.TutTypeIntermediate,
    InventoryType.HardEnemies: InventoryType.TutTypeAdvanced,
    InventoryType.IslandMap: InventoryType.TutTypeIntermediate,
    InventoryType.DockCommands: {
        3: InventoryType.TutTypeBasic,
        5: InventoryType.TutTypeIntermediate,
        7: InventoryType.TutTypeBasic,
        9: InventoryType.TutTypeAdvanced,
        19: InventoryType.TutTypeAdvanced },
    InventoryType.DockCrewCommands: {
        1: InventoryType.TutTypeIntermediate },
    InventoryType.TeleportToFriends: InventoryType.TutTypeIntermediate,
    InventoryType.Flagships: InventoryType.TutTypeIntermediate,
    InventoryType.BackStrike: InventoryType.TutTypeAdvanced,
    InventoryType.Interrupt: InventoryType.TutTypeAdvanced,
    InventoryType.BossEnemy: InventoryType.TutTypeIntermediate,
    InventoryType.TreasureCollection: InventoryType.TutTypeAdvanced,
    InventoryType.SearchableContainers: InventoryType.TutTypeBasic,
    InventoryType.UseEmotes: InventoryType.TutTypeAdvanced,
    InventoryType.SpanishPrivateers: InventoryType.TutTypeAdvanced,
    InventoryType.FrenchPrivateers: InventoryType.TutTypeAdvanced,
    InventoryType.Groggy: InventoryType.TutTypeBasic,
    InventoryType.ChatPreferences: InventoryType.TutTypeBasic,
    InventoryType.SailShip: InventoryType.TutTypeBasic,
    InventoryType.FishingTutorial: InventoryType.TutTypeBasic,
    InventoryType.FishingEnterGame: InventoryType.TutTypeBasic,
    InventoryType.FishingAfterCast: InventoryType.TutTypeBasic,
    InventoryType.FishingAboutToBite: InventoryType.TutTypeBasic,
    InventoryType.FishingFishOnLine: InventoryType.TutTypeBasic,
    InventoryType.FishingLineHealth: InventoryType.TutTypeBasic,
    InventoryType.FishingLineBroken: InventoryType.TutTypeBasic,
    InventoryType.FishingNoMoreLures: InventoryType.TutTypeBasic,
    InventoryType.FishingCaughtFish: InventoryType.TutTypeBasic,
    InventoryType.FishingLevelGain: InventoryType.TutTypeBasic,
    InventoryType.FishingOceanEye: InventoryType.TutTypeBasic,
    InventoryType.FishingSink: InventoryType.TutTypeBasic,
    InventoryType.FishingStall: InventoryType.TutTypeBasic,
    InventoryType.FishingPull: InventoryType.TutTypeBasic,
    InventoryType.FishingHealLine: InventoryType.TutTypeBasic,
    InventoryType.FishingLegendAppear: InventoryType.TutTypeBasic,
    InventoryType.FishingLegendStruggle: InventoryType.TutTypeBasic,
    InventoryType.FishingLegendReel: InventoryType.TutTypeBasic,
    InventoryType.FishingLegendCaught: InventoryType.TutTypeBasic,
    InventoryType.FishingLevel10: InventoryType.TutTypeBasic,
    InventoryType.FishingCaughtAllFish: InventoryType.TutTypeBasic,
    InventoryType.FishingLineBroken2: InventoryType.TutTypeBasic,
    InventoryType.FirstLootContainer: InventoryType.TutTypeBasic,
    InventoryType.GunTrainingRequired: InventoryType.TutTypeAdvanced,
    InventoryType.DollTrainingRequired: InventoryType.TutTypeAdvanced,
    InventoryType.DaggerTrainingRequired: InventoryType.TutTypeAdvanced,
    InventoryType.StaffTrainingRequired: InventoryType.TutTypeAdvanced,
    InventoryType.EquippingWeapons: InventoryType.TutTypeAdvanced,
    InventoryType.InventoryFull: InventoryType.TutTypeAdvanced,
    InventoryType.FirstSailingItem: InventoryType.TutTypeAdvanced }
...
class InventoryId:
    ...
    idFlags[InventoryCategory.MONEY] = (0, TWO_WAY_TRADE_STACK_CATEGORY)
    ...
    for i in xrange(InventoryType.begin_Category, InventoryType.end_Category):
    ...
    for i in xrange(InventoryType.begin_Weapon, InventoryType.end_Weapon):
    ...
    for i in xrange(InventoryType.begin_Ingredient, InventoryType.end_Ingredient):
    ...
    for i in xrange(InventoryType.begin_ShipCannon, InventoryType.end_ShipCannon):
        idFlags[i] = ShipCannonStack

    idFlags[InventoryCategory.CONSUMABLES] = (0, TWO_WAY_TRADE_LOCATABLE_CATEGORY)
    ConsumablesStack = (InventoryCategory.CONSUMABLES, TWO_WAY_TRADE_LOCATABLE)
    for i in xrange(InventoryType.begin_Consumables, InventoryType.end_Consumables):
        idFlags[i] = ConsumablesStack

    idFlags[InventoryCategory.FISHING_LURES] = (0, FREE_TAKE_CATEGORY)
    ConsumablesStack = (InventoryCategory.FISHING_LURES, FREE_TAKE_STACK)
    for i in xrange(InventoryType.begin_FishingLures, InventoryType.end_FishingLures):
        idFlags[i] = ConsumablesStack
    ...
    idFlags[InventoryCategory.QUEST_SLOTS] = (0, TWO_WAY_TRADE_STACK_CATEGORY)
    QuestSlotStack = (InventoryCategory.QUEST_SLOTS, TWO_WAY_TRADE_STACK)
    for i in xrange(InventoryType.begin_QuestSlot, InventoryType.end_QuestSlot):
    ...
    for i in xrange(InventoryType.begin_MaxPlayerAttribute, InventoryType.end_MaxPlayerAttribute):
        idFlags[i] = MaxPlayerAttributeStack

    idFlags[InventoryCategory.NUM_RESPEC] = (0, TWO_WAY_TRADE_STACK_CATEGORY)
    RespecStack = (InventoryCategory.NUM_RESPEC, TWO_WAY_TRADE_STACK)
    for i in xrange(InventoryType.begin_NumRespec, InventoryType.end_NumRespec):
    ...
    for i in xrange(InventoryType.begin_PvPRenown, InventoryType.end_PvPRenown):
        idFlags[i] = PvPStack
    ...
    for i in xrange(InventoryType.begin_TeleportAccess, InventoryType.end_TeleportAccess):
    ...
    for i in xrange(InventoryType.begin_WeaponSkillMelee, InventoryType.end_WeaponSkillMelee):
    ...
    for i in xrange(InventoryType.begin_WeaponSkillCutlass, InventoryType.end_WeaponSkillCutlass):
    ...
    for i in xrange(InventoryType.begin_WeaponSkillPistol, InventoryType.end_WeaponSkillPistol):
    ...
    for i in xrange(InventoryType.begin_WeaponSkillMusket, InventoryType.end_WeaponSkillMusket):
    ...
    for i in xrange(InventoryType.begin_WeaponSkillBayonet, InventoryType.end_WeaponSkillBayonet):
    ...
    for i in xrange(InventoryType.begin_WeaponSkillDagger, InventoryType.end_WeaponSkillDagger):
    ...
    for i in xrange(InventoryType.begin_SkillSailing, InventoryType.end_SkillSailing):
    ...
    for i in xrange(InventoryType.begin_Vitae, InventoryType.end_Vitae):
    ...
    for i in xrange(InventoryType.begin_Unspent, InventoryType.end_Unspent):
    ...
    for i in xrange(InventoryType.begin_WeaponSkillGrenade, InventoryType.end_WeaponSkillGrenade):
    ...
    for i in xrange(InventoryType.begin_WeaponSkillDoll, InventoryType.end_WeaponSkillDoll):
    ...
    for i in xrange(InventoryType.begin_WeaponSkillWand, InventoryType.end_WeaponSkillWand):
    ...
    for i in xrange(InventoryType.begin_WeaponSkillKettle, InventoryType.end_WeaponSkillKettle):
    ...
    for i in xrange(InventoryType.begin_WeaponSkillCannon, InventoryType.end_ExtendedWeaponSkillCannon):
    ...
    for i in xrange(InventoryType.begin_WeaponSkillCannonDefense, InventoryType.end_WeaponSkillCannonDefense):
    ...
    for i in xrange(InventoryType.begin_WeaponSkillFishingRod, InventoryType.end_WeaponSkillFishingRod):
    ...
    for i in xrange(InventoryType.begin_WeaponSkillItem, InventoryType.end_WeaponSkillItem):
    ...
    for i in xrange(InventoryType.begin_KeyItem, InventoryType.end_KeyItem):
    ...
    for i in xrange(InventoryType.begin_TeleportToken, InventoryType.end_TeleportToken):
    ...
    for i in xrange(InventoryType.begin_RepairTokens, InventoryType.end_RepairTokens):
    ...
    for i in xrange(InventoryType.begin_WeaponPistolAmmo, InventoryType.end_WeaponPistolAmmo):
    ...
    for i in xrange(InventoryType.begin_WeaponMusketAmmo, InventoryType.end_WeaponMusketAmmo):
    ...
    for i in xrange(InventoryType.begin_WeaponGrenadeAmmo, InventoryType.end_WeaponGrenadeAmmo):
    ...
    for i in xrange(InventoryType.begin_WeaponCannonAmmo, InventoryType.end_WeaponCannonAmmo):
    ...
    for i in xrange(InventoryType.begin_Collections, InventoryType.end_Collections):
    ...
    for i in xrange(InventoryType.begin_RankingCategories, InventoryType.end_RankingCategories):
    ...
    for i in xrange(InventoryType.begin_WeaponDaggerAmmo, InventoryType.end_WeaponDaggerAmmo):
    ...
    for i in xrange(InventoryType.begin_PistolPouches, InventoryType.end_PistolPouches):
    ...
    for i in xrange(InventoryType.begin_DaggerPouches, InventoryType.end_DaggerPouches):
    ...
    for i in xrange(InventoryType.begin_GrenadePouches, InventoryType.end_GrenadePouches):
    ...
    for i in xrange(InventoryType.begin_CannonPouches, InventoryType.end_CannonPouches):
    ...
    for i in xrange(InventoryType.begin_Cards, InventoryType.end_Cards):
    ...
    idFlags[InventoryCategory.CONTEXTUAL_TUTORIAL_TYPES] = (0, FREE_TAKE_CATEGORY)
    ...
    idFlags[InventoryCategory.CONTEXTUAL_TUTORIALS] = (0, FREE_TAKE_CATEGORY)
    ...
    idFlags[InventoryCategory.TATTOO] = (0, FREE_TAKE_CATEGORY)
    TattooStack = (InventoryCategory.TATTOO, FREE_TAKE_LOCATABLE)
    for i in xrange(InventoryType.begin_Tattoo, InventoryType.end_Tattoo):
        idFlags[i] = TattooStack

    idFlags[InventoryCategory.JEWELRY] = (0, FREE_TAKE_CATEGORY)
    JewelryStack = (InventoryCategory.JEWELRY, FREE_TAKE_LOCATABLE)
    for i in xrange(InventoryType.begin_Jewelry, InventoryType.end_Jewelry):
        idFlags[i] = JewelryStack

    idFlags[InventoryCategory.HAVE_CRAFTED_FLAGS] = (0, FREE_GIVE_CATEGORY)
    ...
    getLimitChange = staticmethod(getLimitChange)

    def getLimitMinChange(id):
        return id | InventoryId.IS_LIMIT_CHANGE | InventoryId.MIN_CHANGE

    getLimitMinChange = staticmethod(getLimitMinChange)

    def getStackPercentChange(id):
        return id | InventoryId.PERCENT_CHANGE

    getStackPercentChange = staticmethod(getStackPercentChange)

    def getChangeCategoryOrType(id):
        return id & ~(InventoryId.IS_LIMIT_CHANGE)

    getChangeCategoryOrType = staticmethod(getChangeCategoryOrType)
