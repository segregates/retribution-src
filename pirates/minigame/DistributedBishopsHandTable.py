...
class DistributedBishopsHandTable(DistributedGameTable.DistributedGameTable):
    ...
    def __init__(self, cr):
        ...
        self.seatStatus = [ [
            0,
            -1] for x in xrange(self.NumSeats) ]
    ...
    def announceGenerate(self):
        ...
        self.timerLabel = DirectLabel(relief = None, text = '', text_fg = (1, 1, 1, 1), text_shadow = (0, 0, 0, 1), textMayChange = 1, text_font = PiratesGlobals.getPirateOutlineFont())
    ...
    def delete(self):
        self._DistributedBishopsHandTable__stopGameTimer()
    ...
    def _DistributedBishopsHandTable__stopGameTimer(self):
