...
ENEMY_START_PATH_POS_LIST = {
    INVASION_PORT_ROYAL: {
        1: (-61.0232, -192.343, 11.1546),
        2: (534.141, -379.633, 4.22788),
        3: (339.465, -461.702, 6.63037),
        4: (13.4009, -284.659, 4.03184),
        5: (226.343, -315.485, 13.9557),
        6: None,
        7: None,
        8: None,
        10: (-61.0232, -192.343, 11.1546),
        11: (339.465, -461.702, 6.63037) },
    INVASION_TORTUGA: {
        1: (77.7542, -392.561, 1.39463),
        2: (107.408, -401.547, 0.175161),
        3: (316.505, -256.694, 0.729866),
        4: (337.154, -174.624, 0.432898),
        5: None,
        6: None,
        7: None,
        10: (77.7542, -392.561, 1.39463),
        11: (316.505, -256.694, 0.729866) },
    INVASION_DEL_FUEGO: {
        1: (-1300.7, -493.171, 0.849964),
        2: (-1292.32, -551.34, 3.20932),
        3: (-1489.03, 362.417, 5.01261),
        4: (-1277.69, 554.611, 1.51438),
        5: (-1089.08, -190.335, 0.694368),
        6: None,
        7: (-1177.85, 18.5966, 0.722509),
        8: None,
        10: (-1300.7, -493.171, 0.849964),
        11: (-1489.03, 362.417, 5.01261),
        12: (-1277.69, 554.611, 1.51438) } }
...
CAPTURE_POINT_PATH_POS_LIST = {
    INVASION_PORT_ROYAL: {
        1: Point3(-59.1151, -187.478, 12.366),
        2: Point3(372.508, -466.794, 3.98782),
        3: Point3(130.951, -261.169, 38.2806),
        4: Point3(391.335, -247.478, 13.9557),
        5: Point3(-126.583, 64.0033, 35.8098),
        6: Point3(221.399, 80.8056, 35.6117),
        7: Point3(47.3903, 350.277, 85.5975) },
    INVASION_TORTUGA: {
        1: Point3(57.6055, -346.396, 5.64634),
        2: Point3(222.423, -169.901, 6.71903),
        3: Point3(43.6479, -120.363, 16.7635),
        4: Point3(281.659, 1.409, 8.39594),
        5: Point3(-28.37, 58.491, 30.5733),
        6: Point3(318.294, 126.935, 12.182),
        7: None },
    INVASION_DEL_FUEGO: {
        1: Point3(-1244.69, -547.2, 11.288),
        2: Point3(-1336.16, 268.509, 10.6513),
        3: Point3(-1260.94, 471.589, 5.94097),
        4: None,
        5: Point3(-1199.04, 55.6291, 2.19007),
        6: Point3(-918.66, 400.498, 15.0496),
        7: None } }
...
FOG_COLORS = {
    INVASION_PORT_ROYAL: Vec4(0.1, 0.12, 0.03, 1),
    INVASION_TORTUGA: Vec4(0.1, 0.12, 0.03, 1),
    INVASION_DEL_FUEGO: Vec4(0.1, 0.12, 0.03, 1) }
...
JR_PATHS = {
    INVASION_PORT_ROYAL: {
        (0, 1): [
            Point3(-43.8825, -239.528, 3.03623),
            Point3(-62.3444, -166.508, 17.9701)],
        (1, 5): [
            Point3(-89.7967, -82.5102, 34.9792),
            Point3(-125.313, 18.7841, 35.2021),
            Point3(-119.152, 65.9646, 36.4963)],
        (5, 7): [
            Point3(-91.2655, 97.4878, 39.968),
            Point3(-74.2463, 103.105, 42.419),
            Point3(-26.6557, 176.269, 58.5433),
            Point3(-11.1696, 257.124, 78.2706),
            Point3(-5.13773, 281.093, 84.1871),
            Point3(26.7467, 335.128, 84.2789)],
        (0, 2): [
            Point3(399.478, -452.454, 3.10073),
            Point3(336.32, -460.439, 6.96459)],
        (2, 4): [
            Point3(297.142, -401.346, 13.9557),
            Point3(369.162, -330.924, 13.9557),
            Point3(401.266, -253.636, 13.9557)],
        (4, 6): [
            Point3(374.898, -201.071, 13.9557),
            Point3(358.458, -119.725, 14.7235),
            Point3(408.256, -97.515, 27.8583),
            Point3(418.754, -74.8395, 32.1563),
            Point3(413.975, -52.8406, 32.5726),
            Point3(383.277, -41.3519, 32.8422),
            Point3(376.512, -16.9647, 40.2479),
            Point3(355.754, 25.1279, 41.2657),
            Point3(328.945, 57.7713, 41.2657),
            Point3(283.197, 76.1017, 41.2657),
            Point3(227.305, 82.0586, 35.673)],
        (6, 7): [
            Point3(200.214, 109.271, 36.33),
            Point3(195.359, 119.363, 37.4573),
            Point3(191.927, 147.958, 38.7167),
            Point3(177.632, 201.103, 45.168),
            Point3(157.167, 211.012, 52.6092),
            Point3(113.697, 223.263, 65.7057),
            Point3(97.7321, 255.417, 77.6612),
            Point3(92.3337, 277.835, 83.735),
            Point3(72.4895, 334.517, 84.2789)] },
    INVASION_TORTUGA: {
        (0, 1): [
            Point3(67.0641, -386.78, 1.77451),
            Point3(47.4459, -360.073, 4.26133)],
        (1, 3): [
            Point3(20.8564, -302.938, 6.96829),
            Point3(2.31014, -265.455, 7.93029),
            Point3(10.7063, -202.721, 9.40618),
            Point3(54.9207, -127.113, 15.4122)],
        (3, 5): [
            Point3(42.5136, -70.0453, 26.8595),
            Point3(23.0176, -46.1746, 29.1847),
            Point3(19.765, -40.8399, 29.5809),
            Point3(-4.84028, -27.9147, 30.6739),
            Point3(-32.9961, 7.57262, 29.534),
            Point3(-36.8601, 14.503, 29.4988),
            Point3(-33.6866, 33.086, 30.1041),
            Point3(-32.0029, 75.2962, 30.3034)],
        (5, 7): [
            Point3(-10.7064, 110.148, 30.7391),
            Point3(11.5704, 113.84, 31.1967),
            Point3(53.3613, 111.254, 31.2772)],
        (0, 2): [
            Point3(293.969, -245.331, 2.31207),
            Point3(258.291, -172.621, 5.27697)],
        (2, 4): [
            Point3(223.905, -63.0303, 8.73826),
            Point3(241.803, -27.9764, 8.91244),
            Point3(280.385, -2.24409, 8.3111)],
        (4, 6): [
            Point3(295.033, 6.26949, 8.06414),
            Point3(322.144, 21.6205, 7.78477),
            Point3(341.453, 55.5907, 7.24173),
            Point3(321.157, 127.525, 11.6012)],
        (6, 7): [
            Point3(280.984, 151.618, 24.6632),
            Point3(264.343, 163.028, 29.5431),
            Point3(226.525, 186.121, 31.015),
            Point3(168.767, 176.928, 31.2232),
            Point3(121.853, 118.714, 30.2191),
            Point3(116.232, 112.712, 30.1649),
            Point3(106.008, 84.7669, 29.7169),
            Point3(96.0121, 71.9735, 29.7394)] },
    INVASION_DEL_FUEGO: {
        (0, 1): [
            Point3(-1265.08, -527.948, 7.72675)],
        (1, 4): [
            Point3(-1246.63, -473.303, 4.10242),
            Point3(-1214.06, -423.89, 35.6783),
            Point3(-1167.41, -345.169, 35.6835),
            Point3(-1137.54, -294.761, 2.01549),
            Point3(-1096.93, -261.442, 1.23705)],
        (4, 7): [
            Point3(-1029.58, -199.25, 1.99986),
            Point3(-998.645, -154.637, 2.1946)],
        (0, 2): [
            Point3(-1489.56, 363.81, 5.01256),
            Point3(-1362.69, 254.972, 9.26481)],
        (2, 5): [
            Point3(-1324.21, 200.345, 11.9518),
            Point3(-1237.55, 177.173, 9.89098),
            Point3(-1201.42, 58.2305, 2.27976)],
        (5, 7): [
            Point3(-1116.76, 46.3089, 4.93439),
            Point3(-1060.53, -25.0102, 1.86531),
            Point3(-1006.15, -84.6436, 2.19162)],
        (0, 3): [
            Point3(-1264.8, 531.995, 2.73673),
            Point3(-1257.18, 497.701, 4.56281)],
        (3, 6): [
            Point3(-1184.4, 469.418, 12.3011),
            Point3(-1141.76, 430.489, 16.1967),
            Point3(-1100.93, 420.015, 19.1489),
            Point3(-983.191, 443.208, 16.1529),
            Point3(-924.758, 407.871, 15.0837),
            Point3(-912.644, 339.663, 16.3741),
            Point3(-920.645, 312.75, 17.7257)],
        (6, 7): [
            Point3(-971.018, 213.917, 27.0729),
            Point3(-963.09, 176.192, 29.7741),
            Point3(-910.649, 133.697, 27.1761),
            Point3(-910.866, 56.3491, 13.2449),
            Point3(-991.102, 11.8028, 3.52431),
            Point3(-1015.01, -64.5912, 2.18138),
            Point3(-993.32, -92.5042, 2.29201)] } }
JR_POINTS = {
    INVASION_PORT_ROYAL: {
        10: [
            0,
