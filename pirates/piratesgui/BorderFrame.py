from panda3d.core import Buffer, ModelNode, NodePath, Point3, TextNode, Texture, TextureStage, VBase4, Vec3, Vec4
...
class BorderFrame(DirectFrame):
    ...
    def __init__(self, parent = None, **kw):
        ...
        self.setupGeometry()
        if not parent:
            self.reparentTo(aspect2d, self['sortOrder'])
