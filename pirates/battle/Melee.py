...
def getHitSfx():
    global hitSfxs
    if not hitSfxs:
        hitSfxs = (loadSfx(SoundGlobals.SFX_MELEE_HIT_01), loadSfx(SoundGlobals.SFX_MELEE_HIT_02))
...
def getMissSfx():
    global missSfxs
    if not missSfxs:
        missSfxs = (loadSfx(SoundGlobals.SFX_MELEE_MISS_01), loadSfx(SoundGlobals.SFX_MELEE_MISS_02))
...
class Melee(Weapon.Weapon):
    modelTypes = {
        InventoryType.MeleeWeaponL1: ('models/props/mrReid', Vec4(1, 1, 1, 1)),
        InventoryType.MeleeWeaponL2: ('models/props/mrReid', Vec4(1, 1, 1, 1)),
        InventoryType.MeleeWeaponL3: ('models/props/mrReid', Vec4(1, 1, 1, 1)),
        InventoryType.MeleeWeaponL4: ('models/props/mrReid', Vec4(1, 1, 1, 1)),
        InventoryType.MeleeWeaponL5: ('models/props/mrReid', Vec4(1, 1, 1, 1)),
        InventoryType.MeleeWeaponL6: ('models/props/mrReid', Vec4(1, 1, 1, 1)) }
    vertex_list = [
