...
class Bat(Creature):
    ...
    SfxNames.update({
        'attack_left': SoundGlobals.SFX_MONSTER_BAT_ATTACK,
        'death': SoundGlobals.SFX_MONSTER_BAT_DEATH,
        'pain': SoundGlobals.SFX_MONSTER_BAT_PAIN })
    sfx = { }
    AnimList = (('idle', 'idle'), ('idle_hang', 'idle_hang'), ('glide', 'glide'), ('wounded_flight', 'wounded_flight'), ('takeoff', 'takeoff'), ('land', 'land'), ('attack_forward', 'attack_forward'), ('attack_right', 'attack_right'), ('sudden_gust', 'sudden_gust'), ('sudden_gust_alt', 'sudden_gust_alt'), ('pain', 'pain_left'), ('pain_right', 'pain_right'), ('death', 'death'), ('intro', 'spawn'))
