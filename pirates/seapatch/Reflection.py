from panda3d.core import BitMask32, BoundingVolume, Buffer, Camera, CardMaker, ClipPlaneAttrib, ColorBlendAttrib, CullFaceAttrib, DisplayRegion, Geom, GeomNode, GeomTriangles, GeomVertexArrayFormat, GeomVertexData, GeomVertexFormat, GeomVertexWriter, InternalName, Lens, NodePath, OmniBoundingVolume, PNMImage, Plane, PlaneNode, Point3, RenderState, StencilAttrib, Texture, VBase4, Vec2, Vec3, Vec4
...
class Reflection(DirectObject):
    ...
    def enable(self, enable):
        ...
        if enable:
            ...
            self.reflection_state = True
        elif self.reflection_buffer != None:
