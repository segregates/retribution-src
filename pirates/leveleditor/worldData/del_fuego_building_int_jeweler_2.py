...
objectStruct = {
    'Objects': {
        '1233252992.0akelts3': {
            ...
            'Name': '',
            'AdditionalData': [
                'interior_shanty_store_jeweler'],
            'Instanced': True,
            'Objects': {
                '1201219847.02dxschafe': {
                ...
                '1201223902.67dxschafe': {
                    ...
                    'AnimSet': 'default',
                    'CustomModel': 'None',
                    'Hpr': VBase3(-75.734, 0.0, 0.0),
                    'Patrol Radius': '12.0000',
                    'Pos': Point3(9.8848, -2.035, 0.0),
                    'PoseAnim': '',
                    'PoseFrame': '',
                    'Private Status': 'All',
                    'Respawns': True,
    ...
    'ObjectIds': {
        '1201219847.02dxschafe': '["Objects"]["1233252992.0akelts3"]["Objects"]["1201219847.02dxschafe"]',
        '1201223902.67dxschafe': '["Objects"]["1233252992.0akelts3"]["Objects"]["1201223902.67dxschafe"]',
        '1233252992.0akelts3': '["Objects"]["1233252992.0akelts3"]' } }
