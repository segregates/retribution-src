...
CutsceneData = {
    Cutscene1_1_1: CutsceneDesc(id = Cutscene1_1_1, components = [
        ''], actorFunctors = [
        CutJackSparrow,
        Functor(CutLocalPirate, False)], soundFile = loadSfxString(SoundGlobals.CS_1_1_A_JS), filmSizeHorizontal = 42.667, focalLength = 50),
    Cutscene1_1_2: CutsceneDesc(id = Cutscene1_1_2, components = [
        ''], actorFunctors = [
        CutJackSparrow,
        Functor(CutLocalPirate, False)], soundFile = loadSfxString(SoundGlobals.CS_1_1_B_JS), filmSizeHorizontal = 42.667, focalLength = 50),
    Cutscene1_1_5_a: CutsceneDesc(id = Cutscene1_1_5_a, components = [
        ''], actorFunctors = [
        Functor(CutLocalPirate, False),
        Functor(CutBartenderMmsDoggerel, 1),
        Functor(CutBartenderFmiNell, 1)], soundFile = loadSfxString(SoundGlobals.CS_1_1_5_A_DAN), filmSizeHorizontal = 42.667, focalLength = 50),
    Cutscene1_1_5_b: CutsceneDesc(id = Cutscene1_1_5_b, components = [
        ''], actorFunctors = [
        Functor(CutLocalPirate, False),
        Functor(CutBartenderMmsDoggerel, 1),
        Functor(CutBartenderFmiNell, 1)], soundFile = loadSfxString(SoundGlobals.CS_1_1_5_B_DAN), filmSizeHorizontal = 42.667, focalLength = 50),
    Cutscene1_1_5_c: CutsceneDesc(id = Cutscene1_1_5_c, components = [
        ''], actorFunctors = [
        Functor(CutLocalPirate, False),
        Functor(CutBartenderMmsDoggerel, 1),
        Functor(CutBartenderFmiNell, 1)], soundFile = loadSfxString(SoundGlobals.CS_1_1_5_C_DAN), filmSizeHorizontal = 42.667, focalLength = 50),
    Cutscene1_2: CutsceneDesc(id = Cutscene1_2, components = [
        ...
        Functor(CutShip, ShipGlobals.STUMPY_SHIP, ShipGlobals.Styles.Player)], soundFile = loadSfxString(SoundGlobals.CS_1_2_DOCK), filmSizeHorizontal = 42.667, focalLength = 50),
    Cutscene1_3: CutsceneDesc(id = Cutscene1_3, components = [
        ...
        Functor(CutShip, ShipGlobals.SKEL_DEATH_OMEN, ShipGlobals.Styles.Undead)], soundFile = loadSfxString(SoundGlobals.CS_1_3_JR), filmSizeHorizontal = 42.667, focalLength = 50),
    Cutscene2_1: CutsceneDesc(id = Cutscene2_1, components = [
        ''], actorFunctors = [
        Functor(CutWillTurner, '1152830677.95jubutler'),
        Functor(CutLocalPirate, False)], soundFile = loadSfxString(SoundGlobals.CS_2_1_A_WT), filmSizeHorizontal = 42.667, focalLength = 72),
    Cutscene2_1_b: CutsceneDesc(id = Cutscene2_1_b, components = [
        ''], actorFunctors = [
        Functor(CutWillTurner, '1152830677.95jubutler'),
        Functor(CutLocalPirate, False),
        Functor(CutSkeleton, EarthUndead[2], 2),
        Functor(CutSkeleton, EarthUndead[1], 3)], soundFile = loadSfxString(SoundGlobals.CS_2_1_B_WT), filmSizeHorizontal = 42.667, focalLength = 35),
    Cutscene2_2: CutsceneDesc(id = Cutscene2_2, components = [
        ...
        Functor(CutGenericActor, 'crablegs', 'crablegs_zero', 'models/props/')], soundFile = loadSfxString(SoundGlobals.CS_2_2_TD), filmSizeHorizontal = 42.667, focalLength = 72),
    Cutscene2_3: CutsceneDesc(id = Cutscene2_3, components = [
        ''], actorFunctors = [
        Functor(CutElizabethSwan, '1171325040.86MAsaduzz'),
        Functor(CutLocalPirate, False),
        Functor(CutGenericActor, 'paper', 'paper_zero', 'models/props/')], soundFile = loadSfxString(SoundGlobals.CS_2_3_ES), filmSizeHorizontal = 42.667, focalLength = 32),
    Cutscene2_4: CutsceneDesc(id = Cutscene2_4, components = [
        '_a'], actorFunctors = [
        Functor(CutCaptBarbossa, '1172618710.78sdnaik'),
        Functor(CutLocalPirate, False),
        Functor(CutGenericActor, 'monkey', 'monkey_hi', 'models/char/')], soundFile = loadSfxString(SoundGlobals.CS_2_4_A_CB), filmSizeHorizontal = 42.667, focalLength = 50),
    Cutscene2_4_b: CutsceneDesc(id = Cutscene2_4_b, components = [
        '_b',
        '_c'], actorFunctors = [
        Functor(CutCaptBarbossa, '1172618710.78sdnaik'),
        Functor(CutLocalPirate, True),
        Functor(CutGenericActor, 'monkey', 'monkey_hi', 'models/char/')], soundFile = loadSfxString(SoundGlobals.CS_2_4_B_CB), filmSizeHorizontal = 42.667, focalLength = 50),
    Cutscene2_5: CutsceneDesc(id = Cutscene2_5, components = [
        ''], actorFunctors = [
        CutJackSparrow,
        Functor(CutLocalPirate, False),
        Functor(CutGenericActor, 'mug', 'mug_zero', 'models/props/'),
        Functor(CutBartenderPear, 1)], soundFile = loadSfxString(SoundGlobals.CS_2_5_JS), filmSizeHorizontal = 42.667, focalLength = 30),
    Cutscene3_1: CutsceneDesc(id = Cutscene3_1, components = [
        ...
        Functor(CutShip, ShipGlobals.BLACK_PEARL, ShipGlobals.Styles.BP)], soundFile = loadSfxString(SoundGlobals.CS_3_1_BP), filmSizeHorizontal = 42.667, focalLength = 50),
    Cutscene3_2: CutsceneDesc(id = Cutscene3_2, components = [
        ''], actorFunctors = [
        CutJackSparrow,
        Functor(CutLocalPirate, False),
        Functor(CutJoshGibbs, '1168022298.47Shochet')], soundFile = loadSfxString(SoundGlobals.CS_3_2_JS), filmSizeHorizontal = 42.667, focalLength = 50),
    Cutscene6_1: CutsceneDesc(id = Cutscene6_1, components = [
        ''], actorFunctors = [
        Functor(CutTiaDalma, '1154497344.0jubutlerPR'),
        Functor(CutLocalPirate, False)], soundFile = loadSfxString(SoundGlobals.CS_6_1_TD), filmSizeHorizontal = 42.667, focalLength = 50) }
