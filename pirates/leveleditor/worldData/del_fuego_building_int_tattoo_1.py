...
objectStruct = {
        ...
        '1233168896.0akelts0': {
            ...
            'Objects': {
                ...
                '1201230131.11dxschafe': {
                    ...
                    'AnimSet': 'default',
                    'CustomModel': 'None',
                    'Hpr': VBase3(-146.051, 0.0, 0.0),
                    'Patrol Radius': '12.0000',
                    'Pos': Point3(-4.944, -7.019, 0.0),
                    'PoseAnim': '',
                    'PoseFrame': '',
                    'Private Status': 'All',
                    'Respawns': True,
                    ...
                    'Start State': 'Idle',
                    'Team': 'Villager' },
                '1201547343.75dxschafe': {
                    'Type': 'Light - Dynamic',
                    'Attenuation': '0.005',
                    'ConeAngle': '60.0000',
                    'DropOff': '0.0000',
                    'FlickRate': '0.5000',
                    'Hpr': VBase3(-150.688, -16.466, 0.0),
                    'Intensity': '0.8313',
                    'LightType': 'SPOT',
                    'Pos': Point3(-17.738, 6.711, 15.010),
                    'Scale': VBase3(1.0, 1.0, 1.0),
                    'Visual': {
                        'Color': (1, 1, 1, 1),
    ...
    'ObjectIds': {
        '1201136836.84dxschafe': '["Objects"]["1233168896.0akelts0"]["Objects"]["1201136836.84dxschafe"]',
        '1201230131.11dxschafe': '["Objects"]["1233168896.0akelts0"]["Objects"]["1201230131.11dxschafe"]',
        '1201547343.75dxschafe': '["Objects"]["1233168896.0akelts0"]["Objects"]["1201547343.75dxschafe"]',
        '1233168896.0akelts0': '["Objects"]["1233168896.0akelts0"]' } }
