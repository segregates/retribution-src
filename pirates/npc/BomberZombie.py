...
class BomberZombie(Skeleton):
    AnimList = (('idle', 'idle'), ('idle_hit', 'idle_hit'), ('walk', 'walk'), ('walk_hit', 'walk_hit'), ('run', 'run'), ('run_hit', 'run_hit'), ('death', 'death'))
    ...
    class AnimationMixer(AnimationMixer):
        ...
        AnimRankings = {
            ...
            'idle_hit': (ACTION['INPLACE_1'], ACTION['INPLACE_1'], ACTION['INPLACE_1']),
            'walk': (LOOP['MOTION'], LOOP['MOTION'], LOOP['MOTION']),
            'walk_hit': (ACTION['INMOTION_1'], ACTION['INMOTION_1'], ACTION['INMOTION_1']),
            'run': (LOOP['MOTION'], LOOP['MOTION'], LOOP['MOTION']),
            'run_hit': (ACTION['INMOTION_1'], ACTION['INMOTION_1'], ACTION['INMOTION_1']),
