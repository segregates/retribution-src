...
class GuildInviter(DirectFrame):
    ...
    def __init__(self, avId, avName):
        ...
        self.context = None
        self.bOk = GuildInviterButton(text = OTPLocalizer.GuildInviterOK, command = self._GuildInviter__handleOk)
        self.bOk.reparentTo(self)
        self.bOk.setPos(0.2, 0, 0.05)
        self.bOk.hide()
        self.bCancel = GuildInviterButton(text = OTPLocalizer.GuildInviterCancel, command = self._GuildInviter__handleCancel)
        self.bCancel.reparentTo(self)
        self.bCancel.setPos(0.2, 0, 0.05)
        self.bCancel.hide()
        self.bYes = GuildInviterButton(text = OTPLocalizer.GuildInviterYes, command = self._GuildInviter__handleYes)
        self.bYes.reparentTo(self)
        self.bYes.setPos(0.1, 0, 0.05)
        self.bYes.hide()
        self.bNo = GuildInviterButton(text = OTPLocalizer.GuildInviterNo, command = self._GuildInviter__handleNo)
    ...
    def enterGetNewGuild(self):
        ...
        self.bCancel.show()
        self.accept('clickedNametag', self._GuildInviter__handleClickedNametag)
    ...
    def _GuildInviter__handleClickedNametag(self, avatar):
    ...
    def enterTooMany(self):
        localAvatar.guiMgr.messageStack.addTextMessage(OTPLocalizer.GuuldInviterTooMany, name = self.avName, avId = self.avId, icon = ('guild', None))
        self.context = None
        self.destroy()
    ...
    def _GuildInviter__joinedGuild(self, avId, info):
        if self.avId == avId:
    ...
    def enterNotAvailable(self):
        localAvatar.guiMgr.messageStack.addTextMessage(OTPLocalizer.GuildInviterNotAvailable, name = self.avName, avId = self.avId, icon = ('guild', None))
        self.context = None
        self.destroy()
    ...
    def enterNotAcceptingGuilds(self):
        localAvatar.guiMgr.messageStack.addTextMessage(OTPLocalizer.GuildInviterGuildSaidNo, name = self.avName, avId = self.avId, icon = ('guild', None))
        self.context = None
        self.destroy()
    ...
    def enterWentAway(self):
        localAvatar.guiMgr.messageStack.addTextMessage(OTPLocalizer.GuildInviterWentAway, name = self.avName, avId = self.avId, icon = ('guild', None))
    ...
    def enterGuildFull(self):
        localAvatar.guiMgr.messageStack.addTextMessage(OTPLocalizer.GuildInviterTooFull, icon = ('guild', None))
        self.context = None
        self.destroy()
    ...
    def enterBusy(self):
        localAvatar.guiMgr.messageStack.addTextMessage(OTPLocalizer.GuildInviterBusy, name = self.avName, avId = self.avId, icon = ('guild', None))
        self.context = None
        self.destroy()
    ...
    def enterAlreadyInGuild(self):
        localAvatar.guiMgr.messageStack.addTextMessage(OTPLocalizer.GuildInviterAlready, name = self.avName, avId = self.avId, icon = ('guild', None))
        self.context = None
        self.destroy()
    ...
    def enterAlreadyInvited(self):
        localAvatar.guiMgr.messageStack.addTextMessage(OTPLocalizer.GuildInviterAlreadyInvited, name = self.avName, avId = self.avId, icon = ('guild', None))
    ...
    def enterAskingNPC(self):
        localAvatar.guiMgr.messageStack.addTextMessage(OTPLocalizer.GuildInviterAskingNPC, name = self.avName, avId = self.avId, icon = ('guild', None))
    ...
    def enterGuildsNoMore(self):
        ...
        localAvatar.guiMgr.messageStack.addTextMessage(OTPLocalizer.GuildInviterFriendsNoMore, name = self.avName, avId = self.avId, icon = ('guild', None))
        self.context = None
        self.destroy()
    ...
    def enterOtherTooMany(self):
        localAvatar.guiMgr.messageStack.addTextMessage(OTPLocalizer.GuildInviterTooMany, name = self.avName, avId = self.avId, icon = ('guild', None))
        self.context = None
        self.destroy()
    ...
    def enterMaybe(self):
        localAvatar.guiMgr.messageStack.addTextMessage(OTPLocalizer.GuildInviterMaybe, name = self.avName, avId = self.avId, icon = ('guild', None))
        self.context = None
        self.destroy()
    ...
    def enterDown(self):
        localAvatar.guiMgr.messageStack.addTextMessage(OTPLocalizer.GuildInviterDown, icon = ('guild', None))
        self.context = None
        self.destroy()
    ...
    def _GuildInviter__handleOk(self):
        self.destroy()


    def _GuildInviter__handleCancel(self):
        self.destroy()


    def _GuildInviter__handleYes(self):
    ...
    def _GuildInviter__handleNo(self):
        self.destroy()


    def _GuildInviter__handleList(self):
        messenger.send('openGuildsList')


    def _GuildInviter__guildConsidering(self, yesNoAlready, context):
        if yesNoAlready == 1:
