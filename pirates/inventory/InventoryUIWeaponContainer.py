...
class InventoryUIWeaponContainer(InventoryUISlotContainer.InventoryUISlotContainer):
    ...
    def __init__(self, manager, sizeX = 1.0, sizeZ = 1.0, countX = 4, countZ = 4, slotList = None):
        ...
        self.rightClickAction = {
            InventoryType.ItemTypeWeapon: (Locations.RANGE_EQUIP_WEAPONS, None, 0),
            InventoryType.ItemTypeCharm: (Locations.RANGE_EQUIP_ITEMS, None, 1) }
    ...
    def postUpdate(self, cell):
        ...
        if avInv and avInv.findAvailableLocation(InventoryType.ItemTypeWeapon) in [
