...
class Doll(Weapon.Weapon):
    modelTypes = [
        'models/handheld/pir_m_hnd_dol_bane_a',
        'models/handheld/pir_m_hnd_dol_bane_b',
        'models/handheld/pir_m_hnd_dol_bane_c',
        'models/handheld/pir_m_hnd_dol_bane_d',
        'models/handheld/pir_m_hnd_dol_bane_e',
        'models/handheld/pir_m_hnd_dol_mojo_a',
        'models/handheld/pir_m_hnd_dol_mojo_b',
        'models/handheld/pir_m_hnd_dol_mojo_c',
        'models/handheld/pir_m_hnd_dol_mojo_d',
        'models/handheld/pir_m_hnd_dol_mojo_e',
        'models/handheld/pir_m_hnd_dol_spirit_a',
        'models/handheld/pir_m_hnd_dol_spirit_b',
        'models/handheld/pir_m_hnd_dol_spirit_c',
        'models/handheld/pir_m_hnd_dol_spirit_d',
        'models/handheld/pir_m_hnd_dol_spirit_e']
    effectTypeInfo = {
        ItemGlobals.DollDefault: (Vec4(1, 1, 1, 1), 'None'),
        ItemGlobals.DollCloth: (Vec4(0.5, 0.3, 1, 1), 'effectCloth'),
        ItemGlobals.DollWitch: (Vec4(1, 0.7, 0.7, 1), 'effectWitch'),
        ItemGlobals.DollPirate: (Vec4(1, 1, 1, 1), 'effectPirate'),
        ItemGlobals.DollTaboo: (Vec4(1, 1, 1, 1), 'effectTaboo'),
        ItemGlobals.DollMojo: (Vec4(0.7, 0.5, 1, 1), 'effectMojo') }
    ...
    def setupSounds(cls):
        ...
        Doll.missSfxs = (loadSfx(SoundGlobals.SFX_WEAPON_DOLL_MISS_01), loadSfx(SoundGlobals.SFX_WEAPON_DOLL_MISS_02))
        Doll.skillSfxs = {
            EnemySkills.MISC_VOODOO_REFLECT: loadSfx(SoundGlobals.SFX_SKILL_REFLECT_WARD) }
