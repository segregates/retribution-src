...
class Stump(Creature):
    ...
    SfxNames.update({
        'death': SoundGlobals.SFX_MONSTER_MOSSMAN_DEATH,
        'pain': SoundGlobals.SFX_MONSTER_MOSSMAN_PAIN,
        'spawn': SoundGlobals.SFX_MONSTER_MOSSMAN_SPAWN })
    sfx = { }
    AnimList = (('idle', 'idle'), ('walk', 'walk'), ('run', 'run'), ('death', 'death'), ('intro', 'intro'), ('jump', 'jump'), ('kick', 'kick'), ('kick_right', 'kick_right'), ('slap_left', 'slap_left'), ('slap_right', 'slap_right'), ('strafe_left', 'strafe_left'), ('strafe_right', 'strafe_right'), ('swat_left', 'swat_left'), ('swat_right', 'swat_right'), ('jump_attack', 'jump_attack'), ('pain', 'pain'))
