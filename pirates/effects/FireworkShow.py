...
colors = [
    Vec4(1, 1, 1, 1),
    Vec4(1, 0.100, 0.100, 1),
    Vec4(0.100, 1, 0.100, 1),
    Vec4(0.299, 1, 0.299, 1),
    Vec4(0.200, 0.200, 1, 1),
    Vec4(1, 1, 0.100, 1),
    Vec4(1, 0.5, 0.100, 1),
    Vec4(1, 0.100, 1, 1),
    Vec4(0.100, 1, 1, 1),
...
class FireworkShow(NodePath):
    ...
    def __init__(self, showType):
        ...
        self.sectionData = {
            ...
            HolidayGlobals.MARDIGRAS: [
                (0, 77)] }
        self.showMusic = {
            HolidayGlobals.NEWYEARS: SoundGlobals.MUSIC_FIREWORKS,
    ...
    def begin(self, timestamp):
        ...
        for section in self.sectionData.get(self.showType):
            ...
            if timestamp < sectionDur:
                ...
                taskMgr.doMethodLater(time, self.beginSection, 'beginSection' + str(startIndex) + str(endIndex), extraArgs = [
                    startIndex,
                    endIndex,
                    timestamp])
    ...
    def wantFireworkSounds(self):
        if localAvatar.getGameState() != 'Cutscene':
            pass
        return base.cr.timeOfDayManager.environment not in [
            TODDefs.ENV_CAVE,
            TODDefs.ENV_LAVACAVE,
