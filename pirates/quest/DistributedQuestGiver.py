from panda3d.core import Camera, ColorBlendAttrib, NodePath, Texture
...
class DistributedQuestGiver(Avatar.Avatar):
    ...
    def hasQuestOffers(self):
        ...
        prereqExcludes = config.GetString('exclude-prereq-quests', '')
    ...
    def updateNametagQuestIcon(self, questId = None, item = None, note = None):
        ...
        if self.nametagIcon:
            self.nametagIcon.remove_node()

        if self.nametagIconGlow:
            self.nametagIconGlow.remove_node()
