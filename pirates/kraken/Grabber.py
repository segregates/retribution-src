from panda3d.core import BitMask32, CollideMask, CollisionNode, CollisionSphere, CollisionTube, NodePath, Point3, Vec3
...
class Grabber(Creature, TentacleUtils):
    ...
    def initStatusTableBETA(self):
        ...
        if self.hasLOD():
            ...
            root = self
        jointList = [
            root.find('**/def_tent_01'),
            root.find('**/def_tent_04'),
            root.find('**/def_tent_07'),
            root.find('**/def_tent_10'),
            root.find('**/def_tent_14')]
