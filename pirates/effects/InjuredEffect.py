from panda3d.core import ColorBlendAttrib, ModelNode, TextureStage, Vec3, Vec4
# File: I (Python 2.4)
...
class InjuredEffect(PooledEffect, EffectController):
    ...
    def createTrack(self):
        ...
        pulseFadeOut = LerpColorScaleInterval(self.effectModel, self.duration / 2.25, Vec4(1, 1, 1, 0.179), startColorScale = Vec4(1, 1, 1, 0.598))
        pulseFadeIn = LerpColorScaleInterval(self.effectModel, self.duration / 1.75, Vec4(1, 1, 1, 0.598), startColorScale = Vec4(1, 1, 1, 0.149))
