...
objectStruct = {
    ...
    'FogRanges': { },
    'Objects': {
        '1231366863.52caoconno0': {
            'Type': 'Building Interior',
            'Name': '',
            'AdditionalData': [
                'interior_spanish_store_tailor'],
            'Instanced': True,
            'Objects': {
                '1169077081.52mike': {
                    'Type': 'Townsperson',
                    ...
                    'HelpID': 'NONE',
                    'Holiday': '',
                    'Hpr': VBase3(91.4684, 0.0, 0.0),
                    'Instanced World': 'None',
                    'Level': '37',
                    'Notice Animation 1': '',
                    'Notice Animation 2': '',
                    'Patrol Radius': '12.0000',
                    'Pos': Point3(13.84, 3.5169, 0.0),
                    'PoseAnim': '',
                    'PoseFrame': '',
                    'Private Status': 'All',
                    'PropLeft': 'None',
    ...
    'ObjectIds': {
        '1169077081.52mike': '["Objects"]["1231366863.52caoconno0"]["Objects"]["1169077081.52mike"]',
        '1231366863.52caoconno0': '["Objects"]["1231366863.52caoconno0"]',
        '1236730926.46piwanow': '["Objects"]["1231366863.52caoconno0"]["Objects"]["1236730926.46piwanow"]',
        '1236731444.46piwanow': '["Objects"]["1231366863.52caoconno0"]["Objects"]["1236731444.46piwanow"]' } }
extraInfo = {
    'camPos': Point3(10.4194, 30.8103, 13.6137),
    'camHpr': VBase3(-174.686, -19.6256, 0),
