from panda3d.core import AnimControl, ColorBlendAttrib, GeomNode, LODNode, NodePath, VBase4, Vec3, Vec4
...
class DistributedCreature(DistributedBattleNPC):
    ...
    def setAvatarType(self, avatarType):
        ...
        self.setupCreature(self.avatarType)
        DistributedBattleNPC.setAvatarType(self, self.avatarType)
