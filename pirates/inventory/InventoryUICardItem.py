        ...
        def invArrived(inv):
            if inv:
                ...
                if self.amount <= 1:
                    ...
                    self.configure(text_fg = PiratesGuiGlobals.TextFG0, text_font = PiratesGlobals.getInterfaceFont(), text_scale = PiratesGuiGlobals.TextScaleLarge, text_pos = (0.05, 0.043))
