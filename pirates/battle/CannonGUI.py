...
class CannonGUI(DirectFrame):
    ...
    def __init__(self, cannon):
        ...
        DirectFrame.__init__(self, parent = base.a2dBottomCenter, relief = None, pos = (0, 0, 0.35), scale = 0.6)
