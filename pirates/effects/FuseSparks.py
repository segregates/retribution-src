...
class FuseSparks(PooledEffect, EffectController):
    ...
    def createTrack(self):
        scaleFlashUp = LerpScaleInterval(self.flash, 0.100, 1.10, startScale = 0.800000)
        scaleFlashDown = LerpScaleInterval(self.flash, 0.149, 0.800000, startScale = 1.3)
