from panda3d.core import ColorAttrib, ColorBlendAttrib, Light, NodePath, TextNode, Vec3, Vec4
...
SkillEffectDescriptions = {
    WeaponGlobals.C_POISON: [
        ...
        PLocalizer.PoisonUpgrade],
    WeaponGlobals.C_ACID: [
        PLocalizer.AcidDesc,
        PLocalizer.AcidUpgrade],
    WeaponGlobals.C_HOLD: [
        PLocalizer.HoldDesc,
        PLocalizer.HoldUpgrade],
    WeaponGlobals.C_WOUND: [
        PLocalizer.WoundDesc,
        PLocalizer.WoundUpgrade],
    WeaponGlobals.C_ON_FIRE: [
        PLocalizer.OnFireDesc,
        PLocalizer.OnFireUpgrade],
    WeaponGlobals.C_FLAMING: [
        PLocalizer.OnFireDesc,
        PLocalizer.OnFireUpgrade],
    WeaponGlobals.C_STUN: [
        PLocalizer.StunDesc,
        PLocalizer.StunUpgrade],
    WeaponGlobals.C_UNSTUN: [
        PLocalizer.UnstunDesc,
        PLocalizer.UnstunUpgrade],
    WeaponGlobals.C_SLOW: [
        PLocalizer.SlowDesc,
        PLocalizer.SlowUpgrade],
    WeaponGlobals.C_PAIN: [
        PLocalizer.SlowDesc,
        PLocalizer.SlowUpgrade],
    WeaponGlobals.C_BLIND: [
        PLocalizer.BlindDesc,
        PLocalizer.BlindUpgrade],
    WeaponGlobals.C_DIRT: [
        PLocalizer.BlindDesc,
        PLocalizer.BlindUpgrade],
    WeaponGlobals.C_CURSE: [
        PLocalizer.CurseDesc,
        PLocalizer.CurseUpgrade],
    WeaponGlobals.C_HASTEN: [
        PLocalizer.HastenDesc,
        PLocalizer.HastenUpgrade],
    WeaponGlobals.C_TAUNT: [
        PLocalizer.TauntDesc,
        PLocalizer.TauntUpgrade],
    WeaponGlobals.C_WEAKEN: [
        PLocalizer.WeakenDesc,
        PLocalizer.WeakenUpgrade],
    WeaponGlobals.C_SOULTAP: [
        PLocalizer.SoulTapDesc],
    WeaponGlobals.C_MANADRAIN: [
        PLocalizer.ManaDrainDesc],
    WeaponGlobals.C_LIFEDRAIN: [
        PLocalizer.LifeDrainDesc],
    WeaponGlobals.C_UNDEAD_KILLER: [
        PLocalizer.UndeadKillerDesc],
    WeaponGlobals.C_MONSTER_KILLER: [
        PLocalizer.MonsterKillerDesc],
    WeaponGlobals.C_BUFF_BREAK: [
        PLocalizer.BuffBreakDesc,
        PLocalizer.BuffBreakUpgrade],
    WeaponGlobals.C_REGEN: [
        PLocalizer.RegenDesc,
        PLocalizer.RegenUpgrade],
    WeaponGlobals.C_KNOCKDOWN: [
        PLocalizer.KnockdownDesc],
    WeaponGlobals.C_CANNON_DAMAGE_LVL1: PotionRecipeData.PotionRecipeList[10]['desc'],
    WeaponGlobals.C_CANNON_DAMAGE_LVL2: PotionRecipeData.PotionRecipeList[14]['desc'],
    WeaponGlobals.C_CANNON_DAMAGE_LVL3: PotionRecipeData.PotionRecipeList[18]['desc'],
    ...
    WeaponGlobals.C_HEAD_GROW: safeSubstitute(PLocalizer.PotionDescs[InventoryType.HeadGrow], {
        ...
        'dur': 0,
        'unit': 0 }),
    WeaponGlobals.C_CRAZY_SKIN_COLOR: PotionRecipeData.PotionRecipeList[3]['desc'],
    WeaponGlobals.C_SIZE_REDUCE: PotionRecipeData.PotionRecipeList[4]['desc'],
    WeaponGlobals.C_SIZE_INCREASE: PotionRecipeData.PotionRecipeList[5]['desc'],
    WeaponGlobals.C_HEAD_FIRE: PotionRecipeData.PotionRecipeList[6]['desc'],
    WeaponGlobals.C_SCORPION_TRANSFORM: PotionRecipeData.PotionRecipeList[7]['desc'],
    WeaponGlobals.C_ALLIGATOR_TRANSFORM: PotionRecipeData.PotionRecipeList[8]['desc'],
    WeaponGlobals.C_CRAB_TRANSFORM: PotionRecipeData.PotionRecipeList[9]['desc'],
    WeaponGlobals.C_ACCURACY_BONUS_LVL1: PotionRecipeData.PotionRecipeList[30]['desc'],
    WeaponGlobals.C_ACCURACY_BONUS_LVL2: PotionRecipeData.PotionRecipeList[31]['desc'],
    WeaponGlobals.C_ACCURACY_BONUS_LVL3: PotionRecipeData.PotionRecipeList[32]['desc'],
    WeaponGlobals.C_REMOVE_GROGGY: PotionRecipeData.PotionRecipeList[34]['desc'],
    WeaponGlobals.C_TOXIN: [
        PLocalizer.ToxinDesc,
        PLocalizer.ToxinUpgrade],
    WeaponGlobals.C_ON_CURSED_FIRE: [
        PLocalizer.OnFireDesc,
        PLocalizer.OnFireUpgrade],
    WeaponGlobals.C_FULLSAIL: [
        PLocalizer.FullSailDesc],
    WeaponGlobals.C_COMEABOUT: [
        PLocalizer.ComeAboutDesc],
    WeaponGlobals.C_OPENFIRE: [
        PLocalizer.OpenFireDesc],
    WeaponGlobals.C_RAM: [
        PLocalizer.RamDesc],
    WeaponGlobals.C_TAKECOVER: [
        PLocalizer.TakeCoverDesc],
    WeaponGlobals.C_RECHARGE: [
        PLocalizer.PowerRechargeDesc],
    WeaponGlobals.C_WRECKHULL: [
        PLocalizer.WreckHullDesc],
    WeaponGlobals.C_WRECKMASTS: [
        PLocalizer.WreckMastsDesc],
    WeaponGlobals.C_SINKHER: [
        PLocalizer.SinkHerDesc],
    WeaponGlobals.C_INCOMING: [
        PLocalizer.IncomingDesc],
    WeaponGlobals.C_ATTUNE: [
        PLocalizer.AttuneDesc] }
SkillComboReq = {
    InventoryType.DaggerCut: None,
    InventoryType.DaggerSwipe: None,
    InventoryType.DaggerGouge: PLocalizer.ComboReqSwipe,
    InventoryType.DaggerEviscerate: PLocalizer.ComboReqGouge,
    InventoryType.CutlassHack: None,
    InventoryType.CutlassSlash: None,
    InventoryType.CutlassCleave: PLocalizer.ComboReqSlash,
    InventoryType.CutlassFlourish: PLocalizer.ComboReqCleave,
    InventoryType.CutlassStab: PLocalizer.ComboReqFlourish }
SPECIAL_SKILL_ICONS = [
    None,
    'pir_t_gui_frm_skill_special',
    'pir_t_gui_frm_skill_defensive',
    'pir_t_gui_frm_skill_offensive']
...
class SkillButton(DirectFrame):
    ...
    def __init__(self, skillId, callback, quantity = 0, skillRank = 0, showQuantity = False, showHelp = False, showRing = False, hotkey = None, name = '', showIcon = True, rechargeSkillId = False, isWeaponSkill = False, assocAmmo = []):
        ...
        if showRing:
            ...
            if self.isBreakAttackSkill and timeSpentRecharging < self.totalRechargeTime:
                ...
                if (self.totalRechargeTime or timeSpentRecharging) and not (timeSpentRecharging > self.totalRechargeTime):
                    self.skillRingIval.start() #startT = timeSpentRecharging) # TODO: Fix this

            if not (timeSpentRecharging > self.totalRechargeTime):
        ...
        if self.isWeaponSkill:
            self.weaponLabel = DirectLabel(parent = self, relief = None,
                                           ...
                                           textMayChange = 0, pos = (0.0, 0, -0.12),
