...
objectStruct = {
    ...
    'Objects': {
        '1233252608.0akelts0': {
            ...
            'Name': '',
            'AdditionalData': [
                'interior_shanty_store_tailor'],
            'Instanced': True,
            'Objects': {
                '1201219260.78dxschafe': {
                ...
                '1201226462.13dxschafe': {
                    ...
                    'AnimSet': 'default',
                    'CustomModel': 'None',
                    'Hpr': VBase3(-99.9860, 0.0, 0.0),
                    'Patrol Radius': '12.0000',
                    'Pos': Point3(23.725, 0.647, 0.0),
                    'PoseAnim': '',
                    'PoseFrame': '',
                    'Private Status': 'All',
                    'Respawns': True,
                    ...
                    'Start State': 'Idle',
                    'Team': 'Villager' },
                '1201560304.8dxschafe': {
                    'Type': 'Light - Dynamic',
                    'Attenuation': '0.005',
                    'ConeAngle': '60.0000',
                    'DropOff': '25.4819',
                    'FlickRate': '0.5000',
                    'Hpr': VBase3(156.279, -15.023, 0.0),
                    'Intensity': '0.6145',
                    'LightType': 'SPOT',
                    'Pos': Point3(33.97, 8.3510000000000009, 12.51),
                    'Scale': VBase3(1.0, 1.0, 1.0),
                    'Visual': {
                        'Color': (1, 1, 1, 1),
    ...
    'ObjectIds': {
        '1201219260.78dxschafe': '["Objects"]["1233252608.0akelts0"]["Objects"]["1201219260.78dxschafe"]',
        '1201226462.13dxschafe': '["Objects"]["1233252608.0akelts0"]["Objects"]["1201226462.13dxschafe"]',
        '1201560304.8dxschafe': '["Objects"]["1233252608.0akelts0"]["Objects"]["1201560304.8dxschafe"]',
        '1233252608.0akelts0': '["Objects"]["1233252608.0akelts0"]' } }
