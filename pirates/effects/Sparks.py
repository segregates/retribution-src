...
class Sparks(PooledEffect, EffectController):
    ...
    def createTrack(self):
        ...
        self.p0.renderer.setFinalXScale(0.00400 * self.cardScale)
        ...
        self.startEffect = Sequence(Func(self.p0.setBirthRate, 0.00500), Func(self.p0.setPoolSize, 32), Func(self.p0.clearToInitial), Func(self.f.start, self, self.particleDummy), Func(self.f.reparentTo, self))
