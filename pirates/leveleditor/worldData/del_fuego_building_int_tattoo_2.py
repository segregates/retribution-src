...
objectStruct = {
        ...
        '1233252608.0akelts6': {
            ...
            'Objects': {
                ...
                '1201224743.34dxschafe': {
                    ...
                    'AnimSet': 'default',
                    'CustomModel': 'None',
                    'Hpr': VBase3(-81.683, 0.0, 0.0),
                    'Patrol Radius': '12.0000',
                    'Pos': Point3(9.9586, 1.266, 0.0),
                    'PoseAnim': '',
                    'PoseFrame': '',
                    'Private Status': 'All',
                    'Respawns': True,
                    ...
                    'Start State': 'Idle',
                    'Team': 'Villager' },
                '1201559943.36dxschafe': {
                    'Type': 'Light - Dynamic',
                    'Attenuation': '0.005',
                    'ConeAngle': '45.3614',
                    'DropOff': '0.0000',
                    'FlickRate': '0.5000',
                    'Hpr': VBase3(-156.352, -22.196, 6.7069),
                    'Intensity': '0.5783',
                    'LightType': 'SPOT',
                    'Pos': Point3(-5.772, 18.225, 16.4228),
                    'Scale': VBase3(1.0, 1.0, 1.0),
                    'Visual': {
                        'Color': (1, 1, 1, 1),
                        'Model': 'models/props/light_tool_bulb' } },
                '1201561394.09dxschafe': {
                    'Type': 'Light - Dynamic',
                    'Attenuation': '0.005',
                    'ConeAngle': '90.2711',
                    'DropOff': '22.7711',
                    'FlickRate': '0.5000',
                    'Hpr': VBase3(116.2, 36.161, -3.898),
                    'Intensity': '0.5060',
                    'LightType': 'SPOT',
                    'Pos': Point3(14.489, 3.431, -0.142),
                    'Scale': VBase3(1.0, 1.0, 1.0),
                    'Visual': {
                        'Color': (1, 1, 1, 1),
                        'Model': 'models/props/light_tool_bulb' } } },
    ...
    'ObjectIds': {
        '1201219079.81dxschafe': '["Objects"]["1233252608.0akelts6"]["Objects"]["1201219079.81dxschafe"]',
        '1201219079.83dxschafe': '["Objects"]["1233252608.0akelts6"]["Objects"]["1201219079.83dxschafe"]',
        '1201224743.34dxschafe': '["Objects"]["1233252608.0akelts6"]["Objects"]["1201224743.34dxschafe"]',
        '1201559943.36dxschafe': '["Objects"]["1233252608.0akelts6"]["Objects"]["1201559943.36dxschafe"]',
        '1201561394.09dxschafe': '["Objects"]["1233252608.0akelts6"]["Objects"]["1201561394.09dxschafe"]',
        '1233252608.0akelts6': '["Objects"]["1233252608.0akelts6"]' } }
