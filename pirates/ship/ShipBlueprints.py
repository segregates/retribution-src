from panda3d.core import AnimBundle, CollideMask, GeomNode, Light, ModelNode, NodePath, SceneGraphReducer, Texture, TextureAttrib
...
LogoDict = {
    ShipGlobals.Logos.Navy: 'logo_redSkull',
    ShipGlobals.Logos.BlackPearl: 'ship_sailBP_patches',
    ShipGlobals.Logos.EITC: 'logo_eitc',
    ShipGlobals.Logos.EITC_Emblem: 'logo_eitc_emblem',
    ShipGlobals.Logos.PVP_French: 'logo_french_flag',
    ShipGlobals.Logos.PVP_Spanish: 'logo_spanish_flag',
    ShipGlobals.Logos.Bandit_Bull: 'pir_t_shp_logo_bandit_01',
...
shipStyles = {
    ...
    ShipGlobals.Styles.EITC: 'ships_static_a_palette_3cmla_2_swp_2',
    ShipGlobals.Styles.Undead: 'ships_static_a_palette_3cmla_3_swp_3',
    ShipGlobals.Styles.BP: 'ships_static_a_palette_3cmla_4_swp_4',
    ShipGlobals.Styles.Treasure_Navy: 'ships_static_a_palette_3cmla_5_swp_5',
    ShipGlobals.Styles.Treasure_EITC: 'ships_static_a_palette_3cmla_6_swp_6',
    ShipGlobals.Styles.QueenAnnesRevenge: 'ships_static_qar_palette_3cmla_1',
    ShipGlobals.Styles.BountyHunter_A: 'ships_static_a_palette_3cmla_1',
    ShipGlobals.Styles.BountyHunter_B: 'ships_static_a_palette_3cmla_1',
    ShipGlobals.Styles.BountyHunter_C: 'ships_static_a_palette_3cmla_3_swp_3',
    ShipGlobals.Styles.BountyHunter_D: 'ships_static_a_palette_3cmla_4_swp_4',
...
ColorDict = {
    ...
    ShipGlobals.Styles.French: 'pir_t_shp_clr_french',
    ShipGlobals.Styles.Spanish: 'pir_t_shp_clr_spanish',
    ShipGlobals.Styles.BP: 'pir_t_shp_clr_blackPearl',
    ShipGlobals.Styles.Bandit01: 'pir_t_shp_clr_bandit_01',
    ShipGlobals.Styles.Bandit02: 'pir_t_shp_clr_bandit_02',
    ShipGlobals.Styles.Bandit03: 'pir_t_shp_clr_bandit_03',
    ShipGlobals.Styles.Bandit04: 'pir_t_shp_clr_bandit_04',
    ShipGlobals.Styles.Treasure_Navy: 'pir_t_shp_clr_navy',
    ShipGlobals.Styles.Treasure_EITC: 'pir_t_shp_clr_eitc',
    ShipGlobals.Styles.QueenAnnesRevenge: 'pir_t_shp_clr_bandit_01',
    ShipGlobals.Styles.BountyHunter_A: 'pir_t_shp_clr_7stripe_green',
    ShipGlobals.Styles.BountyHunter_B: 'pir_t_shp_clr_7stripe_red',
    ShipGlobals.Styles.BountyHunter_C: 'pir_t_shp_clr_bandit_03',
    ShipGlobals.Styles.BountyHunter_D: 'pir_t_shp_clr_7stripe_violet',
...
MastData = {
    ShipGlobals.Masts.Main_Tri: {
        'maxHeight': 2,
        'prefix': 'main_tri' },
    ShipGlobals.Masts.Main_Square: {
        'maxHeight': 3,
        'prefix': 'main_square' },
    ShipGlobals.Masts.Fore_Tri: {
        'maxHeight': 1,
        'prefix': 'fore_tri' },
    ShipGlobals.Masts.Fore_Multi: {
        'maxHeight': 3,
        'prefix': 'fore_multi' },
    ShipGlobals.Masts.Aft_Tri: {
        'maxHeight': 1,
        'prefix': 'aft_tri' },
    ShipGlobals.Masts.Skel_Main_A: {
        'maxHeight': 3,
        'prefix': 'main_square_skeletonA' },
    ShipGlobals.Masts.Skel_Main_B: {
        'maxHeight': 3,
        'prefix': 'main_square_skeletonB' },
    ShipGlobals.Masts.Skel_Tri: {
        'maxHeight': 2,
        'prefix': 'main_tri_skeleton' },
    ShipGlobals.Masts.Skel_Fore: {
        'maxHeight': 2,
        'prefix': 'fore_skeleton' },
...
metaAnims = [
    ...
    'tiedup']
HullDict = {
    ShipGlobals.WARSHIPL1: 'frg_light',
    ShipGlobals.WARSHIPL2: 'frg_regular',
    ShipGlobals.WARSHIPL3: 'frg_war',
    ShipGlobals.MERCHANTL1: 'gal_light',
    ShipGlobals.MERCHANTL2: 'gal_regular',
    ShipGlobals.MERCHANTL3: 'gal_war',
    ...
    ShipGlobals.CARRACKL2: 'car_regular',
    ShipGlobals.CARRACKL3: 'car_war',
    ShipGlobals.CORVETTEL1: 'car_regular',
    ShipGlobals.CORVETTEL2: 'car_regular',
    ShipGlobals.CORVETTEL3: 'car_regular' }
...
def generateMastCache(mastClass):
    ...
    NodePath(data.charRoot).getChildren().detach()
