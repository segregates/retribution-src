...
class StunEffect(PooledEffect, EffectController):
    ...
    def __init__(self):
        ...
        self.p0.emitter.setAmplitude(0.100)
    ...
    def createTrack(self):
        ...
        self.p0.renderer.setFinalXScale(0.00600 * self.cardScale * self.effectScale)
        ...
        self.startEffect = Sequence(Func(self.p0.clearToInitial), Func(self.p0.setBirthRate, 0.200), Func(self.f.start, self, self.dummy2), Func(rotate.loop), Func(rotateH.loop))
