...
class SpectralSmoke(PooledEffect, EffectController):
    ...
    def __init__(self):
        ...
        self.p0.renderer.setUserAlpha(0.149)
        self.p0.renderer.setFromNode(self.card)
        self.p0.renderer.setColor(Vec4(1.0, 1.0, 1.0, 1.0))
        self.p0.renderer.setXScaleFlag(1)
        self.p0.renderer.setYScaleFlag(1)
        self.p0.renderer.setAnimAngleFlag(0)
        self.p0.renderer.setInitialXScale(0.0074 * self.cardScale)
        self.p0.renderer.setFinalXScale(0.0149 * self.cardScale)
        self.p0.renderer.setInitialYScale(0.0074 * self.cardScale)
    ...
    def createTrack(self, duration = 1.0, delay = 0.0):
        self.startEffect = Sequence(Wait(delay), Func(self.p0.setBirthRate, 0.0250), Func(self.p0.clearToInitial), Func(self.f.start, self, self))
