...
class Wasp(Creature):
    ...
    SfxNames.update({
        'death': SoundGlobals.SFX_MONSTER_WASP_DEATH,
        'pain': SoundGlobals.SFX_MONSTER_WASP_PAIN })
    sfx = { }
    AnimList = (('idle', 'idle'), ('idle_flying', 'idle_fly'), ('walk', 'walk'), ('drop', 'react_drop'), ('advance', 'attack_advance'), ('sting', 'attack_sting'), ('leap_sting', 'attack_leap_sting'), ('pain', 'react_pull_back'), ('death', 'react_death'))
    ...
    class AnimationMixer(Creature.AnimationMixer):
        ...
        AnimRankings = {
            'idle': (LOOP['LOOP'],),
            'idle_flying': (LOOP['LOOP'],),
            'walk': (LOOP['LOOP'],),
            'advance': (ACTION['ACTION'],),
            'drop': (ACTION['ACTION'],),
            'sting': (ACTION['ACTION'],),
            'leap_sting': (ACTION['ACTION'],),
            'ouch': (ACTION['ACTION'],),
            'death': (ACTION['MOVIE'],),
            'pain': (ACTION['ACTION'],) }
