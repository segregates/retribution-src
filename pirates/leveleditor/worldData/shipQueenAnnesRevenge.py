        ...
        '1302550960.6jubutler': {
            ...
            'Objects': {
                ...
                '1302551263.39jubutler': {
                    ...
                    'Pause Chance': '100',
                    'Pause Duration': '30',
                    'Pos': Point3(-10.083, 6.623, 25.561),
                    'Scale': VBase3(1.0, 1.0, 1.0),
                    'VisSize': '',
                    'Visual': {
                        'Color': (0.65, 0, 0, 1),
                ...
                '1302551267.54jubutler': {
                    ...
                    'Pause Chance': '100',
                    'Pause Duration': '30',
                    'Pos': Point3(10.468, 5.1926, 25.707),
                    'Scale': VBase3(1.0, 1.0, 1.0),
                    'VisSize': '',
                    'Visual': {
                        'Color': (0.65, 0, 0, 1),
                ...
                '1302561022.57jloehrle': {
                    ...
                    'AnimSet': 'default',
                    'AuraFX': 'None',
                    'Hpr': VBase3(-177.312, 0.0, 0.0),
                    'Min Population': '1',
                    'Patrol Radius': '12.0000',
                    'Pause Chance': '100',
                    'Pause Duration': '30',
                    'Pos': Point3(-1.14, 30.475, 27.427),
                    'PoseAnim': '',
                    'PoseFrame': '',
                    'PropFXLeft': 'None',
                    'PropFXRight': 'None',
...
extraInfo = {
    'camPos': Point3(-123.069, -59.1584, 128.28),
    'camHpr': VBase3(-67.7526, -39.2734, 0),
