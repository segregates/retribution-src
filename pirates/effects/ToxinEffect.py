...
class ToxinEffect(PooledEffect, EffectController):
    ...
    def __init__(self):
        ...
        self.p0.renderer.getColorInterpolationManager().addLinear(0.0, 1.0, Vec4(0.800000, 0.598, 1, 1), Vec4(0.200, 0.100, 0.25, 0.5), 1)
    ...
    def createTrack(self):
        ...
        self.p0.renderer.setFinalXScale(0.050000 * self.cardScale * self.effectScale)
        self.p0.renderer.setInitialYScale(0.001 * self.cardScale * self.effectScale)
        self.p0.renderer.setFinalYScale(0.0400 * self.cardScale * self.effectScale)
