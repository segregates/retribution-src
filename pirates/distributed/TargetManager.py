from panda3d.core import BitMask32, CollideMask, CollisionEntry, CollisionHandler, CollisionHandlerQueue, CollisionNode, CollisionSegment, CollisionTraverser, Lens, NodePath, Point3, Vec3
...
class TargetManager(DistributedObject.DistributedObject, TargetManagerBase.TargetManagerBase):
    ...
    TypesWithoutReticles = (ItemGlobals.SWORD, ItemGlobals.DOLL, ItemGlobals.GRENADE, ItemGlobals.FISHING, ItemGlobals.QUEST_PROP)
    WeaponBaseRange = {
    ...
    def delete(self):
        ...
        self.stopFollowAim()
        self.aimRayNodePath.remove_node()
        self.reticleHolder.remove_node()
        self.reticle.remove_node()
        self.distanceChecker.remove_node()
