...
class GuiTray(DirectFrame):
    ...
    def __init__(self, parent, w = 0.5, h = 0.1, draggable = 0, **kw):
        ...
        if draggable:
            optiondefs = (('relief',
             ...
             ('state',
              ...
              None),
             ('frameColor',
              PiratesGuiGlobals.FrameColor,
              None),
             ('borderWidth',
              PiratesGuiGlobals.BorderWidth,
              None),
             ('frameSize',
              (0,
               self.width,
        ...
        if self.draggable:
            self.dragBar = DirectButton(parent=self, relief=DGG.FLAT, frameColor=PiratesGuiGlobals.ButtonColor1, frameSize=(0,
             0.02,
             0,
             (self.height - (0.01 * 2))), pos=(0.01, 0, 0.01))
