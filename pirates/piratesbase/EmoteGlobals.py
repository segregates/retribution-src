...
emotes = {
    EMOTE_RECEIVE_DOLL: {
        'anim': 'doll_receive',
        'prop': 'models/handheld/voodoo_doll_high' },
    EMOTE_RECEIVE_STAFF: {
        'anim': 'staff_receive',
        'prop': 'models/handheld/voodoo_staff_high' },
    EMOTE_RECEIVE_DAGGER: {
        'anim': 'dagger_receive',
        'prop': 'models/handheld/dagger_high' },
    EMOTE_RECEIVE_GRENADE: {
        'anim': 'bomb_receive',
        'prop': 'models/ammunition/grenade' },
    EMOTE_COIN_FLIP: {
        'anim': 'emote_coin_flip_loop',
        'loop': 1,
        'prop': 'models/handheld/coin_high' },
    EMOTE_DANCE_JIG: {
        'anim': 'emote_dance_jig_loop',
        'loop': 1,
    ...
    EMOTE_VALENTINES: {
        'prereqs': [
            IsHoliday(HolidayGlobals.VALENTINESDAY)],
        'anim': 'emote_wink',
        'group': OL.Emotes_General },
    EMOTE_NOISEMAKER: {
        'prereqs': [
        ...
        'anim': 'emote_newyears',
        'prop': 'models/handheld/pir_m_hnd_hol_noisemaker08',
        'group': OL.Emotes_General,
        'sfx': loadSfxString(SoundGlobals.SFX_AVATAR_NOISEMAKER) },
    EMOTE_HALLOWEEN: {
        'prereqs': [
            IsHoliday(HolidayGlobals.ZOMBIEEMOTE)],
        'anim': 'emote_thriller',
        'group': OL.Emotes_General },
    EMOTE_CHEER: {
        'anim': 'emote_celebrate' },
    EMOTE_TIRED: {
        'anim': 'sleep_idle_loop',
        'loop': 1 },
    EMOTE_NOD: {
        'anim': 'emote_yes' },
    EMOTE_GREET: {
    ...
    EMOTE_HAPPY: {
        'anim': 'emote_smile' },
    EMOTE_DANCE: {
        'anim': 'emote_dance_jig',
        'loop': 1 },
    EMOTE_BORED: {
        'anim': 'idle_B_shiftWeight',
        'loop': 1 },
    EMOTE_CACKLE: {
        'anim': 'emote_laugh' },
    EMOTE_HAIL: {
    ...
    EMOTE_DUHHH: {
        'anim': 'emote_duhhh' },
    EMOTE_BLOWKISS: {
        'anim': 'emote_blow_kiss' },
    EMOTE_FLIRT: {
        'anim': 'emote_flirt' },
    EMOTE_SASSY: {
        'anim': 'emote_sassy' },
    EMOTE_TALKTOHAND: {
        'anim': 'emote_talk_to_the_hand' },
    EMOTE_INSANE: {
        'anim': 'emote_crazy' },
    EMOTE_CUTTHROAT: {
        'anim': 'emote_cut_throat' },
    EMOTE_EMBARRASSED: {
        'anim': 'emote_embarrassed' },
    EMOTE_FACESMACK: {
        'anim': 'emote_face_smack' },
    EMOTE_HANDITOVER: {
        'anim': 'emote_hand_it_over' },
    EMOTE_HEADSCRATCH: {
        'anim': 'emote_head_scratch' },
    EMOTE_NERVOUS: {
        'anim': 'emote_nervous' },
    EMOTE_PETRIFIED: {
        'anim': 'emote_scared' },
    EMOTE_SHOWMEMONEY: {
        'anim': 'emote_show_me_the_money' },
    EMOTE_SHRUG: {
        'anim': 'emote_shrug' },
    EMOTE_SINCERETHANKS: {
        'anim': 'emote_sincere_thanks' },
    EMOTE_SNARL: {
        'anim': 'emote_snarl' },
    EMOTE_GUN_DRAW: {
        'anim': 'gun_draw',
        'prop': 'models/handheld/pir_m_hnd_gun_pistol_a' },
    EMOTE_GUN_AIM: {
        'anim': 'gun_aim_idle',
        'loop': 1,
        'prop': 'models/handheld/pir_m_hnd_gun_pistol_a' },
    ...
    EMOTE_FART: {
        'anim': 'fart',
        'sfx': loadSfxString(SoundGlobals.SFX_MINIGAME_POTION_FX_FART_1) },
    EMOTE_DRINKPOTION: {
        'anim': 'drink_potion',
        'prop': 'models/handheld/bottle_high',
        'sfx': loadSfxString(SoundGlobals.SFX_CONSUMABLE_DRINK) },
    EMOTE_NED_CRAZY: {
        'anim': 'crazy_ned_day_interact' },
    EMOTE_BLACKHAND_SWORD_A: {
        'anim': 'hand_curse_get_sword',
        'prop': 'models/handheld/pir_m_hnd_swd_davyJones_g',
        'waitProp': 0.5,
        'durProp': 17.0,
        'vfx': BlackhandCurseSword },
    EMOTE_BLACKHAND_SWORD_B: {
        'anim': 'hand_curse_get_sword',
        'prop': 'models/handheld/pir_m_hnd_swd_davyJones_a',
        'waitProp': 0.5,
        'durProp': 17.0,
        'vfx': BlackhandCurseSword },
    EMOTE_BLACKHAND_SWORD_C: {
        'anim': 'hand_curse_get_sword',
        'prop': 'models/handheld/pir_m_hnd_swd_davyJones_e',
        'waitProp': 0.5,
        'durProp': 17.0,
        'vfx': BlackhandCurseSword },
    EMOTE_BLACKHAND: {
        'prereqs': [
            DidQuest('rc.le.10lootTreasure')],
        'anim': 'hand_curse_check',
        'group': OL.Emotes_General } }
...
RewardReceivedToEmoteCmds = {
    InventoryType.DollToken: (EMOTE_RECEIVE_DOLL, PiratesGuiGlobals.REWARD_PANEL_DOLL),
    InventoryType.WandToken: (EMOTE_RECEIVE_STAFF, PiratesGuiGlobals.REWARD_PANEL_STAFF),
    InventoryType.DaggerToken: (EMOTE_RECEIVE_DAGGER, PiratesGuiGlobals.REWARD_PANEL_DAGGER),
    InventoryType.GrenadeToken: (EMOTE_RECEIVE_GRENADE, PiratesGuiGlobals.REWARD_PANEL_GRENADE),
    InventoryType.SailPowerRecharge: (EMOTE_CELEBRATE, PiratesGuiGlobals.REWARD_PANEL_BLACK_PEARL),
    ItemGlobals.BITTER_END: (EMOTE_BLACKHAND_SWORD_A, PiratesGuiGlobals.REWARD_PANEL_RAVENS_COVE_A),
    ItemGlobals.SPINECREST_SWORD: (EMOTE_BLACKHAND_SWORD_B, PiratesGuiGlobals.REWARD_PANEL_RAVENS_COVE_B),
    ItemGlobals.NAUTILUS_BLADE: (EMOTE_BLACKHAND_SWORD_C, PiratesGuiGlobals.REWARD_PANEL_RAVENS_COVE_C) }
