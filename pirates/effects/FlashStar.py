...
class FlashStar(PooledEffect, EffectController):
    ...
    def createTrack(self):
        ...
        anim1 = Sequence(Wait(0.050000), Parallel(ray1Fadein, ray1Fadeout))
        anim2 = Sequence(Wait(0.100), Parallel(ray2Fadein, ray2Fadeout))
        anim3 = Sequence(Wait(0.149), Parallel(ray3Fadein, ray3Fadeout))
        anim4 = Sequence(Wait(0.200), Parallel(ray4Fadein, ray4Fadeout))
        anim5 = Sequence(Wait(0.348), Parallel(ray1Fadein, ray1Fadeout))
        anim6 = Sequence(Wait(0.4), Parallel(ray2Fadein, ray2Fadeout))
        anim7 = Sequence(Wait(0.450), Parallel(ray3Fadein, ray3Fadeout))
