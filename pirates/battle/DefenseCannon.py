...
ammoHitSfx = {
    InventoryType.DefenseCannonColdShot: loadSfx(SoundGlobals.SFX_MINIGAME_CANNON_ICE_FREEZE),
    InventoryType.DefenseCannonSmokePowder: loadSfx(SoundGlobals.SFX_WEAPON_CANNON_DIST_FIRE_01) }
