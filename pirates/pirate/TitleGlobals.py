...
landPVPIcons = {
    ...
    2: 'pir_t_ico_inf_lnd_brawler',
    3: 'pir_t_ico_inf_lnd_duelist',
    4: 'pir_t_ico_inf_lnd_buccaneer',
    5: 'pir_t_ico_inf_lnd_swashbuckler',
    6: 'pir_t_ico_inf_lnd_warmonger',
    7: 'pir_t_ico_inf_lnd_warmaster' }
shipPVPIcons = {
    0: None,
    1: 'pir_t_ico_inf_shp_mariner',
    2: 'pir_t_ico_inf_shp_lieutenant',
    3: 'pir_t_ico_inf_shp_commander',
    4: 'pir_t_ico_inf_shp_captain',
