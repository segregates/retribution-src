from panda3d.core import AnimControl, AnimControlCollection, Character, LODNode, Light, Material, ModelNode, NodePath, PartSubset, Texture, TextureStage
...
MissingAnims = {
    ShipGlobals.SKEL_WARSHIPL3: ('tiedup', 'rolldown', 'rollup'),
    ShipGlobals.SKEL_INTERCEPTORL3: ('tiedup', 'rolldown', 'rollup') }
SailReplace = {
    ShipGlobals.QUEEN_ANNES_REVENGE: 0 }
...
class ShipFactory:
    ...
    def getShip(self, shipClass, style = ShipGlobals.Styles.Undefined, logo = ShipGlobals.Logos.Undefined, hullDesign = None, detailLevel = 2, wantWheel = True, hullMaterial = None, sailMaterial = None, sailPattern = None, prowType = None):
        ...
        if sailPattern and sailMaterial and hullMaterial or shipClass in SailReplace:
