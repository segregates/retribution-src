...
RepIcons = {
    ...
    InventoryType.CutlassRep: 'pir_t_ico_swd_cutlass_a',
    InventoryType.PistolRep: 'pir_t_ico_gun_pistol_a',
    InventoryType.MusketRep: 'pir_t_ico_gun_pistol_a',
    InventoryType.DaggerRep: 'pir_t_ico_knf_small',
    InventoryType.GrenadeRep: 'pir_t_ico_bom_grenade',
    InventoryType.DollRep: 'pir_t_ico_dol_straw',
    InventoryType.WandRep: 'pir_t_ico_stf_wood',
    InventoryType.CannonRep: 'pir_t_ico_can_single',
    InventoryType.SailingRep: 'sail_full_sail',
    InventoryType.FishingRep: 'pir_t_gui_fsh_purchaseIcon' }
