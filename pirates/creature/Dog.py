...
class Dog(Animal):
    ...
    SfxNames.update({ })
    AnimList = (('idle', 'idle_sitting_keys'), ('idle_sitting', 'idle_sitting_keys'), ('walk', 'walk_keys'), ('idle_standing', 'idle_standing_keys'), ('bark_sitting', 'bark_sitting_keys'), ('bark_standing', 'bark_standing_keys'), ('into_sit', 'into_sit_keys'), ('into_lying_down', 'into_lying_down'), ('wag_sitting', 'wag_sitting_keys'), ('wag_standing', 'wag_standing_keys'))
