from panda3d.core import GeomNode, LODNode, PartBundle, Point3, RenderState, SceneGraphReducer, Texture, TransformState, VBase3, VBase4, Vec3, Vec4
...
class MasterHuman(HumanBase.HumanBase, Biped.Biped):
    ...
    def generateTexture(self):
        if config.GetBool('want-face-textures', 1): # Why is there a bool for this?!?!
            self.generateFaceTexture()
    ...
    def initHeadControlShapes(self):
        ...
        for jointName in cjs:
            ...
            matrixIHelper[jointName] = [pos[0], pos[1], pos[2], hpr[0], hpr[1], hpr[2], scale[0], scale[1], scale[2]]
