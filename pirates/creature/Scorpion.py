...
class Scorpion(Creature):
    ...
    SfxNames.update({
        'death': SoundGlobals.SFX_MONSTER_SCORPION_DEATH,
        'pain': SoundGlobals.SFX_MONSTER_SCORPION_PAIN })
    sfx = { }
    AnimList = (('idle', 'idle'), ('walk', 'walk'), ('run', 'run'), ('attack_left', 'attack_left'), ('attack_right', 'attack_right'), ('attack_both', 'attack_both'), ('attack_tail_sting', 'attack_tail_sting'), ('pick_up_human', 'pick_up_human'), ('react_left', 'react_left'), ('react_right', 'react_right'), ('pain', 'knockback'), ('rear_up', 'rear_up'), ('death', 'death'))
