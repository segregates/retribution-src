...
class VoodooPestilence(PooledEffect, EffectController):
    ...
    def __init__(self):
        ...
        self.p0.renderer.getColorInterpolationManager().addLinear(0.0, 1.0, Vec4(1.0, 1.0, 1.0, 1.0), Vec4(0.100, 0.200, 0.100, 0.5), 1)
        self.p0.emitter.setEmissionType(BaseParticleEmitter.ETRADIATE)
        self.p0.emitter.setAmplitude(0.299)
        self.p0.emitter.setAmplitudeSpread(0.0)
        self.p0.emitter.setOffsetForce(Vec3(0.0, 0.0, -0.450))
    ...
    def createTrack(self):
        self.p0.renderer.setInitialXScale(0.00300 * self.effectScale * self.cardScale)
