...
class DistributedDinghy(DistributedInteractive):
    ...
    def denyAccess(self, type):
        ...
        elif type == PiratesGlobals.SeasAreClosed:
            # Until sailing is written, lets deny access to the dinghy.
    ...
    def enterUse(self):
        ...
        self.shipSelection = ShipDeployPanel(PLocalizer.ChooseShipTitle, self.requestExit, siegeTeam = self.team)
