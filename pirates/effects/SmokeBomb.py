...
class SmokeBomb(PooledEffect, EffectController):
    ...
    def __init__(self):
        ...
        self.p0.renderer.getColorInterpolationManager().addLinear(0.0, 0.800000, Vec4(0.75, 0.75, 0.75, 1.0), Vec4(0.4, 0.4, 0.200, 0.5), 1)
        self.p0.renderer.getColorInterpolationManager().addLinear(0.800000, 1.0, Vec4(0.4, 0.4, 0.200, 0.5), Vec4(0.0, 0.0, 0.0, 0.0), 1)
