...
objectStruct = {
    ...
    'FogRanges': { },
    'Objects': {
        '1231799724.82caoconno0': {
            'Type': 'Building Interior',
            'Name': '',
            'AdditionalData': [
                'interior_shanty_blacksmith'],
            'Instanced': True,
            'Objects': {
                '1181607808.0dxschafe': {
                    ...
                    'CustomModel': 'None',
                    'HelpID': 'NONE',
                    'Hpr': VBase3(-143.334, 0.0, 0.0),
                    'Patrol Radius': '12.0000',
                    'Pos': Point3(-5.4858, 7.68200, 0.0),
                    'PoseAnim': '',
                    'PoseFrame': '',
                    'Private Status': 'All',
                    'Respawns': True,
                ...
                '1213291115.62aapatel': {
                    ...
                    'CustomModel': 'None',
                    'HelpID': 'NONE',
                    'Hpr': VBase3(170.083, 0.0, 0.0),
                    'Patrol Radius': '12.0000',
                    'Pos': Point3(7.423, 9.624, 0.0),
                    'PoseAnim': '',
                    'PoseFrame': '',
                    'Private Status': 'All',
                    'Respawns': True,
    ...
    'ObjectIds': {
        '1181607808.0dxschafe': '["Objects"]["1231799724.82caoconno0"]["Objects"]["1181607808.0dxschafe"]',
        '1213291084.25aapatel': '["Objects"]["1231799724.82caoconno0"]["Objects"]["1213291084.25aapatel"]',
        '1213291115.62aapatel': '["Objects"]["1231799724.82caoconno0"]["Objects"]["1213291115.62aapatel"]',
        '1231799724.82caoconno0': '["Objects"]["1231799724.82caoconno0"]' } }
