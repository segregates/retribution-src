...
CREATURE_CLASS_DICT = {
    ...
    'Devourer Crab': 'Crab',
    'FlyTrap': 'FlyTrap',
    'Rancid FlyTrap': 'FlyTrap',
    'Ancient FlyTrap': 'FlyTrap',
    'Stump': 'Stump',
    'Twisted Stump': 'Stump',
    'Alligator': 'Alligator',
    'Bayou Gator': 'Alligator',
    'Huge Gator': 'Alligator',
    'Big Gator': 'Alligator',
    'Bat': 'Bat',
    'Rabid Bat': 'Bat',
    'Vampire Bat': 'Bat',
    ...
    'Soldier Wasp': 'Wasp',
    'Scorpion': 'Scorpion',
    'Dire Scorpion': 'Scorpion',
    'Dread Scorpion': 'Scorpion' }
...
def getStyleEnumerations():
    styleInfo = PLocalizer.ShipStyleNames
...
def getLogoEnumerations():
    logoInfo = PLocalizer.ShipLogoNames
    logos = logoInfo.keys()
    logos.sort()
