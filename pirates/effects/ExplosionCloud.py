...
class ExplosionCloud(PooledEffect, EffectController):
    ...
    def createTrack(self, rate = 1):
        ...
        self.p0.renderer.setInitialXScale(0.200 * self.cardScale)
        ...
        self.p0.renderer.getColorInterpolationManager().addLinear(0.0, 0.80000001192092896, Vec4(1.0, 1.0, 1.0, 1.0), Vec4(0.39215686917304993, 0.19607843458652496, 0.0, 1.0), 1)
