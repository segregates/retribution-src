...
class RepairPumpingGame(RepairMincroGame):
    ...
    def destroy(self):
        ...
        self.pumpBar.remove_node()
        self.pumpLine.remove_node()
        self.goalBox.remove_node()
        self.pumpHandle.remove_node()
        self.waterMeter.remove_node()
        self.waterTop.remove_node()
        self.ghostLine.remove_node()
        self.shipBackground.remove_node()
        self.shipForground.remove_node()
