...
class Immolate(PooledEffect, EffectController):
    ...
    def __init__(self):
        ...
        self.p0.renderer.setFinalXScale(0.074 * self.cardScale)
        ...
        self.p0.renderer.getColorInterpolationManager().addLinear(0.0, 1.0, Vec4(0.800000, 0.65, 0.65, 0.5), Vec4(0.0, 0.0, 0.0, 0.0), 1)
        self.p0.emitter.setEmissionType(BaseParticleEmitter.ETRADIATE)
        self.p0.emitter.setAmplitude(3.0)
        self.p0.emitter.setAmplitudeSpread(1.0)
        self.p0.emitter.setOffsetForce(Vec3(0.0, 0.0, -0.598))
