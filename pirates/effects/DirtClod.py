...
class DirtClod(PooledEffect, EffectController):
    ...
    def createTrack(self):
        ...
        self.p0.factory.setMassBase(0.299)
        self.p0.factory.setMassSpread(0.050000)
        ...
        self.p0.renderer.setFinalXScale(0.070 * self.cardScale)
        ...
        self.track = Sequence(Func(self.p0.setBirthRate, 0.0299), Func(self.p0.clearToInitial), Func(self.f.start, self, self.particleDummy), Func(self.f.reparentTo, self), Wait(0.100), Func(self.p0.setBirthRate, 100), Wait(3.0), Func(self.cleanUpEffect))
