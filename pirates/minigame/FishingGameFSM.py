...
class FishingGameFSM(FSM.FSM):
    ...
    def enterChargeCast(self):
        ...
        self.accept('mouse1', self.request, [
            'Cast'])
    ...
    def enterFishing(self):
        ...
        self.accept('mouse1', self.request, [
            'Reeling'])
        self.accept('space', self.request, [
            'QuickReel'])
    ...
    def enterReeling(self):
        ...
        self.accept('mouse1-up', self.request, [
            'Fishing'])
        self.accept('space', self.request, [
            'QuickReel'])
    ...
    def enterLose(self):
        ...
        if self.gameObject.fishManager.activeFish.fsm.getCurrentOrNextState() not in [
            'Offscreen',
            'Flee']:
