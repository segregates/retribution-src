from panda3d.core import Texture, Vec3, Vec4
import Weapon
...
class Dagger(Weapon.Weapon):
    modelTypes = [
        'models/handheld/pir_m_hnd_knf_dagger_a',
        'models/handheld/pir_m_hnd_knf_dagger_b',
        'models/handheld/pir_m_hnd_knf_dagger_c',
        'models/handheld/pir_m_hnd_knf_dagger_d',
        'models/handheld/pir_m_hnd_knf_dagger_e',
        'models/handheld/pir_m_hnd_knf_dirk_a',
        'models/handheld/pir_m_hnd_knf_dirk_b',
        'models/handheld/pir_m_hnd_knf_dirk_c',
        'models/handheld/pir_m_hnd_knf_dirk_d',
        'models/handheld/pir_m_hnd_knf_dirk_e',
        'models/handheld/pir_m_hnd_knf_hollow_a',
        'models/handheld/pir_m_hnd_knf_hollow_b',
        'models/handheld/pir_m_hnd_knf_hollow_c',
        'models/handheld/pir_m_hnd_knf_hollow_d',
    ...
    def setupSounds(cls):
        ...
        Dagger.hitSfxs = (loadSfx(SoundGlobals.SFX_WEAPON_DAGGER_HIT),)
        Dagger.mistimedHitSfxs = (loadSfx(SoundGlobals.SFX_WEAPON_DAGGER_MISTIMEDHIT),)
        Dagger.skillSfxs = {
            InventoryType.DaggerCut: loadSfx(SoundGlobals.SFX_WEAPON_DAGGER_CUT),
            InventoryType.DaggerSwipe: loadSfx(SoundGlobals.SFX_WEAPON_DAGGER_SWIPE),
            InventoryType.DaggerGouge: loadSfx(SoundGlobals.SFX_WEAPON_DAGGER_GOUGE),
            InventoryType.DaggerEviscerate: loadSfx(SoundGlobals.SFX_WEAPON_DAGGER_EVISCERATE),
            InventoryType.DaggerAsp: loadSfx(SoundGlobals.SFX_WEAPON_DAGGER_ASP),
            InventoryType.DaggerAdder: loadSfx(SoundGlobals.SFX_WEAPON_DAGGER_ADDER),
            InventoryType.DaggerThrowDirt: loadSfx(SoundGlobals.SFX_WEAPON_DAGGER_THROW_DIRT),
            InventoryType.DaggerSidewinder: loadSfx(SoundGlobals.SFX_WEAPON_DAGGER_SIDEWINDER),
            InventoryType.DaggerViperNest: loadSfx(SoundGlobals.SFX_WEAPON_DAGGER_VIPER_NEST),
            EnemySkills.DAGGER_BARRAGE: loadSfx(SoundGlobals.SFX_WEAPON_DAGGER_BARRAGE),
            EnemySkills.DAGGER_ICEBARRAGE: loadSfx(SoundGlobals.SFX_WEAPON_DAGGER_BARRAGE),
            EnemySkills.DAGGER_DAGGERRAIN: loadSfx(SoundGlobals.SFX_WEAPON_DAGGER_RAIN),
            EnemySkills.DAGGER_THROW_COMBO_1: loadSfx(SoundGlobals.SFX_WEAPON_DAGGER_THROW_COMBO_1),
            EnemySkills.DAGGER_THROW_COMBO_2: loadSfx(SoundGlobals.SFX_WEAPON_DAGGER_THROW_COMBO_2),
            EnemySkills.DAGGER_THROW_COMBO_3: loadSfx(SoundGlobals.SFX_WEAPON_DAGGER_THROW_COMBO_3),
            EnemySkills.DAGGER_THROW_COMBO_4: loadSfx(SoundGlobals.SFX_WEAPON_DAGGER_THROW_COMBO_4),
