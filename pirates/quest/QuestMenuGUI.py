...
class QuestMenuGUI(DirectFrame):
    ...
    def setOffers(self, offers):
        ...
        for (i, offer) in zip(range(len(offers)), offers):
            ...
            if questLadderName and questLadderName in PLocalizer.QuestStrings and 'title' in PLocalizer.QuestStrings[questLadderName].keys():
                questTitle = PLocalizer.QuestStrings[questLadderName]['title']
            elif offer.questId in PLocalizer.QuestStrings and 'title' in PLocalizer.QuestStrings[offer.questId].keys():
