...
class CannonDefenseGoldRemaingUI:
    ...
    def _loadAssets(self):
        ...
        try:
            ...
            self._CannonDefenseGoldRemaingUI__createTextLabel(model)
    ...
    def _CannonDefenseGoldRemaingUI__createTextLabel(self, parent):
        ...
        goldTxtNode.setScale(0.0299)
        goldTxtNode.setX(0.035000)
        goldTxtNode.setZ(0.00500)
        goldTxtNode.setDepthTest(False)
        goldTxtNode.setDepthWrite(False)


    def destroy(self):
        self.mineCounter.remove_node()
