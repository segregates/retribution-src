...
class BattleNPCGameFSM(BattleAvatarGameFSM.BattleAvatarGameFSM):
    ...
    def enterLandRoam(self, extraArgs=[]):
        BattleAvatarGameFSM.BattleAvatarGameFSM.enterLandRoam(self, extraArgs)
        if self.av.collisionMode & PiratesGlobals.COLL_MODE_FLOORS_CL:
            self.av.performQuickFloorCheck()
