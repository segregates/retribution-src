from panda3d.core import ColorBlendAttrib, lookAt
# File: B (Python 2.4)
...
class BeamEffect(PooledEffect, EffectController):
    ...
    def _BeamEffect__calculateBeam(self):
    ...
    def createTrack(self, duration = 1.0):
        anim = Sequence()
        anim.append(Func(self._BeamEffect__calculateBeam))
        for i in xrange(self.numPoses):
