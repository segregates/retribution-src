...
class InventorySellConfirm(BorderFrame):
    ...
    def setup(self):
        ...
        self.confirmButton = GuiButton.GuiButton(parent = self, text = PLocalizer.InventorySell, text_fg = PiratesGuiGlobals.TextFG2, text_pos = (0.0, -0.014), text_scale = PiratesGuiGlobals.TextScaleLarge, text_align = TextNode.ACenter, text_shadow = PiratesGuiGlobals.TextShadow, image = GuiButton.GuiButton.blueGenericButton, image_scale = (0.6, 0.6, 0.6), pos = (self.sizeX * 0.5, 0, 0.12), relief = None, command = self.confirmSale)
