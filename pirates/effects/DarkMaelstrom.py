from panda3d.core import ColorBlendAttrib, ColorWriteAttrib, NodePath, Point3, Texture, Vec4
...
class DarkMaelstrom(DirectObject, NodePath):
    ...
    def __init__(self, newParent = None):
        ...
        bolt1In = self.bolt1.colorInterval(0.100, Vec4(1, 1, 1, 1), startColor = Vec4(0, 0, 0, 0))
        bolt1Out = self.bolt1.colorInterval(0.100, Vec4(0, 0, 0, 0), startColor = Vec4(1, 1, 1, 1))
        bolt2In = self.bolt2.colorInterval(0.100, Vec4(1, 1, 1, 1), startColor = Vec4(0, 0, 0, 0))
        bolt2Out = self.bolt2.colorInterval(0.100, Vec4(0, 0, 0, 0), startColor = Vec4(1, 1, 1, 1))
        bolt3In = self.bolt3.colorInterval(0.100, Vec4(1, 1, 1, 1), startColor = Vec4(0, 0, 0, 0))
        bolt3Out = self.bolt3.colorInterval(0.100, Vec4(0, 0, 0, 0), startColor = Vec4(1, 1, 1, 1))
        bolt4In = self.bolt4.colorInterval(0.100, Vec4(1, 1, 1, 1), startColor = Vec4(0, 0, 0, 0))
        bolt4Out = self.bolt4.colorInterval(0.100, Vec4(0, 0, 0, 0), startColor = Vec4(1, 1, 1, 1))
        playBolt1 = Sequence(bolt1In, Wait(0.100), bolt1Out)
        playBolt2 = Sequence(bolt2In, Wait(0.100), bolt2Out)
        playBolt3 = Sequence(bolt3In, Wait(0.100), bolt3Out)
        playBolt4 = Sequence(bolt4In, Wait(0.100), bolt4Out)
