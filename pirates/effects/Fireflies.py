from panda3d.physics import BaseParticleEmitter, BaseParticleRenderer, ColorInterpolationManager, LinearNoiseForce
from panda3d.core import ColorBlendAttrib, ModelNode, NodePath, Point3, Vec3, Vec4
# File: F (Python 2.4)
...
class Fireflies(EffectController, NodePath):
    ...
    def __init__(self):
        ...
        force0 = LinearNoiseForce(0.100, 0)
    ...
    def createTrack(self):
        ...
        self.p0.renderer.setInitialXScale(0.00129 * self.cardScale)
        self.p0.renderer.setFinalXScale(0.00129 * self.cardScale)
        self.p0.renderer.setInitialYScale(0.00129 * self.cardScale)
        self.p0.renderer.setFinalYScale(0.00129 * self.cardScale)
        ...
        self.startEffect = Sequence(Func(self.p0.setBirthRate, 0.02), Func(self.p0.setPoolSize, 256), Func(self.p0.clearToInitial), Func(self.f.start, self, self.particleDummy), Func(self.f.reparentTo, self))
