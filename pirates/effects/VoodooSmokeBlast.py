...
class VoodooSmokeBlast(PooledEffect, EffectController):
    cardScale = 128.0
    ...
    def __init__(self):
        ...
        self.speed = 20.0
        if not VoodooSmokeBlast.particleDummy:
            VoodooSmokeBlast.particleDummy = render.attachNewNode(ModelNode('VoodooSmokeBlastParticleDummy'))
            VoodooSmokeBlast.particleDummy.setDepthWrite(0)
            VoodooSmokeBlast.particleDummy.setLightOff()

        self.f = ParticleEffect.ParticleEffect('VoodooSmokeBlast')
        ...
        self.p0.renderer.getColorInterpolationManager().addLinear(0.0, 1.0, Vec4(1, 0.4, 0.4, 1.0), Vec4(0.0, 0.0, 0.0, 0.0), 1)
